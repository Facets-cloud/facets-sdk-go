...
const (
	...
	// NotificationTagsForTypeResultIDAUDITENTITY captures enum value "AUDIT_ENTITY"
	NotificationTagsForTypeResultIDAUDITENTITY string = "AUDIT_ENTITY"

	// NotificationTagsForTypeResultIDAUDITACTION captures enum value "AUDIT_ACTION"
	NotificationTagsForTypeResultIDAUDITACTION string = "AUDIT_ACTION"
)
