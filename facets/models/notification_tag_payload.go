...
type NotificationTagPayload struct {
	...
	// notification tag
	// Enum: ["CLUSTER_NAME","CLUSTER_TYPE","QASUITE_RESULT","DR_ACTION","DR_STATUS","STACK_NAME","SEVERITY","ALERT_NAME","DEPLOYMENT_STATUS","APPLICATION_NAME","SEND_RESOLVED","RELEASE_TYPE","ENVIRONMENT_TEARDOWN_NOTIFY_BEFORE","AUDIT_ENTITY","AUDIT_ACTION"]
...
const (
	...
	// NotificationTagPayloadNotificationTagAUDITENTITY captures enum value "AUDIT_ENTITY"
	NotificationTagPayloadNotificationTagAUDITENTITY string = "AUDIT_ENTITY"

	// NotificationTagPayloadNotificationTagAUDITACTION captures enum value "AUDIT_ACTION"
	NotificationTagPayloadNotificationTagAUDITACTION string = "AUDIT_ACTION"
)
