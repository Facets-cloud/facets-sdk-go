...
func (m *Pod) validateMetadata(formats strfmt.Registry) error {
...
func (m *Pod) validateSpec(formats strfmt.Registry) error {
...
func (m *Pod) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Pod) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
