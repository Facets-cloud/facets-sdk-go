...
func (m *PodAffinityTerm) validateNamespaceSelector(formats strfmt.Registry) error {
...
func (m *PodAffinityTerm) contextValidateNamespaceSelector(ctx context.Context, formats strfmt.Registry) error {
