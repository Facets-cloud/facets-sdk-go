...
var projectTypeAllowedCloudsItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		projectTypeAllowedCloudsItemsEnum = append(projectTypeAllowedCloudsItemsEnum, v)
	}
}

func (m *ProjectType) validateAllowedCloudsItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, projectTypeAllowedCloudsItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ProjectType) validateAllowedClouds(formats strfmt.Registry) error {
...
func (m *ProjectType) validateCreationDate(formats strfmt.Registry) error {
...
var projectTypeTypeIacToolPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		projectTypeTypeIacToolPropEnum = append(projectTypeTypeIacToolPropEnum, v)
	}
}

const (

	// ProjectTypeIacToolTERRAFORM captures enum value "TERRAFORM"
	ProjectTypeIacToolTERRAFORM string = "TERRAFORM"

	// ProjectTypeIacToolOPENTOFU captures enum value "OPENTOFU"
	ProjectTypeIacToolOPENTOFU string = "OPENTOFU"
)

// prop value enum
func (m *ProjectType) validateIacToolEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, projectTypeTypeIacToolPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ProjectType) validateIacTool(formats strfmt.Registry) error {
...
func (m *ProjectType) validateLastModifiedDate(formats strfmt.Registry) error {
...
func (m *ProjectType) validateMappedResources(formats strfmt.Registry) error {
...
func (m *ProjectType) validateTemplateGitDetails(formats strfmt.Registry) error {
...
// ContextValidate validate this project type based on the context it is used
...
func (m *ProjectType) contextValidateMappedResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProjectType) contextValidateTemplateGitDetails(ctx context.Context, formats strfmt.Registry) error {
