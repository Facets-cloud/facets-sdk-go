...
// ContextValidate validate this service overview based on the context it is used
func (m *ServiceOverview) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ServiceOverview) contextValidatePorts(ctx context.Context, formats strfmt.Registry) error {
