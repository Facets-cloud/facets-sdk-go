	...
	if m.AbsoluteFile != nil {
		if err := m.AbsoluteFile.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("absoluteFile")
			}
			return err
		}
	}
	...
	if m.CanonicalFile != nil {
		if err := m.CanonicalFile.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("canonicalFile")
			}
			return err
		}
	}
	...
	if m.ParentFile != nil {
		if err := m.ParentFile.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("parentFile")
			}
			return err
		}
	}
...
func (m *File) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateAbsoluteFile(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateCanonicalFile(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateParentFile(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *File) contextValidateAbsoluteFile(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.AbsoluteFile != nil {
		...
		if err := m.AbsoluteFile.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("absoluteFile")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("absoluteFile")
...
func (m *File) contextValidateCanonicalFile(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.CanonicalFile != nil {
		...
		if err := m.CanonicalFile.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("canonicalFile")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("canonicalFile")
...
func (m *File) contextValidateParentFile(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.ParentFile != nil {
		...
		if err := m.ParentFile.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("parentFile")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("parentFile")
