...
func (m *Resource) contextValidateFile(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Resource) contextValidateURI(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Resource) contextValidateURL(ctx context.Context, formats strfmt.Registry) error {
