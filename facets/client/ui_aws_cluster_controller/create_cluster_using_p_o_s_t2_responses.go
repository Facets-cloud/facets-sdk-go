...
func (o *CreateClusterUsingPOST2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CreateClusterUsingPOST2Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/aws/clusters][%d] createClusterUsingPOST2Forbidden %s", 403, payload)
}
...
func (o *CreateClusterUsingPOST2Forbidden) GetPayload() string {
	return o.Payload
}
