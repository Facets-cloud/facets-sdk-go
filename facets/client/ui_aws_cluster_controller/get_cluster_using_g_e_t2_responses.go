...
func (o *GetClusterUsingGET2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetClusterUsingGET2Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/aws/clusters/{clusterId}][%d] getClusterUsingGET2Forbidden %s", 403, payload)
}
...
func (o *GetClusterUsingGET2Forbidden) GetPayload() string {
	return o.Payload
}
