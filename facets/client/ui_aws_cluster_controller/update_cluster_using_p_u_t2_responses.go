...
func (o *UpdateClusterUsingPUT2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /cc-ui/v1/aws/clusters/{clusterId}] updateClusterUsingPUT2", response, response.Code())
	}
}
...
func (o *UpdateClusterUsingPUT2OK) Error() string {
	...
	return fmt.Sprintf("[PUT /cc-ui/v1/aws/clusters/{clusterId}][%d] updateClusterUsingPUT2OK %s", 200, payload)
}
...
func (o *UpdateClusterUsingPUT2OK) GetPayload() *models.AwsCluster {
	return o.Payload
}
...
func (o *UpdateClusterUsingPUT2Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/aws/clusters/{clusterId}][%d] updateClusterUsingPUT2Forbidden %s", 403, payload)
}
...
func (o *UpdateClusterUsingPUT2Forbidden) GetPayload() string {
	return o.Payload
}
