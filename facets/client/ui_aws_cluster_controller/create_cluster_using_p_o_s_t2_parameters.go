...
CreateClusterUsingPOST2Params contains all the parameters to send to the API endpoint
	...
	for the create cluster using p o s t2 operation.
...
// WithDefaults hydrates default values in the create cluster using p o s t2 params (not the query body).
//
...
// SetDefaults hydrates default values in the create cluster using p o s t2 params (not the query body).
//
// All values with no default are reset to their zero value.
