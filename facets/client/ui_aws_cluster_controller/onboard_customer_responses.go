...
func (o *OnboardCustomerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewOnboardCustomerForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewOnboardCustomerForbidden creates a OnboardCustomerForbidden with default headers values
func NewOnboardCustomerForbidden() *OnboardCustomerForbidden {
	return &OnboardCustomerForbidden{}
}

/*
OnboardCustomerForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type OnboardCustomerForbidden struct {
	Payload string
}

// IsSuccess returns true when this onboard customer forbidden response has a 2xx status code
func (o *OnboardCustomerForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this onboard customer forbidden response has a 3xx status code
func (o *OnboardCustomerForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this onboard customer forbidden response has a 4xx status code
func (o *OnboardCustomerForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this onboard customer forbidden response has a 5xx status code
func (o *OnboardCustomerForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this onboard customer forbidden response a status code equal to that given
func (o *OnboardCustomerForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the onboard customer forbidden response
func (o *OnboardCustomerForbidden) Code() int {
	return 403
}

func (o *OnboardCustomerForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/aws/clusters/onboard-customer][%d] onboardCustomerForbidden %s", 403, payload)
}

func (o *OnboardCustomerForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/aws/clusters/onboard-customer][%d] onboardCustomerForbidden %s", 403, payload)
}

func (o *OnboardCustomerForbidden) GetPayload() string {
	return o.Payload
}

func (o *OnboardCustomerForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
