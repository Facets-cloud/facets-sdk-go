...
func (o *GetArtifactCIReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetArtifactCIForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetArtifactCIForbidden creates a GetArtifactCIForbidden with default headers values
func NewGetArtifactCIForbidden() *GetArtifactCIForbidden {
	return &GetArtifactCIForbidden{}
}

/*
GetArtifactCIForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetArtifactCIForbidden struct {
	Payload string
}

// IsSuccess returns true when this get artifact c i forbidden response has a 2xx status code
func (o *GetArtifactCIForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get artifact c i forbidden response has a 3xx status code
func (o *GetArtifactCIForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get artifact c i forbidden response has a 4xx status code
func (o *GetArtifactCIForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get artifact c i forbidden response has a 5xx status code
func (o *GetArtifactCIForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get artifact c i forbidden response a status code equal to that given
func (o *GetArtifactCIForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get artifact c i forbidden response
func (o *GetArtifactCIForbidden) Code() int {
	return 403
}

func (o *GetArtifactCIForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifacts-ci/{ciId}][%d] getArtifactCIForbidden %s", 403, payload)
}

func (o *GetArtifactCIForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifacts-ci/{ciId}][%d] getArtifactCIForbidden %s", 403, payload)
}

func (o *GetArtifactCIForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetArtifactCIForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
