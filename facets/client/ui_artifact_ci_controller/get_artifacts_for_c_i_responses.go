...
func (o *GetArtifactsForCIReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetArtifactsForCIForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetArtifactsForCIForbidden creates a GetArtifactsForCIForbidden with default headers values
func NewGetArtifactsForCIForbidden() *GetArtifactsForCIForbidden {
	return &GetArtifactsForCIForbidden{}
}

/*
GetArtifactsForCIForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetArtifactsForCIForbidden struct {
	Payload string
}

// IsSuccess returns true when this get artifacts for c i forbidden response has a 2xx status code
func (o *GetArtifactsForCIForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get artifacts for c i forbidden response has a 3xx status code
func (o *GetArtifactsForCIForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get artifacts for c i forbidden response has a 4xx status code
func (o *GetArtifactsForCIForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get artifacts for c i forbidden response has a 5xx status code
func (o *GetArtifactsForCIForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get artifacts for c i forbidden response a status code equal to that given
func (o *GetArtifactsForCIForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get artifacts for c i forbidden response
func (o *GetArtifactsForCIForbidden) Code() int {
	return 403
}

func (o *GetArtifactsForCIForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifacts-ci/{ciName}/artifacts][%d] getArtifactsForCIForbidden %s", 403, payload)
}

func (o *GetArtifactsForCIForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifacts-ci/{ciName}/artifacts][%d] getArtifactsForCIForbidden %s", 403, payload)
}

func (o *GetArtifactsForCIForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetArtifactsForCIForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
