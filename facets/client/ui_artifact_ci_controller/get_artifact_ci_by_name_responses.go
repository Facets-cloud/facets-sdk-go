...
func (o *GetArtifactCiByNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetArtifactCiByNameForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetArtifactCiByNameForbidden creates a GetArtifactCiByNameForbidden with default headers values
func NewGetArtifactCiByNameForbidden() *GetArtifactCiByNameForbidden {
	return &GetArtifactCiByNameForbidden{}
}

/*
GetArtifactCiByNameForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetArtifactCiByNameForbidden struct {
	Payload string
}

// IsSuccess returns true when this get artifact ci by name forbidden response has a 2xx status code
func (o *GetArtifactCiByNameForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get artifact ci by name forbidden response has a 3xx status code
func (o *GetArtifactCiByNameForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get artifact ci by name forbidden response has a 4xx status code
func (o *GetArtifactCiByNameForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get artifact ci by name forbidden response has a 5xx status code
func (o *GetArtifactCiByNameForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get artifact ci by name forbidden response a status code equal to that given
func (o *GetArtifactCiByNameForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get artifact ci by name forbidden response
func (o *GetArtifactCiByNameForbidden) Code() int {
	return 403
}

func (o *GetArtifactCiByNameForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifacts-ci/name/{ciName}][%d] getArtifactCiByNameForbidden %s", 403, payload)
}

func (o *GetArtifactCiByNameForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifacts-ci/name/{ciName}][%d] getArtifactCiByNameForbidden %s", 403, payload)
}

func (o *GetArtifactCiByNameForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetArtifactCiByNameForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
