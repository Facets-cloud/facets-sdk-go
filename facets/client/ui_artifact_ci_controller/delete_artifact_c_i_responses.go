...
func (o *DeleteArtifactCIReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteArtifactCIForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteArtifactCIForbidden creates a DeleteArtifactCIForbidden with default headers values
func NewDeleteArtifactCIForbidden() *DeleteArtifactCIForbidden {
	return &DeleteArtifactCIForbidden{}
}

/*
DeleteArtifactCIForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteArtifactCIForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete artifact c i forbidden response has a 2xx status code
func (o *DeleteArtifactCIForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete artifact c i forbidden response has a 3xx status code
func (o *DeleteArtifactCIForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete artifact c i forbidden response has a 4xx status code
func (o *DeleteArtifactCIForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete artifact c i forbidden response has a 5xx status code
func (o *DeleteArtifactCIForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete artifact c i forbidden response a status code equal to that given
func (o *DeleteArtifactCIForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete artifact c i forbidden response
func (o *DeleteArtifactCIForbidden) Code() int {
	return 403
}

func (o *DeleteArtifactCIForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/artifacts-ci/{ciId}][%d] deleteArtifactCIForbidden %s", 403, payload)
}

func (o *DeleteArtifactCIForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/artifacts-ci/{ciId}][%d] deleteArtifactCIForbidden %s", 403, payload)
}

func (o *DeleteArtifactCIForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteArtifactCIForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
