...
func (o *UpdateArtifactCIReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateArtifactCIForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateArtifactCIForbidden creates a UpdateArtifactCIForbidden with default headers values
func NewUpdateArtifactCIForbidden() *UpdateArtifactCIForbidden {
	return &UpdateArtifactCIForbidden{}
}

/*
UpdateArtifactCIForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateArtifactCIForbidden struct {
	Payload string
}

// IsSuccess returns true when this update artifact c i forbidden response has a 2xx status code
func (o *UpdateArtifactCIForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update artifact c i forbidden response has a 3xx status code
func (o *UpdateArtifactCIForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update artifact c i forbidden response has a 4xx status code
func (o *UpdateArtifactCIForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update artifact c i forbidden response has a 5xx status code
func (o *UpdateArtifactCIForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update artifact c i forbidden response a status code equal to that given
func (o *UpdateArtifactCIForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update artifact c i forbidden response
func (o *UpdateArtifactCIForbidden) Code() int {
	return 403
}

func (o *UpdateArtifactCIForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/artifacts-ci/{ciId}][%d] updateArtifactCIForbidden %s", 403, payload)
}

func (o *UpdateArtifactCIForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/artifacts-ci/{ciId}][%d] updateArtifactCIForbidden %s", 403, payload)
}

func (o *UpdateArtifactCIForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateArtifactCIForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
