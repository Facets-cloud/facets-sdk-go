...
func (o *CreateArtifactCIReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCreateArtifactCIForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateArtifactCIForbidden creates a CreateArtifactCIForbidden with default headers values
func NewCreateArtifactCIForbidden() *CreateArtifactCIForbidden {
	return &CreateArtifactCIForbidden{}
}

/*
CreateArtifactCIForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CreateArtifactCIForbidden struct {
	Payload string
}

// IsSuccess returns true when this create artifact c i forbidden response has a 2xx status code
func (o *CreateArtifactCIForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create artifact c i forbidden response has a 3xx status code
func (o *CreateArtifactCIForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create artifact c i forbidden response has a 4xx status code
func (o *CreateArtifactCIForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create artifact c i forbidden response has a 5xx status code
func (o *CreateArtifactCIForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create artifact c i forbidden response a status code equal to that given
func (o *CreateArtifactCIForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create artifact c i forbidden response
func (o *CreateArtifactCIForbidden) Code() int {
	return 403
}

func (o *CreateArtifactCIForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts-ci][%d] createArtifactCIForbidden %s", 403, payload)
}

func (o *CreateArtifactCIForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts-ci][%d] createArtifactCIForbidden %s", 403, payload)
}

func (o *CreateArtifactCIForbidden) GetPayload() string {
	return o.Payload
}

func (o *CreateArtifactCIForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
