...
func (o *GetAllWorkflowsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllWorkflowsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllWorkflowsForbidden creates a GetAllWorkflowsForbidden with default headers values
func NewGetAllWorkflowsForbidden() *GetAllWorkflowsForbidden {
	return &GetAllWorkflowsForbidden{}
}

/*
GetAllWorkflowsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllWorkflowsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all workflows forbidden response has a 2xx status code
func (o *GetAllWorkflowsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all workflows forbidden response has a 3xx status code
func (o *GetAllWorkflowsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all workflows forbidden response has a 4xx status code
func (o *GetAllWorkflowsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all workflows forbidden response has a 5xx status code
func (o *GetAllWorkflowsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all workflows forbidden response a status code equal to that given
func (o *GetAllWorkflowsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all workflows forbidden response
func (o *GetAllWorkflowsForbidden) Code() int {
	return 403
}

func (o *GetAllWorkflowsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/workflow][%d] getAllWorkflowsForbidden %s", 403, payload)
}

func (o *GetAllWorkflowsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/workflow][%d] getAllWorkflowsForbidden %s", 403, payload)
}

func (o *GetAllWorkflowsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllWorkflowsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
