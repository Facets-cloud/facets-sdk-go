...
func (o *UpdateWorkflowParams) WithBody(body *models.PromotionWorkflow) *UpdateWorkflowParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update workflow params
func (o *UpdateWorkflowParams) SetBody(body *models.PromotionWorkflow) {
	o.Body = body
}
