...
func (o *DeleteWorkflowReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteWorkflowForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteWorkflowForbidden creates a DeleteWorkflowForbidden with default headers values
func NewDeleteWorkflowForbidden() *DeleteWorkflowForbidden {
	return &DeleteWorkflowForbidden{}
}

/*
DeleteWorkflowForbidden describes a response with status code 403, with default header values.
...
// IsSuccess returns true when this delete workflow forbidden response has a 2xx status code
func (o *DeleteWorkflowForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete workflow forbidden response has a 3xx status code
func (o *DeleteWorkflowForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete workflow forbidden response has a 4xx status code
func (o *DeleteWorkflowForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete workflow forbidden response has a 5xx status code
func (o *DeleteWorkflowForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete workflow forbidden response a status code equal to that given
func (o *DeleteWorkflowForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete workflow forbidden response
func (o *DeleteWorkflowForbidden) Code() int {
	return 403
}

func (o *DeleteWorkflowForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/workflow/{workflowId}][%d] deleteWorkflowForbidden %s", 403, payload)
}

func (o *DeleteWorkflowForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/workflow/{workflowId}][%d] deleteWorkflowForbidden %s", 403, payload)
}

func (o *DeleteWorkflowForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteWorkflowForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
