...
func (o *CreateWorkflowParams) WithBody(body *models.PromotionWorkflow) *CreateWorkflowParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create workflow params
func (o *CreateWorkflowParams) SetBody(body *models.PromotionWorkflow) {
	o.Body = body
}
