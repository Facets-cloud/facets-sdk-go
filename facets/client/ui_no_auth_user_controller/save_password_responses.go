...
func (o *SavePasswordReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewSavePasswordForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSavePasswordForbidden creates a SavePasswordForbidden with default headers values
func NewSavePasswordForbidden() *SavePasswordForbidden {
	return &SavePasswordForbidden{}
}

/*
SavePasswordForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type SavePasswordForbidden struct {
	Payload string
}

// IsSuccess returns true when this save password forbidden response has a 2xx status code
func (o *SavePasswordForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this save password forbidden response has a 3xx status code
func (o *SavePasswordForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this save password forbidden response has a 4xx status code
func (o *SavePasswordForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this save password forbidden response has a 5xx status code
func (o *SavePasswordForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this save password forbidden response a status code equal to that given
func (o *SavePasswordForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the save password forbidden response
func (o *SavePasswordForbidden) Code() int {
	return 403
}

func (o *SavePasswordForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public-ui/v1/user/savePassword][%d] savePasswordForbidden %s", 403, payload)
}

func (o *SavePasswordForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public-ui/v1/user/savePassword][%d] savePasswordForbidden %s", 403, payload)
}

func (o *SavePasswordForbidden) GetPayload() string {
	return o.Payload
}

func (o *SavePasswordForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
