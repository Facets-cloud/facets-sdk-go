...
/*
ValidateTokenForbidden describes a response with status code 403, with default header values.
...
// IsSuccess returns true when this validate token forbidden response has a 2xx status code
func (o *ValidateTokenForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this validate token forbidden response has a 3xx status code
func (o *ValidateTokenForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this validate token forbidden response has a 4xx status code
func (o *ValidateTokenForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this validate token forbidden response has a 5xx status code
func (o *ValidateTokenForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this validate token forbidden response a status code equal to that given
func (o *ValidateTokenForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the validate token forbidden response
func (o *ValidateTokenForbidden) Code() int {
	return 403
}

func (o *ValidateTokenForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public-ui/v1/user/token/validate][%d] validateTokenForbidden %s", 403, payload)
}

func (o *ValidateTokenForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public-ui/v1/user/token/validate][%d] validateTokenForbidden %s", 403, payload)
}

func (o *ValidateTokenForbidden) GetPayload() string {
	return o.Payload
}
