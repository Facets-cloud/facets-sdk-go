...
func (o *ResetPasswordRequestReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewResetPasswordRequestForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewResetPasswordRequestForbidden creates a ResetPasswordRequestForbidden with default headers values
func NewResetPasswordRequestForbidden() *ResetPasswordRequestForbidden {
	return &ResetPasswordRequestForbidden{}
}

/*
ResetPasswordRequestForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ResetPasswordRequestForbidden struct {
	Payload string
}

// IsSuccess returns true when this reset password request forbidden response has a 2xx status code
func (o *ResetPasswordRequestForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this reset password request forbidden response has a 3xx status code
func (o *ResetPasswordRequestForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this reset password request forbidden response has a 4xx status code
func (o *ResetPasswordRequestForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this reset password request forbidden response has a 5xx status code
func (o *ResetPasswordRequestForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this reset password request forbidden response a status code equal to that given
func (o *ResetPasswordRequestForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the reset password request forbidden response
func (o *ResetPasswordRequestForbidden) Code() int {
	return 403
}

func (o *ResetPasswordRequestForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public-ui/v1/user/resetPassword][%d] resetPasswordRequestForbidden %s", 403, payload)
}

func (o *ResetPasswordRequestForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public-ui/v1/user/resetPassword][%d] resetPasswordRequestForbidden %s", 403, payload)
}

func (o *ResetPasswordRequestForbidden) GetPayload() string {
	return o.Payload
}

func (o *ResetPasswordRequestForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
