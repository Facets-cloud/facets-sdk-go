...
func (o *ResetPasswordRequestParams) WithBody(body *models.ResetPasswordRequest) *ResetPasswordRequestParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the reset password request params
func (o *ResetPasswordRequestParams) SetBody(body *models.ResetPasswordRequest) {
	o.Body = body
}
