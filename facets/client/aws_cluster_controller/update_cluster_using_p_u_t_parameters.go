...
// WithRequest adds the request to the update cluster using p u t params
func (o *UpdateClusterUsingPUTParams) WithRequest(request *models.AwsClusterRequest) *UpdateClusterUsingPUTParams {
	o.SetRequest(request)
	return o
}

// SetRequest adds the request to the update cluster using p u t params
func (o *UpdateClusterUsingPUTParams) SetRequest(request *models.AwsClusterRequest) {
	o.Request = request
}
