...
func (o *IsAwsCostExplorerEnabledReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewIsAwsCostExplorerEnabledForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIsAwsCostExplorerEnabledForbidden creates a IsAwsCostExplorerEnabledForbidden with default headers values
func NewIsAwsCostExplorerEnabledForbidden() *IsAwsCostExplorerEnabledForbidden {
	return &IsAwsCostExplorerEnabledForbidden{}
}

/*
IsAwsCostExplorerEnabledForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type IsAwsCostExplorerEnabledForbidden struct {
	Payload string
}

// IsSuccess returns true when this is aws cost explorer enabled forbidden response has a 2xx status code
func (o *IsAwsCostExplorerEnabledForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this is aws cost explorer enabled forbidden response has a 3xx status code
func (o *IsAwsCostExplorerEnabledForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this is aws cost explorer enabled forbidden response has a 4xx status code
func (o *IsAwsCostExplorerEnabledForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this is aws cost explorer enabled forbidden response has a 5xx status code
func (o *IsAwsCostExplorerEnabledForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this is aws cost explorer enabled forbidden response a status code equal to that given
func (o *IsAwsCostExplorerEnabledForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the is aws cost explorer enabled forbidden response
func (o *IsAwsCostExplorerEnabledForbidden) Code() int {
	return 403
}

func (o *IsAwsCostExplorerEnabledForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/cost-explorer/aws/enabled][%d] isAwsCostExplorerEnabledForbidden %s", 403, payload)
}

func (o *IsAwsCostExplorerEnabledForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/cost-explorer/aws/enabled][%d] isAwsCostExplorerEnabledForbidden %s", 403, payload)
}

func (o *IsAwsCostExplorerEnabledForbidden) GetPayload() string {
	return o.Payload
}

func (o *IsAwsCostExplorerEnabledForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
