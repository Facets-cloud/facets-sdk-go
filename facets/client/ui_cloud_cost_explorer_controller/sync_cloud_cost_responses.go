...
func (o *SyncCloudCostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewSyncCloudCostForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSyncCloudCostForbidden creates a SyncCloudCostForbidden with default headers values
func NewSyncCloudCostForbidden() *SyncCloudCostForbidden {
	return &SyncCloudCostForbidden{}
}

/*
SyncCloudCostForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type SyncCloudCostForbidden struct {
	Payload string
}

// IsSuccess returns true when this sync cloud cost forbidden response has a 2xx status code
func (o *SyncCloudCostForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this sync cloud cost forbidden response has a 3xx status code
func (o *SyncCloudCostForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this sync cloud cost forbidden response has a 4xx status code
func (o *SyncCloudCostForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this sync cloud cost forbidden response has a 5xx status code
func (o *SyncCloudCostForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this sync cloud cost forbidden response a status code equal to that given
func (o *SyncCloudCostForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the sync cloud cost forbidden response
func (o *SyncCloudCostForbidden) Code() int {
	return 403
}

func (o *SyncCloudCostForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/cost-explorer/sync-cost][%d] syncCloudCostForbidden %s", 403, payload)
}

func (o *SyncCloudCostForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/cost-explorer/sync-cost][%d] syncCloudCostForbidden %s", 403, payload)
}

func (o *SyncCloudCostForbidden) GetPayload() string {
	return o.Payload
}

func (o *SyncCloudCostForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
