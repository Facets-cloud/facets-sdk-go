...
func (o *GetDailyCloudCostParams) WithEnd(end strfmt.Date) *GetDailyCloudCostParams {
	o.SetEnd(end)
	return o
}

// SetEnd adds the end to the get daily cloud cost params
func (o *GetDailyCloudCostParams) SetEnd(end strfmt.Date) {
	o.End = end
}
...
func (o *GetDailyCloudCostParams) WithStart(start strfmt.Date) *GetDailyCloudCostParams {
	o.SetStart(start)
	return o
}

// SetStart adds the start to the get daily cloud cost params
func (o *GetDailyCloudCostParams) SetStart(start strfmt.Date) {
	o.Start = start
}
...
// bindParamGetDailyCloudCost binds the parameter clusterIds
func (o *GetDailyCloudCostParams) bindParamClusterIds(formats strfmt.Registry) []string {
