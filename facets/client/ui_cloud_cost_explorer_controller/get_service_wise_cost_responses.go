...
func (o *GetServiceWiseCostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetServiceWiseCostForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetServiceWiseCostForbidden creates a GetServiceWiseCostForbidden with default headers values
func NewGetServiceWiseCostForbidden() *GetServiceWiseCostForbidden {
	return &GetServiceWiseCostForbidden{}
}

/*
GetServiceWiseCostForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetServiceWiseCostForbidden struct {
	Payload string
}

// IsSuccess returns true when this get service wise cost forbidden response has a 2xx status code
func (o *GetServiceWiseCostForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get service wise cost forbidden response has a 3xx status code
func (o *GetServiceWiseCostForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get service wise cost forbidden response has a 4xx status code
func (o *GetServiceWiseCostForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get service wise cost forbidden response has a 5xx status code
func (o *GetServiceWiseCostForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get service wise cost forbidden response a status code equal to that given
func (o *GetServiceWiseCostForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get service wise cost forbidden response
func (o *GetServiceWiseCostForbidden) Code() int {
	return 403
}

func (o *GetServiceWiseCostForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/cost-explorer/service-wise-cost/{clusterId}][%d] getServiceWiseCostForbidden %s", 403, payload)
}

func (o *GetServiceWiseCostForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/cost-explorer/service-wise-cost/{clusterId}][%d] getServiceWiseCostForbidden %s", 403, payload)
}

func (o *GetServiceWiseCostForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetServiceWiseCostForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
