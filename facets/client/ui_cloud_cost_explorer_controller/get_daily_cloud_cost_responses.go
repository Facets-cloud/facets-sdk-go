...
func (o *GetDailyCloudCostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetDailyCloudCostForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetDailyCloudCostForbidden creates a GetDailyCloudCostForbidden with default headers values
func NewGetDailyCloudCostForbidden() *GetDailyCloudCostForbidden {
	return &GetDailyCloudCostForbidden{}
}

/*
GetDailyCloudCostForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetDailyCloudCostForbidden struct {
	Payload string
}

// IsSuccess returns true when this get daily cloud cost forbidden response has a 2xx status code
func (o *GetDailyCloudCostForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get daily cloud cost forbidden response has a 3xx status code
func (o *GetDailyCloudCostForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get daily cloud cost forbidden response has a 4xx status code
func (o *GetDailyCloudCostForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get daily cloud cost forbidden response has a 5xx status code
func (o *GetDailyCloudCostForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get daily cloud cost forbidden response a status code equal to that given
func (o *GetDailyCloudCostForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get daily cloud cost forbidden response
func (o *GetDailyCloudCostForbidden) Code() int {
	return 403
}

func (o *GetDailyCloudCostForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/cost-explorer/stack/{stackName}/daily-cost][%d] getDailyCloudCostForbidden %s", 403, payload)
}

func (o *GetDailyCloudCostForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/cost-explorer/stack/{stackName}/daily-cost][%d] getDailyCloudCostForbidden %s", 403, payload)
}

func (o *GetDailyCloudCostForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetDailyCloudCostForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
