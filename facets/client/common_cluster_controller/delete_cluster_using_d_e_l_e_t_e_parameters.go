...
// WithClusterID adds the clusterID to the delete cluster using d e l e t e params
func (o *DeleteClusterUsingDELETEParams) WithClusterID(clusterID string) *DeleteClusterUsingDELETEParams {
	o.SetClusterID(clusterID)
	return o
}

// SetClusterID adds the clusterId to the delete cluster using d e l e t e params
func (o *DeleteClusterUsingDELETEParams) SetClusterID(clusterID string) {
