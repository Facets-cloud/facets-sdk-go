...
func (o *ListServicesByLabelsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewListServicesByLabelsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewListServicesByLabelsForbidden creates a ListServicesByLabelsForbidden with default headers values
func NewListServicesByLabelsForbidden() *ListServicesByLabelsForbidden {
	return &ListServicesByLabelsForbidden{}
}

/*
ListServicesByLabelsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ListServicesByLabelsForbidden struct {
	Payload string
}

// IsSuccess returns true when this list services by labels forbidden response has a 2xx status code
func (o *ListServicesByLabelsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this list services by labels forbidden response has a 3xx status code
func (o *ListServicesByLabelsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list services by labels forbidden response has a 4xx status code
func (o *ListServicesByLabelsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this list services by labels forbidden response has a 5xx status code
func (o *ListServicesByLabelsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this list services by labels forbidden response a status code equal to that given
func (o *ListServicesByLabelsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the list services by labels forbidden response
func (o *ListServicesByLabelsForbidden) Code() int {
	return 403
}

func (o *ListServicesByLabelsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/services][%d] listServicesByLabelsForbidden %s", 403, payload)
}

func (o *ListServicesByLabelsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/services][%d] listServicesByLabelsForbidden %s", 403, payload)
}

func (o *ListServicesByLabelsForbidden) GetPayload() string {
	return o.Payload
}

func (o *ListServicesByLabelsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
