...
func (o *ContainerLogsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewContainerLogsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewContainerLogsForbidden creates a ContainerLogsForbidden with default headers values
func NewContainerLogsForbidden() *ContainerLogsForbidden {
	return &ContainerLogsForbidden{}
}

/*
ContainerLogsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ContainerLogsForbidden struct {
	Payload string
}

// IsSuccess returns true when this container logs forbidden response has a 2xx status code
func (o *ContainerLogsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this container logs forbidden response has a 3xx status code
func (o *ContainerLogsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this container logs forbidden response has a 4xx status code
func (o *ContainerLogsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this container logs forbidden response has a 5xx status code
func (o *ContainerLogsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this container logs forbidden response a status code equal to that given
func (o *ContainerLogsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the container logs forbidden response
func (o *ContainerLogsForbidden) Code() int {
	return 403
}

func (o *ContainerLogsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/pods/{podName}/{containerName}/logs][%d] containerLogsForbidden %s", 403, payload)
}

func (o *ContainerLogsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/pods/{podName}/{containerName}/logs][%d] containerLogsForbidden %s", 403, payload)
}

func (o *ContainerLogsForbidden) GetPayload() string {
	return o.Payload
}

func (o *ContainerLogsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
