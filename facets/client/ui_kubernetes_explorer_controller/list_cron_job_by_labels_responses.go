...
func (o *ListCronJobByLabelsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewListCronJobByLabelsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewListCronJobByLabelsForbidden creates a ListCronJobByLabelsForbidden with default headers values
func NewListCronJobByLabelsForbidden() *ListCronJobByLabelsForbidden {
	return &ListCronJobByLabelsForbidden{}
}

/*
ListCronJobByLabelsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ListCronJobByLabelsForbidden struct {
	Payload string
}

// IsSuccess returns true when this list cron job by labels forbidden response has a 2xx status code
func (o *ListCronJobByLabelsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this list cron job by labels forbidden response has a 3xx status code
func (o *ListCronJobByLabelsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list cron job by labels forbidden response has a 4xx status code
func (o *ListCronJobByLabelsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this list cron job by labels forbidden response has a 5xx status code
func (o *ListCronJobByLabelsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this list cron job by labels forbidden response a status code equal to that given
func (o *ListCronJobByLabelsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the list cron job by labels forbidden response
func (o *ListCronJobByLabelsForbidden) Code() int {
	return 403
}

func (o *ListCronJobByLabelsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/cronJobs][%d] listCronJobByLabelsForbidden %s", 403, payload)
}

func (o *ListCronJobByLabelsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/cronJobs][%d] listCronJobByLabelsForbidden %s", 403, payload)
}

func (o *ListCronJobByLabelsForbidden) GetPayload() string {
	return o.Payload
}

func (o *ListCronJobByLabelsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
