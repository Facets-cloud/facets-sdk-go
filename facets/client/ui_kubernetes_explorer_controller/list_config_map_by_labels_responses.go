...
func (o *ListConfigMapByLabelsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewListConfigMapByLabelsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewListConfigMapByLabelsForbidden creates a ListConfigMapByLabelsForbidden with default headers values
func NewListConfigMapByLabelsForbidden() *ListConfigMapByLabelsForbidden {
	return &ListConfigMapByLabelsForbidden{}
}

/*
ListConfigMapByLabelsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ListConfigMapByLabelsForbidden struct {
	Payload string
}

// IsSuccess returns true when this list config map by labels forbidden response has a 2xx status code
func (o *ListConfigMapByLabelsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this list config map by labels forbidden response has a 3xx status code
func (o *ListConfigMapByLabelsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list config map by labels forbidden response has a 4xx status code
func (o *ListConfigMapByLabelsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this list config map by labels forbidden response has a 5xx status code
func (o *ListConfigMapByLabelsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this list config map by labels forbidden response a status code equal to that given
func (o *ListConfigMapByLabelsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the list config map by labels forbidden response
func (o *ListConfigMapByLabelsForbidden) Code() int {
	return 403
}

func (o *ListConfigMapByLabelsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/configMaps][%d] listConfigMapByLabelsForbidden %s", 403, payload)
}

func (o *ListConfigMapByLabelsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/configMaps][%d] listConfigMapByLabelsForbidden %s", 403, payload)
}

func (o *ListConfigMapByLabelsForbidden) GetPayload() string {
	return o.Payload
}

func (o *ListConfigMapByLabelsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
