...
func (o *ListDeploymentsByLabelsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewListDeploymentsByLabelsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewListDeploymentsByLabelsForbidden creates a ListDeploymentsByLabelsForbidden with default headers values
func NewListDeploymentsByLabelsForbidden() *ListDeploymentsByLabelsForbidden {
	return &ListDeploymentsByLabelsForbidden{}
}

/*
ListDeploymentsByLabelsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ListDeploymentsByLabelsForbidden struct {
	Payload string
}

// IsSuccess returns true when this list deployments by labels forbidden response has a 2xx status code
func (o *ListDeploymentsByLabelsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this list deployments by labels forbidden response has a 3xx status code
func (o *ListDeploymentsByLabelsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list deployments by labels forbidden response has a 4xx status code
func (o *ListDeploymentsByLabelsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this list deployments by labels forbidden response has a 5xx status code
func (o *ListDeploymentsByLabelsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this list deployments by labels forbidden response a status code equal to that given
func (o *ListDeploymentsByLabelsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the list deployments by labels forbidden response
func (o *ListDeploymentsByLabelsForbidden) Code() int {
	return 403
}

func (o *ListDeploymentsByLabelsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/deployments][%d] listDeploymentsByLabelsForbidden %s", 403, payload)
}

func (o *ListDeploymentsByLabelsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/deployments][%d] listDeploymentsByLabelsForbidden %s", 403, payload)
}

func (o *ListDeploymentsByLabelsForbidden) GetPayload() string {
	return o.Payload
}

func (o *ListDeploymentsByLabelsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
