...
func (o *ListJobsByLabelsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewListJobsByLabelsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewListJobsByLabelsForbidden creates a ListJobsByLabelsForbidden with default headers values
func NewListJobsByLabelsForbidden() *ListJobsByLabelsForbidden {
	return &ListJobsByLabelsForbidden{}
}

/*
ListJobsByLabelsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ListJobsByLabelsForbidden struct {
	Payload string
}

// IsSuccess returns true when this list jobs by labels forbidden response has a 2xx status code
func (o *ListJobsByLabelsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this list jobs by labels forbidden response has a 3xx status code
func (o *ListJobsByLabelsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list jobs by labels forbidden response has a 4xx status code
func (o *ListJobsByLabelsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this list jobs by labels forbidden response has a 5xx status code
func (o *ListJobsByLabelsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this list jobs by labels forbidden response a status code equal to that given
func (o *ListJobsByLabelsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the list jobs by labels forbidden response
func (o *ListJobsByLabelsForbidden) Code() int {
	return 403
}

func (o *ListJobsByLabelsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/jobs][%d] listJobsByLabelsForbidden %s", 403, payload)
}

func (o *ListJobsByLabelsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/jobs][%d] listJobsByLabelsForbidden %s", 403, payload)
}

func (o *ListJobsByLabelsForbidden) GetPayload() string {
	return o.Payload
}

func (o *ListJobsByLabelsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
