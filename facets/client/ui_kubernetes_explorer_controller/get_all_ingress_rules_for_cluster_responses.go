...
func (o *GetAllIngressRulesForClusterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllIngressRulesForClusterForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllIngressRulesForClusterForbidden creates a GetAllIngressRulesForClusterForbidden with default headers values
func NewGetAllIngressRulesForClusterForbidden() *GetAllIngressRulesForClusterForbidden {
	return &GetAllIngressRulesForClusterForbidden{}
}

/*
GetAllIngressRulesForClusterForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllIngressRulesForClusterForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all ingress rules for cluster forbidden response has a 2xx status code
func (o *GetAllIngressRulesForClusterForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all ingress rules for cluster forbidden response has a 3xx status code
func (o *GetAllIngressRulesForClusterForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all ingress rules for cluster forbidden response has a 4xx status code
func (o *GetAllIngressRulesForClusterForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all ingress rules for cluster forbidden response has a 5xx status code
func (o *GetAllIngressRulesForClusterForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all ingress rules for cluster forbidden response a status code equal to that given
func (o *GetAllIngressRulesForClusterForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all ingress rules for cluster forbidden response
func (o *GetAllIngressRulesForClusterForbidden) Code() int {
	return 403
}

func (o *GetAllIngressRulesForClusterForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/ingress-rules][%d] getAllIngressRulesForClusterForbidden %s", 403, payload)
}

func (o *GetAllIngressRulesForClusterForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/ingress-rules][%d] getAllIngressRulesForClusterForbidden %s", 403, payload)
}

func (o *GetAllIngressRulesForClusterForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllIngressRulesForClusterForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
