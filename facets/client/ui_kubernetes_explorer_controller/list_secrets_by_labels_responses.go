...
func (o *ListSecretsByLabelsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewListSecretsByLabelsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewListSecretsByLabelsForbidden creates a ListSecretsByLabelsForbidden with default headers values
func NewListSecretsByLabelsForbidden() *ListSecretsByLabelsForbidden {
	return &ListSecretsByLabelsForbidden{}
}

/*
ListSecretsByLabelsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ListSecretsByLabelsForbidden struct {
	Payload string
}

// IsSuccess returns true when this list secrets by labels forbidden response has a 2xx status code
func (o *ListSecretsByLabelsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this list secrets by labels forbidden response has a 3xx status code
func (o *ListSecretsByLabelsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list secrets by labels forbidden response has a 4xx status code
func (o *ListSecretsByLabelsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this list secrets by labels forbidden response has a 5xx status code
func (o *ListSecretsByLabelsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this list secrets by labels forbidden response a status code equal to that given
func (o *ListSecretsByLabelsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the list secrets by labels forbidden response
func (o *ListSecretsByLabelsForbidden) Code() int {
	return 403
}

func (o *ListSecretsByLabelsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/secrets][%d] listSecretsByLabelsForbidden %s", 403, payload)
}

func (o *ListSecretsByLabelsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/secrets][%d] listSecretsByLabelsForbidden %s", 403, payload)
}

func (o *ListSecretsByLabelsForbidden) GetPayload() string {
	return o.Payload
}

func (o *ListSecretsByLabelsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
