...
func (o *ListDaemonSetsByLabelsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewListDaemonSetsByLabelsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewListDaemonSetsByLabelsForbidden creates a ListDaemonSetsByLabelsForbidden with default headers values
func NewListDaemonSetsByLabelsForbidden() *ListDaemonSetsByLabelsForbidden {
	return &ListDaemonSetsByLabelsForbidden{}
}

/*
ListDaemonSetsByLabelsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ListDaemonSetsByLabelsForbidden struct {
	Payload string
}

// IsSuccess returns true when this list daemon sets by labels forbidden response has a 2xx status code
func (o *ListDaemonSetsByLabelsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this list daemon sets by labels forbidden response has a 3xx status code
func (o *ListDaemonSetsByLabelsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list daemon sets by labels forbidden response has a 4xx status code
func (o *ListDaemonSetsByLabelsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this list daemon sets by labels forbidden response has a 5xx status code
func (o *ListDaemonSetsByLabelsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this list daemon sets by labels forbidden response a status code equal to that given
func (o *ListDaemonSetsByLabelsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the list daemon sets by labels forbidden response
func (o *ListDaemonSetsByLabelsForbidden) Code() int {
	return 403
}

func (o *ListDaemonSetsByLabelsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/daemonSets][%d] listDaemonSetsByLabelsForbidden %s", 403, payload)
}

func (o *ListDaemonSetsByLabelsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/daemonSets][%d] listDaemonSetsByLabelsForbidden %s", 403, payload)
}

func (o *ListDaemonSetsByLabelsForbidden) GetPayload() string {
	return o.Payload
}

func (o *ListDaemonSetsByLabelsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
