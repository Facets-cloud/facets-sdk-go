...
func (o *ListIngressesByLabelsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewListIngressesByLabelsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewListIngressesByLabelsForbidden creates a ListIngressesByLabelsForbidden with default headers values
func NewListIngressesByLabelsForbidden() *ListIngressesByLabelsForbidden {
	return &ListIngressesByLabelsForbidden{}
}

/*
ListIngressesByLabelsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ListIngressesByLabelsForbidden struct {
	Payload string
}

// IsSuccess returns true when this list ingresses by labels forbidden response has a 2xx status code
func (o *ListIngressesByLabelsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this list ingresses by labels forbidden response has a 3xx status code
func (o *ListIngressesByLabelsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list ingresses by labels forbidden response has a 4xx status code
func (o *ListIngressesByLabelsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this list ingresses by labels forbidden response has a 5xx status code
func (o *ListIngressesByLabelsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this list ingresses by labels forbidden response a status code equal to that given
func (o *ListIngressesByLabelsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the list ingresses by labels forbidden response
func (o *ListIngressesByLabelsForbidden) Code() int {
	return 403
}

func (o *ListIngressesByLabelsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/ingresses][%d] listIngressesByLabelsForbidden %s", 403, payload)
}

func (o *ListIngressesByLabelsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/ingresses][%d] listIngressesByLabelsForbidden %s", 403, payload)
}

func (o *ListIngressesByLabelsForbidden) GetPayload() string {
	return o.Payload
}

func (o *ListIngressesByLabelsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
