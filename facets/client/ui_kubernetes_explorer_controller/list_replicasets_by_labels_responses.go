...
func (o *ListReplicasetsByLabelsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewListReplicasetsByLabelsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewListReplicasetsByLabelsForbidden creates a ListReplicasetsByLabelsForbidden with default headers values
func NewListReplicasetsByLabelsForbidden() *ListReplicasetsByLabelsForbidden {
	return &ListReplicasetsByLabelsForbidden{}
}

/*
ListReplicasetsByLabelsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ListReplicasetsByLabelsForbidden struct {
	Payload string
}

// IsSuccess returns true when this list replicasets by labels forbidden response has a 2xx status code
func (o *ListReplicasetsByLabelsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this list replicasets by labels forbidden response has a 3xx status code
func (o *ListReplicasetsByLabelsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list replicasets by labels forbidden response has a 4xx status code
func (o *ListReplicasetsByLabelsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this list replicasets by labels forbidden response has a 5xx status code
func (o *ListReplicasetsByLabelsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this list replicasets by labels forbidden response a status code equal to that given
func (o *ListReplicasetsByLabelsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the list replicasets by labels forbidden response
func (o *ListReplicasetsByLabelsForbidden) Code() int {
	return 403
}

func (o *ListReplicasetsByLabelsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/replicasets][%d] listReplicasetsByLabelsForbidden %s", 403, payload)
}

func (o *ListReplicasetsByLabelsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/replicasets][%d] listReplicasetsByLabelsForbidden %s", 403, payload)
}

func (o *ListReplicasetsByLabelsForbidden) GetPayload() string {
	return o.Payload
}

func (o *ListReplicasetsByLabelsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
