...
func (o *GetManifestReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetManifestForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetManifestForbidden creates a GetManifestForbidden with default headers values
func NewGetManifestForbidden() *GetManifestForbidden {
	return &GetManifestForbidden{}
}

/*
GetManifestForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetManifestForbidden struct {
	Payload string
}

// IsSuccess returns true when this get manifest forbidden response has a 2xx status code
func (o *GetManifestForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get manifest forbidden response has a 3xx status code
func (o *GetManifestForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get manifest forbidden response has a 4xx status code
func (o *GetManifestForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get manifest forbidden response has a 5xx status code
func (o *GetManifestForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get manifest forbidden response a status code equal to that given
func (o *GetManifestForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get manifest forbidden response
func (o *GetManifestForbidden) Code() int {
	return 403
}

func (o *GetManifestForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/{k8sResourceType}/{k8sResourceName}/manifest][%d] getManifestForbidden %s", 403, payload)
}

func (o *GetManifestForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/{k8sResourceType}/{k8sResourceName}/manifest][%d] getManifestForbidden %s", 403, payload)
}

func (o *GetManifestForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetManifestForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
