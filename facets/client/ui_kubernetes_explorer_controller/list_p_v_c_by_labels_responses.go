...
func (o *ListPVCByLabelsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewListPVCByLabelsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewListPVCByLabelsForbidden creates a ListPVCByLabelsForbidden with default headers values
func NewListPVCByLabelsForbidden() *ListPVCByLabelsForbidden {
	return &ListPVCByLabelsForbidden{}
}

/*
ListPVCByLabelsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ListPVCByLabelsForbidden struct {
	Payload string
}

// IsSuccess returns true when this list p v c by labels forbidden response has a 2xx status code
func (o *ListPVCByLabelsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this list p v c by labels forbidden response has a 3xx status code
func (o *ListPVCByLabelsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list p v c by labels forbidden response has a 4xx status code
func (o *ListPVCByLabelsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this list p v c by labels forbidden response has a 5xx status code
func (o *ListPVCByLabelsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this list p v c by labels forbidden response a status code equal to that given
func (o *ListPVCByLabelsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the list p v c by labels forbidden response
func (o *ListPVCByLabelsForbidden) Code() int {
	return 403
}

func (o *ListPVCByLabelsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/pvc][%d] listPVCByLabelsForbidden %s", 403, payload)
}

func (o *ListPVCByLabelsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/pvc][%d] listPVCByLabelsForbidden %s", 403, payload)
}

func (o *ListPVCByLabelsForbidden) GetPayload() string {
	return o.Payload
}

func (o *ListPVCByLabelsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
