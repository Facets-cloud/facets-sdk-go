...
func (o *ListPVByLabelsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewListPVByLabelsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewListPVByLabelsForbidden creates a ListPVByLabelsForbidden with default headers values
func NewListPVByLabelsForbidden() *ListPVByLabelsForbidden {
	return &ListPVByLabelsForbidden{}
}

/*
ListPVByLabelsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ListPVByLabelsForbidden struct {
	Payload string
}

// IsSuccess returns true when this list p v by labels forbidden response has a 2xx status code
func (o *ListPVByLabelsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this list p v by labels forbidden response has a 3xx status code
func (o *ListPVByLabelsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list p v by labels forbidden response has a 4xx status code
func (o *ListPVByLabelsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this list p v by labels forbidden response has a 5xx status code
func (o *ListPVByLabelsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this list p v by labels forbidden response a status code equal to that given
func (o *ListPVByLabelsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the list p v by labels forbidden response
func (o *ListPVByLabelsForbidden) Code() int {
	return 403
}

func (o *ListPVByLabelsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/pv][%d] listPVByLabelsForbidden %s", 403, payload)
}

func (o *ListPVByLabelsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/pv][%d] listPVByLabelsForbidden %s", 403, payload)
}

func (o *ListPVByLabelsForbidden) GetPayload() string {
	return o.Payload
}

func (o *ListPVByLabelsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
