...
func (o *ListEventsByK8sResourceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewListEventsByK8sResourceForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewListEventsByK8sResourceForbidden creates a ListEventsByK8sResourceForbidden with default headers values
func NewListEventsByK8sResourceForbidden() *ListEventsByK8sResourceForbidden {
	return &ListEventsByK8sResourceForbidden{}
}

/*
ListEventsByK8sResourceForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ListEventsByK8sResourceForbidden struct {
	Payload string
}

// IsSuccess returns true when this list events by k8s resource forbidden response has a 2xx status code
func (o *ListEventsByK8sResourceForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this list events by k8s resource forbidden response has a 3xx status code
func (o *ListEventsByK8sResourceForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list events by k8s resource forbidden response has a 4xx status code
func (o *ListEventsByK8sResourceForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this list events by k8s resource forbidden response has a 5xx status code
func (o *ListEventsByK8sResourceForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this list events by k8s resource forbidden response a status code equal to that given
func (o *ListEventsByK8sResourceForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the list events by k8s resource forbidden response
func (o *ListEventsByK8sResourceForbidden) Code() int {
	return 403
}

func (o *ListEventsByK8sResourceForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/{k8sResourceType}/{k8sResourceName}/events][%d] listEventsByK8sResourceForbidden %s", 403, payload)
}

func (o *ListEventsByK8sResourceForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/k8s-explorer/{k8sResourceType}/{k8sResourceName}/events][%d] listEventsByK8sResourceForbidden %s", 403, payload)
}

func (o *ListEventsByK8sResourceForbidden) GetPayload() string {
	return o.Payload
}

func (o *ListEventsByK8sResourceForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
