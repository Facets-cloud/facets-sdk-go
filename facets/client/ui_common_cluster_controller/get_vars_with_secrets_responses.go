...
func (o *GetVarsWithSecretsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetVarsWithSecretsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetVarsWithSecretsForbidden creates a GetVarsWithSecretsForbidden with default headers values
func NewGetVarsWithSecretsForbidden() *GetVarsWithSecretsForbidden {
	return &GetVarsWithSecretsForbidden{}
}

/*
GetVarsWithSecretsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetVarsWithSecretsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get vars with secrets forbidden response has a 2xx status code
func (o *GetVarsWithSecretsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get vars with secrets forbidden response has a 3xx status code
func (o *GetVarsWithSecretsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get vars with secrets forbidden response has a 4xx status code
func (o *GetVarsWithSecretsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get vars with secrets forbidden response has a 5xx status code
func (o *GetVarsWithSecretsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get vars with secrets forbidden response a status code equal to that given
func (o *GetVarsWithSecretsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get vars with secrets forbidden response
func (o *GetVarsWithSecretsForbidden) Code() int {
	return 403
}

func (o *GetVarsWithSecretsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/vars-with-secrets][%d] getVarsWithSecretsForbidden %s", 403, payload)
}

func (o *GetVarsWithSecretsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/vars-with-secrets][%d] getVarsWithSecretsForbidden %s", 403, payload)
}

func (o *GetVarsWithSecretsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetVarsWithSecretsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
