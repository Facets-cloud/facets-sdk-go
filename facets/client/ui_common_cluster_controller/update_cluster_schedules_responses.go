...
func (o *UpdateClusterSchedulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateClusterSchedulesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateClusterSchedulesForbidden creates a UpdateClusterSchedulesForbidden with default headers values
func NewUpdateClusterSchedulesForbidden() *UpdateClusterSchedulesForbidden {
	return &UpdateClusterSchedulesForbidden{}
}

/*
UpdateClusterSchedulesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateClusterSchedulesForbidden struct {
	Payload string
}

// IsSuccess returns true when this update cluster schedules forbidden response has a 2xx status code
func (o *UpdateClusterSchedulesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update cluster schedules forbidden response has a 3xx status code
func (o *UpdateClusterSchedulesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update cluster schedules forbidden response has a 4xx status code
func (o *UpdateClusterSchedulesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update cluster schedules forbidden response has a 5xx status code
func (o *UpdateClusterSchedulesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update cluster schedules forbidden response a status code equal to that given
func (o *UpdateClusterSchedulesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update cluster schedules forbidden response
func (o *UpdateClusterSchedulesForbidden) Code() int {
	return 403
}

func (o *UpdateClusterSchedulesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/clusters/{clusterId}/schedule/{clusterScheduleId}][%d] updateClusterSchedulesForbidden %s", 403, payload)
}

func (o *UpdateClusterSchedulesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/clusters/{clusterId}/schedule/{clusterScheduleId}][%d] updateClusterSchedulesForbidden %s", 403, payload)
}

func (o *UpdateClusterSchedulesForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateClusterSchedulesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
