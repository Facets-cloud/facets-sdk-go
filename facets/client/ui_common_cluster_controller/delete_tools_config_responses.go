...
func (o *DeleteToolsConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteToolsConfigForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteToolsConfigForbidden creates a DeleteToolsConfigForbidden with default headers values
func NewDeleteToolsConfigForbidden() *DeleteToolsConfigForbidden {
	return &DeleteToolsConfigForbidden{}
}

/*
DeleteToolsConfigForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteToolsConfigForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete tools config forbidden response has a 2xx status code
func (o *DeleteToolsConfigForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete tools config forbidden response has a 3xx status code
func (o *DeleteToolsConfigForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete tools config forbidden response has a 4xx status code
func (o *DeleteToolsConfigForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete tools config forbidden response has a 5xx status code
func (o *DeleteToolsConfigForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete tools config forbidden response a status code equal to that given
func (o *DeleteToolsConfigForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete tools config forbidden response
func (o *DeleteToolsConfigForbidden) Code() int {
	return 403
}

func (o *DeleteToolsConfigForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/clusters/{clusterId}/tools-config][%d] deleteToolsConfigForbidden %s", 403, payload)
}

func (o *DeleteToolsConfigForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/clusters/{clusterId}/tools-config][%d] deleteToolsConfigForbidden %s", 403, payload)
}

func (o *DeleteToolsConfigForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteToolsConfigForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
