...
type ClientService interface {
	...
	BulkEditInheritFromBaseForResources1(params *BulkEditInheritFromBaseForResources1Params, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*BulkEditInheritFromBaseForResources1OK, error)
	...
	GetAddOnModules1(params *GetAddOnModules1Params, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAddOnModules1OK, error)
	...
	GetClusterInfoByName(params *GetClusterInfoByNameParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetClusterInfoByNameOK, error)
	...
	GetModuleInputs1(params *GetModuleInputs1Params, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetModuleInputs1OK, error)
...
/*
BulkEditInheritFromBaseForResources1 bulk edit inherit from base for resources 1 API
*/
func (a *Client) BulkEditInheritFromBaseForResources1(params *BulkEditInheritFromBaseForResources1Params, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*BulkEditInheritFromBaseForResources1OK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewBulkEditInheritFromBaseForResources1Params()
	}
	op := &runtime.ClientOperation{
		ID:                 "bulkEditInheritFromBaseForResources_1",
		Method:             "PUT",
		PathPattern:        "/cc-ui/v1/clusters/{clusterId}/resource-inherit-from-base",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &BulkEditInheritFromBaseForResources1Reader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*BulkEditInheritFromBaseForResources1OK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for bulkEditInheritFromBaseForResources_1: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
GetAddOnModules1 gets add ons for a resource in a cluster
*/
func (a *Client) GetAddOnModules1(params *GetAddOnModules1Params, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAddOnModules1OK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewGetAddOnModules1Params()
	}
	op := &runtime.ClientOperation{
		ID:                 "getAddOnModules_1",
		Method:             "GET",
		PathPattern:        "/cc-ui/v1/clusters/{clusterId}/resourceType/{resourceType}/resourceName/{resourceName}/add-ons",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetAddOnModules1Reader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*GetAddOnModules1OK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getAddOnModules_1: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
GetClusterInfoByName gets cluster info by stack name and cluster name
*/
func (a *Client) GetClusterInfoByName(params *GetClusterInfoByNameParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetClusterInfoByNameOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewGetClusterInfoByNameParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getClusterInfoByName",
		Method:             "GET",
		PathPattern:        "/cc-ui/v1/clusters/stack/{stackName}/cluster/{clusterName}/info",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetClusterInfoByNameReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*GetClusterInfoByNameOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getClusterInfoByName: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
GetModuleInputs1 gets module inputs for a cluster
*/
func (a *Client) GetModuleInputs1(params *GetModuleInputs1Params, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetModuleInputs1OK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewGetModuleInputs1Params()
	}
	op := &runtime.ClientOperation{
		ID:                 "getModuleInputs_1",
		Method:             "GET",
		PathPattern:        "/cc-ui/v1/clusters/{clusterId}/intent/{intent}/flavor/{flavor}/input",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetModuleInputs1Reader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*GetModuleInputs1OK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getModuleInputs_1: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
