...
func (o *DeleteClusterForceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteClusterForceForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteClusterForceForbidden creates a DeleteClusterForceForbidden with default headers values
func NewDeleteClusterForceForbidden() *DeleteClusterForceForbidden {
	return &DeleteClusterForceForbidden{}
}

/*
DeleteClusterForceForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteClusterForceForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete cluster force forbidden response has a 2xx status code
func (o *DeleteClusterForceForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete cluster force forbidden response has a 3xx status code
func (o *DeleteClusterForceForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete cluster force forbidden response has a 4xx status code
func (o *DeleteClusterForceForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete cluster force forbidden response has a 5xx status code
func (o *DeleteClusterForceForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete cluster force forbidden response a status code equal to that given
func (o *DeleteClusterForceForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete cluster force forbidden response
func (o *DeleteClusterForceForbidden) Code() int {
	return 403
}

func (o *DeleteClusterForceForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/clusters/{clusterId}/force][%d] deleteClusterForceForbidden %s", 403, payload)
}

func (o *DeleteClusterForceForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/clusters/{clusterId}/force][%d] deleteClusterForceForbidden %s", 403, payload)
}

func (o *DeleteClusterForceForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteClusterForceForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
