...
func (o *UpsertProvidedResourcesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpsertProvidedResourcesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpsertProvidedResourcesForbidden creates a UpsertProvidedResourcesForbidden with default headers values
func NewUpsertProvidedResourcesForbidden() *UpsertProvidedResourcesForbidden {
	return &UpsertProvidedResourcesForbidden{}
}

/*
UpsertProvidedResourcesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpsertProvidedResourcesForbidden struct {
	Payload string
}

// IsSuccess returns true when this upsert provided resources forbidden response has a 2xx status code
func (o *UpsertProvidedResourcesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this upsert provided resources forbidden response has a 3xx status code
func (o *UpsertProvidedResourcesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this upsert provided resources forbidden response has a 4xx status code
func (o *UpsertProvidedResourcesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this upsert provided resources forbidden response has a 5xx status code
func (o *UpsertProvidedResourcesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this upsert provided resources forbidden response a status code equal to that given
func (o *UpsertProvidedResourcesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the upsert provided resources forbidden response
func (o *UpsertProvidedResourcesForbidden) Code() int {
	return 403
}

func (o *UpsertProvidedResourcesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/providedResources][%d] upsertProvidedResourcesForbidden %s", 403, payload)
}

func (o *UpsertProvidedResourcesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/providedResources][%d] upsertProvidedResourcesForbidden %s", 403, payload)
}

func (o *UpsertProvidedResourcesForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpsertProvidedResourcesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
