...
func (o *UpsertVarsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewUpsertVarsForbidden creates a UpsertVarsForbidden with default headers values
func NewUpsertVarsForbidden() *UpsertVarsForbidden {
	return &UpsertVarsForbidden{}
}

/*
UpsertVarsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpsertVarsForbidden struct {
	Payload string
}

// IsSuccess returns true when this upsert vars forbidden response has a 2xx status code
func (o *UpsertVarsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this upsert vars forbidden response has a 3xx status code
func (o *UpsertVarsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this upsert vars forbidden response has a 4xx status code
func (o *UpsertVarsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this upsert vars forbidden response has a 5xx status code
func (o *UpsertVarsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this upsert vars forbidden response a status code equal to that given
func (o *UpsertVarsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the upsert vars forbidden response
func (o *UpsertVarsForbidden) Code() int {
	return 403
}

func (o *UpsertVarsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/vars/upsert][%d] upsertVarsForbidden %s", 403, payload)
}

func (o *UpsertVarsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/vars/upsert][%d] upsertVarsForbidden %s", 403, payload)
}

func (o *UpsertVarsForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpsertVarsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
