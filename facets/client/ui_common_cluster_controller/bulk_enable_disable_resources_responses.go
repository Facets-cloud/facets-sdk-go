...
func (o *BulkEnableDisableResourcesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewBulkEnableDisableResourcesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewBulkEnableDisableResourcesForbidden creates a BulkEnableDisableResourcesForbidden with default headers values
func NewBulkEnableDisableResourcesForbidden() *BulkEnableDisableResourcesForbidden {
	return &BulkEnableDisableResourcesForbidden{}
}

/*
BulkEnableDisableResourcesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type BulkEnableDisableResourcesForbidden struct {
	Payload string
}

// IsSuccess returns true when this bulk enable disable resources forbidden response has a 2xx status code
func (o *BulkEnableDisableResourcesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this bulk enable disable resources forbidden response has a 3xx status code
func (o *BulkEnableDisableResourcesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this bulk enable disable resources forbidden response has a 4xx status code
func (o *BulkEnableDisableResourcesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this bulk enable disable resources forbidden response has a 5xx status code
func (o *BulkEnableDisableResourcesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this bulk enable disable resources forbidden response a status code equal to that given
func (o *BulkEnableDisableResourcesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the bulk enable disable resources forbidden response
func (o *BulkEnableDisableResourcesForbidden) Code() int {
	return 403
}

func (o *BulkEnableDisableResourcesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/clusters/{clusterId}/resource-enable-disable][%d] bulkEnableDisableResourcesForbidden %s", 403, payload)
}

func (o *BulkEnableDisableResourcesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/clusters/{clusterId}/resource-enable-disable][%d] bulkEnableDisableResourcesForbidden %s", 403, payload)
}

func (o *BulkEnableDisableResourcesForbidden) GetPayload() string {
	return o.Payload
}

func (o *BulkEnableDisableResourcesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
