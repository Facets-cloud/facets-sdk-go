...
func (o *GetAlertsOK) GetPayload() map[string]any {
	return o.Payload
}
...
func (o *GetAlertsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/alerts][%d] getAlertsForbidden %s", 403, payload)
}
...
func (o *GetAlertsForbidden) GetPayload() string {
	return o.Payload
}
