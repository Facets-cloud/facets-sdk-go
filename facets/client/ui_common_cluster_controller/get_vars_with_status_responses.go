...
func (o *GetVarsWithStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetVarsWithStatusForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetVarsWithStatusForbidden creates a GetVarsWithStatusForbidden with default headers values
func NewGetVarsWithStatusForbidden() *GetVarsWithStatusForbidden {
	return &GetVarsWithStatusForbidden{}
}

/*
GetVarsWithStatusForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetVarsWithStatusForbidden struct {
	Payload string
}

// IsSuccess returns true when this get vars with status forbidden response has a 2xx status code
func (o *GetVarsWithStatusForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get vars with status forbidden response has a 3xx status code
func (o *GetVarsWithStatusForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get vars with status forbidden response has a 4xx status code
func (o *GetVarsWithStatusForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get vars with status forbidden response has a 5xx status code
func (o *GetVarsWithStatusForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get vars with status forbidden response a status code equal to that given
func (o *GetVarsWithStatusForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get vars with status forbidden response
func (o *GetVarsWithStatusForbidden) Code() int {
	return 403
}

func (o *GetVarsWithStatusForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/varsWithStatus][%d] getVarsWithStatusForbidden %s", 403, payload)
}

func (o *GetVarsWithStatusForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/varsWithStatus][%d] getVarsWithStatusForbidden %s", 403, payload)
}

func (o *GetVarsWithStatusForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetVarsWithStatusForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
