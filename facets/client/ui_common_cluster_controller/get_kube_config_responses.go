...
// IsSuccess returns true when this get kube config forbidden response has a 2xx status code
func (o *GetKubeConfigForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get kube config forbidden response has a 3xx status code
func (o *GetKubeConfigForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get kube config forbidden response has a 4xx status code
func (o *GetKubeConfigForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get kube config forbidden response has a 5xx status code
func (o *GetKubeConfigForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get kube config forbidden response a status code equal to that given
func (o *GetKubeConfigForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get kube config forbidden response
func (o *GetKubeConfigForbidden) Code() int {
	return 403
}

func (o *GetKubeConfigForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/kubeconfig][%d] getKubeConfigForbidden %s", 403, payload)
}

func (o *GetKubeConfigForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/kubeconfig][%d] getKubeConfigForbidden %s", 403, payload)
}

func (o *GetKubeConfigForbidden) GetPayload() string {
	return o.Payload
}
