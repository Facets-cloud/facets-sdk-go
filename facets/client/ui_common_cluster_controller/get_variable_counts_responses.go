...
func (o *GetVariableCountsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetVariableCountsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetVariableCountsForbidden creates a GetVariableCountsForbidden with default headers values
func NewGetVariableCountsForbidden() *GetVariableCountsForbidden {
	return &GetVariableCountsForbidden{}
}

/*
GetVariableCountsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetVariableCountsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get variable counts forbidden response has a 2xx status code
func (o *GetVariableCountsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get variable counts forbidden response has a 3xx status code
func (o *GetVariableCountsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get variable counts forbidden response has a 4xx status code
func (o *GetVariableCountsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get variable counts forbidden response has a 5xx status code
func (o *GetVariableCountsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get variable counts forbidden response a status code equal to that given
func (o *GetVariableCountsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get variable counts forbidden response
func (o *GetVariableCountsForbidden) Code() int {
	return 403
}

func (o *GetVariableCountsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/variable-counts][%d] getVariableCountsForbidden %s", 403, payload)
}

func (o *GetVariableCountsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/variable-counts][%d] getVariableCountsForbidden %s", 403, payload)
}

func (o *GetVariableCountsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetVariableCountsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
