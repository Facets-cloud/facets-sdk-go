...
func (o *GetAvailabilitySchedulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAvailabilitySchedulesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAvailabilitySchedulesForbidden creates a GetAvailabilitySchedulesForbidden with default headers values
func NewGetAvailabilitySchedulesForbidden() *GetAvailabilitySchedulesForbidden {
	return &GetAvailabilitySchedulesForbidden{}
}

/*
GetAvailabilitySchedulesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAvailabilitySchedulesForbidden struct {
	Payload string
}

// IsSuccess returns true when this get availability schedules forbidden response has a 2xx status code
func (o *GetAvailabilitySchedulesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get availability schedules forbidden response has a 3xx status code
func (o *GetAvailabilitySchedulesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get availability schedules forbidden response has a 4xx status code
func (o *GetAvailabilitySchedulesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get availability schedules forbidden response has a 5xx status code
func (o *GetAvailabilitySchedulesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get availability schedules forbidden response a status code equal to that given
func (o *GetAvailabilitySchedulesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get availability schedules forbidden response
func (o *GetAvailabilitySchedulesForbidden) Code() int {
	return 403
}

func (o *GetAvailabilitySchedulesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/availability-schedule][%d] getAvailabilitySchedulesForbidden %s", 403, payload)
}

func (o *GetAvailabilitySchedulesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/availability-schedule][%d] getAvailabilitySchedulesForbidden %s", 403, payload)
}

func (o *GetAvailabilitySchedulesForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAvailabilitySchedulesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
