...
func (o *GetVPNProfileReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetVPNProfileForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetVPNProfileForbidden creates a GetVPNProfileForbidden with default headers values
func NewGetVPNProfileForbidden() *GetVPNProfileForbidden {
	return &GetVPNProfileForbidden{}
}

/*
GetVPNProfileForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetVPNProfileForbidden struct {
	Payload string
}

// IsSuccess returns true when this get v p n profile forbidden response has a 2xx status code
func (o *GetVPNProfileForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get v p n profile forbidden response has a 3xx status code
func (o *GetVPNProfileForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get v p n profile forbidden response has a 4xx status code
func (o *GetVPNProfileForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get v p n profile forbidden response has a 5xx status code
func (o *GetVPNProfileForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get v p n profile forbidden response a status code equal to that given
func (o *GetVPNProfileForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get v p n profile forbidden response
func (o *GetVPNProfileForbidden) Code() int {
	return 403
}

func (o *GetVPNProfileForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/vpn-profile][%d] getVPNProfileForbidden %s", 403, payload)
}

func (o *GetVPNProfileForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/vpn-profile][%d] getVPNProfileForbidden %s", 403, payload)
}

func (o *GetVPNProfileForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetVPNProfileForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
