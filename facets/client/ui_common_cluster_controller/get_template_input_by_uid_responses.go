...
func (o *GetTemplateInputByUIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetTemplateInputByUIDForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetTemplateInputByUIDForbidden creates a GetTemplateInputByUIDForbidden with default headers values
func NewGetTemplateInputByUIDForbidden() *GetTemplateInputByUIDForbidden {
	return &GetTemplateInputByUIDForbidden{}
}

/*
GetTemplateInputByUIDForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetTemplateInputByUIDForbidden struct {
	Payload string
}

// IsSuccess returns true when this get template input by Uid forbidden response has a 2xx status code
func (o *GetTemplateInputByUIDForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get template input by Uid forbidden response has a 3xx status code
func (o *GetTemplateInputByUIDForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get template input by Uid forbidden response has a 4xx status code
func (o *GetTemplateInputByUIDForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get template input by Uid forbidden response has a 5xx status code
func (o *GetTemplateInputByUIDForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get template input by Uid forbidden response a status code equal to that given
func (o *GetTemplateInputByUIDForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get template input by Uid forbidden response
func (o *GetTemplateInputByUIDForbidden) Code() int {
	return 403
}

func (o *GetTemplateInputByUIDForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/templateInputs/{inputType}/items/{uid}][%d] getTemplateInputByUidForbidden %s", 403, payload)
}

func (o *GetTemplateInputByUIDForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/templateInputs/{inputType}/items/{uid}][%d] getTemplateInputByUidForbidden %s", 403, payload)
}

func (o *GetTemplateInputByUIDForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetTemplateInputByUIDForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
