...
func (o *UpdateClusterBranchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateClusterBranchForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateClusterBranchForbidden creates a UpdateClusterBranchForbidden with default headers values
func NewUpdateClusterBranchForbidden() *UpdateClusterBranchForbidden {
	return &UpdateClusterBranchForbidden{}
}

/*
UpdateClusterBranchForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateClusterBranchForbidden struct {
	Payload string
}

// IsSuccess returns true when this update cluster branch forbidden response has a 2xx status code
func (o *UpdateClusterBranchForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update cluster branch forbidden response has a 3xx status code
func (o *UpdateClusterBranchForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update cluster branch forbidden response has a 4xx status code
func (o *UpdateClusterBranchForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update cluster branch forbidden response has a 5xx status code
func (o *UpdateClusterBranchForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update cluster branch forbidden response a status code equal to that given
func (o *UpdateClusterBranchForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update cluster branch forbidden response
func (o *UpdateClusterBranchForbidden) Code() int {
	return 403
}

func (o *UpdateClusterBranchForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /cc-ui/v1/clusters/{clusterId}/branch][%d] updateClusterBranchForbidden %s", 403, payload)
}

func (o *UpdateClusterBranchForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /cc-ui/v1/clusters/{clusterId}/branch][%d] updateClusterBranchForbidden %s", 403, payload)
}

func (o *UpdateClusterBranchForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateClusterBranchForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
