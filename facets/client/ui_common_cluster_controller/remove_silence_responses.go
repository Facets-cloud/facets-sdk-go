...
func (o *RemoveSilenceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRemoveSilenceForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *RemoveSilenceOK) GetPayload() map[string]any {
	return o.Payload
}
...
// NewRemoveSilenceForbidden creates a RemoveSilenceForbidden with default headers values
func NewRemoveSilenceForbidden() *RemoveSilenceForbidden {
	return &RemoveSilenceForbidden{}
}

/*
RemoveSilenceForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RemoveSilenceForbidden struct {
	Payload string
}

// IsSuccess returns true when this remove silence forbidden response has a 2xx status code
func (o *RemoveSilenceForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this remove silence forbidden response has a 3xx status code
func (o *RemoveSilenceForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this remove silence forbidden response has a 4xx status code
func (o *RemoveSilenceForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this remove silence forbidden response has a 5xx status code
func (o *RemoveSilenceForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this remove silence forbidden response a status code equal to that given
func (o *RemoveSilenceForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the remove silence forbidden response
func (o *RemoveSilenceForbidden) Code() int {
	return 403
}

func (o *RemoveSilenceForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/clusters/{clusterId}/alerts/silence/{silenceId}][%d] removeSilenceForbidden %s", 403, payload)
}

func (o *RemoveSilenceForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/clusters/{clusterId}/alerts/silence/{silenceId}][%d] removeSilenceForbidden %s", 403, payload)
}

func (o *RemoveSilenceForbidden) GetPayload() string {
	return o.Payload
}

func (o *RemoveSilenceForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
