...
func (o *CopyConfigurationsSelectiveReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCopyConfigurationsSelectiveForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCopyConfigurationsSelectiveForbidden creates a CopyConfigurationsSelectiveForbidden with default headers values
func NewCopyConfigurationsSelectiveForbidden() *CopyConfigurationsSelectiveForbidden {
	return &CopyConfigurationsSelectiveForbidden{}
}

/*
CopyConfigurationsSelectiveForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CopyConfigurationsSelectiveForbidden struct {
	Payload string
}

// IsSuccess returns true when this copy configurations selective forbidden response has a 2xx status code
func (o *CopyConfigurationsSelectiveForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this copy configurations selective forbidden response has a 3xx status code
func (o *CopyConfigurationsSelectiveForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this copy configurations selective forbidden response has a 4xx status code
func (o *CopyConfigurationsSelectiveForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this copy configurations selective forbidden response has a 5xx status code
func (o *CopyConfigurationsSelectiveForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this copy configurations selective forbidden response a status code equal to that given
func (o *CopyConfigurationsSelectiveForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the copy configurations selective forbidden response
func (o *CopyConfigurationsSelectiveForbidden) Code() int {
	return 403
}

func (o *CopyConfigurationsSelectiveForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/clusters/{clusterId}/copy-configurations-selective][%d] copyConfigurationsSelectiveForbidden %s", 403, payload)
}

func (o *CopyConfigurationsSelectiveForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/clusters/{clusterId}/copy-configurations-selective][%d] copyConfigurationsSelectiveForbidden %s", 403, payload)
}

func (o *CopyConfigurationsSelectiveForbidden) GetPayload() string {
	return o.Payload
}

func (o *CopyConfigurationsSelectiveForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
