...
func (o *AttachImageReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewAttachImageForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewAttachImageForbidden creates a AttachImageForbidden with default headers values
func NewAttachImageForbidden() *AttachImageForbidden {
	return &AttachImageForbidden{}
}

/*
AttachImageForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type AttachImageForbidden struct {
	Payload string
}

// IsSuccess returns true when this attach image forbidden response has a 2xx status code
func (o *AttachImageForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this attach image forbidden response has a 3xx status code
func (o *AttachImageForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this attach image forbidden response has a 4xx status code
func (o *AttachImageForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this attach image forbidden response has a 5xx status code
func (o *AttachImageForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this attach image forbidden response a status code equal to that given
func (o *AttachImageForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the attach image forbidden response
func (o *AttachImageForbidden) Code() int {
	return 403
}

func (o *AttachImageForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/attach-image][%d] attachImageForbidden %s", 403, payload)
}

func (o *AttachImageForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/attach-image][%d] attachImageForbidden %s", 403, payload)
}

func (o *AttachImageForbidden) GetPayload() string {
	return o.Payload
}

func (o *AttachImageForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
