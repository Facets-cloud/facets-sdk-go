...
func (o *DetachImageReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDetachImageForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDetachImageForbidden creates a DetachImageForbidden with default headers values
func NewDetachImageForbidden() *DetachImageForbidden {
	return &DetachImageForbidden{}
}

/*
DetachImageForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DetachImageForbidden struct {
	Payload string
}

// IsSuccess returns true when this detach image forbidden response has a 2xx status code
func (o *DetachImageForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this detach image forbidden response has a 3xx status code
func (o *DetachImageForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this detach image forbidden response has a 4xx status code
func (o *DetachImageForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this detach image forbidden response has a 5xx status code
func (o *DetachImageForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this detach image forbidden response a status code equal to that given
func (o *DetachImageForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the detach image forbidden response
func (o *DetachImageForbidden) Code() int {
	return 403
}

func (o *DetachImageForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/clusters/{clusterId}/detachImage][%d] detachImageForbidden %s", 403, payload)
}

func (o *DetachImageForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/clusters/{clusterId}/detachImage][%d] detachImageForbidden %s", 403, payload)
}

func (o *DetachImageForbidden) GetPayload() string {
	return o.Payload
}

func (o *DetachImageForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
