...
func (o *EditToolsConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewEditToolsConfigForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewEditToolsConfigForbidden creates a EditToolsConfigForbidden with default headers values
func NewEditToolsConfigForbidden() *EditToolsConfigForbidden {
	return &EditToolsConfigForbidden{}
}

/*
EditToolsConfigForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type EditToolsConfigForbidden struct {
	Payload string
}

// IsSuccess returns true when this edit tools config forbidden response has a 2xx status code
func (o *EditToolsConfigForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this edit tools config forbidden response has a 3xx status code
func (o *EditToolsConfigForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this edit tools config forbidden response has a 4xx status code
func (o *EditToolsConfigForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this edit tools config forbidden response has a 5xx status code
func (o *EditToolsConfigForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this edit tools config forbidden response a status code equal to that given
func (o *EditToolsConfigForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the edit tools config forbidden response
func (o *EditToolsConfigForbidden) Code() int {
	return 403
}

func (o *EditToolsConfigForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/clusters/{clusterId}/tools-config/{toolsConfigId}][%d] editToolsConfigForbidden %s", 403, payload)
}

func (o *EditToolsConfigForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/clusters/{clusterId}/tools-config/{toolsConfigId}][%d] editToolsConfigForbidden %s", 403, payload)
}

func (o *EditToolsConfigForbidden) GetPayload() string {
	return o.Payload
}

func (o *EditToolsConfigForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
