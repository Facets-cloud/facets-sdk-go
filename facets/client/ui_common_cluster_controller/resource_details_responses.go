...
func (o *ResourceDetailsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewResourceDetailsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewResourceDetailsForbidden creates a ResourceDetailsForbidden with default headers values
func NewResourceDetailsForbidden() *ResourceDetailsForbidden {
	return &ResourceDetailsForbidden{}
}

/*
ResourceDetailsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ResourceDetailsForbidden struct {
	Payload string
}

// IsSuccess returns true when this resource details forbidden response has a 2xx status code
func (o *ResourceDetailsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this resource details forbidden response has a 3xx status code
func (o *ResourceDetailsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this resource details forbidden response has a 4xx status code
func (o *ResourceDetailsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this resource details forbidden response has a 5xx status code
func (o *ResourceDetailsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this resource details forbidden response a status code equal to that given
func (o *ResourceDetailsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the resource details forbidden response
func (o *ResourceDetailsForbidden) Code() int {
	return 403
}

func (o *ResourceDetailsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/resourceDetails][%d] resourceDetailsForbidden %s", 403, payload)
}

func (o *ResourceDetailsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/resourceDetails][%d] resourceDetailsForbidden %s", 403, payload)
}

func (o *ResourceDetailsForbidden) GetPayload() string {
	return o.Payload
}

func (o *ResourceDetailsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
