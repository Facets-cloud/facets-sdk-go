...
func (o *GetClusterInfoReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetClusterInfoForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetClusterInfoForbidden creates a GetClusterInfoForbidden with default headers values
func NewGetClusterInfoForbidden() *GetClusterInfoForbidden {
	return &GetClusterInfoForbidden{}
}

/*
GetClusterInfoForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetClusterInfoForbidden struct {
	Payload string
}

// IsSuccess returns true when this get cluster info forbidden response has a 2xx status code
func (o *GetClusterInfoForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get cluster info forbidden response has a 3xx status code
func (o *GetClusterInfoForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get cluster info forbidden response has a 4xx status code
func (o *GetClusterInfoForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get cluster info forbidden response has a 5xx status code
func (o *GetClusterInfoForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get cluster info forbidden response a status code equal to that given
func (o *GetClusterInfoForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get cluster info forbidden response
func (o *GetClusterInfoForbidden) Code() int {
	return 403
}

func (o *GetClusterInfoForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/info][%d] getClusterInfoForbidden %s", 403, payload)
}

func (o *GetClusterInfoForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/info][%d] getClusterInfoForbidden %s", 403, payload)
}

func (o *GetClusterInfoForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetClusterInfoForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
