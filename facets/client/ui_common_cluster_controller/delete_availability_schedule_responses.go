...
func (o *DeleteAvailabilityScheduleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteAvailabilityScheduleForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteAvailabilityScheduleForbidden creates a DeleteAvailabilityScheduleForbidden with default headers values
func NewDeleteAvailabilityScheduleForbidden() *DeleteAvailabilityScheduleForbidden {
	return &DeleteAvailabilityScheduleForbidden{}
}

/*
DeleteAvailabilityScheduleForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteAvailabilityScheduleForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete availability schedule forbidden response has a 2xx status code
func (o *DeleteAvailabilityScheduleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete availability schedule forbidden response has a 3xx status code
func (o *DeleteAvailabilityScheduleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete availability schedule forbidden response has a 4xx status code
func (o *DeleteAvailabilityScheduleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete availability schedule forbidden response has a 5xx status code
func (o *DeleteAvailabilityScheduleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete availability schedule forbidden response a status code equal to that given
func (o *DeleteAvailabilityScheduleForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete availability schedule forbidden response
func (o *DeleteAvailabilityScheduleForbidden) Code() int {
	return 403
}

func (o *DeleteAvailabilityScheduleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/clusters/{clusterId}/availability-schedule/{availabilityScheduleId}][%d] deleteAvailabilityScheduleForbidden %s", 403, payload)
}

func (o *DeleteAvailabilityScheduleForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/clusters/{clusterId}/availability-schedule/{availabilityScheduleId}][%d] deleteAvailabilityScheduleForbidden %s", 403, payload)
}

func (o *DeleteAvailabilityScheduleForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteAvailabilityScheduleForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
