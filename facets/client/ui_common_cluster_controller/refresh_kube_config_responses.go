...
func (o *RefreshKubeConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRefreshKubeConfigForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRefreshKubeConfigForbidden creates a RefreshKubeConfigForbidden with default headers values
func NewRefreshKubeConfigForbidden() *RefreshKubeConfigForbidden {
	return &RefreshKubeConfigForbidden{}
}

/*
RefreshKubeConfigForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RefreshKubeConfigForbidden struct {
	Payload string
}

// IsSuccess returns true when this refresh kube config forbidden response has a 2xx status code
func (o *RefreshKubeConfigForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this refresh kube config forbidden response has a 3xx status code
func (o *RefreshKubeConfigForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this refresh kube config forbidden response has a 4xx status code
func (o *RefreshKubeConfigForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this refresh kube config forbidden response has a 5xx status code
func (o *RefreshKubeConfigForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this refresh kube config forbidden response a status code equal to that given
func (o *RefreshKubeConfigForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the refresh kube config forbidden response
func (o *RefreshKubeConfigForbidden) Code() int {
	return 403
}

func (o *RefreshKubeConfigForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/kubeconfig/refresh][%d] refreshKubeConfigForbidden %s", 403, payload)
}

func (o *RefreshKubeConfigForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/kubeconfig/refresh][%d] refreshKubeConfigForbidden %s", 403, payload)
}

func (o *RefreshKubeConfigForbidden) GetPayload() string {
	return o.Payload
}

func (o *RefreshKubeConfigForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
