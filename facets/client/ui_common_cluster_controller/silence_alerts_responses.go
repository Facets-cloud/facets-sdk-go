...
func (o *SilenceAlertsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewSilenceAlertsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *SilenceAlertsOK) GetPayload() map[string]any {
	return o.Payload
}
...
// NewSilenceAlertsForbidden creates a SilenceAlertsForbidden with default headers values
func NewSilenceAlertsForbidden() *SilenceAlertsForbidden {
	return &SilenceAlertsForbidden{}
}

/*
SilenceAlertsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type SilenceAlertsForbidden struct {
	Payload string
}

// IsSuccess returns true when this silence alerts forbidden response has a 2xx status code
func (o *SilenceAlertsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this silence alerts forbidden response has a 3xx status code
func (o *SilenceAlertsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this silence alerts forbidden response has a 4xx status code
func (o *SilenceAlertsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this silence alerts forbidden response has a 5xx status code
func (o *SilenceAlertsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this silence alerts forbidden response a status code equal to that given
func (o *SilenceAlertsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the silence alerts forbidden response
func (o *SilenceAlertsForbidden) Code() int {
	return 403
}

func (o *SilenceAlertsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/silence-alerts][%d] silenceAlertsForbidden %s", 403, payload)
}

func (o *SilenceAlertsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/silence-alerts][%d] silenceAlertsForbidden %s", 403, payload)
}

func (o *SilenceAlertsForbidden) GetPayload() string {
	return o.Payload
}

func (o *SilenceAlertsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
