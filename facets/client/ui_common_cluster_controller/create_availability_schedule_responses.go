...
func (o *CreateAvailabilityScheduleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCreateAvailabilityScheduleForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateAvailabilityScheduleForbidden creates a CreateAvailabilityScheduleForbidden with default headers values
func NewCreateAvailabilityScheduleForbidden() *CreateAvailabilityScheduleForbidden {
	return &CreateAvailabilityScheduleForbidden{}
}

/*
CreateAvailabilityScheduleForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CreateAvailabilityScheduleForbidden struct {
	Payload string
}

// IsSuccess returns true when this create availability schedule forbidden response has a 2xx status code
func (o *CreateAvailabilityScheduleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create availability schedule forbidden response has a 3xx status code
func (o *CreateAvailabilityScheduleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create availability schedule forbidden response has a 4xx status code
func (o *CreateAvailabilityScheduleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create availability schedule forbidden response has a 5xx status code
func (o *CreateAvailabilityScheduleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create availability schedule forbidden response a status code equal to that given
func (o *CreateAvailabilityScheduleForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create availability schedule forbidden response
func (o *CreateAvailabilityScheduleForbidden) Code() int {
	return 403
}

func (o *CreateAvailabilityScheduleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/availability-schedule][%d] createAvailabilityScheduleForbidden %s", 403, payload)
}

func (o *CreateAvailabilityScheduleForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/availability-schedule][%d] createAvailabilityScheduleForbidden %s", 403, payload)
}

func (o *CreateAvailabilityScheduleForbidden) GetPayload() string {
	return o.Payload
}

func (o *CreateAvailabilityScheduleForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
