...
func (o *GetOpenAlertsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetOpenAlertsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *GetOpenAlertsOK) GetPayload() map[string]any {
	return o.Payload
}
...
// NewGetOpenAlertsForbidden creates a GetOpenAlertsForbidden with default headers values
func NewGetOpenAlertsForbidden() *GetOpenAlertsForbidden {
	return &GetOpenAlertsForbidden{}
}

/*
GetOpenAlertsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetOpenAlertsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get open alerts forbidden response has a 2xx status code
func (o *GetOpenAlertsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get open alerts forbidden response has a 3xx status code
func (o *GetOpenAlertsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get open alerts forbidden response has a 4xx status code
func (o *GetOpenAlertsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get open alerts forbidden response has a 5xx status code
func (o *GetOpenAlertsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get open alerts forbidden response a status code equal to that given
func (o *GetOpenAlertsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get open alerts forbidden response
func (o *GetOpenAlertsForbidden) Code() int {
	return 403
}

func (o *GetOpenAlertsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/open-alerts][%d] getOpenAlertsForbidden %s", 403, payload)
}

func (o *GetOpenAlertsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/open-alerts][%d] getOpenAlertsForbidden %s", 403, payload)
}

func (o *GetOpenAlertsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetOpenAlertsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
