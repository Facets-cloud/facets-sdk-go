...
func (o *PauseReleaseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewPauseReleaseForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewPauseReleaseForbidden creates a PauseReleaseForbidden with default headers values
func NewPauseReleaseForbidden() *PauseReleaseForbidden {
	return &PauseReleaseForbidden{}
}

/*
PauseReleaseForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type PauseReleaseForbidden struct {
	Payload string
}

// IsSuccess returns true when this pause release forbidden response has a 2xx status code
func (o *PauseReleaseForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this pause release forbidden response has a 3xx status code
func (o *PauseReleaseForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this pause release forbidden response has a 4xx status code
func (o *PauseReleaseForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this pause release forbidden response has a 5xx status code
func (o *PauseReleaseForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this pause release forbidden response a status code equal to that given
func (o *PauseReleaseForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the pause release forbidden response
func (o *PauseReleaseForbidden) Code() int {
	return 403
}

func (o *PauseReleaseForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/pause-release][%d] pauseReleaseForbidden %s", 403, payload)
}

func (o *PauseReleaseForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/pause-release][%d] pauseReleaseForbidden %s", 403, payload)
}

func (o *PauseReleaseForbidden) GetPayload() string {
	return o.Payload
}

func (o *PauseReleaseForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
