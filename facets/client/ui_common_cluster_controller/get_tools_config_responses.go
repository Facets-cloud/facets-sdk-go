...
func (o *GetToolsConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetToolsConfigForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetToolsConfigForbidden creates a GetToolsConfigForbidden with default headers values
func NewGetToolsConfigForbidden() *GetToolsConfigForbidden {
	return &GetToolsConfigForbidden{}
}

/*
GetToolsConfigForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetToolsConfigForbidden struct {
	Payload string
}

// IsSuccess returns true when this get tools config forbidden response has a 2xx status code
func (o *GetToolsConfigForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get tools config forbidden response has a 3xx status code
func (o *GetToolsConfigForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get tools config forbidden response has a 4xx status code
func (o *GetToolsConfigForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get tools config forbidden response has a 5xx status code
func (o *GetToolsConfigForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get tools config forbidden response a status code equal to that given
func (o *GetToolsConfigForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get tools config forbidden response
func (o *GetToolsConfigForbidden) Code() int {
	return 403
}

func (o *GetToolsConfigForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/tools-config][%d] getToolsConfigForbidden %s", 403, payload)
}

func (o *GetToolsConfigForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/tools-config][%d] getToolsConfigForbidden %s", 403, payload)
}

func (o *GetToolsConfigForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetToolsConfigForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
