...
func (o *CreateUserGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CreateUserGroupForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/user-groups/][%d] createUserGroupForbidden %s", 403, payload)
}
...
func (o *CreateUserGroupForbidden) GetPayload() string {
	return o.Payload
}
