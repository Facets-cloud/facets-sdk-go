...
func (o *GetUserGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetUserGroupForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/user-groups/{groupId}][%d] getUserGroupForbidden %s", 403, payload)
}
...
func (o *GetUserGroupForbidden) GetPayload() string {
	return o.Payload
}
