...
func (o *GetAllGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllGroupForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllGroupForbidden creates a GetAllGroupForbidden with default headers values
func NewGetAllGroupForbidden() *GetAllGroupForbidden {
	return &GetAllGroupForbidden{}
}

/*
GetAllGroupForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllGroupForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all group forbidden response has a 2xx status code
func (o *GetAllGroupForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all group forbidden response has a 3xx status code
func (o *GetAllGroupForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all group forbidden response has a 4xx status code
func (o *GetAllGroupForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all group forbidden response has a 5xx status code
func (o *GetAllGroupForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all group forbidden response a status code equal to that given
func (o *GetAllGroupForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all group forbidden response
func (o *GetAllGroupForbidden) Code() int {
	return 403
}

func (o *GetAllGroupForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/user-groups/][%d] getAllGroupForbidden %s", 403, payload)
}

func (o *GetAllGroupForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/user-groups/][%d] getAllGroupForbidden %s", 403, payload)
}

func (o *GetAllGroupForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllGroupForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
