...
func (o *GetAllUserGroupsExpandedReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllUserGroupsExpandedForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllUserGroupsExpandedForbidden creates a GetAllUserGroupsExpandedForbidden with default headers values
func NewGetAllUserGroupsExpandedForbidden() *GetAllUserGroupsExpandedForbidden {
	return &GetAllUserGroupsExpandedForbidden{}
}

/*
GetAllUserGroupsExpandedForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllUserGroupsExpandedForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all user groups expanded forbidden response has a 2xx status code
func (o *GetAllUserGroupsExpandedForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all user groups expanded forbidden response has a 3xx status code
func (o *GetAllUserGroupsExpandedForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all user groups expanded forbidden response has a 4xx status code
func (o *GetAllUserGroupsExpandedForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all user groups expanded forbidden response has a 5xx status code
func (o *GetAllUserGroupsExpandedForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all user groups expanded forbidden response a status code equal to that given
func (o *GetAllUserGroupsExpandedForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all user groups expanded forbidden response
func (o *GetAllUserGroupsExpandedForbidden) Code() int {
	return 403
}

func (o *GetAllUserGroupsExpandedForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/user-groups/list/groups-expanded][%d] getAllUserGroupsExpandedForbidden %s", 403, payload)
}

func (o *GetAllUserGroupsExpandedForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/user-groups/list/groups-expanded][%d] getAllUserGroupsExpandedForbidden %s", 403, payload)
}

func (o *GetAllUserGroupsExpandedForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllUserGroupsExpandedForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
