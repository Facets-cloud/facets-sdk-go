...
func (o *DeleteUserGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DeleteUserGroupForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/user-groups/{groupId}][%d] deleteUserGroupForbidden %s", 403, payload)
}
...
func (o *DeleteUserGroupForbidden) GetPayload() string {
	return o.Payload
}
