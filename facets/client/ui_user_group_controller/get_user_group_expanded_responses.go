...
func (o *GetUserGroupExpandedReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetUserGroupExpandedForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetUserGroupExpandedForbidden creates a GetUserGroupExpandedForbidden with default headers values
func NewGetUserGroupExpandedForbidden() *GetUserGroupExpandedForbidden {
	return &GetUserGroupExpandedForbidden{}
}

/*
GetUserGroupExpandedForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetUserGroupExpandedForbidden struct {
	Payload string
}

// IsSuccess returns true when this get user group expanded forbidden response has a 2xx status code
func (o *GetUserGroupExpandedForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get user group expanded forbidden response has a 3xx status code
func (o *GetUserGroupExpandedForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get user group expanded forbidden response has a 4xx status code
func (o *GetUserGroupExpandedForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get user group expanded forbidden response has a 5xx status code
func (o *GetUserGroupExpandedForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get user group expanded forbidden response a status code equal to that given
func (o *GetUserGroupExpandedForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get user group expanded forbidden response
func (o *GetUserGroupExpandedForbidden) Code() int {
	return 403
}

func (o *GetUserGroupExpandedForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/user-groups/{groupId}/group-expanded][%d] getUserGroupExpandedForbidden %s", 403, payload)
}

func (o *GetUserGroupExpandedForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/user-groups/{groupId}/group-expanded][%d] getUserGroupExpandedForbidden %s", 403, payload)
}

func (o *GetUserGroupExpandedForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetUserGroupExpandedForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
