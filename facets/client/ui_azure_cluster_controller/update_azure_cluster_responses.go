...
func (o *UpdateAzureClusterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateAzureClusterForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateAzureClusterForbidden creates a UpdateAzureClusterForbidden with default headers values
func NewUpdateAzureClusterForbidden() *UpdateAzureClusterForbidden {
	return &UpdateAzureClusterForbidden{}
}

/*
UpdateAzureClusterForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateAzureClusterForbidden struct {
	Payload string
}

// IsSuccess returns true when this update azure cluster forbidden response has a 2xx status code
func (o *UpdateAzureClusterForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update azure cluster forbidden response has a 3xx status code
func (o *UpdateAzureClusterForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update azure cluster forbidden response has a 4xx status code
func (o *UpdateAzureClusterForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update azure cluster forbidden response has a 5xx status code
func (o *UpdateAzureClusterForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update azure cluster forbidden response a status code equal to that given
func (o *UpdateAzureClusterForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update azure cluster forbidden response
func (o *UpdateAzureClusterForbidden) Code() int {
	return 403
}

func (o *UpdateAzureClusterForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/azure/clusters/{clusterId}][%d] updateAzureClusterForbidden %s", 403, payload)
}

func (o *UpdateAzureClusterForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/azure/clusters/{clusterId}][%d] updateAzureClusterForbidden %s", 403, payload)
}

func (o *UpdateAzureClusterForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateAzureClusterForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
