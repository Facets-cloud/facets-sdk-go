...
func (o *ValidateVnetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewValidateVnetForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewValidateVnetForbidden creates a ValidateVnetForbidden with default headers values
func NewValidateVnetForbidden() *ValidateVnetForbidden {
	return &ValidateVnetForbidden{}
}

/*
ValidateVnetForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ValidateVnetForbidden struct {
	Payload string
}

// IsSuccess returns true when this validate vnet forbidden response has a 2xx status code
func (o *ValidateVnetForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this validate vnet forbidden response has a 3xx status code
func (o *ValidateVnetForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this validate vnet forbidden response has a 4xx status code
func (o *ValidateVnetForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this validate vnet forbidden response has a 5xx status code
func (o *ValidateVnetForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this validate vnet forbidden response a status code equal to that given
func (o *ValidateVnetForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the validate vnet forbidden response
func (o *ValidateVnetForbidden) Code() int {
	return 403
}

func (o *ValidateVnetForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/azure/clusters/validate-vnet][%d] validateVnetForbidden %s", 403, payload)
}

func (o *ValidateVnetForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/azure/clusters/validate-vnet][%d] validateVnetForbidden %s", 403, payload)
}

func (o *ValidateVnetForbidden) GetPayload() string {
	return o.Payload
}

func (o *ValidateVnetForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
