...
// WithWebComponentID adds the webComponentID to the delete component params
func (o *DeleteComponentParams) WithWebComponentID(webComponentID string) *DeleteComponentParams {
	o.SetWebComponentID(webComponentID)
	return o
}

// SetWebComponentID adds the webComponentId to the delete component params
func (o *DeleteComponentParams) SetWebComponentID(webComponentID string) {
