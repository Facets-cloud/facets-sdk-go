...
func (o *UpdateComponentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 404:
		...
		return nil, result
	case 405:
		result := NewUpdateComponentMethodNotAllowed()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /cc-ui/v1/web-components/{webComponentId}] updateComponent", response, response.Code())
	}
}
...
func (o *UpdateComponentOK) Error() string {
	...
	return fmt.Sprintf("[PUT /cc-ui/v1/web-components/{webComponentId}][%d] updateComponentOK %s", 200, payload)
}
...
func (o *UpdateComponentOK) GetPayload() *models.WebComponentDTO {
	return o.Payload
}
...
func (o *UpdateComponentBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/web-components/{webComponentId}][%d] updateComponentBadRequest %s", 400, payload)
}
...
func (o *UpdateComponentBadRequest) GetPayload() *models.ErrorDetails {
	return o.Payload
}
...
func (o *UpdateComponentForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/web-components/{webComponentId}][%d] updateComponentForbidden %s", 403, payload)
}
...
func (o *UpdateComponentForbidden) GetPayload() string {
	return o.Payload
}
...
func (o *UpdateComponentNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/web-components/{webComponentId}][%d] updateComponentNotFound %s", 404, payload)
}
...
func (o *UpdateComponentNotFound) GetPayload() *models.ErrorDetails {
	return o.Payload
}
...
// NewUpdateComponentMethodNotAllowed creates a UpdateComponentMethodNotAllowed with default headers values
func NewUpdateComponentMethodNotAllowed() *UpdateComponentMethodNotAllowed {
	return &UpdateComponentMethodNotAllowed{}
}

/*
UpdateComponentMethodNotAllowed describes a response with status code 405, with default header values.

Method Not Allowed
*/
type UpdateComponentMethodNotAllowed struct {
	Payload *models.ErrorDetails
}

// IsSuccess returns true when this update component method not allowed response has a 2xx status code
func (o *UpdateComponentMethodNotAllowed) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update component method not allowed response has a 3xx status code
func (o *UpdateComponentMethodNotAllowed) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update component method not allowed response has a 4xx status code
func (o *UpdateComponentMethodNotAllowed) IsClientError() bool {
	return true
}

// IsServerError returns true when this update component method not allowed response has a 5xx status code
func (o *UpdateComponentMethodNotAllowed) IsServerError() bool {
	return false
}

// IsCode returns true when this update component method not allowed response a status code equal to that given
func (o *UpdateComponentMethodNotAllowed) IsCode(code int) bool {
	return code == 405
}

// Code gets the status code for the update component method not allowed response
func (o *UpdateComponentMethodNotAllowed) Code() int {
	return 405
}

func (o *UpdateComponentMethodNotAllowed) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/web-components/{webComponentId}][%d] updateComponentMethodNotAllowed %s", 405, payload)
}

func (o *UpdateComponentMethodNotAllowed) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/web-components/{webComponentId}][%d] updateComponentMethodNotAllowed %s", 405, payload)
}

func (o *UpdateComponentMethodNotAllowed) GetPayload() *models.ErrorDetails {
	return o.Payload
}

func (o *UpdateComponentMethodNotAllowed) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdateComponentInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/web-components/{webComponentId}][%d] updateComponentInternalServerError %s", 500, payload)
}
...
func (o *UpdateComponentInternalServerError) GetPayload() *models.ErrorDetails {
	return o.Payload
}
