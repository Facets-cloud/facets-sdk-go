...
// WithWebComponentID adds the webComponentID to the get component params
func (o *GetComponentParams) WithWebComponentID(webComponentID string) *GetComponentParams {
	o.SetWebComponentID(webComponentID)
	return o
}

// SetWebComponentID adds the webComponentId to the get component params
func (o *GetComponentParams) SetWebComponentID(webComponentID string) {
