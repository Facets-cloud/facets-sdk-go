...
func (o *DeleteComponentForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/web-components/{webComponentId}][%d] deleteComponentForbidden %s", 403, payload)
}
...
func (o *DeleteComponentForbidden) GetPayload() string {
	return o.Payload
}
