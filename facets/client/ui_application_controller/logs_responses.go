...
// NewLogsForbidden creates a LogsForbidden with default headers values
func NewLogsForbidden() *LogsForbidden {
	return &LogsForbidden{}
}

/*
LogsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type LogsForbidden struct {
	Payload string
}

// IsSuccess returns true when this logs forbidden response has a 2xx status code
func (o *LogsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this logs forbidden response has a 3xx status code
func (o *LogsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this logs forbidden response has a 4xx status code
func (o *LogsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this logs forbidden response has a 5xx status code
func (o *LogsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this logs forbidden response a status code equal to that given
func (o *LogsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the logs forbidden response
func (o *LogsForbidden) Code() int {
	return 403
}

func (o *LogsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/pods/{podName}/logs][%d] logsForbidden %s", 403, payload)
}

func (o *LogsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/pods/{podName}/logs][%d] logsForbidden %s", 403, payload)
}

func (o *LogsForbidden) GetPayload() string {
	return o.Payload
}

func (o *LogsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
