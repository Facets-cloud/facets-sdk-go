...
func (o *GetResourceByNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetResourceByNameForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *GetResourceByNameOK) GetPayload() map[string]any {
	return o.Payload
}
...
// NewGetResourceByNameForbidden creates a GetResourceByNameForbidden with default headers values
func NewGetResourceByNameForbidden() *GetResourceByNameForbidden {
	return &GetResourceByNameForbidden{}
}

/*
GetResourceByNameForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetResourceByNameForbidden struct {
	Payload string
}

// IsSuccess returns true when this get resource by name forbidden response has a 2xx status code
func (o *GetResourceByNameForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get resource by name forbidden response has a 3xx status code
func (o *GetResourceByNameForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get resource by name forbidden response has a 4xx status code
func (o *GetResourceByNameForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get resource by name forbidden response has a 5xx status code
func (o *GetResourceByNameForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get resource by name forbidden response a status code equal to that given
func (o *GetResourceByNameForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get resource by name forbidden response
func (o *GetResourceByNameForbidden) Code() int {
	return 403
}

func (o *GetResourceByNameForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/{resourceType}/{appName}][%d] getResourceByNameForbidden %s", 403, payload)
}

func (o *GetResourceByNameForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/{resourceType}/{appName}][%d] getResourceByNameForbidden %s", 403, payload)
}

func (o *GetResourceByNameForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetResourceByNameForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
