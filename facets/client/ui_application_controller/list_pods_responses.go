...
func (o *ListPodsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewListPodsForbidden creates a ListPodsForbidden with default headers values
func NewListPodsForbidden() *ListPodsForbidden {
	return &ListPodsForbidden{}
}

/*
ListPodsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ListPodsForbidden struct {
	Payload string
}

// IsSuccess returns true when this list pods forbidden response has a 2xx status code
func (o *ListPodsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this list pods forbidden response has a 3xx status code
func (o *ListPodsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list pods forbidden response has a 4xx status code
func (o *ListPodsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this list pods forbidden response has a 5xx status code
func (o *ListPodsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this list pods forbidden response a status code equal to that given
func (o *ListPodsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the list pods forbidden response
func (o *ListPodsForbidden) Code() int {
	return 403
}

func (o *ListPodsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/resourceName/{applicationName}/pods][%d] listPodsForbidden %s", 403, payload)
}

func (o *ListPodsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/resourceName/{applicationName}/pods][%d] listPodsForbidden %s", 403, payload)
}

func (o *ListPodsForbidden) GetPayload() string {
	return o.Payload
}

func (o *ListPodsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
