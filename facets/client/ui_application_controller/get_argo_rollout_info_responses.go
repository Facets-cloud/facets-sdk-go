...
func (o *GetArgoRolloutInfoReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetArgoRolloutInfoForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *GetArgoRolloutInfoOK) GetPayload() any {
	return o.Payload
}
...
// NewGetArgoRolloutInfoForbidden creates a GetArgoRolloutInfoForbidden with default headers values
func NewGetArgoRolloutInfoForbidden() *GetArgoRolloutInfoForbidden {
	return &GetArgoRolloutInfoForbidden{}
}

/*
GetArgoRolloutInfoForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetArgoRolloutInfoForbidden struct {
	Payload string
}

// IsSuccess returns true when this get argo rollout info forbidden response has a 2xx status code
func (o *GetArgoRolloutInfoForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get argo rollout info forbidden response has a 3xx status code
func (o *GetArgoRolloutInfoForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get argo rollout info forbidden response has a 4xx status code
func (o *GetArgoRolloutInfoForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get argo rollout info forbidden response has a 5xx status code
func (o *GetArgoRolloutInfoForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get argo rollout info forbidden response a status code equal to that given
func (o *GetArgoRolloutInfoForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get argo rollout info forbidden response
func (o *GetArgoRolloutInfoForbidden) Code() int {
	return 403
}

func (o *GetArgoRolloutInfoForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/argo-info][%d] getArgoRolloutInfoForbidden %s", 403, payload)
}

func (o *GetArgoRolloutInfoForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/argo-info][%d] getArgoRolloutInfoForbidden %s", 403, payload)
}

func (o *GetArgoRolloutInfoForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetArgoRolloutInfoForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
