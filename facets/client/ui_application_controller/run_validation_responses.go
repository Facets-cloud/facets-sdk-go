...
func (o *RunValidationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRunValidationForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRunValidationForbidden creates a RunValidationForbidden with default headers values
func NewRunValidationForbidden() *RunValidationForbidden {
	return &RunValidationForbidden{}
}

/*
RunValidationForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RunValidationForbidden struct {
	Payload string
}

// IsSuccess returns true when this run validation forbidden response has a 2xx status code
func (o *RunValidationForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this run validation forbidden response has a 3xx status code
func (o *RunValidationForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this run validation forbidden response has a 4xx status code
func (o *RunValidationForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this run validation forbidden response has a 5xx status code
func (o *RunValidationForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this run validation forbidden response a status code equal to that given
func (o *RunValidationForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the run validation forbidden response
func (o *RunValidationForbidden) Code() int {
	return 403
}

func (o *RunValidationForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/validate][%d] runValidationForbidden %s", 403, payload)
}

func (o *RunValidationForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/validate][%d] runValidationForbidden %s", 403, payload)
}

func (o *RunValidationForbidden) GetPayload() string {
	return o.Payload
}

func (o *RunValidationForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
