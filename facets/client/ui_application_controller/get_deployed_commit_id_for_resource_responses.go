...
func (o *GetDeployedCommitIDForResourceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetDeployedCommitIDForResourceForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetDeployedCommitIDForResourceForbidden creates a GetDeployedCommitIDForResourceForbidden with default headers values
func NewGetDeployedCommitIDForResourceForbidden() *GetDeployedCommitIDForResourceForbidden {
	return &GetDeployedCommitIDForResourceForbidden{}
}

/*
GetDeployedCommitIDForResourceForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetDeployedCommitIDForResourceForbidden struct {
	Payload string
}

// IsSuccess returns true when this get deployed commit Id for resource forbidden response has a 2xx status code
func (o *GetDeployedCommitIDForResourceForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get deployed commit Id for resource forbidden response has a 3xx status code
func (o *GetDeployedCommitIDForResourceForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get deployed commit Id for resource forbidden response has a 4xx status code
func (o *GetDeployedCommitIDForResourceForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get deployed commit Id for resource forbidden response has a 5xx status code
func (o *GetDeployedCommitIDForResourceForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get deployed commit Id for resource forbidden response a status code equal to that given
func (o *GetDeployedCommitIDForResourceForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get deployed commit Id for resource forbidden response
func (o *GetDeployedCommitIDForResourceForbidden) Code() int {
	return 403
}

func (o *GetDeployedCommitIDForResourceForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/resourceType/{resourceType}/resourceName/{resourceName}/deployed-commit-id][%d] getDeployedCommitIdForResourceForbidden %s", 403, payload)
}

func (o *GetDeployedCommitIDForResourceForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/resourceType/{resourceType}/resourceName/{resourceName}/deployed-commit-id][%d] getDeployedCommitIdForResourceForbidden %s", 403, payload)
}

func (o *GetDeployedCommitIDForResourceForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetDeployedCommitIDForResourceForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
