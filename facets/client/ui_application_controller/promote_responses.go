...
func (o *PromoteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PromoteForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/clusters/{clusterId}/promote][%d] promoteForbidden %s", 403, payload)
}
...
func (o *PromoteForbidden) GetPayload() string {
	return o.Payload
}
