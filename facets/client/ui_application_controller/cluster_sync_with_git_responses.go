...
func (o *ClusterSyncWithGitReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewClusterSyncWithGitForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewClusterSyncWithGitForbidden creates a ClusterSyncWithGitForbidden with default headers values
func NewClusterSyncWithGitForbidden() *ClusterSyncWithGitForbidden {
	return &ClusterSyncWithGitForbidden{}
}

/*
ClusterSyncWithGitForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ClusterSyncWithGitForbidden struct {
	Payload string
}

// IsSuccess returns true when this cluster sync with git forbidden response has a 2xx status code
func (o *ClusterSyncWithGitForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this cluster sync with git forbidden response has a 3xx status code
func (o *ClusterSyncWithGitForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this cluster sync with git forbidden response has a 4xx status code
func (o *ClusterSyncWithGitForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this cluster sync with git forbidden response has a 5xx status code
func (o *ClusterSyncWithGitForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this cluster sync with git forbidden response a status code equal to that given
func (o *ClusterSyncWithGitForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the cluster sync with git forbidden response
func (o *ClusterSyncWithGitForbidden) Code() int {
	return 403
}

func (o *ClusterSyncWithGitForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/sync-with-git][%d] clusterSyncWithGitForbidden %s", 403, payload)
}

func (o *ClusterSyncWithGitForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/sync-with-git][%d] clusterSyncWithGitForbidden %s", 403, payload)
}

func (o *ClusterSyncWithGitForbidden) GetPayload() string {
	return o.Payload
}

func (o *ClusterSyncWithGitForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
