...
/*
GetAllForbidden describes a response with status code 403, with default header values.
...
// IsSuccess returns true when this get all forbidden response has a 2xx status code
func (o *GetAllForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all forbidden response has a 3xx status code
func (o *GetAllForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all forbidden response has a 4xx status code
func (o *GetAllForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all forbidden response has a 5xx status code
func (o *GetAllForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all forbidden response a status code equal to that given
func (o *GetAllForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all forbidden response
func (o *GetAllForbidden) Code() int {
	return 403
}

func (o *GetAllForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/user-token][%d] getAllForbidden %s", 403, payload)
}

func (o *GetAllForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/user-token][%d] getAllForbidden %s", 403, payload)
}

func (o *GetAllForbidden) GetPayload() string {
	return o.Payload
}
