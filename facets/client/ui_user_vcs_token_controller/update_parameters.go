...
type UpdateParams struct {
	...
	// Body.
	Body *models.UserVCSTokenRequest
...
func (o *UpdateParams) WithBody(body *models.UserVCSTokenRequest) *UpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update params
func (o *UpdateParams) SetBody(body *models.UserVCSTokenRequest) {
	o.Body = body
}
