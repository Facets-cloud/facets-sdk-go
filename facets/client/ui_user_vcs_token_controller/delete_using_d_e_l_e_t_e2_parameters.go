...
// WithID adds the id to the delete using d e l e t e 2 params
func (o *DeleteUsingDELETE2Params) WithID(id string) *DeleteUsingDELETE2Params {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete using d e l e t e 2 params
func (o *DeleteUsingDELETE2Params) SetID(id string) {
	o.ID = id
}
