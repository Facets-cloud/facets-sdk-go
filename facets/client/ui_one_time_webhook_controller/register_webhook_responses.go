...
func (o *RegisterWebhookReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRegisterWebhookForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRegisterWebhookForbidden creates a RegisterWebhookForbidden with default headers values
func NewRegisterWebhookForbidden() *RegisterWebhookForbidden {
	return &RegisterWebhookForbidden{}
}

/*
RegisterWebhookForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RegisterWebhookForbidden struct {
	Payload string
}

// IsSuccess returns true when this register webhook forbidden response has a 2xx status code
func (o *RegisterWebhookForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this register webhook forbidden response has a 3xx status code
func (o *RegisterWebhookForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this register webhook forbidden response has a 4xx status code
func (o *RegisterWebhookForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this register webhook forbidden response has a 5xx status code
func (o *RegisterWebhookForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this register webhook forbidden response a status code equal to that given
func (o *RegisterWebhookForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the register webhook forbidden response
func (o *RegisterWebhookForbidden) Code() int {
	return 403
}

func (o *RegisterWebhookForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/onetime-webhook/register][%d] registerWebhookForbidden %s", 403, payload)
}

func (o *RegisterWebhookForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/onetime-webhook/register][%d] registerWebhookForbidden %s", 403, payload)
}

func (o *RegisterWebhookForbidden) GetPayload() string {
	return o.Payload
}

func (o *RegisterWebhookForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
