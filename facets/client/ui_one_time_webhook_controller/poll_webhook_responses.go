...
func (o *PollWebhookReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewPollWebhookForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewPollWebhookForbidden creates a PollWebhookForbidden with default headers values
func NewPollWebhookForbidden() *PollWebhookForbidden {
	return &PollWebhookForbidden{}
}

/*
PollWebhookForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type PollWebhookForbidden struct {
	Payload string
}

// IsSuccess returns true when this poll webhook forbidden response has a 2xx status code
func (o *PollWebhookForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this poll webhook forbidden response has a 3xx status code
func (o *PollWebhookForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this poll webhook forbidden response has a 4xx status code
func (o *PollWebhookForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this poll webhook forbidden response has a 5xx status code
func (o *PollWebhookForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this poll webhook forbidden response a status code equal to that given
func (o *PollWebhookForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the poll webhook forbidden response
func (o *PollWebhookForbidden) Code() int {
	return 403
}

func (o *PollWebhookForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/onetime-webhook/poll/{webhookId}][%d] pollWebhookForbidden %s", 403, payload)
}

func (o *PollWebhookForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/onetime-webhook/poll/{webhookId}][%d] pollWebhookForbidden %s", 403, payload)
}

func (o *PollWebhookForbidden) GetPayload() string {
	return o.Payload
}

func (o *PollWebhookForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
