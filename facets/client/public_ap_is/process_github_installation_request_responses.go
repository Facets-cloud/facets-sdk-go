...
func (o *ProcessGithubInstallationRequestReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewProcessGithubInstallationRequestForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewProcessGithubInstallationRequestForbidden creates a ProcessGithubInstallationRequestForbidden with default headers values
func NewProcessGithubInstallationRequestForbidden() *ProcessGithubInstallationRequestForbidden {
	return &ProcessGithubInstallationRequestForbidden{}
}

/*
ProcessGithubInstallationRequestForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ProcessGithubInstallationRequestForbidden struct {
	Payload string
}

// IsSuccess returns true when this process github installation request forbidden response has a 2xx status code
func (o *ProcessGithubInstallationRequestForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this process github installation request forbidden response has a 3xx status code
func (o *ProcessGithubInstallationRequestForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this process github installation request forbidden response has a 4xx status code
func (o *ProcessGithubInstallationRequestForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this process github installation request forbidden response has a 5xx status code
func (o *ProcessGithubInstallationRequestForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this process github installation request forbidden response a status code equal to that given
func (o *ProcessGithubInstallationRequestForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the process github installation request forbidden response
func (o *ProcessGithubInstallationRequestForbidden) Code() int {
	return 403
}

func (o *ProcessGithubInstallationRequestForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/github-installation-request][%d] processGithubInstallationRequestForbidden %s", 403, payload)
}

func (o *ProcessGithubInstallationRequestForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/github-installation-request][%d] processGithubInstallationRequestForbidden %s", 403, payload)
}

func (o *ProcessGithubInstallationRequestForbidden) GetPayload() string {
	return o.Payload
}

func (o *ProcessGithubInstallationRequestForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
