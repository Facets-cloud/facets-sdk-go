...
func (o *LinkAzureAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewLinkAzureAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewLinkAzureAccountForbidden creates a LinkAzureAccountForbidden with default headers values
func NewLinkAzureAccountForbidden() *LinkAzureAccountForbidden {
	return &LinkAzureAccountForbidden{}
}

/*
LinkAzureAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type LinkAzureAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this link azure account forbidden response has a 2xx status code
func (o *LinkAzureAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this link azure account forbidden response has a 3xx status code
func (o *LinkAzureAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this link azure account forbidden response has a 4xx status code
func (o *LinkAzureAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this link azure account forbidden response has a 5xx status code
func (o *LinkAzureAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this link azure account forbidden response a status code equal to that given
func (o *LinkAzureAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the link azure account forbidden response
func (o *LinkAzureAccountForbidden) Code() int {
	return 403
}

func (o *LinkAzureAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-azure][%d] linkAzureAccountForbidden %s", 403, payload)
}

func (o *LinkAzureAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-azure][%d] linkAzureAccountForbidden %s", 403, payload)
}

func (o *LinkAzureAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *LinkAzureAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
