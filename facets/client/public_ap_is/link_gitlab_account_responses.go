...
func (o *LinkGitlabAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewLinkGitlabAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewLinkGitlabAccountForbidden creates a LinkGitlabAccountForbidden with default headers values
func NewLinkGitlabAccountForbidden() *LinkGitlabAccountForbidden {
	return &LinkGitlabAccountForbidden{}
}

/*
LinkGitlabAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type LinkGitlabAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this link gitlab account forbidden response has a 2xx status code
func (o *LinkGitlabAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this link gitlab account forbidden response has a 3xx status code
func (o *LinkGitlabAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this link gitlab account forbidden response has a 4xx status code
func (o *LinkGitlabAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this link gitlab account forbidden response has a 5xx status code
func (o *LinkGitlabAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this link gitlab account forbidden response a status code equal to that given
func (o *LinkGitlabAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the link gitlab account forbidden response
func (o *LinkGitlabAccountForbidden) Code() int {
	return 403
}

func (o *LinkGitlabAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-gitlab][%d] linkGitlabAccountForbidden %s", 403, payload)
}

func (o *LinkGitlabAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-gitlab][%d] linkGitlabAccountForbidden %s", 403, payload)
}

func (o *LinkGitlabAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *LinkGitlabAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
