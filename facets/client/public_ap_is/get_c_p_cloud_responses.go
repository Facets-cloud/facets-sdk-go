...
func (o *GetCPCloudReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewGetCPCloudForbidden creates a GetCPCloudForbidden with default headers values
func NewGetCPCloudForbidden() *GetCPCloudForbidden {
	return &GetCPCloudForbidden{}
}

/*
GetCPCloudForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetCPCloudForbidden struct {
	Payload string
}

// IsSuccess returns true when this get c p cloud forbidden response has a 2xx status code
func (o *GetCPCloudForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get c p cloud forbidden response has a 3xx status code
func (o *GetCPCloudForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get c p cloud forbidden response has a 4xx status code
func (o *GetCPCloudForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get c p cloud forbidden response has a 5xx status code
func (o *GetCPCloudForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get c p cloud forbidden response a status code equal to that given
func (o *GetCPCloudForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get c p cloud forbidden response
func (o *GetCPCloudForbidden) Code() int {
	return 403
}

func (o *GetCPCloudForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /public/v1/cp-cloud][%d] getCPCloudForbidden %s", 403, payload)
}

func (o *GetCPCloudForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /public/v1/cp-cloud][%d] getCPCloudForbidden %s", 403, payload)
}

func (o *GetCPCloudForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetCPCloudForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
