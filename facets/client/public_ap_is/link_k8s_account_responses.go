...
func (o *LinkK8sAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewLinkK8sAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewLinkK8sAccountForbidden creates a LinkK8sAccountForbidden with default headers values
func NewLinkK8sAccountForbidden() *LinkK8sAccountForbidden {
	return &LinkK8sAccountForbidden{}
}

/*
LinkK8sAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type LinkK8sAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this link k8s account forbidden response has a 2xx status code
func (o *LinkK8sAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this link k8s account forbidden response has a 3xx status code
func (o *LinkK8sAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this link k8s account forbidden response has a 4xx status code
func (o *LinkK8sAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this link k8s account forbidden response has a 5xx status code
func (o *LinkK8sAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this link k8s account forbidden response a status code equal to that given
func (o *LinkK8sAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the link k8s account forbidden response
func (o *LinkK8sAccountForbidden) Code() int {
	return 403
}

func (o *LinkK8sAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-kubernetes][%d] linkK8sAccountForbidden %s", 403, payload)
}

func (o *LinkK8sAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-kubernetes][%d] linkK8sAccountForbidden %s", 403, payload)
}

func (o *LinkK8sAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *LinkK8sAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
