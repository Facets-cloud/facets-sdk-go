...
func (o *HealthCheckReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewHealthCheckForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *HealthCheckOK) GetPayload() map[string]any {
	return o.Payload
}
...
// NewHealthCheckForbidden creates a HealthCheckForbidden with default headers values
func NewHealthCheckForbidden() *HealthCheckForbidden {
	return &HealthCheckForbidden{}
}

/*
HealthCheckForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type HealthCheckForbidden struct {
	Payload string
}

// IsSuccess returns true when this health check forbidden response has a 2xx status code
func (o *HealthCheckForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this health check forbidden response has a 3xx status code
func (o *HealthCheckForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this health check forbidden response has a 4xx status code
func (o *HealthCheckForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this health check forbidden response has a 5xx status code
func (o *HealthCheckForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this health check forbidden response a status code equal to that given
func (o *HealthCheckForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the health check forbidden response
func (o *HealthCheckForbidden) Code() int {
	return 403
}

func (o *HealthCheckForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /public/v1/health][%d] healthCheckForbidden %s", 403, payload)
}

func (o *HealthCheckForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /public/v1/health][%d] healthCheckForbidden %s", 403, payload)
}

func (o *HealthCheckForbidden) GetPayload() string {
	return o.Payload
}

func (o *HealthCheckForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
