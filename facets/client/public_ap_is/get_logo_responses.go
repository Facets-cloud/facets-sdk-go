...
func (o *GetLogoReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewGetLogoForbidden creates a GetLogoForbidden with default headers values
func NewGetLogoForbidden() *GetLogoForbidden {
	return &GetLogoForbidden{}
}

/*
GetLogoForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetLogoForbidden struct {
	Payload string
}

// IsSuccess returns true when this get logo forbidden response has a 2xx status code
func (o *GetLogoForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get logo forbidden response has a 3xx status code
func (o *GetLogoForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get logo forbidden response has a 4xx status code
func (o *GetLogoForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get logo forbidden response has a 5xx status code
func (o *GetLogoForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get logo forbidden response a status code equal to that given
func (o *GetLogoForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get logo forbidden response
func (o *GetLogoForbidden) Code() int {
	return 403
}

func (o *GetLogoForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /public/v1/logo][%d] getLogoForbidden %s", 403, payload)
}

func (o *GetLogoForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /public/v1/logo][%d] getLogoForbidden %s", 403, payload)
}

func (o *GetLogoForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetLogoForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
