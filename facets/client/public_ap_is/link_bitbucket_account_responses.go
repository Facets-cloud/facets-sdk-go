...
func (o *LinkBitbucketAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewLinkBitbucketAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewLinkBitbucketAccountForbidden creates a LinkBitbucketAccountForbidden with default headers values
func NewLinkBitbucketAccountForbidden() *LinkBitbucketAccountForbidden {
	return &LinkBitbucketAccountForbidden{}
}

/*
LinkBitbucketAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type LinkBitbucketAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this link bitbucket account forbidden response has a 2xx status code
func (o *LinkBitbucketAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this link bitbucket account forbidden response has a 3xx status code
func (o *LinkBitbucketAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this link bitbucket account forbidden response has a 4xx status code
func (o *LinkBitbucketAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this link bitbucket account forbidden response has a 5xx status code
func (o *LinkBitbucketAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this link bitbucket account forbidden response a status code equal to that given
func (o *LinkBitbucketAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the link bitbucket account forbidden response
func (o *LinkBitbucketAccountForbidden) Code() int {
	return 403
}

func (o *LinkBitbucketAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-bitbucket][%d] linkBitbucketAccountForbidden %s", 403, payload)
}

func (o *LinkBitbucketAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-bitbucket][%d] linkBitbucketAccountForbidden %s", 403, payload)
}

func (o *LinkBitbucketAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *LinkBitbucketAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
