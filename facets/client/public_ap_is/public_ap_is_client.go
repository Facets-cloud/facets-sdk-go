...
type ClientService interface {
	...
	GetModuleSchema(params *GetModuleSchemaParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetModuleSchemaOK, error)

	GetModuleSchemaByType(params *GetModuleSchemaByTypeParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetModuleSchemaByTypeOK, error)

	GetSamlLoginOptions(params *GetSamlLoginOptionsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetSamlLoginOptionsOK, error)
...
/*
GetModuleSchema get module schema API
*/
func (a *Client) GetModuleSchema(params *GetModuleSchemaParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetModuleSchemaOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewGetModuleSchemaParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getModuleSchema",
		Method:             "GET",
		PathPattern:        "/public/v1/module/{intent}/{flavor}/{version}/schema",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetModuleSchemaReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*GetModuleSchemaOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getModuleSchema: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

/*
GetModuleSchemaByType get module schema by type API
*/
func (a *Client) GetModuleSchemaByType(params *GetModuleSchemaByTypeParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetModuleSchemaByTypeOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewGetModuleSchemaByTypeParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getModuleSchemaByType",
		Method:             "GET",
		PathPattern:        "/public/v1/module/{intent}/{flavor}/{version}/schema/{type}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetModuleSchemaByTypeReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*GetModuleSchemaByTypeOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getModuleSchemaByType: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

/*
GetSamlLoginOptions get saml login options API
*/
func (a *Client) GetSamlLoginOptions(params *GetSamlLoginOptionsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetSamlLoginOptionsOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewGetSamlLoginOptionsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getSamlLoginOptions",
		Method:             "GET",
		PathPattern:        "/public/v1/samlLoginOptions",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetSamlLoginOptionsReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*GetSamlLoginOptionsOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getSamlLoginOptions: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
