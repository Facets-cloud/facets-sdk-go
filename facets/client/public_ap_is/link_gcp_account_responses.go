...
func (o *LinkGcpAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewLinkGcpAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewLinkGcpAccountForbidden creates a LinkGcpAccountForbidden with default headers values
func NewLinkGcpAccountForbidden() *LinkGcpAccountForbidden {
	return &LinkGcpAccountForbidden{}
}

/*
LinkGcpAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type LinkGcpAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this link gcp account forbidden response has a 2xx status code
func (o *LinkGcpAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this link gcp account forbidden response has a 3xx status code
func (o *LinkGcpAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this link gcp account forbidden response has a 4xx status code
func (o *LinkGcpAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this link gcp account forbidden response has a 5xx status code
func (o *LinkGcpAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this link gcp account forbidden response a status code equal to that given
func (o *LinkGcpAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the link gcp account forbidden response
func (o *LinkGcpAccountForbidden) Code() int {
	return 403
}

func (o *LinkGcpAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-gcp][%d] linkGcpAccountForbidden %s", 403, payload)
}

func (o *LinkGcpAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-gcp][%d] linkGcpAccountForbidden %s", 403, payload)
}

func (o *LinkGcpAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *LinkGcpAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
