...
func (o *GetLoginOptionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetLoginOptionsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetLoginOptionsForbidden creates a GetLoginOptionsForbidden with default headers values
func NewGetLoginOptionsForbidden() *GetLoginOptionsForbidden {
	return &GetLoginOptionsForbidden{}
}

/*
GetLoginOptionsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetLoginOptionsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get login options forbidden response has a 2xx status code
func (o *GetLoginOptionsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get login options forbidden response has a 3xx status code
func (o *GetLoginOptionsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get login options forbidden response has a 4xx status code
func (o *GetLoginOptionsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get login options forbidden response has a 5xx status code
func (o *GetLoginOptionsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get login options forbidden response a status code equal to that given
func (o *GetLoginOptionsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get login options forbidden response
func (o *GetLoginOptionsForbidden) Code() int {
	return 403
}

func (o *GetLoginOptionsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /public/v1/loginOptions][%d] getLoginOptionsForbidden %s", 403, payload)
}

func (o *GetLoginOptionsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /public/v1/loginOptions][%d] getLoginOptionsForbidden %s", 403, payload)
}

func (o *GetLoginOptionsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetLoginOptionsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
