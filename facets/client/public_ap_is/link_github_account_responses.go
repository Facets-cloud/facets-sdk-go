...
func (o *LinkGithubAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewLinkGithubAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewLinkGithubAccountForbidden creates a LinkGithubAccountForbidden with default headers values
func NewLinkGithubAccountForbidden() *LinkGithubAccountForbidden {
	return &LinkGithubAccountForbidden{}
}

/*
LinkGithubAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type LinkGithubAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this link github account forbidden response has a 2xx status code
func (o *LinkGithubAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this link github account forbidden response has a 3xx status code
func (o *LinkGithubAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this link github account forbidden response has a 4xx status code
func (o *LinkGithubAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this link github account forbidden response has a 5xx status code
func (o *LinkGithubAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this link github account forbidden response a status code equal to that given
func (o *LinkGithubAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the link github account forbidden response
func (o *LinkGithubAccountForbidden) Code() int {
	return 403
}

func (o *LinkGithubAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-github][%d] linkGithubAccountForbidden %s", 403, payload)
}

func (o *LinkGithubAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-github][%d] linkGithubAccountForbidden %s", 403, payload)
}

func (o *LinkGithubAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *LinkGithubAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
