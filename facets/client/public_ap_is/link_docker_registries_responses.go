...
func (o *LinkDockerRegistriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewLinkDockerRegistriesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewLinkDockerRegistriesForbidden creates a LinkDockerRegistriesForbidden with default headers values
func NewLinkDockerRegistriesForbidden() *LinkDockerRegistriesForbidden {
	return &LinkDockerRegistriesForbidden{}
}

/*
LinkDockerRegistriesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type LinkDockerRegistriesForbidden struct {
	Payload string
}

// IsSuccess returns true when this link docker registries forbidden response has a 2xx status code
func (o *LinkDockerRegistriesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this link docker registries forbidden response has a 3xx status code
func (o *LinkDockerRegistriesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this link docker registries forbidden response has a 4xx status code
func (o *LinkDockerRegistriesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this link docker registries forbidden response has a 5xx status code
func (o *LinkDockerRegistriesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this link docker registries forbidden response a status code equal to that given
func (o *LinkDockerRegistriesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the link docker registries forbidden response
func (o *LinkDockerRegistriesForbidden) Code() int {
	return 403
}

func (o *LinkDockerRegistriesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-docker-registries][%d] linkDockerRegistriesForbidden %s", 403, payload)
}

func (o *LinkDockerRegistriesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-docker-registries][%d] linkDockerRegistriesForbidden %s", 403, payload)
}

func (o *LinkDockerRegistriesForbidden) GetPayload() string {
	return o.Payload
}

func (o *LinkDockerRegistriesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
