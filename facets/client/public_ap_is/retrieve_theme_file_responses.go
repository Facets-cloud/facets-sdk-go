...
func (o *RetrieveThemeFileReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRetrieveThemeFileForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRetrieveThemeFileForbidden creates a RetrieveThemeFileForbidden with default headers values
func NewRetrieveThemeFileForbidden() *RetrieveThemeFileForbidden {
	return &RetrieveThemeFileForbidden{}
}

/*
RetrieveThemeFileForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RetrieveThemeFileForbidden struct {
	Payload string
}

// IsSuccess returns true when this retrieve theme file forbidden response has a 2xx status code
func (o *RetrieveThemeFileForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this retrieve theme file forbidden response has a 3xx status code
func (o *RetrieveThemeFileForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this retrieve theme file forbidden response has a 4xx status code
func (o *RetrieveThemeFileForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this retrieve theme file forbidden response has a 5xx status code
func (o *RetrieveThemeFileForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this retrieve theme file forbidden response a status code equal to that given
func (o *RetrieveThemeFileForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the retrieve theme file forbidden response
func (o *RetrieveThemeFileForbidden) Code() int {
	return 403
}

func (o *RetrieveThemeFileForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /public/v1/themeFile][%d] retrieveThemeFileForbidden %s", 403, payload)
}

func (o *RetrieveThemeFileForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /public/v1/themeFile][%d] retrieveThemeFileForbidden %s", 403, payload)
}

func (o *RetrieveThemeFileForbidden) GetPayload() string {
	return o.Payload
}

func (o *RetrieveThemeFileForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
