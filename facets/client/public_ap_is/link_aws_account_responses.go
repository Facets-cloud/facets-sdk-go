...
func (o *LinkAwsAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewLinkAwsAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewLinkAwsAccountForbidden creates a LinkAwsAccountForbidden with default headers values
func NewLinkAwsAccountForbidden() *LinkAwsAccountForbidden {
	return &LinkAwsAccountForbidden{}
}

/*
LinkAwsAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type LinkAwsAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this link aws account forbidden response has a 2xx status code
func (o *LinkAwsAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this link aws account forbidden response has a 3xx status code
func (o *LinkAwsAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this link aws account forbidden response has a 4xx status code
func (o *LinkAwsAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this link aws account forbidden response has a 5xx status code
func (o *LinkAwsAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this link aws account forbidden response a status code equal to that given
func (o *LinkAwsAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the link aws account forbidden response
func (o *LinkAwsAccountForbidden) Code() int {
	return 403
}

func (o *LinkAwsAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-aws][%d] linkAwsAccountForbidden %s", 403, payload)
}

func (o *LinkAwsAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-aws][%d] linkAwsAccountForbidden %s", 403, payload)
}

func (o *LinkAwsAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *LinkAwsAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
