...
func (o *LinkECRReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewLinkECRForbidden creates a LinkECRForbidden with default headers values
func NewLinkECRForbidden() *LinkECRForbidden {
	return &LinkECRForbidden{}
}

/*
LinkECRForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type LinkECRForbidden struct {
	Payload string
}

// IsSuccess returns true when this link e c r forbidden response has a 2xx status code
func (o *LinkECRForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this link e c r forbidden response has a 3xx status code
func (o *LinkECRForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this link e c r forbidden response has a 4xx status code
func (o *LinkECRForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this link e c r forbidden response has a 5xx status code
func (o *LinkECRForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this link e c r forbidden response a status code equal to that given
func (o *LinkECRForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the link e c r forbidden response
func (o *LinkECRForbidden) Code() int {
	return 403
}

func (o *LinkECRForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-ecr][%d] linkECRForbidden %s", 403, payload)
}

func (o *LinkECRForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/v1/link-ecr][%d] linkECRForbidden %s", 403, payload)
}

func (o *LinkECRForbidden) GetPayload() string {
	return o.Payload
}

func (o *LinkECRForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
