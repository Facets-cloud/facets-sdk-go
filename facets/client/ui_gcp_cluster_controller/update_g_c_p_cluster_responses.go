...
func (o *UpdateGCPClusterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateGCPClusterForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateGCPClusterForbidden creates a UpdateGCPClusterForbidden with default headers values
func NewUpdateGCPClusterForbidden() *UpdateGCPClusterForbidden {
	return &UpdateGCPClusterForbidden{}
}

/*
UpdateGCPClusterForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateGCPClusterForbidden struct {
	Payload string
}

// IsSuccess returns true when this update g c p cluster forbidden response has a 2xx status code
func (o *UpdateGCPClusterForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update g c p cluster forbidden response has a 3xx status code
func (o *UpdateGCPClusterForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update g c p cluster forbidden response has a 4xx status code
func (o *UpdateGCPClusterForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update g c p cluster forbidden response has a 5xx status code
func (o *UpdateGCPClusterForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update g c p cluster forbidden response a status code equal to that given
func (o *UpdateGCPClusterForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update g c p cluster forbidden response
func (o *UpdateGCPClusterForbidden) Code() int {
	return 403
}

func (o *UpdateGCPClusterForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/gcp/clusters/{clusterId}][%d] updateGCPClusterForbidden %s", 403, payload)
}

func (o *UpdateGCPClusterForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/gcp/clusters/{clusterId}][%d] updateGCPClusterForbidden %s", 403, payload)
}

func (o *UpdateGCPClusterForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateGCPClusterForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
