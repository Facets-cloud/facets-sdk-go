...
func (o *CreateGCPClusterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCreateGCPClusterForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateGCPClusterForbidden creates a CreateGCPClusterForbidden with default headers values
func NewCreateGCPClusterForbidden() *CreateGCPClusterForbidden {
	return &CreateGCPClusterForbidden{}
}

/*
CreateGCPClusterForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CreateGCPClusterForbidden struct {
	Payload string
}

// IsSuccess returns true when this create g c p cluster forbidden response has a 2xx status code
func (o *CreateGCPClusterForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create g c p cluster forbidden response has a 3xx status code
func (o *CreateGCPClusterForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create g c p cluster forbidden response has a 4xx status code
func (o *CreateGCPClusterForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create g c p cluster forbidden response has a 5xx status code
func (o *CreateGCPClusterForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create g c p cluster forbidden response a status code equal to that given
func (o *CreateGCPClusterForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create g c p cluster forbidden response
func (o *CreateGCPClusterForbidden) Code() int {
	return 403
}

func (o *CreateGCPClusterForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/gcp/clusters][%d] createGCPClusterForbidden %s", 403, payload)
}

func (o *CreateGCPClusterForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/gcp/clusters][%d] createGCPClusterForbidden %s", 403, payload)
}

func (o *CreateGCPClusterForbidden) GetPayload() string {
	return o.Payload
}

func (o *CreateGCPClusterForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
