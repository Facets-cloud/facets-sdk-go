...
func (o *GetGCPClusterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetGCPClusterForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetGCPClusterForbidden creates a GetGCPClusterForbidden with default headers values
func NewGetGCPClusterForbidden() *GetGCPClusterForbidden {
	return &GetGCPClusterForbidden{}
}

/*
GetGCPClusterForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetGCPClusterForbidden struct {
	Payload string
}

// IsSuccess returns true when this get g c p cluster forbidden response has a 2xx status code
func (o *GetGCPClusterForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get g c p cluster forbidden response has a 3xx status code
func (o *GetGCPClusterForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get g c p cluster forbidden response has a 4xx status code
func (o *GetGCPClusterForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get g c p cluster forbidden response has a 5xx status code
func (o *GetGCPClusterForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get g c p cluster forbidden response a status code equal to that given
func (o *GetGCPClusterForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get g c p cluster forbidden response
func (o *GetGCPClusterForbidden) Code() int {
	return 403
}

func (o *GetGCPClusterForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/gcp/clusters/{clusterId}][%d] getGCPClusterForbidden %s", 403, payload)
}

func (o *GetGCPClusterForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/gcp/clusters/{clusterId}][%d] getGCPClusterForbidden %s", 403, payload)
}

func (o *GetGCPClusterForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetGCPClusterForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
