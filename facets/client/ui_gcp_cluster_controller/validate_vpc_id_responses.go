...
func (o *ValidateVpcIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewValidateVpcIDForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewValidateVpcIDForbidden creates a ValidateVpcIDForbidden with default headers values
func NewValidateVpcIDForbidden() *ValidateVpcIDForbidden {
	return &ValidateVpcIDForbidden{}
}

/*
ValidateVpcIDForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ValidateVpcIDForbidden struct {
	Payload string
}

// IsSuccess returns true when this validate vpc Id forbidden response has a 2xx status code
func (o *ValidateVpcIDForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this validate vpc Id forbidden response has a 3xx status code
func (o *ValidateVpcIDForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this validate vpc Id forbidden response has a 4xx status code
func (o *ValidateVpcIDForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this validate vpc Id forbidden response has a 5xx status code
func (o *ValidateVpcIDForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this validate vpc Id forbidden response a status code equal to that given
func (o *ValidateVpcIDForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the validate vpc Id forbidden response
func (o *ValidateVpcIDForbidden) Code() int {
	return 403
}

func (o *ValidateVpcIDForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/gcp/clusters/validate-vpcId][%d] validateVpcIdForbidden %s", 403, payload)
}

func (o *ValidateVpcIDForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/gcp/clusters/validate-vpcId][%d] validateVpcIdForbidden %s", 403, payload)
}

func (o *ValidateVpcIDForbidden) GetPayload() string {
	return o.Payload
}

func (o *ValidateVpcIDForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
