...
// WithBody adds the body to the create g c p cluster params
func (o *CreateGCPClusterParams) WithBody(body *models.GCPClusterRequest) *CreateGCPClusterParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create g c p cluster params
func (o *CreateGCPClusterParams) SetBody(body *models.GCPClusterRequest) {
	o.Body = body
}
