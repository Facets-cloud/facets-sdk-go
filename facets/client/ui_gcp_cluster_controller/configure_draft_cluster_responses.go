...
func (o *ConfigureDraftClusterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewConfigureDraftClusterForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewConfigureDraftClusterForbidden creates a ConfigureDraftClusterForbidden with default headers values
func NewConfigureDraftClusterForbidden() *ConfigureDraftClusterForbidden {
	return &ConfigureDraftClusterForbidden{}
}

/*
ConfigureDraftClusterForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ConfigureDraftClusterForbidden struct {
	Payload string
}

// IsSuccess returns true when this configure draft cluster forbidden response has a 2xx status code
func (o *ConfigureDraftClusterForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this configure draft cluster forbidden response has a 3xx status code
func (o *ConfigureDraftClusterForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this configure draft cluster forbidden response has a 4xx status code
func (o *ConfigureDraftClusterForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this configure draft cluster forbidden response has a 5xx status code
func (o *ConfigureDraftClusterForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this configure draft cluster forbidden response a status code equal to that given
func (o *ConfigureDraftClusterForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the configure draft cluster forbidden response
func (o *ConfigureDraftClusterForbidden) Code() int {
	return 403
}

func (o *ConfigureDraftClusterForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/gcp/clusters/configure/{clusterId}][%d] configureDraftClusterForbidden %s", 403, payload)
}

func (o *ConfigureDraftClusterForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/gcp/clusters/configure/{clusterId}][%d] configureDraftClusterForbidden %s", 403, payload)
}

func (o *ConfigureDraftClusterForbidden) GetPayload() string {
	return o.Payload
}

func (o *ConfigureDraftClusterForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
