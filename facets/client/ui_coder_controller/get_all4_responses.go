...
func (o *GetAll4Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewGetAll4Forbidden creates a GetAll4Forbidden with default headers values
func NewGetAll4Forbidden() *GetAll4Forbidden {
	return &GetAll4Forbidden{}
}

/*
GetAll4Forbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAll4Forbidden struct {
	Payload string
}

// IsSuccess returns true when this get all4 forbidden response has a 2xx status code
func (o *GetAll4Forbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all4 forbidden response has a 3xx status code
func (o *GetAll4Forbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all4 forbidden response has a 4xx status code
func (o *GetAll4Forbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all4 forbidden response has a 5xx status code
func (o *GetAll4Forbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all4 forbidden response a status code equal to that given
func (o *GetAll4Forbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all4 forbidden response
func (o *GetAll4Forbidden) Code() int {
	return 403
}

func (o *GetAll4Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/coder/stack/{stackName}/resourceType/{resourceType}/resourceName/{resourceName}/workspaces][%d] getAll4Forbidden %s", 403, payload)
}

func (o *GetAll4Forbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/coder/stack/{stackName}/resourceType/{resourceType}/resourceName/{resourceName}/workspaces][%d] getAll4Forbidden %s", 403, payload)
}

func (o *GetAll4Forbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAll4Forbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
