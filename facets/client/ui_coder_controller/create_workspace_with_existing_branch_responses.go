...
func (o *CreateWorkspaceWithExistingBranchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCreateWorkspaceWithExistingBranchForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateWorkspaceWithExistingBranchForbidden creates a CreateWorkspaceWithExistingBranchForbidden with default headers values
func NewCreateWorkspaceWithExistingBranchForbidden() *CreateWorkspaceWithExistingBranchForbidden {
	return &CreateWorkspaceWithExistingBranchForbidden{}
}

/*
CreateWorkspaceWithExistingBranchForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CreateWorkspaceWithExistingBranchForbidden struct {
	Payload string
}

// IsSuccess returns true when this create workspace with existing branch forbidden response has a 2xx status code
func (o *CreateWorkspaceWithExistingBranchForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create workspace with existing branch forbidden response has a 3xx status code
func (o *CreateWorkspaceWithExistingBranchForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create workspace with existing branch forbidden response has a 4xx status code
func (o *CreateWorkspaceWithExistingBranchForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create workspace with existing branch forbidden response has a 5xx status code
func (o *CreateWorkspaceWithExistingBranchForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create workspace with existing branch forbidden response a status code equal to that given
func (o *CreateWorkspaceWithExistingBranchForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create workspace with existing branch forbidden response
func (o *CreateWorkspaceWithExistingBranchForbidden) Code() int {
	return 403
}

func (o *CreateWorkspaceWithExistingBranchForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/coder/stack/{stackName}/resourceType/{resourceType}/resourceName/{resourceName}/existing-branch][%d] createWorkspaceWithExistingBranchForbidden %s", 403, payload)
}

func (o *CreateWorkspaceWithExistingBranchForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/coder/stack/{stackName}/resourceType/{resourceType}/resourceName/{resourceName}/existing-branch][%d] createWorkspaceWithExistingBranchForbidden %s", 403, payload)
}

func (o *CreateWorkspaceWithExistingBranchForbidden) GetPayload() string {
	return o.Payload
}

func (o *CreateWorkspaceWithExistingBranchForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
