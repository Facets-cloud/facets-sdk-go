...
func (o *GetAll3Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewGetAll3Forbidden creates a GetAll3Forbidden with default headers values
func NewGetAll3Forbidden() *GetAll3Forbidden {
	return &GetAll3Forbidden{}
}

/*
GetAll3Forbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAll3Forbidden struct {
	Payload string
}

// IsSuccess returns true when this get all3 forbidden response has a 2xx status code
func (o *GetAll3Forbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all3 forbidden response has a 3xx status code
func (o *GetAll3Forbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all3 forbidden response has a 4xx status code
func (o *GetAll3Forbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all3 forbidden response has a 5xx status code
func (o *GetAll3Forbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all3 forbidden response a status code equal to that given
func (o *GetAll3Forbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all3 forbidden response
func (o *GetAll3Forbidden) Code() int {
	return 403
}

func (o *GetAll3Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/coder/stack/{stackName}/workspaces][%d] getAll3Forbidden %s", 403, payload)
}

func (o *GetAll3Forbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/coder/stack/{stackName}/workspaces][%d] getAll3Forbidden %s", 403, payload)
}

func (o *GetAll3Forbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAll3Forbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
