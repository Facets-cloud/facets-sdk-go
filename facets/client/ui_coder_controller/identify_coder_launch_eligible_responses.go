...
func (o *IdentifyCoderLaunchEligibleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewIdentifyCoderLaunchEligibleForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewIdentifyCoderLaunchEligibleForbidden creates a IdentifyCoderLaunchEligibleForbidden with default headers values
func NewIdentifyCoderLaunchEligibleForbidden() *IdentifyCoderLaunchEligibleForbidden {
	return &IdentifyCoderLaunchEligibleForbidden{}
}

/*
IdentifyCoderLaunchEligibleForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type IdentifyCoderLaunchEligibleForbidden struct {
	Payload string
}

// IsSuccess returns true when this identify coder launch eligible forbidden response has a 2xx status code
func (o *IdentifyCoderLaunchEligibleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this identify coder launch eligible forbidden response has a 3xx status code
func (o *IdentifyCoderLaunchEligibleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this identify coder launch eligible forbidden response has a 4xx status code
func (o *IdentifyCoderLaunchEligibleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this identify coder launch eligible forbidden response has a 5xx status code
func (o *IdentifyCoderLaunchEligibleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this identify coder launch eligible forbidden response a status code equal to that given
func (o *IdentifyCoderLaunchEligibleForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the identify coder launch eligible forbidden response
func (o *IdentifyCoderLaunchEligibleForbidden) Code() int {
	return 403
}

func (o *IdentifyCoderLaunchEligibleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/coder/stack/{stackName}/coder-eligibility][%d] identifyCoderLaunchEligibleForbidden %s", 403, payload)
}

func (o *IdentifyCoderLaunchEligibleForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/coder/stack/{stackName}/coder-eligibility][%d] identifyCoderLaunchEligibleForbidden %s", 403, payload)
}

func (o *IdentifyCoderLaunchEligibleForbidden) GetPayload() string {
	return o.Payload
}

func (o *IdentifyCoderLaunchEligibleForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
