...
func (o *GetProjectTypeByIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetProjectTypeByIDForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetProjectTypeByIDForbidden creates a GetProjectTypeByIDForbidden with default headers values
func NewGetProjectTypeByIDForbidden() *GetProjectTypeByIDForbidden {
	return &GetProjectTypeByIDForbidden{}
}

/*
GetProjectTypeByIDForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetProjectTypeByIDForbidden struct {
	Payload string
}

// IsSuccess returns true when this get project type by Id forbidden response has a 2xx status code
func (o *GetProjectTypeByIDForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get project type by Id forbidden response has a 3xx status code
func (o *GetProjectTypeByIDForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get project type by Id forbidden response has a 4xx status code
func (o *GetProjectTypeByIDForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get project type by Id forbidden response has a 5xx status code
func (o *GetProjectTypeByIDForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get project type by Id forbidden response a status code equal to that given
func (o *GetProjectTypeByIDForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get project type by Id forbidden response
func (o *GetProjectTypeByIDForbidden) Code() int {
	return 403
}

func (o *GetProjectTypeByIDForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/project-types/{id}][%d] getProjectTypeByIdForbidden %s", 403, payload)
}

func (o *GetProjectTypeByIDForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/project-types/{id}][%d] getProjectTypeByIdForbidden %s", 403, payload)
}

func (o *GetProjectTypeByIDForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetProjectTypeByIDForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
