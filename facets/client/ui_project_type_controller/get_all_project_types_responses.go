...
func (o *GetAllProjectTypesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllProjectTypesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllProjectTypesForbidden creates a GetAllProjectTypesForbidden with default headers values
func NewGetAllProjectTypesForbidden() *GetAllProjectTypesForbidden {
	return &GetAllProjectTypesForbidden{}
}

/*
GetAllProjectTypesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllProjectTypesForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all project types forbidden response has a 2xx status code
func (o *GetAllProjectTypesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all project types forbidden response has a 3xx status code
func (o *GetAllProjectTypesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all project types forbidden response has a 4xx status code
func (o *GetAllProjectTypesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all project types forbidden response has a 5xx status code
func (o *GetAllProjectTypesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all project types forbidden response a status code equal to that given
func (o *GetAllProjectTypesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all project types forbidden response
func (o *GetAllProjectTypesForbidden) Code() int {
	return 403
}

func (o *GetAllProjectTypesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/project-types][%d] getAllProjectTypesForbidden %s", 403, payload)
}

func (o *GetAllProjectTypesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/project-types][%d] getAllProjectTypesForbidden %s", 403, payload)
}

func (o *GetAllProjectTypesForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllProjectTypesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
