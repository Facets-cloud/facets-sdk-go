...
func (o *DeleteProjectTypeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteProjectTypeForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteProjectTypeForbidden creates a DeleteProjectTypeForbidden with default headers values
func NewDeleteProjectTypeForbidden() *DeleteProjectTypeForbidden {
	return &DeleteProjectTypeForbidden{}
}

/*
DeleteProjectTypeForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteProjectTypeForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete project type forbidden response has a 2xx status code
func (o *DeleteProjectTypeForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete project type forbidden response has a 3xx status code
func (o *DeleteProjectTypeForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete project type forbidden response has a 4xx status code
func (o *DeleteProjectTypeForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete project type forbidden response has a 5xx status code
func (o *DeleteProjectTypeForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete project type forbidden response a status code equal to that given
func (o *DeleteProjectTypeForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete project type forbidden response
func (o *DeleteProjectTypeForbidden) Code() int {
	return 403
}

func (o *DeleteProjectTypeForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/project-types/{id}][%d] deleteProjectTypeForbidden %s", 403, payload)
}

func (o *DeleteProjectTypeForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/project-types/{id}][%d] deleteProjectTypeForbidden %s", 403, payload)
}

func (o *DeleteProjectTypeForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteProjectTypeForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
