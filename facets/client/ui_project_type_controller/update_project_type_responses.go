...
func (o *UpdateProjectTypeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateProjectTypeForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateProjectTypeForbidden creates a UpdateProjectTypeForbidden with default headers values
func NewUpdateProjectTypeForbidden() *UpdateProjectTypeForbidden {
	return &UpdateProjectTypeForbidden{}
}

/*
UpdateProjectTypeForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateProjectTypeForbidden struct {
	Payload string
}

// IsSuccess returns true when this update project type forbidden response has a 2xx status code
func (o *UpdateProjectTypeForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update project type forbidden response has a 3xx status code
func (o *UpdateProjectTypeForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update project type forbidden response has a 4xx status code
func (o *UpdateProjectTypeForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update project type forbidden response has a 5xx status code
func (o *UpdateProjectTypeForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update project type forbidden response a status code equal to that given
func (o *UpdateProjectTypeForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update project type forbidden response
func (o *UpdateProjectTypeForbidden) Code() int {
	return 403
}

func (o *UpdateProjectTypeForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/project-types/{id}][%d] updateProjectTypeForbidden %s", 403, payload)
}

func (o *UpdateProjectTypeForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/project-types/{id}][%d] updateProjectTypeForbidden %s", 403, payload)
}

func (o *UpdateProjectTypeForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateProjectTypeForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
