...
func (o *SaveCiCdDetailsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewSaveCiCdDetailsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSaveCiCdDetailsForbidden creates a SaveCiCdDetailsForbidden with default headers values
func NewSaveCiCdDetailsForbidden() *SaveCiCdDetailsForbidden {
	return &SaveCiCdDetailsForbidden{}
}

/*
SaveCiCdDetailsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type SaveCiCdDetailsForbidden struct {
	Payload string
}

// IsSuccess returns true when this save ci cd details forbidden response has a 2xx status code
func (o *SaveCiCdDetailsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this save ci cd details forbidden response has a 3xx status code
func (o *SaveCiCdDetailsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this save ci cd details forbidden response has a 4xx status code
func (o *SaveCiCdDetailsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this save ci cd details forbidden response has a 5xx status code
func (o *SaveCiCdDetailsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this save ci cd details forbidden response a status code equal to that given
func (o *SaveCiCdDetailsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the save ci cd details forbidden response
func (o *SaveCiCdDetailsForbidden) Code() int {
	return 403
}

func (o *SaveCiCdDetailsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/ci-cd][%d] saveCiCdDetailsForbidden %s", 403, payload)
}

func (o *SaveCiCdDetailsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/ci-cd][%d] saveCiCdDetailsForbidden %s", 403, payload)
}

func (o *SaveCiCdDetailsForbidden) GetPayload() string {
	return o.Payload
}

func (o *SaveCiCdDetailsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
