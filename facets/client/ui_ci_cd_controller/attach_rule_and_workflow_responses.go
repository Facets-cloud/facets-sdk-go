...
func (o *AttachRuleAndWorkflowReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewAttachRuleAndWorkflowForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewAttachRuleAndWorkflowForbidden creates a AttachRuleAndWorkflowForbidden with default headers values
func NewAttachRuleAndWorkflowForbidden() *AttachRuleAndWorkflowForbidden {
	return &AttachRuleAndWorkflowForbidden{}
}

/*
AttachRuleAndWorkflowForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type AttachRuleAndWorkflowForbidden struct {
	Payload string
}

// IsSuccess returns true when this attach rule and workflow forbidden response has a 2xx status code
func (o *AttachRuleAndWorkflowForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this attach rule and workflow forbidden response has a 3xx status code
func (o *AttachRuleAndWorkflowForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this attach rule and workflow forbidden response has a 4xx status code
func (o *AttachRuleAndWorkflowForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this attach rule and workflow forbidden response has a 5xx status code
func (o *AttachRuleAndWorkflowForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this attach rule and workflow forbidden response a status code equal to that given
func (o *AttachRuleAndWorkflowForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the attach rule and workflow forbidden response
func (o *AttachRuleAndWorkflowForbidden) Code() int {
	return 403
}

func (o *AttachRuleAndWorkflowForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/ci-cd/attach][%d] attachRuleAndWorkflowForbidden %s", 403, payload)
}

func (o *AttachRuleAndWorkflowForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/ci-cd/attach][%d] attachRuleAndWorkflowForbidden %s", 403, payload)
}

func (o *AttachRuleAndWorkflowForbidden) GetPayload() string {
	return o.Payload
}

func (o *AttachRuleAndWorkflowForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
