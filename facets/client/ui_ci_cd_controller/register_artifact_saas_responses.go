...
func (o *RegisterArtifactSaasReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRegisterArtifactSaasForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRegisterArtifactSaasForbidden creates a RegisterArtifactSaasForbidden with default headers values
func NewRegisterArtifactSaasForbidden() *RegisterArtifactSaasForbidden {
	return &RegisterArtifactSaasForbidden{}
}

/*
RegisterArtifactSaasForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RegisterArtifactSaasForbidden struct {
	Payload string
}

// IsSuccess returns true when this register artifact saas forbidden response has a 2xx status code
func (o *RegisterArtifactSaasForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this register artifact saas forbidden response has a 3xx status code
func (o *RegisterArtifactSaasForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this register artifact saas forbidden response has a 4xx status code
func (o *RegisterArtifactSaasForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this register artifact saas forbidden response has a 5xx status code
func (o *RegisterArtifactSaasForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this register artifact saas forbidden response a status code equal to that given
func (o *RegisterArtifactSaasForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the register artifact saas forbidden response
func (o *RegisterArtifactSaasForbidden) Code() int {
	return 403
}

func (o *RegisterArtifactSaasForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/ci-cd/register][%d] registerArtifactSaasForbidden %s", 403, payload)
}

func (o *RegisterArtifactSaasForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/ci-cd/register][%d] registerArtifactSaasForbidden %s", 403, payload)
}

func (o *RegisterArtifactSaasForbidden) GetPayload() string {
	return o.Payload
}

func (o *RegisterArtifactSaasForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
