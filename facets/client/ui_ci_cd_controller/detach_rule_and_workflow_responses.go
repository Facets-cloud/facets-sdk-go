...
func (o *DetachRuleAndWorkflowReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDetachRuleAndWorkflowForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDetachRuleAndWorkflowForbidden creates a DetachRuleAndWorkflowForbidden with default headers values
func NewDetachRuleAndWorkflowForbidden() *DetachRuleAndWorkflowForbidden {
	return &DetachRuleAndWorkflowForbidden{}
}

/*
DetachRuleAndWorkflowForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DetachRuleAndWorkflowForbidden struct {
	Payload string
}

// IsSuccess returns true when this detach rule and workflow forbidden response has a 2xx status code
func (o *DetachRuleAndWorkflowForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this detach rule and workflow forbidden response has a 3xx status code
func (o *DetachRuleAndWorkflowForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this detach rule and workflow forbidden response has a 4xx status code
func (o *DetachRuleAndWorkflowForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this detach rule and workflow forbidden response has a 5xx status code
func (o *DetachRuleAndWorkflowForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this detach rule and workflow forbidden response a status code equal to that given
func (o *DetachRuleAndWorkflowForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the detach rule and workflow forbidden response
func (o *DetachRuleAndWorkflowForbidden) Code() int {
	return 403
}

func (o *DetachRuleAndWorkflowForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/ci-cd/detach][%d] detachRuleAndWorkflowForbidden %s", 403, payload)
}

func (o *DetachRuleAndWorkflowForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/ci-cd/detach][%d] detachRuleAndWorkflowForbidden %s", 403, payload)
}

func (o *DetachRuleAndWorkflowForbidden) GetPayload() string {
	return o.Payload
}

func (o *DetachRuleAndWorkflowForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
