...
func (o *GetCiCdDetailsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetCiCdDetailsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetCiCdDetailsForbidden creates a GetCiCdDetailsForbidden with default headers values
func NewGetCiCdDetailsForbidden() *GetCiCdDetailsForbidden {
	return &GetCiCdDetailsForbidden{}
}

/*
GetCiCdDetailsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetCiCdDetailsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get ci cd details forbidden response has a 2xx status code
func (o *GetCiCdDetailsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get ci cd details forbidden response has a 3xx status code
func (o *GetCiCdDetailsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get ci cd details forbidden response has a 4xx status code
func (o *GetCiCdDetailsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get ci cd details forbidden response has a 5xx status code
func (o *GetCiCdDetailsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get ci cd details forbidden response a status code equal to that given
func (o *GetCiCdDetailsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get ci cd details forbidden response
func (o *GetCiCdDetailsForbidden) Code() int {
	return 403
}

func (o *GetCiCdDetailsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/ci-cd/{stackName}][%d] getCiCdDetailsForbidden %s", 403, payload)
}

func (o *GetCiCdDetailsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/ci-cd/{stackName}][%d] getCiCdDetailsForbidden %s", 403, payload)
}

func (o *GetCiCdDetailsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetCiCdDetailsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
