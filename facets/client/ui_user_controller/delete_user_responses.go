...
func (o *DeleteUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 404:
		...
		return nil, result
	case 405:
		result := NewDeleteUserMethodNotAllowed()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /cc-ui/v1/users/{userId}] deleteUser", response, response.Code())
	}
}
...
func (o *DeleteUserOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /cc-ui/v1/users/{userId}][%d] deleteUserOK %s", 200, payload)
}
...
func (o *DeleteUserBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/users/{userId}][%d] deleteUserBadRequest %s", 400, payload)
}
...
func (o *DeleteUserBadRequest) GetPayload() *models.ErrorDetails {
	return o.Payload
}
...
func (o *DeleteUserForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/users/{userId}][%d] deleteUserForbidden %s", 403, payload)
}
...
func (o *DeleteUserForbidden) GetPayload() string {
	return o.Payload
}
...
func (o *DeleteUserNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/users/{userId}][%d] deleteUserNotFound %s", 404, payload)
}
...
func (o *DeleteUserNotFound) GetPayload() *models.ErrorDetails {
	return o.Payload
}
...
// NewDeleteUserMethodNotAllowed creates a DeleteUserMethodNotAllowed with default headers values
func NewDeleteUserMethodNotAllowed() *DeleteUserMethodNotAllowed {
	return &DeleteUserMethodNotAllowed{}
}

/*
DeleteUserMethodNotAllowed describes a response with status code 405, with default header values.

Method Not Allowed
*/
type DeleteUserMethodNotAllowed struct {
	Payload *models.ErrorDetails
}

// IsSuccess returns true when this delete user method not allowed response has a 2xx status code
func (o *DeleteUserMethodNotAllowed) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete user method not allowed response has a 3xx status code
func (o *DeleteUserMethodNotAllowed) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete user method not allowed response has a 4xx status code
func (o *DeleteUserMethodNotAllowed) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete user method not allowed response has a 5xx status code
func (o *DeleteUserMethodNotAllowed) IsServerError() bool {
	return false
}

// IsCode returns true when this delete user method not allowed response a status code equal to that given
func (o *DeleteUserMethodNotAllowed) IsCode(code int) bool {
	return code == 405
}

// Code gets the status code for the delete user method not allowed response
func (o *DeleteUserMethodNotAllowed) Code() int {
	return 405
}

func (o *DeleteUserMethodNotAllowed) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/users/{userId}][%d] deleteUserMethodNotAllowed %s", 405, payload)
}

func (o *DeleteUserMethodNotAllowed) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/users/{userId}][%d] deleteUserMethodNotAllowed %s", 405, payload)
}

func (o *DeleteUserMethodNotAllowed) GetPayload() *models.ErrorDetails {
	return o.Payload
}

func (o *DeleteUserMethodNotAllowed) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *DeleteUserInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/users/{userId}][%d] deleteUserInternalServerError %s", 500, payload)
}
...
func (o *DeleteUserInternalServerError) GetPayload() *models.ErrorDetails {
	return o.Payload
}
