...
// WithToken adds the token to the create token params
func (o *CreateTokenParams) WithToken(token string) *CreateTokenParams {
	o.SetToken(token)
	return o
}

// SetToken adds the token to the create token params
func (o *CreateTokenParams) SetToken(token string) {
	o.Token = token
}
