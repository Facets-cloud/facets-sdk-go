...
func (o *GetAllUsersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
/*
GetAllUsersForbidden describes a response with status code 403, with default header values.
...
// IsSuccess returns true when this get all users forbidden response has a 2xx status code
func (o *GetAllUsersForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all users forbidden response has a 3xx status code
func (o *GetAllUsersForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all users forbidden response has a 4xx status code
func (o *GetAllUsersForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all users forbidden response has a 5xx status code
func (o *GetAllUsersForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all users forbidden response a status code equal to that given
func (o *GetAllUsersForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all users forbidden response
func (o *GetAllUsersForbidden) Code() int {
	return 403
}

func (o *GetAllUsersForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/users/][%d] getAllUsersForbidden %s", 403, payload)
}

func (o *GetAllUsersForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/users/][%d] getAllUsersForbidden %s", 403, payload)
}

func (o *GetAllUsersForbidden) GetPayload() string {
	return o.Payload
}
