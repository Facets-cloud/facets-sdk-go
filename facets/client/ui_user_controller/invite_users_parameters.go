...
func (o *InviteUsersParams) WithBody(body *models.InviteUserRequest) *InviteUsersParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the invite users params
func (o *InviteUsersParams) SetBody(body *models.InviteUserRequest) {
	o.Body = body
}
