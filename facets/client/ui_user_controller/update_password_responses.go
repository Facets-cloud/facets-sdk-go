...
func (o *UpdatePasswordReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
/*
UpdatePasswordForbidden describes a response with status code 403, with default header values.
...
// IsSuccess returns true when this update password forbidden response has a 2xx status code
func (o *UpdatePasswordForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update password forbidden response has a 3xx status code
func (o *UpdatePasswordForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update password forbidden response has a 4xx status code
func (o *UpdatePasswordForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update password forbidden response has a 5xx status code
func (o *UpdatePasswordForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update password forbidden response a status code equal to that given
func (o *UpdatePasswordForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update password forbidden response
func (o *UpdatePasswordForbidden) Code() int {
	return 403
}

func (o *UpdatePasswordForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/users/updatePassword][%d] updatePasswordForbidden %s", 403, payload)
}

func (o *UpdatePasswordForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/users/updatePassword][%d] updatePasswordForbidden %s", 403, payload)
}

func (o *UpdatePasswordForbidden) GetPayload() string {
	return o.Payload
}
