...
func (o *GetUserExpandedReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetUserExpandedForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetUserExpandedForbidden creates a GetUserExpandedForbidden with default headers values
func NewGetUserExpandedForbidden() *GetUserExpandedForbidden {
	return &GetUserExpandedForbidden{}
}

/*
GetUserExpandedForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetUserExpandedForbidden struct {
	Payload string
}

// IsSuccess returns true when this get user expanded forbidden response has a 2xx status code
func (o *GetUserExpandedForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get user expanded forbidden response has a 3xx status code
func (o *GetUserExpandedForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get user expanded forbidden response has a 4xx status code
func (o *GetUserExpandedForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get user expanded forbidden response has a 5xx status code
func (o *GetUserExpandedForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get user expanded forbidden response a status code equal to that given
func (o *GetUserExpandedForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get user expanded forbidden response
func (o *GetUserExpandedForbidden) Code() int {
	return 403
}

func (o *GetUserExpandedForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/users/{userId}/user-expanded][%d] getUserExpandedForbidden %s", 403, payload)
}

func (o *GetUserExpandedForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/users/{userId}/user-expanded][%d] getUserExpandedForbidden %s", 403, payload)
}

func (o *GetUserExpandedForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetUserExpandedForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
