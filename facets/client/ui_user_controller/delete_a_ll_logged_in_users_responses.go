...
func (o *DeleteALlLoggedInUsersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteALlLoggedInUsersForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteALlLoggedInUsersForbidden creates a DeleteALlLoggedInUsersForbidden with default headers values
func NewDeleteALlLoggedInUsersForbidden() *DeleteALlLoggedInUsersForbidden {
	return &DeleteALlLoggedInUsersForbidden{}
}

/*
DeleteALlLoggedInUsersForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteALlLoggedInUsersForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete a ll logged in users forbidden response has a 2xx status code
func (o *DeleteALlLoggedInUsersForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete a ll logged in users forbidden response has a 3xx status code
func (o *DeleteALlLoggedInUsersForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete a ll logged in users forbidden response has a 4xx status code
func (o *DeleteALlLoggedInUsersForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete a ll logged in users forbidden response has a 5xx status code
func (o *DeleteALlLoggedInUsersForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete a ll logged in users forbidden response a status code equal to that given
func (o *DeleteALlLoggedInUsersForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete a ll logged in users forbidden response
func (o *DeleteALlLoggedInUsersForbidden) Code() int {
	return 403
}

func (o *DeleteALlLoggedInUsersForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/users/loggedIn/session][%d] deleteALlLoggedInUsersForbidden %s", 403, payload)
}

func (o *DeleteALlLoggedInUsersForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/users/loggedIn/session][%d] deleteALlLoggedInUsersForbidden %s", 403, payload)
}

func (o *DeleteALlLoggedInUsersForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteALlLoggedInUsersForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
