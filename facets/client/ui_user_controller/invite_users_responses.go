...
func (o *InviteUsersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
/*
InviteUsersForbidden describes a response with status code 403, with default header values.
...
// IsSuccess returns true when this invite users forbidden response has a 2xx status code
func (o *InviteUsersForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this invite users forbidden response has a 3xx status code
func (o *InviteUsersForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this invite users forbidden response has a 4xx status code
func (o *InviteUsersForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this invite users forbidden response has a 5xx status code
func (o *InviteUsersForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this invite users forbidden response a status code equal to that given
func (o *InviteUsersForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the invite users forbidden response
func (o *InviteUsersForbidden) Code() int {
	return 403
}

func (o *InviteUsersForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/users/invite-users][%d] inviteUsersForbidden %s", 403, payload)
}

func (o *InviteUsersForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/users/invite-users][%d] inviteUsersForbidden %s", 403, payload)
}

func (o *InviteUsersForbidden) GetPayload() string {
	return o.Payload
}
