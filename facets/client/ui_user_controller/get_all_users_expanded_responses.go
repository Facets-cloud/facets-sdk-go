...
func (o *GetAllUsersExpandedReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllUsersExpandedForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllUsersExpandedForbidden creates a GetAllUsersExpandedForbidden with default headers values
func NewGetAllUsersExpandedForbidden() *GetAllUsersExpandedForbidden {
	return &GetAllUsersExpandedForbidden{}
}

/*
GetAllUsersExpandedForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllUsersExpandedForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all users expanded forbidden response has a 2xx status code
func (o *GetAllUsersExpandedForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all users expanded forbidden response has a 3xx status code
func (o *GetAllUsersExpandedForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all users expanded forbidden response has a 4xx status code
func (o *GetAllUsersExpandedForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all users expanded forbidden response has a 5xx status code
func (o *GetAllUsersExpandedForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all users expanded forbidden response a status code equal to that given
func (o *GetAllUsersExpandedForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all users expanded forbidden response
func (o *GetAllUsersExpandedForbidden) Code() int {
	return 403
}

func (o *GetAllUsersExpandedForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/users/list/users-expanded][%d] getAllUsersExpandedForbidden %s", 403, payload)
}

func (o *GetAllUsersExpandedForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/users/list/users-expanded][%d] getAllUsersExpandedForbidden %s", 403, payload)
}

func (o *GetAllUsersExpandedForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllUsersExpandedForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
