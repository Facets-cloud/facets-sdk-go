...
import (
	...
	"github.com/Facets-cloud/facets-sdk-go/facets/client/ui_saml_controller"
	...
	"github.com/Facets-cloud/facets-sdk-go/facets/client/ui_tekton_action_controller"
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *Facets {
	...
	cli.UIEnvironmentController = ui_environment_controller.New(transport, formats)
	...
	cli.UISamlController = ui_saml_controller.New(transport, formats)
	...
	cli.UITektonActionController = ui_tekton_action_controller.New(transport, formats)
	...
	cli.VariableManagement = variable_management.New(transport, formats)
	return cli
}
...
type Facets struct {
	...
	UIEnvironmentController ui_environment_controller.ClientService
	...
	UISamlController ui_saml_controller.ClientService

	UISettingsController ui_settings_controller.ClientService

	UIStackController ui_stack_controller.ClientService

	UITektonActionController ui_tekton_action_controller.ClientService
	...
	VariableManagement variable_management.ClientService
...
func (c *Facets) SetTransport(transport runtime.ClientTransport) {
	...
	c.UIEnvironmentController.SetTransport(transport)
	...
	c.UISamlController.SetTransport(transport)
	c.UISettingsController.SetTransport(transport)
	c.UIStackController.SetTransport(transport)
	c.UITektonActionController.SetTransport(transport)
	...
	c.VariableManagement.SetTransport(transport)
}
