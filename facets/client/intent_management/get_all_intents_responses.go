...
func (o *GetAllIntentsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllIntentsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllIntentsForbidden creates a GetAllIntentsForbidden with default headers values
func NewGetAllIntentsForbidden() *GetAllIntentsForbidden {
	return &GetAllIntentsForbidden{}
}

/*
GetAllIntentsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllIntentsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all intents forbidden response has a 2xx status code
func (o *GetAllIntentsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all intents forbidden response has a 3xx status code
func (o *GetAllIntentsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all intents forbidden response has a 4xx status code
func (o *GetAllIntentsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all intents forbidden response has a 5xx status code
func (o *GetAllIntentsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all intents forbidden response a status code equal to that given
func (o *GetAllIntentsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all intents forbidden response
func (o *GetAllIntentsForbidden) Code() int {
	return 403
}

func (o *GetAllIntentsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/intents][%d] getAllIntentsForbidden %s", 403, payload)
}

func (o *GetAllIntentsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/intents][%d] getAllIntentsForbidden %s", 403, payload)
}

func (o *GetAllIntentsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllIntentsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
