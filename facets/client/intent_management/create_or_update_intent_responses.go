...
func (o *CreateOrUpdateIntentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCreateOrUpdateIntentForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateOrUpdateIntentForbidden creates a CreateOrUpdateIntentForbidden with default headers values
func NewCreateOrUpdateIntentForbidden() *CreateOrUpdateIntentForbidden {
	return &CreateOrUpdateIntentForbidden{}
}

/*
CreateOrUpdateIntentForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CreateOrUpdateIntentForbidden struct {
	Payload string
}

// IsSuccess returns true when this create or update intent forbidden response has a 2xx status code
func (o *CreateOrUpdateIntentForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create or update intent forbidden response has a 3xx status code
func (o *CreateOrUpdateIntentForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create or update intent forbidden response has a 4xx status code
func (o *CreateOrUpdateIntentForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create or update intent forbidden response has a 5xx status code
func (o *CreateOrUpdateIntentForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create or update intent forbidden response a status code equal to that given
func (o *CreateOrUpdateIntentForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create or update intent forbidden response
func (o *CreateOrUpdateIntentForbidden) Code() int {
	return 403
}

func (o *CreateOrUpdateIntentForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/intents][%d] createOrUpdateIntentForbidden %s", 403, payload)
}

func (o *CreateOrUpdateIntentForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/intents][%d] createOrUpdateIntentForbidden %s", 403, payload)
}

func (o *CreateOrUpdateIntentForbidden) GetPayload() string {
	return o.Payload
}

func (o *CreateOrUpdateIntentForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
