...
func (o *DeleteIntentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
/*
DeleteIntentForbidden describes a response with status code 403, with default header values.
...
// IsSuccess returns true when this delete intent forbidden response has a 2xx status code
func (o *DeleteIntentForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete intent forbidden response has a 3xx status code
func (o *DeleteIntentForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete intent forbidden response has a 4xx status code
func (o *DeleteIntentForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete intent forbidden response has a 5xx status code
func (o *DeleteIntentForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete intent forbidden response a status code equal to that given
func (o *DeleteIntentForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete intent forbidden response
func (o *DeleteIntentForbidden) Code() int {
	return 403
}

func (o *DeleteIntentForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/intents/{name}][%d] deleteIntentForbidden %s", 403, payload)
}

func (o *DeleteIntentForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/intents/{name}][%d] deleteIntentForbidden %s", 403, payload)
}

func (o *DeleteIntentForbidden) GetPayload() string {
	return o.Payload
}
