...
func (o *GetAuditLogsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetAuditLogsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/audit-logs][%d] getAuditLogsForbidden %s", 403, payload)
}
...
func (o *GetAuditLogsForbidden) GetPayload() string {
	return o.Payload
}
