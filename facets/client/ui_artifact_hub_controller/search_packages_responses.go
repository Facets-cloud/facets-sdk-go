...
func (o *SearchPackagesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewSearchPackagesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSearchPackagesForbidden creates a SearchPackagesForbidden with default headers values
func NewSearchPackagesForbidden() *SearchPackagesForbidden {
	return &SearchPackagesForbidden{}
}

/*
SearchPackagesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type SearchPackagesForbidden struct {
	Payload string
}

// IsSuccess returns true when this search packages forbidden response has a 2xx status code
func (o *SearchPackagesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this search packages forbidden response has a 3xx status code
func (o *SearchPackagesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this search packages forbidden response has a 4xx status code
func (o *SearchPackagesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this search packages forbidden response has a 5xx status code
func (o *SearchPackagesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this search packages forbidden response a status code equal to that given
func (o *SearchPackagesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the search packages forbidden response
func (o *SearchPackagesForbidden) Code() int {
	return 403
}

func (o *SearchPackagesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifactHub/search-packages][%d] searchPackagesForbidden %s", 403, payload)
}

func (o *SearchPackagesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifactHub/search-packages][%d] searchPackagesForbidden %s", 403, payload)
}

func (o *SearchPackagesForbidden) GetPayload() string {
	return o.Payload
}

func (o *SearchPackagesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
