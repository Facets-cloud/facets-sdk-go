...
func (o *GetClusterUsingGET2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /cc/v1/gcp/clusters/{clusterId}] getClusterUsingGET_2", response, response.Code())
	}
}
...
func (o *GetClusterUsingGET2OK) Error() string {
	...
	return fmt.Sprintf("[GET /cc/v1/gcp/clusters/{clusterId}][%d] getClusterUsingGET2OK %s", 200, payload)
}
...
func (o *GetClusterUsingGET2OK) GetPayload() *models.GCPCluster {
	return o.Payload
}
...
func (o *GetClusterUsingGET2Unauthorized) Error() string {
	return fmt.Sprintf("[GET /cc/v1/gcp/clusters/{clusterId}][%d] getClusterUsingGET2Unauthorized", 401)
}
...
func (o *GetClusterUsingGET2Forbidden) Error() string {
	return fmt.Sprintf("[GET /cc/v1/gcp/clusters/{clusterId}][%d] getClusterUsingGET2Forbidden", 403)
}
...
func (o *GetClusterUsingGET2NotFound) Error() string {
	return fmt.Sprintf("[GET /cc/v1/gcp/clusters/{clusterId}][%d] getClusterUsingGET2NotFound", 404)
}
