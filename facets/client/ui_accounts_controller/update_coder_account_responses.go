...
func (o *UpdateCoderAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateCoderAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateCoderAccountForbidden creates a UpdateCoderAccountForbidden with default headers values
func NewUpdateCoderAccountForbidden() *UpdateCoderAccountForbidden {
	return &UpdateCoderAccountForbidden{}
}

/*
UpdateCoderAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateCoderAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this update coder account forbidden response has a 2xx status code
func (o *UpdateCoderAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update coder account forbidden response has a 3xx status code
func (o *UpdateCoderAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update coder account forbidden response has a 4xx status code
func (o *UpdateCoderAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update coder account forbidden response has a 5xx status code
func (o *UpdateCoderAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update coder account forbidden response a status code equal to that given
func (o *UpdateCoderAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update coder account forbidden response
func (o *UpdateCoderAccountForbidden) Code() int {
	return 403
}

func (o *UpdateCoderAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/accounts/coder/{id}][%d] updateCoderAccountForbidden %s", 403, payload)
}

func (o *UpdateCoderAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/accounts/coder/{id}][%d] updateCoderAccountForbidden %s", 403, payload)
}

func (o *UpdateCoderAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateCoderAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
