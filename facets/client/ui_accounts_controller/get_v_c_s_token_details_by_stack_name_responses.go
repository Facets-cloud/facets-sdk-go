...
func (o *GetVCSTokenDetailsByStackNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetVCSTokenDetailsByStackNameForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetVCSTokenDetailsByStackNameForbidden creates a GetVCSTokenDetailsByStackNameForbidden with default headers values
func NewGetVCSTokenDetailsByStackNameForbidden() *GetVCSTokenDetailsByStackNameForbidden {
	return &GetVCSTokenDetailsByStackNameForbidden{}
}

/*
GetVCSTokenDetailsByStackNameForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetVCSTokenDetailsByStackNameForbidden struct {
	Payload string
}

// IsSuccess returns true when this get v c s token details by stack name forbidden response has a 2xx status code
func (o *GetVCSTokenDetailsByStackNameForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get v c s token details by stack name forbidden response has a 3xx status code
func (o *GetVCSTokenDetailsByStackNameForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get v c s token details by stack name forbidden response has a 4xx status code
func (o *GetVCSTokenDetailsByStackNameForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get v c s token details by stack name forbidden response has a 5xx status code
func (o *GetVCSTokenDetailsByStackNameForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get v c s token details by stack name forbidden response a status code equal to that given
func (o *GetVCSTokenDetailsByStackNameForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get v c s token details by stack name forbidden response
func (o *GetVCSTokenDetailsByStackNameForbidden) Code() int {
	return 403
}

func (o *GetVCSTokenDetailsByStackNameForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/accounts/stack/{stackName}/token-details][%d] getVCSTokenDetailsByStackNameForbidden %s", 403, payload)
}

func (o *GetVCSTokenDetailsByStackNameForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/accounts/stack/{stackName}/token-details][%d] getVCSTokenDetailsByStackNameForbidden %s", 403, payload)
}

func (o *GetVCSTokenDetailsByStackNameForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetVCSTokenDetailsByStackNameForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
