...
func (o *CreateGitLabAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCreateGitLabAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateGitLabAccountForbidden creates a CreateGitLabAccountForbidden with default headers values
func NewCreateGitLabAccountForbidden() *CreateGitLabAccountForbidden {
	return &CreateGitLabAccountForbidden{}
}

/*
CreateGitLabAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CreateGitLabAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this create git lab account forbidden response has a 2xx status code
func (o *CreateGitLabAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create git lab account forbidden response has a 3xx status code
func (o *CreateGitLabAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create git lab account forbidden response has a 4xx status code
func (o *CreateGitLabAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create git lab account forbidden response has a 5xx status code
func (o *CreateGitLabAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create git lab account forbidden response a status code equal to that given
func (o *CreateGitLabAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create git lab account forbidden response
func (o *CreateGitLabAccountForbidden) Code() int {
	return 403
}

func (o *CreateGitLabAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/gitlab/][%d] createGitLabAccountForbidden %s", 403, payload)
}

func (o *CreateGitLabAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/gitlab/][%d] createGitLabAccountForbidden %s", 403, payload)
}

func (o *CreateGitLabAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *CreateGitLabAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
