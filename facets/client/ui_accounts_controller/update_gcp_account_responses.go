...
func (o *UpdateGcpAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateGcpAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateGcpAccountForbidden creates a UpdateGcpAccountForbidden with default headers values
func NewUpdateGcpAccountForbidden() *UpdateGcpAccountForbidden {
	return &UpdateGcpAccountForbidden{}
}

/*
UpdateGcpAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateGcpAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this update gcp account forbidden response has a 2xx status code
func (o *UpdateGcpAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update gcp account forbidden response has a 3xx status code
func (o *UpdateGcpAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update gcp account forbidden response has a 4xx status code
func (o *UpdateGcpAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update gcp account forbidden response has a 5xx status code
func (o *UpdateGcpAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update gcp account forbidden response a status code equal to that given
func (o *UpdateGcpAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update gcp account forbidden response
func (o *UpdateGcpAccountForbidden) Code() int {
	return 403
}

func (o *UpdateGcpAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/accounts/gcp/{id}][%d] updateGcpAccountForbidden %s", 403, payload)
}

func (o *UpdateGcpAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/accounts/gcp/{id}][%d] updateGcpAccountForbidden %s", 403, payload)
}

func (o *UpdateGcpAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateGcpAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
