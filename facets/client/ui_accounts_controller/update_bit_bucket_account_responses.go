...
func (o *UpdateBitBucketAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateBitBucketAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateBitBucketAccountForbidden creates a UpdateBitBucketAccountForbidden with default headers values
func NewUpdateBitBucketAccountForbidden() *UpdateBitBucketAccountForbidden {
	return &UpdateBitBucketAccountForbidden{}
}

/*
UpdateBitBucketAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateBitBucketAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this update bit bucket account forbidden response has a 2xx status code
func (o *UpdateBitBucketAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update bit bucket account forbidden response has a 3xx status code
func (o *UpdateBitBucketAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update bit bucket account forbidden response has a 4xx status code
func (o *UpdateBitBucketAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update bit bucket account forbidden response has a 5xx status code
func (o *UpdateBitBucketAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update bit bucket account forbidden response a status code equal to that given
func (o *UpdateBitBucketAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update bit bucket account forbidden response
func (o *UpdateBitBucketAccountForbidden) Code() int {
	return 403
}

func (o *UpdateBitBucketAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/accounts/bitbucket/{id}][%d] updateBitBucketAccountForbidden %s", 403, payload)
}

func (o *UpdateBitBucketAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/accounts/bitbucket/{id}][%d] updateBitBucketAccountForbidden %s", 403, payload)
}

func (o *UpdateBitBucketAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateBitBucketAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
