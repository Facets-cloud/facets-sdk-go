...
func (o *GetAccountsByTypeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAccountsByTypeForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAccountsByTypeForbidden creates a GetAccountsByTypeForbidden with default headers values
func NewGetAccountsByTypeForbidden() *GetAccountsByTypeForbidden {
	return &GetAccountsByTypeForbidden{}
}

/*
GetAccountsByTypeForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAccountsByTypeForbidden struct {
	Payload string
}

// IsSuccess returns true when this get accounts by type forbidden response has a 2xx status code
func (o *GetAccountsByTypeForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get accounts by type forbidden response has a 3xx status code
func (o *GetAccountsByTypeForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get accounts by type forbidden response has a 4xx status code
func (o *GetAccountsByTypeForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get accounts by type forbidden response has a 5xx status code
func (o *GetAccountsByTypeForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get accounts by type forbidden response a status code equal to that given
func (o *GetAccountsByTypeForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get accounts by type forbidden response
func (o *GetAccountsByTypeForbidden) Code() int {
	return 403
}

func (o *GetAccountsByTypeForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/accounts/type/{type}][%d] getAccountsByTypeForbidden %s", 403, payload)
}

func (o *GetAccountsByTypeForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/accounts/type/{type}][%d] getAccountsByTypeForbidden %s", 403, payload)
}

func (o *GetAccountsByTypeForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAccountsByTypeForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
