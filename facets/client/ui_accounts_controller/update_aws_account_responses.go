...
func (o *UpdateAwsAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// IsSuccess returns true when this update aws account forbidden response has a 2xx status code
func (o *UpdateAwsAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update aws account forbidden response has a 3xx status code
func (o *UpdateAwsAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update aws account forbidden response has a 4xx status code
func (o *UpdateAwsAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update aws account forbidden response has a 5xx status code
func (o *UpdateAwsAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update aws account forbidden response a status code equal to that given
func (o *UpdateAwsAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update aws account forbidden response
...
func (o *UpdateAwsAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/accounts/aws/{id}][%d] updateAwsAccountForbidden %s", 403, payload)
}
...
func (o *UpdateAwsAccountForbidden) GetPayload() string {
	return o.Payload
}
