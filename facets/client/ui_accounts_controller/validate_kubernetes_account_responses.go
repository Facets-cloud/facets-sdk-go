...
func (o *ValidateKubernetesAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewValidateKubernetesAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewValidateKubernetesAccountForbidden creates a ValidateKubernetesAccountForbidden with default headers values
func NewValidateKubernetesAccountForbidden() *ValidateKubernetesAccountForbidden {
	return &ValidateKubernetesAccountForbidden{}
}

/*
ValidateKubernetesAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ValidateKubernetesAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this validate kubernetes account forbidden response has a 2xx status code
func (o *ValidateKubernetesAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this validate kubernetes account forbidden response has a 3xx status code
func (o *ValidateKubernetesAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this validate kubernetes account forbidden response has a 4xx status code
func (o *ValidateKubernetesAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this validate kubernetes account forbidden response has a 5xx status code
func (o *ValidateKubernetesAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this validate kubernetes account forbidden response a status code equal to that given
func (o *ValidateKubernetesAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the validate kubernetes account forbidden response
func (o *ValidateKubernetesAccountForbidden) Code() int {
	return 403
}

func (o *ValidateKubernetesAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/kubernetes/validate][%d] validateKubernetesAccountForbidden %s", 403, payload)
}

func (o *ValidateKubernetesAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/kubernetes/validate][%d] validateKubernetesAccountForbidden %s", 403, payload)
}

func (o *ValidateKubernetesAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *ValidateKubernetesAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
