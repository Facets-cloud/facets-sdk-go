...
func (o *ValidateGitlabAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewValidateGitlabAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewValidateGitlabAccountForbidden creates a ValidateGitlabAccountForbidden with default headers values
func NewValidateGitlabAccountForbidden() *ValidateGitlabAccountForbidden {
	return &ValidateGitlabAccountForbidden{}
}

/*
ValidateGitlabAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ValidateGitlabAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this validate gitlab account forbidden response has a 2xx status code
func (o *ValidateGitlabAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this validate gitlab account forbidden response has a 3xx status code
func (o *ValidateGitlabAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this validate gitlab account forbidden response has a 4xx status code
func (o *ValidateGitlabAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this validate gitlab account forbidden response has a 5xx status code
func (o *ValidateGitlabAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this validate gitlab account forbidden response a status code equal to that given
func (o *ValidateGitlabAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the validate gitlab account forbidden response
func (o *ValidateGitlabAccountForbidden) Code() int {
	return 403
}

func (o *ValidateGitlabAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/gitlab/validate][%d] validateGitlabAccountForbidden %s", 403, payload)
}

func (o *ValidateGitlabAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/gitlab/validate][%d] validateGitlabAccountForbidden %s", 403, payload)
}

func (o *ValidateGitlabAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *ValidateGitlabAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
