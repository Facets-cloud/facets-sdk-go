...
func (o *ValidateAwsAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewValidateAwsAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewValidateAwsAccountForbidden creates a ValidateAwsAccountForbidden with default headers values
func NewValidateAwsAccountForbidden() *ValidateAwsAccountForbidden {
	return &ValidateAwsAccountForbidden{}
}

/*
ValidateAwsAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ValidateAwsAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this validate aws account forbidden response has a 2xx status code
func (o *ValidateAwsAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this validate aws account forbidden response has a 3xx status code
func (o *ValidateAwsAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this validate aws account forbidden response has a 4xx status code
func (o *ValidateAwsAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this validate aws account forbidden response has a 5xx status code
func (o *ValidateAwsAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this validate aws account forbidden response a status code equal to that given
func (o *ValidateAwsAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the validate aws account forbidden response
func (o *ValidateAwsAccountForbidden) Code() int {
	return 403
}

func (o *ValidateAwsAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/aws/validate][%d] validateAwsAccountForbidden %s", 403, payload)
}

func (o *ValidateAwsAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/aws/validate][%d] validateAwsAccountForbidden %s", 403, payload)
}

func (o *ValidateAwsAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *ValidateAwsAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
