...
func (o *GetVCSOrganisationsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetVCSOrganisationsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetVCSOrganisationsForbidden creates a GetVCSOrganisationsForbidden with default headers values
func NewGetVCSOrganisationsForbidden() *GetVCSOrganisationsForbidden {
	return &GetVCSOrganisationsForbidden{}
}

/*
GetVCSOrganisationsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetVCSOrganisationsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get v c s organisations forbidden response has a 2xx status code
func (o *GetVCSOrganisationsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get v c s organisations forbidden response has a 3xx status code
func (o *GetVCSOrganisationsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get v c s organisations forbidden response has a 4xx status code
func (o *GetVCSOrganisationsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get v c s organisations forbidden response has a 5xx status code
func (o *GetVCSOrganisationsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get v c s organisations forbidden response a status code equal to that given
func (o *GetVCSOrganisationsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get v c s organisations forbidden response
func (o *GetVCSOrganisationsForbidden) Code() int {
	return 403
}

func (o *GetVCSOrganisationsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/get-organisations][%d] getVCSOrganisationsForbidden %s", 403, payload)
}

func (o *GetVCSOrganisationsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/get-organisations][%d] getVCSOrganisationsForbidden %s", 403, payload)
}

func (o *GetVCSOrganisationsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetVCSOrganisationsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
