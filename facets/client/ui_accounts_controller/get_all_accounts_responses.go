...
func (o *GetAllAccountsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllAccountsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllAccountsForbidden creates a GetAllAccountsForbidden with default headers values
func NewGetAllAccountsForbidden() *GetAllAccountsForbidden {
	return &GetAllAccountsForbidden{}
}

/*
GetAllAccountsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllAccountsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all accounts forbidden response has a 2xx status code
func (o *GetAllAccountsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all accounts forbidden response has a 3xx status code
func (o *GetAllAccountsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all accounts forbidden response has a 4xx status code
func (o *GetAllAccountsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all accounts forbidden response has a 5xx status code
func (o *GetAllAccountsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all accounts forbidden response a status code equal to that given
func (o *GetAllAccountsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all accounts forbidden response
func (o *GetAllAccountsForbidden) Code() int {
	return 403
}

func (o *GetAllAccountsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/accounts/][%d] getAllAccountsForbidden %s", 403, payload)
}

func (o *GetAllAccountsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/accounts/][%d] getAllAccountsForbidden %s", 403, payload)
}

func (o *GetAllAccountsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllAccountsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
