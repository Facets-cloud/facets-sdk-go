...
func (o *ValidateGcpAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewValidateGcpAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewValidateGcpAccountForbidden creates a ValidateGcpAccountForbidden with default headers values
func NewValidateGcpAccountForbidden() *ValidateGcpAccountForbidden {
	return &ValidateGcpAccountForbidden{}
}

/*
ValidateGcpAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ValidateGcpAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this validate gcp account forbidden response has a 2xx status code
func (o *ValidateGcpAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this validate gcp account forbidden response has a 3xx status code
func (o *ValidateGcpAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this validate gcp account forbidden response has a 4xx status code
func (o *ValidateGcpAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this validate gcp account forbidden response has a 5xx status code
func (o *ValidateGcpAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this validate gcp account forbidden response a status code equal to that given
func (o *ValidateGcpAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the validate gcp account forbidden response
func (o *ValidateGcpAccountForbidden) Code() int {
	return 403
}

func (o *ValidateGcpAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/gcp/validate][%d] validateGcpAccountForbidden %s", 403, payload)
}

func (o *ValidateGcpAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/gcp/validate][%d] validateGcpAccountForbidden %s", 403, payload)
}

func (o *ValidateGcpAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *ValidateGcpAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
