...
// Code gets the status code for the get account forbidden response
func (o *GetAccountForbidden) Code() int {
	return 403
}

func (o *GetAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/accounts/{id}][%d] getAccountForbidden %s", 403, payload)
}
...
func (o *GetAccountForbidden) GetPayload() string {
	return o.Payload
}
