...
func (o *CreateGitHubAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCreateGitHubAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateGitHubAccountForbidden creates a CreateGitHubAccountForbidden with default headers values
func NewCreateGitHubAccountForbidden() *CreateGitHubAccountForbidden {
	return &CreateGitHubAccountForbidden{}
}

/*
CreateGitHubAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CreateGitHubAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this create git hub account forbidden response has a 2xx status code
func (o *CreateGitHubAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create git hub account forbidden response has a 3xx status code
func (o *CreateGitHubAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create git hub account forbidden response has a 4xx status code
func (o *CreateGitHubAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create git hub account forbidden response has a 5xx status code
func (o *CreateGitHubAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create git hub account forbidden response a status code equal to that given
func (o *CreateGitHubAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create git hub account forbidden response
func (o *CreateGitHubAccountForbidden) Code() int {
	return 403
}

func (o *CreateGitHubAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/github/][%d] createGitHubAccountForbidden %s", 403, payload)
}

func (o *CreateGitHubAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/github/][%d] createGitHubAccountForbidden %s", 403, payload)
}

func (o *CreateGitHubAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *CreateGitHubAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
