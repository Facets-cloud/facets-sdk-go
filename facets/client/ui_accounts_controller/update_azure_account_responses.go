...
func (o *UpdateAzureAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateAzureAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateAzureAccountForbidden creates a UpdateAzureAccountForbidden with default headers values
func NewUpdateAzureAccountForbidden() *UpdateAzureAccountForbidden {
	return &UpdateAzureAccountForbidden{}
}

/*
UpdateAzureAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateAzureAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this update azure account forbidden response has a 2xx status code
func (o *UpdateAzureAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update azure account forbidden response has a 3xx status code
func (o *UpdateAzureAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update azure account forbidden response has a 4xx status code
func (o *UpdateAzureAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update azure account forbidden response has a 5xx status code
func (o *UpdateAzureAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update azure account forbidden response a status code equal to that given
func (o *UpdateAzureAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update azure account forbidden response
func (o *UpdateAzureAccountForbidden) Code() int {
	return 403
}

func (o *UpdateAzureAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/accounts/azure/{id}][%d] updateAzureAccountForbidden %s", 403, payload)
}

func (o *UpdateAzureAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/accounts/azure/{id}][%d] updateAzureAccountForbidden %s", 403, payload)
}

func (o *UpdateAzureAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateAzureAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
