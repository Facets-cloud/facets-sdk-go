...
func (o *GetAccountByNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAccountByNameForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAccountByNameForbidden creates a GetAccountByNameForbidden with default headers values
func NewGetAccountByNameForbidden() *GetAccountByNameForbidden {
	return &GetAccountByNameForbidden{}
}

/*
GetAccountByNameForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAccountByNameForbidden struct {
	Payload string
}

// IsSuccess returns true when this get account by name forbidden response has a 2xx status code
func (o *GetAccountByNameForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get account by name forbidden response has a 3xx status code
func (o *GetAccountByNameForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get account by name forbidden response has a 4xx status code
func (o *GetAccountByNameForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get account by name forbidden response has a 5xx status code
func (o *GetAccountByNameForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get account by name forbidden response a status code equal to that given
func (o *GetAccountByNameForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get account by name forbidden response
func (o *GetAccountByNameForbidden) Code() int {
	return 403
}

func (o *GetAccountByNameForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/accounts/name/{name}][%d] getAccountByNameForbidden %s", 403, payload)
}

func (o *GetAccountByNameForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/accounts/name/{name}][%d] getAccountByNameForbidden %s", 403, payload)
}

func (o *GetAccountByNameForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAccountByNameForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
