...
func (o *RefreshAllVCSTokenDetailsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRefreshAllVCSTokenDetailsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRefreshAllVCSTokenDetailsForbidden creates a RefreshAllVCSTokenDetailsForbidden with default headers values
func NewRefreshAllVCSTokenDetailsForbidden() *RefreshAllVCSTokenDetailsForbidden {
	return &RefreshAllVCSTokenDetailsForbidden{}
}

/*
RefreshAllVCSTokenDetailsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RefreshAllVCSTokenDetailsForbidden struct {
	Payload string
}

// IsSuccess returns true when this refresh all v c s token details forbidden response has a 2xx status code
func (o *RefreshAllVCSTokenDetailsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this refresh all v c s token details forbidden response has a 3xx status code
func (o *RefreshAllVCSTokenDetailsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this refresh all v c s token details forbidden response has a 4xx status code
func (o *RefreshAllVCSTokenDetailsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this refresh all v c s token details forbidden response has a 5xx status code
func (o *RefreshAllVCSTokenDetailsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this refresh all v c s token details forbidden response a status code equal to that given
func (o *RefreshAllVCSTokenDetailsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the refresh all v c s token details forbidden response
func (o *RefreshAllVCSTokenDetailsForbidden) Code() int {
	return 403
}

func (o *RefreshAllVCSTokenDetailsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/token-details/refresh][%d] refreshAllVCSTokenDetailsForbidden %s", 403, payload)
}

func (o *RefreshAllVCSTokenDetailsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/token-details/refresh][%d] refreshAllVCSTokenDetailsForbidden %s", 403, payload)
}

func (o *RefreshAllVCSTokenDetailsForbidden) GetPayload() string {
	return o.Payload
}

func (o *RefreshAllVCSTokenDetailsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
