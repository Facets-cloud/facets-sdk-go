...
func (o *UpdateVCSAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateVCSAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateVCSAccountForbidden creates a UpdateVCSAccountForbidden with default headers values
func NewUpdateVCSAccountForbidden() *UpdateVCSAccountForbidden {
	return &UpdateVCSAccountForbidden{}
}

/*
UpdateVCSAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateVCSAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this update v c s account forbidden response has a 2xx status code
func (o *UpdateVCSAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update v c s account forbidden response has a 3xx status code
func (o *UpdateVCSAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update v c s account forbidden response has a 4xx status code
func (o *UpdateVCSAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update v c s account forbidden response has a 5xx status code
func (o *UpdateVCSAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update v c s account forbidden response a status code equal to that given
func (o *UpdateVCSAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update v c s account forbidden response
func (o *UpdateVCSAccountForbidden) Code() int {
	return 403
}

func (o *UpdateVCSAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /cc-ui/v1/accounts/vcs/{id}][%d] updateVCSAccountForbidden %s", 403, payload)
}

func (o *UpdateVCSAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /cc-ui/v1/accounts/vcs/{id}][%d] updateVCSAccountForbidden %s", 403, payload)
}

func (o *UpdateVCSAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateVCSAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
