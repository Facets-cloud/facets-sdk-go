...
func (o *CreateCoderAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCreateCoderAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateCoderAccountForbidden creates a CreateCoderAccountForbidden with default headers values
func NewCreateCoderAccountForbidden() *CreateCoderAccountForbidden {
	return &CreateCoderAccountForbidden{}
}

/*
CreateCoderAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CreateCoderAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this create coder account forbidden response has a 2xx status code
func (o *CreateCoderAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create coder account forbidden response has a 3xx status code
func (o *CreateCoderAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create coder account forbidden response has a 4xx status code
func (o *CreateCoderAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create coder account forbidden response has a 5xx status code
func (o *CreateCoderAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create coder account forbidden response a status code equal to that given
func (o *CreateCoderAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create coder account forbidden response
func (o *CreateCoderAccountForbidden) Code() int {
	return 403
}

func (o *CreateCoderAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/coder/][%d] createCoderAccountForbidden %s", 403, payload)
}

func (o *CreateCoderAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/coder/][%d] createCoderAccountForbidden %s", 403, payload)
}

func (o *CreateCoderAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *CreateCoderAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
