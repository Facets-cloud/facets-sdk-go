...
func (o *UpdateGitLabAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateGitLabAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateGitLabAccountForbidden creates a UpdateGitLabAccountForbidden with default headers values
func NewUpdateGitLabAccountForbidden() *UpdateGitLabAccountForbidden {
	return &UpdateGitLabAccountForbidden{}
}

/*
UpdateGitLabAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateGitLabAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this update git lab account forbidden response has a 2xx status code
func (o *UpdateGitLabAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update git lab account forbidden response has a 3xx status code
func (o *UpdateGitLabAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update git lab account forbidden response has a 4xx status code
func (o *UpdateGitLabAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update git lab account forbidden response has a 5xx status code
func (o *UpdateGitLabAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update git lab account forbidden response a status code equal to that given
func (o *UpdateGitLabAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update git lab account forbidden response
func (o *UpdateGitLabAccountForbidden) Code() int {
	return 403
}

func (o *UpdateGitLabAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/accounts/gitlab/{id}][%d] updateGitLabAccountForbidden %s", 403, payload)
}

func (o *UpdateGitLabAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/accounts/gitlab/{id}][%d] updateGitLabAccountForbidden %s", 403, payload)
}

func (o *UpdateGitLabAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateGitLabAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
