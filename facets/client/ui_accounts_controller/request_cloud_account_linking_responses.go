...
func (o *RequestCloudAccountLinkingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRequestCloudAccountLinkingForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRequestCloudAccountLinkingForbidden creates a RequestCloudAccountLinkingForbidden with default headers values
func NewRequestCloudAccountLinkingForbidden() *RequestCloudAccountLinkingForbidden {
	return &RequestCloudAccountLinkingForbidden{}
}

/*
RequestCloudAccountLinkingForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RequestCloudAccountLinkingForbidden struct {
	Payload string
}

// IsSuccess returns true when this request cloud account linking forbidden response has a 2xx status code
func (o *RequestCloudAccountLinkingForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this request cloud account linking forbidden response has a 3xx status code
func (o *RequestCloudAccountLinkingForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this request cloud account linking forbidden response has a 4xx status code
func (o *RequestCloudAccountLinkingForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this request cloud account linking forbidden response has a 5xx status code
func (o *RequestCloudAccountLinkingForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this request cloud account linking forbidden response a status code equal to that given
func (o *RequestCloudAccountLinkingForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the request cloud account linking forbidden response
func (o *RequestCloudAccountLinkingForbidden) Code() int {
	return 403
}

func (o *RequestCloudAccountLinkingForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/link-cloud][%d] requestCloudAccountLinkingForbidden %s", 403, payload)
}

func (o *RequestCloudAccountLinkingForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/link-cloud][%d] requestCloudAccountLinkingForbidden %s", 403, payload)
}

func (o *RequestCloudAccountLinkingForbidden) GetPayload() string {
	return o.Payload
}

func (o *RequestCloudAccountLinkingForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
