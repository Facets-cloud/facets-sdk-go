...
func (o *RequestVCSLinkingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRequestVCSLinkingForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRequestVCSLinkingForbidden creates a RequestVCSLinkingForbidden with default headers values
func NewRequestVCSLinkingForbidden() *RequestVCSLinkingForbidden {
	return &RequestVCSLinkingForbidden{}
}

/*
RequestVCSLinkingForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RequestVCSLinkingForbidden struct {
	Payload string
}

// IsSuccess returns true when this request v c s linking forbidden response has a 2xx status code
func (o *RequestVCSLinkingForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this request v c s linking forbidden response has a 3xx status code
func (o *RequestVCSLinkingForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this request v c s linking forbidden response has a 4xx status code
func (o *RequestVCSLinkingForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this request v c s linking forbidden response has a 5xx status code
func (o *RequestVCSLinkingForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this request v c s linking forbidden response a status code equal to that given
func (o *RequestVCSLinkingForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the request v c s linking forbidden response
func (o *RequestVCSLinkingForbidden) Code() int {
	return 403
}

func (o *RequestVCSLinkingForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/link-vcs][%d] requestVCSLinkingForbidden %s", 403, payload)
}

func (o *RequestVCSLinkingForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/link-vcs][%d] requestVCSLinkingForbidden %s", 403, payload)
}

func (o *RequestVCSLinkingForbidden) GetPayload() string {
	return o.Payload
}

func (o *RequestVCSLinkingForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
