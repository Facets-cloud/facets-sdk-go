...
func (o *ValidateBitbucketAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewValidateBitbucketAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewValidateBitbucketAccountForbidden creates a ValidateBitbucketAccountForbidden with default headers values
func NewValidateBitbucketAccountForbidden() *ValidateBitbucketAccountForbidden {
	return &ValidateBitbucketAccountForbidden{}
}

/*
ValidateBitbucketAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ValidateBitbucketAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this validate bitbucket account forbidden response has a 2xx status code
func (o *ValidateBitbucketAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this validate bitbucket account forbidden response has a 3xx status code
func (o *ValidateBitbucketAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this validate bitbucket account forbidden response has a 4xx status code
func (o *ValidateBitbucketAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this validate bitbucket account forbidden response has a 5xx status code
func (o *ValidateBitbucketAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this validate bitbucket account forbidden response a status code equal to that given
func (o *ValidateBitbucketAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the validate bitbucket account forbidden response
func (o *ValidateBitbucketAccountForbidden) Code() int {
	return 403
}

func (o *ValidateBitbucketAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/bitbucket/validate][%d] validateBitbucketAccountForbidden %s", 403, payload)
}

func (o *ValidateBitbucketAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/bitbucket/validate][%d] validateBitbucketAccountForbidden %s", 403, payload)
}

func (o *ValidateBitbucketAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *ValidateBitbucketAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
