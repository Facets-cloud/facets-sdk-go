...
func (o *CreateGcpAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCreateGcpAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateGcpAccountForbidden creates a CreateGcpAccountForbidden with default headers values
func NewCreateGcpAccountForbidden() *CreateGcpAccountForbidden {
	return &CreateGcpAccountForbidden{}
}

/*
CreateGcpAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CreateGcpAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this create gcp account forbidden response has a 2xx status code
func (o *CreateGcpAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create gcp account forbidden response has a 3xx status code
func (o *CreateGcpAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create gcp account forbidden response has a 4xx status code
func (o *CreateGcpAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create gcp account forbidden response has a 5xx status code
func (o *CreateGcpAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create gcp account forbidden response a status code equal to that given
func (o *CreateGcpAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create gcp account forbidden response
func (o *CreateGcpAccountForbidden) Code() int {
	return 403
}

func (o *CreateGcpAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/gcp/][%d] createGcpAccountForbidden %s", 403, payload)
}

func (o *CreateGcpAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/gcp/][%d] createGcpAccountForbidden %s", 403, payload)
}

func (o *CreateGcpAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *CreateGcpAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
