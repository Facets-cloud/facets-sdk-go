...
func (o *UpdateGitHubAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateGitHubAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateGitHubAccountForbidden creates a UpdateGitHubAccountForbidden with default headers values
func NewUpdateGitHubAccountForbidden() *UpdateGitHubAccountForbidden {
	return &UpdateGitHubAccountForbidden{}
}

/*
UpdateGitHubAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateGitHubAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this update git hub account forbidden response has a 2xx status code
func (o *UpdateGitHubAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update git hub account forbidden response has a 3xx status code
func (o *UpdateGitHubAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update git hub account forbidden response has a 4xx status code
func (o *UpdateGitHubAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update git hub account forbidden response has a 5xx status code
func (o *UpdateGitHubAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update git hub account forbidden response a status code equal to that given
func (o *UpdateGitHubAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update git hub account forbidden response
func (o *UpdateGitHubAccountForbidden) Code() int {
	return 403
}

func (o *UpdateGitHubAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/accounts/github/{id}][%d] updateGitHubAccountForbidden %s", 403, payload)
}

func (o *UpdateGitHubAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/accounts/github/{id}][%d] updateGitHubAccountForbidden %s", 403, payload)
}

func (o *UpdateGitHubAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateGitHubAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
