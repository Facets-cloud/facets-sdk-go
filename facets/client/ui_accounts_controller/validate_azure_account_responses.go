...
func (o *ValidateAzureAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewValidateAzureAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewValidateAzureAccountForbidden creates a ValidateAzureAccountForbidden with default headers values
func NewValidateAzureAccountForbidden() *ValidateAzureAccountForbidden {
	return &ValidateAzureAccountForbidden{}
}

/*
ValidateAzureAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ValidateAzureAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this validate azure account forbidden response has a 2xx status code
func (o *ValidateAzureAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this validate azure account forbidden response has a 3xx status code
func (o *ValidateAzureAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this validate azure account forbidden response has a 4xx status code
func (o *ValidateAzureAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this validate azure account forbidden response has a 5xx status code
func (o *ValidateAzureAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this validate azure account forbidden response a status code equal to that given
func (o *ValidateAzureAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the validate azure account forbidden response
func (o *ValidateAzureAccountForbidden) Code() int {
	return 403
}

func (o *ValidateAzureAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/azure/validate][%d] validateAzureAccountForbidden %s", 403, payload)
}

func (o *ValidateAzureAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/azure/validate][%d] validateAzureAccountForbidden %s", 403, payload)
}

func (o *ValidateAzureAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *ValidateAzureAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
