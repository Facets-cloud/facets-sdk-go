...
func (o *GetAllVCSTokenDetailsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllVCSTokenDetailsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllVCSTokenDetailsForbidden creates a GetAllVCSTokenDetailsForbidden with default headers values
func NewGetAllVCSTokenDetailsForbidden() *GetAllVCSTokenDetailsForbidden {
	return &GetAllVCSTokenDetailsForbidden{}
}

/*
GetAllVCSTokenDetailsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllVCSTokenDetailsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all v c s token details forbidden response has a 2xx status code
func (o *GetAllVCSTokenDetailsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all v c s token details forbidden response has a 3xx status code
func (o *GetAllVCSTokenDetailsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all v c s token details forbidden response has a 4xx status code
func (o *GetAllVCSTokenDetailsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all v c s token details forbidden response has a 5xx status code
func (o *GetAllVCSTokenDetailsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all v c s token details forbidden response a status code equal to that given
func (o *GetAllVCSTokenDetailsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all v c s token details forbidden response
func (o *GetAllVCSTokenDetailsForbidden) Code() int {
	return 403
}

func (o *GetAllVCSTokenDetailsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/accounts/token-details][%d] getAllVCSTokenDetailsForbidden %s", 403, payload)
}

func (o *GetAllVCSTokenDetailsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/accounts/token-details][%d] getAllVCSTokenDetailsForbidden %s", 403, payload)
}

func (o *GetAllVCSTokenDetailsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllVCSTokenDetailsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
