...
func (o *ValidateGithubAccountReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewValidateGithubAccountForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewValidateGithubAccountForbidden creates a ValidateGithubAccountForbidden with default headers values
func NewValidateGithubAccountForbidden() *ValidateGithubAccountForbidden {
	return &ValidateGithubAccountForbidden{}
}

/*
ValidateGithubAccountForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ValidateGithubAccountForbidden struct {
	Payload string
}

// IsSuccess returns true when this validate github account forbidden response has a 2xx status code
func (o *ValidateGithubAccountForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this validate github account forbidden response has a 3xx status code
func (o *ValidateGithubAccountForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this validate github account forbidden response has a 4xx status code
func (o *ValidateGithubAccountForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this validate github account forbidden response has a 5xx status code
func (o *ValidateGithubAccountForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this validate github account forbidden response a status code equal to that given
func (o *ValidateGithubAccountForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the validate github account forbidden response
func (o *ValidateGithubAccountForbidden) Code() int {
	return 403
}

func (o *ValidateGithubAccountForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/github/validate][%d] validateGithubAccountForbidden %s", 403, payload)
}

func (o *ValidateGithubAccountForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/accounts/github/validate][%d] validateGithubAccountForbidden %s", 403, payload)
}

func (o *ValidateGithubAccountForbidden) GetPayload() string {
	return o.Payload
}

func (o *ValidateGithubAccountForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
