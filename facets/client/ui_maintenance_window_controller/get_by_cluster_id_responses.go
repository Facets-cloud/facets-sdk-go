...
func (o *GetByClusterIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetByClusterIDForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetByClusterIDForbidden creates a GetByClusterIDForbidden with default headers values
func NewGetByClusterIDForbidden() *GetByClusterIDForbidden {
	return &GetByClusterIDForbidden{}
}

/*
GetByClusterIDForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetByClusterIDForbidden struct {
	Payload string
}

// IsSuccess returns true when this get by cluster Id forbidden response has a 2xx status code
func (o *GetByClusterIDForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get by cluster Id forbidden response has a 3xx status code
func (o *GetByClusterIDForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get by cluster Id forbidden response has a 4xx status code
func (o *GetByClusterIDForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get by cluster Id forbidden response has a 5xx status code
func (o *GetByClusterIDForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get by cluster Id forbidden response a status code equal to that given
func (o *GetByClusterIDForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get by cluster Id forbidden response
func (o *GetByClusterIDForbidden) Code() int {
	return 403
}

func (o *GetByClusterIDForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/maintenance-window/{clusterId}][%d] getByClusterIdForbidden %s", 403, payload)
}

func (o *GetByClusterIDForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/maintenance-window/{clusterId}][%d] getByClusterIdForbidden %s", 403, payload)
}

func (o *GetByClusterIDForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetByClusterIDForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
