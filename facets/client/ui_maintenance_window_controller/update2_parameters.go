...
type Update2Params struct {
	...
	// Body.
	Body *models.MaintenanceWindowDTO
...
func (o *Update2Params) WithBody(body *models.MaintenanceWindowDTO) *Update2Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update 2 params
func (o *Update2Params) SetBody(body *models.MaintenanceWindowDTO) {
	o.Body = body
}
