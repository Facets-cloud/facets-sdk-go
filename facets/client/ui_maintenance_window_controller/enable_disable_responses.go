...
func (o *EnableDisableReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewEnableDisableForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewEnableDisableForbidden creates a EnableDisableForbidden with default headers values
func NewEnableDisableForbidden() *EnableDisableForbidden {
	return &EnableDisableForbidden{}
}

/*
EnableDisableForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type EnableDisableForbidden struct {
	Payload string
}

// IsSuccess returns true when this enable disable forbidden response has a 2xx status code
func (o *EnableDisableForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this enable disable forbidden response has a 3xx status code
func (o *EnableDisableForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this enable disable forbidden response has a 4xx status code
func (o *EnableDisableForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this enable disable forbidden response has a 5xx status code
func (o *EnableDisableForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this enable disable forbidden response a status code equal to that given
func (o *EnableDisableForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the enable disable forbidden response
func (o *EnableDisableForbidden) Code() int {
	return 403
}

func (o *EnableDisableForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/maintenance-window/{clusterId}/enable-disable][%d] enableDisableForbidden %s", 403, payload)
}

func (o *EnableDisableForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/maintenance-window/{clusterId}/enable-disable][%d] enableDisableForbidden %s", 403, payload)
}

func (o *EnableDisableForbidden) GetPayload() string {
	return o.Payload
}

func (o *EnableDisableForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
