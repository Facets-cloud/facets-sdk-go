...
func (o *CreateContentFileReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCreateContentFileForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateContentFileForbidden creates a CreateContentFileForbidden with default headers values
func NewCreateContentFileForbidden() *CreateContentFileForbidden {
	return &CreateContentFileForbidden{}
}

/*
CreateContentFileForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CreateContentFileForbidden struct {
	Payload string
}

// IsSuccess returns true when this create content file forbidden response has a 2xx status code
func (o *CreateContentFileForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create content file forbidden response has a 3xx status code
func (o *CreateContentFileForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create content file forbidden response has a 4xx status code
func (o *CreateContentFileForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create content file forbidden response has a 5xx status code
func (o *CreateContentFileForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create content file forbidden response a status code equal to that given
func (o *CreateContentFileForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create content file forbidden response
func (o *CreateContentFileForbidden) Code() int {
	return 403
}

func (o *CreateContentFileForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/content/files][%d] createContentFileForbidden %s", 403, payload)
}

func (o *CreateContentFileForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/content/files][%d] createContentFileForbidden %s", 403, payload)
}

func (o *CreateContentFileForbidden) GetPayload() string {
	return o.Payload
}

func (o *CreateContentFileForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
