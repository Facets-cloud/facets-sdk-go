...
func (o *GetContentFilesBySelectorsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetContentFilesBySelectorsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetContentFilesBySelectorsForbidden creates a GetContentFilesBySelectorsForbidden with default headers values
func NewGetContentFilesBySelectorsForbidden() *GetContentFilesBySelectorsForbidden {
	return &GetContentFilesBySelectorsForbidden{}
}

/*
GetContentFilesBySelectorsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetContentFilesBySelectorsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get content files by selectors forbidden response has a 2xx status code
func (o *GetContentFilesBySelectorsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get content files by selectors forbidden response has a 3xx status code
func (o *GetContentFilesBySelectorsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get content files by selectors forbidden response has a 4xx status code
func (o *GetContentFilesBySelectorsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get content files by selectors forbidden response has a 5xx status code
func (o *GetContentFilesBySelectorsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get content files by selectors forbidden response a status code equal to that given
func (o *GetContentFilesBySelectorsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get content files by selectors forbidden response
func (o *GetContentFilesBySelectorsForbidden) Code() int {
	return 403
}

func (o *GetContentFilesBySelectorsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/content/files/selectors/{contentType}][%d] getContentFilesBySelectorsForbidden %s", 403, payload)
}

func (o *GetContentFilesBySelectorsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/content/files/selectors/{contentType}][%d] getContentFilesBySelectorsForbidden %s", 403, payload)
}

func (o *GetContentFilesBySelectorsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetContentFilesBySelectorsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
