...
func (o *RenderContentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRenderContentForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRenderContentForbidden creates a RenderContentForbidden with default headers values
func NewRenderContentForbidden() *RenderContentForbidden {
	return &RenderContentForbidden{}
}

/*
RenderContentForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RenderContentForbidden struct {
	Payload string
}

// IsSuccess returns true when this render content forbidden response has a 2xx status code
func (o *RenderContentForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this render content forbidden response has a 3xx status code
func (o *RenderContentForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this render content forbidden response has a 4xx status code
func (o *RenderContentForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this render content forbidden response has a 5xx status code
func (o *RenderContentForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this render content forbidden response a status code equal to that given
func (o *RenderContentForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the render content forbidden response
func (o *RenderContentForbidden) Code() int {
	return 403
}

func (o *RenderContentForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/content/files/{contentId}/render][%d] renderContentForbidden %s", 403, payload)
}

func (o *RenderContentForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/content/files/{contentId}/render][%d] renderContentForbidden %s", 403, payload)
}

func (o *RenderContentForbidden) GetPayload() string {
	return o.Payload
}

func (o *RenderContentForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
