...
func (o *DeleteContentFileReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteContentFileForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteContentFileForbidden creates a DeleteContentFileForbidden with default headers values
func NewDeleteContentFileForbidden() *DeleteContentFileForbidden {
	return &DeleteContentFileForbidden{}
}

/*
DeleteContentFileForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteContentFileForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete content file forbidden response has a 2xx status code
func (o *DeleteContentFileForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete content file forbidden response has a 3xx status code
func (o *DeleteContentFileForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete content file forbidden response has a 4xx status code
func (o *DeleteContentFileForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete content file forbidden response has a 5xx status code
func (o *DeleteContentFileForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete content file forbidden response a status code equal to that given
func (o *DeleteContentFileForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete content file forbidden response
func (o *DeleteContentFileForbidden) Code() int {
	return 403
}

func (o *DeleteContentFileForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/content/files/{contentId}][%d] deleteContentFileForbidden %s", 403, payload)
}

func (o *DeleteContentFileForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/content/files/{contentId}][%d] deleteContentFileForbidden %s", 403, payload)
}

func (o *DeleteContentFileForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteContentFileForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
