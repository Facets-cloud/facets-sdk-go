...
func (o *UpdateContentFileReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateContentFileForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateContentFileForbidden creates a UpdateContentFileForbidden with default headers values
func NewUpdateContentFileForbidden() *UpdateContentFileForbidden {
	return &UpdateContentFileForbidden{}
}

/*
UpdateContentFileForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateContentFileForbidden struct {
	Payload string
}

// IsSuccess returns true when this update content file forbidden response has a 2xx status code
func (o *UpdateContentFileForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update content file forbidden response has a 3xx status code
func (o *UpdateContentFileForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update content file forbidden response has a 4xx status code
func (o *UpdateContentFileForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update content file forbidden response has a 5xx status code
func (o *UpdateContentFileForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update content file forbidden response a status code equal to that given
func (o *UpdateContentFileForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update content file forbidden response
func (o *UpdateContentFileForbidden) Code() int {
	return 403
}

func (o *UpdateContentFileForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/content/files/{contentId}][%d] updateContentFileForbidden %s", 403, payload)
}

func (o *UpdateContentFileForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/content/files/{contentId}][%d] updateContentFileForbidden %s", 403, payload)
}

func (o *UpdateContentFileForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateContentFileForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
