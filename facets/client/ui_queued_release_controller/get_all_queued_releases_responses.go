...
func (o *GetAllQueuedReleasesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllQueuedReleasesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllQueuedReleasesForbidden creates a GetAllQueuedReleasesForbidden with default headers values
func NewGetAllQueuedReleasesForbidden() *GetAllQueuedReleasesForbidden {
	return &GetAllQueuedReleasesForbidden{}
}

/*
GetAllQueuedReleasesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllQueuedReleasesForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all queued releases forbidden response has a 2xx status code
func (o *GetAllQueuedReleasesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all queued releases forbidden response has a 3xx status code
func (o *GetAllQueuedReleasesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all queued releases forbidden response has a 4xx status code
func (o *GetAllQueuedReleasesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all queued releases forbidden response has a 5xx status code
func (o *GetAllQueuedReleasesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all queued releases forbidden response a status code equal to that given
func (o *GetAllQueuedReleasesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all queued releases forbidden response
func (o *GetAllQueuedReleasesForbidden) Code() int {
	return 403
}

func (o *GetAllQueuedReleasesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/queued-releases/][%d] getAllQueuedReleasesForbidden %s", 403, payload)
}

func (o *GetAllQueuedReleasesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/queued-releases/][%d] getAllQueuedReleasesForbidden %s", 403, payload)
}

func (o *GetAllQueuedReleasesForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllQueuedReleasesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
