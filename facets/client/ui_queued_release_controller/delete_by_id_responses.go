...
func (o *DeleteByIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewDeleteByIDForbidden creates a DeleteByIDForbidden with default headers values
func NewDeleteByIDForbidden() *DeleteByIDForbidden {
	return &DeleteByIDForbidden{}
}

/*
DeleteByIDForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteByIDForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete by Id forbidden response has a 2xx status code
func (o *DeleteByIDForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete by Id forbidden response has a 3xx status code
func (o *DeleteByIDForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete by Id forbidden response has a 4xx status code
func (o *DeleteByIDForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete by Id forbidden response has a 5xx status code
func (o *DeleteByIDForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete by Id forbidden response a status code equal to that given
func (o *DeleteByIDForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete by Id forbidden response
func (o *DeleteByIDForbidden) Code() int {
	return 403
}

func (o *DeleteByIDForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/clusters/{clusterId}/queued-releases/{queuedReleaseId}][%d] deleteByIdForbidden %s", 403, payload)
}

func (o *DeleteByIDForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/clusters/{clusterId}/queued-releases/{queuedReleaseId}][%d] deleteByIdForbidden %s", 403, payload)
}

func (o *DeleteByIDForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteByIDForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
