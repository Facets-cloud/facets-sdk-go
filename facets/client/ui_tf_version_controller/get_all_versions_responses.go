...
func (o *GetAllVersionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllVersionsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllVersionsForbidden creates a GetAllVersionsForbidden with default headers values
func NewGetAllVersionsForbidden() *GetAllVersionsForbidden {
	return &GetAllVersionsForbidden{}
}

/*
GetAllVersionsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllVersionsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all versions forbidden response has a 2xx status code
func (o *GetAllVersionsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all versions forbidden response has a 3xx status code
func (o *GetAllVersionsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all versions forbidden response has a 4xx status code
func (o *GetAllVersionsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all versions forbidden response has a 5xx status code
func (o *GetAllVersionsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all versions forbidden response a status code equal to that given
func (o *GetAllVersionsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all versions forbidden response
func (o *GetAllVersionsForbidden) Code() int {
	return 403
}

func (o *GetAllVersionsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/terraform/versions][%d] getAllVersionsForbidden %s", 403, payload)
}

func (o *GetAllVersionsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/terraform/versions][%d] getAllVersionsForbidden %s", 403, payload)
}

func (o *GetAllVersionsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllVersionsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
