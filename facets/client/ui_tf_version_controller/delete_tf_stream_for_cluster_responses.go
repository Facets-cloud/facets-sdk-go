...
func (o *DeleteTfStreamForClusterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteTfStreamForClusterForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteTfStreamForClusterForbidden creates a DeleteTfStreamForClusterForbidden with default headers values
func NewDeleteTfStreamForClusterForbidden() *DeleteTfStreamForClusterForbidden {
	return &DeleteTfStreamForClusterForbidden{}
}

/*
DeleteTfStreamForClusterForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteTfStreamForClusterForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete tf stream for cluster forbidden response has a 2xx status code
func (o *DeleteTfStreamForClusterForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete tf stream for cluster forbidden response has a 3xx status code
func (o *DeleteTfStreamForClusterForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete tf stream for cluster forbidden response has a 4xx status code
func (o *DeleteTfStreamForClusterForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete tf stream for cluster forbidden response has a 5xx status code
func (o *DeleteTfStreamForClusterForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete tf stream for cluster forbidden response a status code equal to that given
func (o *DeleteTfStreamForClusterForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete tf stream for cluster forbidden response
func (o *DeleteTfStreamForClusterForbidden) Code() int {
	return 403
}

func (o *DeleteTfStreamForClusterForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/terraform/cluster/{clusterId}][%d] deleteTfStreamForClusterForbidden %s", 403, payload)
}

func (o *DeleteTfStreamForClusterForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/terraform/cluster/{clusterId}][%d] deleteTfStreamForClusterForbidden %s", 403, payload)
}

func (o *DeleteTfStreamForClusterForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteTfStreamForClusterForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
