...
func (o *GetTfVersionsForStreamReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetTfVersionsForStreamForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetTfVersionsForStreamForbidden creates a GetTfVersionsForStreamForbidden with default headers values
func NewGetTfVersionsForStreamForbidden() *GetTfVersionsForStreamForbidden {
	return &GetTfVersionsForStreamForbidden{}
}

/*
GetTfVersionsForStreamForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetTfVersionsForStreamForbidden struct {
	Payload string
}

// IsSuccess returns true when this get tf versions for stream forbidden response has a 2xx status code
func (o *GetTfVersionsForStreamForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get tf versions for stream forbidden response has a 3xx status code
func (o *GetTfVersionsForStreamForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get tf versions for stream forbidden response has a 4xx status code
func (o *GetTfVersionsForStreamForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get tf versions for stream forbidden response has a 5xx status code
func (o *GetTfVersionsForStreamForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get tf versions for stream forbidden response a status code equal to that given
func (o *GetTfVersionsForStreamForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get tf versions for stream forbidden response
func (o *GetTfVersionsForStreamForbidden) Code() int {
	return 403
}

func (o *GetTfVersionsForStreamForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/terraform/stream/{tfStream}/versions][%d] getTfVersionsForStreamForbidden %s", 403, payload)
}

func (o *GetTfVersionsForStreamForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/terraform/stream/{tfStream}/versions][%d] getTfVersionsForStreamForbidden %s", 403, payload)
}

func (o *GetTfVersionsForStreamForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetTfVersionsForStreamForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
