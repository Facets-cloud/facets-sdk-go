...
func (o *GetMetadataKeysReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetMetadataKeysForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetMetadataKeysForbidden creates a GetMetadataKeysForbidden with default headers values
func NewGetMetadataKeysForbidden() *GetMetadataKeysForbidden {
	return &GetMetadataKeysForbidden{}
}

/*
GetMetadataKeysForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetMetadataKeysForbidden struct {
	Payload string
}

// IsSuccess returns true when this get metadata keys forbidden response has a 2xx status code
func (o *GetMetadataKeysForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get metadata keys forbidden response has a 3xx status code
func (o *GetMetadataKeysForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get metadata keys forbidden response has a 4xx status code
func (o *GetMetadataKeysForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get metadata keys forbidden response has a 5xx status code
func (o *GetMetadataKeysForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get metadata keys forbidden response a status code equal to that given
func (o *GetMetadataKeysForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get metadata keys forbidden response
func (o *GetMetadataKeysForbidden) Code() int {
	return 403
}

func (o *GetMetadataKeysForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifacts/metadata/keys][%d] getMetadataKeysForbidden %s", 403, payload)
}

func (o *GetMetadataKeysForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifacts/metadata/keys][%d] getMetadataKeysForbidden %s", 403, payload)
}

func (o *GetMetadataKeysForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetMetadataKeysForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
