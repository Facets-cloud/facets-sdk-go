...
func (o *RegisterArtifactSaas1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRegisterArtifactSaas1Forbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRegisterArtifactSaas1Forbidden creates a RegisterArtifactSaas1Forbidden with default headers values
func NewRegisterArtifactSaas1Forbidden() *RegisterArtifactSaas1Forbidden {
	return &RegisterArtifactSaas1Forbidden{}
}

/*
RegisterArtifactSaas1Forbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RegisterArtifactSaas1Forbidden struct {
	Payload string
}

// IsSuccess returns true when this register artifact saas1 forbidden response has a 2xx status code
func (o *RegisterArtifactSaas1Forbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this register artifact saas1 forbidden response has a 3xx status code
func (o *RegisterArtifactSaas1Forbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this register artifact saas1 forbidden response has a 4xx status code
func (o *RegisterArtifactSaas1Forbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this register artifact saas1 forbidden response has a 5xx status code
func (o *RegisterArtifactSaas1Forbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this register artifact saas1 forbidden response a status code equal to that given
func (o *RegisterArtifactSaas1Forbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the register artifact saas1 forbidden response
func (o *RegisterArtifactSaas1Forbidden) Code() int {
	return 403
}

func (o *RegisterArtifactSaas1Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts/register-saas][%d] registerArtifactSaas1Forbidden %s", 403, payload)
}

func (o *RegisterArtifactSaas1Forbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts/register-saas][%d] registerArtifactSaas1Forbidden %s", 403, payload)
}

func (o *RegisterArtifactSaas1Forbidden) GetPayload() string {
	return o.Payload
}

func (o *RegisterArtifactSaas1Forbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
