...
func (o *UpdateReleaseStreamReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateReleaseStreamForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *UpdateReleaseStreamOK) GetPayload() any {
	return o.Payload
}
...
// NewUpdateReleaseStreamForbidden creates a UpdateReleaseStreamForbidden with default headers values
func NewUpdateReleaseStreamForbidden() *UpdateReleaseStreamForbidden {
	return &UpdateReleaseStreamForbidden{}
}

/*
UpdateReleaseStreamForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateReleaseStreamForbidden struct {
	Payload string
}

// IsSuccess returns true when this update release stream forbidden response has a 2xx status code
func (o *UpdateReleaseStreamForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update release stream forbidden response has a 3xx status code
func (o *UpdateReleaseStreamForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update release stream forbidden response has a 4xx status code
func (o *UpdateReleaseStreamForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update release stream forbidden response has a 5xx status code
func (o *UpdateReleaseStreamForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update release stream forbidden response a status code equal to that given
func (o *UpdateReleaseStreamForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update release stream forbidden response
func (o *UpdateReleaseStreamForbidden) Code() int {
	return 403
}

func (o *UpdateReleaseStreamForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts/clusterId/{clusterId}/currentReleaseStream/{currentReleaseStream}/updatedReleaseStream/{updatedReleaseStream}/updateStream][%d] updateReleaseStreamForbidden %s", 403, payload)
}

func (o *UpdateReleaseStreamForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts/clusterId/{clusterId}/currentReleaseStream/{currentReleaseStream}/updatedReleaseStream/{updatedReleaseStream}/updateStream][%d] updateReleaseStreamForbidden %s", 403, payload)
}

func (o *UpdateReleaseStreamForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateReleaseStreamForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
