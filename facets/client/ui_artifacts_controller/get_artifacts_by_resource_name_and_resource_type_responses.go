...
func (o *GetArtifactsByResourceNameAndResourceTypeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetArtifactsByResourceNameAndResourceTypeForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetArtifactsByResourceNameAndResourceTypeForbidden creates a GetArtifactsByResourceNameAndResourceTypeForbidden with default headers values
func NewGetArtifactsByResourceNameAndResourceTypeForbidden() *GetArtifactsByResourceNameAndResourceTypeForbidden {
	return &GetArtifactsByResourceNameAndResourceTypeForbidden{}
}

/*
GetArtifactsByResourceNameAndResourceTypeForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetArtifactsByResourceNameAndResourceTypeForbidden struct {
	Payload string
}

// IsSuccess returns true when this get artifacts by resource name and resource type forbidden response has a 2xx status code
func (o *GetArtifactsByResourceNameAndResourceTypeForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get artifacts by resource name and resource type forbidden response has a 3xx status code
func (o *GetArtifactsByResourceNameAndResourceTypeForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get artifacts by resource name and resource type forbidden response has a 4xx status code
func (o *GetArtifactsByResourceNameAndResourceTypeForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get artifacts by resource name and resource type forbidden response has a 5xx status code
func (o *GetArtifactsByResourceNameAndResourceTypeForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get artifacts by resource name and resource type forbidden response a status code equal to that given
func (o *GetArtifactsByResourceNameAndResourceTypeForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get artifacts by resource name and resource type forbidden response
func (o *GetArtifactsByResourceNameAndResourceTypeForbidden) Code() int {
	return 403
}

func (o *GetArtifactsByResourceNameAndResourceTypeForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifacts/cluster/{clusterId}/resourceType/{resourceType}/resourceName/{resourceName}][%d] getArtifactsByResourceNameAndResourceTypeForbidden %s", 403, payload)
}

func (o *GetArtifactsByResourceNameAndResourceTypeForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifacts/cluster/{clusterId}/resourceType/{resourceType}/resourceName/{resourceName}][%d] getArtifactsByResourceNameAndResourceTypeForbidden %s", 403, payload)
}

func (o *GetArtifactsByResourceNameAndResourceTypeForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetArtifactsByResourceNameAndResourceTypeForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
