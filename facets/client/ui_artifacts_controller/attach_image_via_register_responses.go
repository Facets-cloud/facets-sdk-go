...
func (o *AttachImageViaRegisterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewAttachImageViaRegisterForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewAttachImageViaRegisterForbidden creates a AttachImageViaRegisterForbidden with default headers values
func NewAttachImageViaRegisterForbidden() *AttachImageViaRegisterForbidden {
	return &AttachImageViaRegisterForbidden{}
}

/*
AttachImageViaRegisterForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type AttachImageViaRegisterForbidden struct {
	Payload string
}

// IsSuccess returns true when this attach image via register forbidden response has a 2xx status code
func (o *AttachImageViaRegisterForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this attach image via register forbidden response has a 3xx status code
func (o *AttachImageViaRegisterForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this attach image via register forbidden response has a 4xx status code
func (o *AttachImageViaRegisterForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this attach image via register forbidden response has a 5xx status code
func (o *AttachImageViaRegisterForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this attach image via register forbidden response a status code equal to that given
func (o *AttachImageViaRegisterForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the attach image via register forbidden response
func (o *AttachImageViaRegisterForbidden) Code() int {
	return 403
}

func (o *AttachImageViaRegisterForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts/attach-image-via-register][%d] attachImageViaRegisterForbidden %s", 403, payload)
}

func (o *AttachImageViaRegisterForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts/attach-image-via-register][%d] attachImageViaRegisterForbidden %s", 403, payload)
}

func (o *AttachImageViaRegisterForbidden) GetPayload() string {
	return o.Payload
}

func (o *AttachImageViaRegisterForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
