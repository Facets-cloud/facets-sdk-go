...
func (o *ReclassifyArtifactsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewReclassifyArtifactsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewReclassifyArtifactsForbidden creates a ReclassifyArtifactsForbidden with default headers values
func NewReclassifyArtifactsForbidden() *ReclassifyArtifactsForbidden {
	return &ReclassifyArtifactsForbidden{}
}

/*
ReclassifyArtifactsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ReclassifyArtifactsForbidden struct {
	Payload string
}

// IsSuccess returns true when this reclassify artifacts forbidden response has a 2xx status code
func (o *ReclassifyArtifactsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this reclassify artifacts forbidden response has a 3xx status code
func (o *ReclassifyArtifactsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this reclassify artifacts forbidden response has a 4xx status code
func (o *ReclassifyArtifactsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this reclassify artifacts forbidden response has a 5xx status code
func (o *ReclassifyArtifactsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this reclassify artifacts forbidden response a status code equal to that given
func (o *ReclassifyArtifactsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the reclassify artifacts forbidden response
func (o *ReclassifyArtifactsForbidden) Code() int {
	return 403
}

func (o *ReclassifyArtifactsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/artifacts/reclassify][%d] reclassifyArtifactsForbidden %s", 403, payload)
}

func (o *ReclassifyArtifactsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/artifacts/reclassify][%d] reclassifyArtifactsForbidden %s", 403, payload)
}

func (o *ReclassifyArtifactsForbidden) GetPayload() string {
	return o.Payload
}

func (o *ReclassifyArtifactsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
