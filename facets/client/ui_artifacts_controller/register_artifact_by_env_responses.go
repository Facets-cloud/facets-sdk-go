...
func (o *RegisterArtifactByEnvReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRegisterArtifactByEnvForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRegisterArtifactByEnvForbidden creates a RegisterArtifactByEnvForbidden with default headers values
func NewRegisterArtifactByEnvForbidden() *RegisterArtifactByEnvForbidden {
	return &RegisterArtifactByEnvForbidden{}
}

/*
RegisterArtifactByEnvForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RegisterArtifactByEnvForbidden struct {
	Payload string
}

// IsSuccess returns true when this register artifact by env forbidden response has a 2xx status code
func (o *RegisterArtifactByEnvForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this register artifact by env forbidden response has a 3xx status code
func (o *RegisterArtifactByEnvForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this register artifact by env forbidden response has a 4xx status code
func (o *RegisterArtifactByEnvForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this register artifact by env forbidden response has a 5xx status code
func (o *RegisterArtifactByEnvForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this register artifact by env forbidden response a status code equal to that given
func (o *RegisterArtifactByEnvForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the register artifact by env forbidden response
func (o *RegisterArtifactByEnvForbidden) Code() int {
	return 403
}

func (o *RegisterArtifactByEnvForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts/register-by-env][%d] registerArtifactByEnvForbidden %s", 403, payload)
}

func (o *RegisterArtifactByEnvForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts/register-by-env][%d] registerArtifactByEnvForbidden %s", 403, payload)
}

func (o *RegisterArtifactByEnvForbidden) GetPayload() string {
	return o.Payload
}

func (o *RegisterArtifactByEnvForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
