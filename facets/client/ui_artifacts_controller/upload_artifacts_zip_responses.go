...
func (o *UploadArtifactsZipReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUploadArtifactsZipForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUploadArtifactsZipForbidden creates a UploadArtifactsZipForbidden with default headers values
func NewUploadArtifactsZipForbidden() *UploadArtifactsZipForbidden {
	return &UploadArtifactsZipForbidden{}
}

/*
UploadArtifactsZipForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UploadArtifactsZipForbidden struct {
	Payload string
}

// IsSuccess returns true when this upload artifacts zip forbidden response has a 2xx status code
func (o *UploadArtifactsZipForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this upload artifacts zip forbidden response has a 3xx status code
func (o *UploadArtifactsZipForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this upload artifacts zip forbidden response has a 4xx status code
func (o *UploadArtifactsZipForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this upload artifacts zip forbidden response has a 5xx status code
func (o *UploadArtifactsZipForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this upload artifacts zip forbidden response a status code equal to that given
func (o *UploadArtifactsZipForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the upload artifacts zip forbidden response
func (o *UploadArtifactsZipForbidden) Code() int {
	return 403
}

func (o *UploadArtifactsZipForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts/upload][%d] uploadArtifactsZipForbidden %s", 403, payload)
}

func (o *UploadArtifactsZipForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts/upload][%d] uploadArtifactsZipForbidden %s", 403, payload)
}

func (o *UploadArtifactsZipForbidden) GetPayload() string {
	return o.Payload
}

func (o *UploadArtifactsZipForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
