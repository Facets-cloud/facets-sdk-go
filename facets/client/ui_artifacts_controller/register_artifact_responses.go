...
func (o *RegisterArtifactReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRegisterArtifactForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRegisterArtifactForbidden creates a RegisterArtifactForbidden with default headers values
func NewRegisterArtifactForbidden() *RegisterArtifactForbidden {
	return &RegisterArtifactForbidden{}
}

/*
RegisterArtifactForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RegisterArtifactForbidden struct {
	Payload string
}

// IsSuccess returns true when this register artifact forbidden response has a 2xx status code
func (o *RegisterArtifactForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this register artifact forbidden response has a 3xx status code
func (o *RegisterArtifactForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this register artifact forbidden response has a 4xx status code
func (o *RegisterArtifactForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this register artifact forbidden response has a 5xx status code
func (o *RegisterArtifactForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this register artifact forbidden response a status code equal to that given
func (o *RegisterArtifactForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the register artifact forbidden response
func (o *RegisterArtifactForbidden) Code() int {
	return 403
}

func (o *RegisterArtifactForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts/register][%d] registerArtifactForbidden %s", 403, payload)
}

func (o *RegisterArtifactForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts/register][%d] registerArtifactForbidden %s", 403, payload)
}

func (o *RegisterArtifactForbidden) GetPayload() string {
	return o.Payload
}

func (o *RegisterArtifactForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
