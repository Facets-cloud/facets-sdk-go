...
func (o *RegisterArtifactByReleaseStreamReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRegisterArtifactByReleaseStreamForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRegisterArtifactByReleaseStreamForbidden creates a RegisterArtifactByReleaseStreamForbidden with default headers values
func NewRegisterArtifactByReleaseStreamForbidden() *RegisterArtifactByReleaseStreamForbidden {
	return &RegisterArtifactByReleaseStreamForbidden{}
}

/*
RegisterArtifactByReleaseStreamForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RegisterArtifactByReleaseStreamForbidden struct {
	Payload string
}

// IsSuccess returns true when this register artifact by release stream forbidden response has a 2xx status code
func (o *RegisterArtifactByReleaseStreamForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this register artifact by release stream forbidden response has a 3xx status code
func (o *RegisterArtifactByReleaseStreamForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this register artifact by release stream forbidden response has a 4xx status code
func (o *RegisterArtifactByReleaseStreamForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this register artifact by release stream forbidden response has a 5xx status code
func (o *RegisterArtifactByReleaseStreamForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this register artifact by release stream forbidden response a status code equal to that given
func (o *RegisterArtifactByReleaseStreamForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the register artifact by release stream forbidden response
func (o *RegisterArtifactByReleaseStreamForbidden) Code() int {
	return 403
}

func (o *RegisterArtifactByReleaseStreamForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts/register-by-release-stream][%d] registerArtifactByReleaseStreamForbidden %s", 403, payload)
}

func (o *RegisterArtifactByReleaseStreamForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts/register-by-release-stream][%d] registerArtifactByReleaseStreamForbidden %s", 403, payload)
}

func (o *RegisterArtifactByReleaseStreamForbidden) GetPayload() string {
	return o.Payload
}

func (o *RegisterArtifactByReleaseStreamForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
