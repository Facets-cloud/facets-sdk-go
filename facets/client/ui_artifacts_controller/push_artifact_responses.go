...
func (o *PushArtifactReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewPushArtifactForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewPushArtifactForbidden creates a PushArtifactForbidden with default headers values
func NewPushArtifactForbidden() *PushArtifactForbidden {
	return &PushArtifactForbidden{}
}

/*
PushArtifactForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type PushArtifactForbidden struct {
	Payload string
}

// IsSuccess returns true when this push artifact forbidden response has a 2xx status code
func (o *PushArtifactForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this push artifact forbidden response has a 3xx status code
func (o *PushArtifactForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this push artifact forbidden response has a 4xx status code
func (o *PushArtifactForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this push artifact forbidden response has a 5xx status code
func (o *PushArtifactForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this push artifact forbidden response a status code equal to that given
func (o *PushArtifactForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the push artifact forbidden response
func (o *PushArtifactForbidden) Code() int {
	return 403
}

func (o *PushArtifactForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts/push][%d] pushArtifactForbidden %s", 403, payload)
}

func (o *PushArtifactForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifacts/push][%d] pushArtifactForbidden %s", 403, payload)
}

func (o *PushArtifactForbidden) GetPayload() string {
	return o.Payload
}

func (o *PushArtifactForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
