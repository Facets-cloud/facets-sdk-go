...
func (o *GetArtifactByApplicationNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetArtifactByApplicationNameForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetArtifactByApplicationNameForbidden creates a GetArtifactByApplicationNameForbidden with default headers values
func NewGetArtifactByApplicationNameForbidden() *GetArtifactByApplicationNameForbidden {
	return &GetArtifactByApplicationNameForbidden{}
}

/*
GetArtifactByApplicationNameForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetArtifactByApplicationNameForbidden struct {
	Payload string
}

// IsSuccess returns true when this get artifact by application name forbidden response has a 2xx status code
func (o *GetArtifactByApplicationNameForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get artifact by application name forbidden response has a 3xx status code
func (o *GetArtifactByApplicationNameForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get artifact by application name forbidden response has a 4xx status code
func (o *GetArtifactByApplicationNameForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get artifact by application name forbidden response has a 5xx status code
func (o *GetArtifactByApplicationNameForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get artifact by application name forbidden response a status code equal to that given
func (o *GetArtifactByApplicationNameForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get artifact by application name forbidden response
func (o *GetArtifactByApplicationNameForbidden) Code() int {
	return 403
}

func (o *GetArtifactByApplicationNameForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifacts/cluster/{clusterId}/application/{applicationName}][%d] getArtifactByApplicationNameForbidden %s", 403, payload)
}

func (o *GetArtifactByApplicationNameForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifacts/cluster/{clusterId}/application/{applicationName}][%d] getArtifactByApplicationNameForbidden %s", 403, payload)
}

func (o *GetArtifactByApplicationNameForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetArtifactByApplicationNameForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
