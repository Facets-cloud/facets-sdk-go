...
// bindParamUpdateReleaseStream binds the parameter excludeApps
func (o *UpdateReleaseStreamParams) bindParamExcludeApps(formats strfmt.Registry) []string {
...
// bindParamUpdateReleaseStream binds the parameter includeApps
func (o *UpdateReleaseStreamParams) bindParamIncludeApps(formats strfmt.Registry) []string {
