...
func (o *AnalyzeAccessReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewAnalyzeAccessForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewAnalyzeAccessForbidden creates a AnalyzeAccessForbidden with default headers values
func NewAnalyzeAccessForbidden() *AnalyzeAccessForbidden {
	return &AnalyzeAccessForbidden{}
}

/*
AnalyzeAccessForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type AnalyzeAccessForbidden struct {
	Payload string
}

// IsSuccess returns true when this analyze access forbidden response has a 2xx status code
func (o *AnalyzeAccessForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this analyze access forbidden response has a 3xx status code
func (o *AnalyzeAccessForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this analyze access forbidden response has a 4xx status code
func (o *AnalyzeAccessForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this analyze access forbidden response has a 5xx status code
func (o *AnalyzeAccessForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this analyze access forbidden response a status code equal to that given
func (o *AnalyzeAccessForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the analyze access forbidden response
func (o *AnalyzeAccessForbidden) Code() int {
	return 403
}

func (o *AnalyzeAccessForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/users/analyze-access][%d] analyzeAccessForbidden %s", 403, payload)
}

func (o *AnalyzeAccessForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/users/analyze-access][%d] analyzeAccessForbidden %s", 403, payload)
}

func (o *AnalyzeAccessForbidden) GetPayload() string {
	return o.Payload
}
