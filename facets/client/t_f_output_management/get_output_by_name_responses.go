...
func (o *GetOutputByNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetOutputByNameForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetOutputByNameForbidden creates a GetOutputByNameForbidden with default headers values
func NewGetOutputByNameForbidden() *GetOutputByNameForbidden {
	return &GetOutputByNameForbidden{}
}

/*
GetOutputByNameForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetOutputByNameForbidden struct {
	Payload string
}

// IsSuccess returns true when this get output by name forbidden response has a 2xx status code
func (o *GetOutputByNameForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get output by name forbidden response has a 3xx status code
func (o *GetOutputByNameForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get output by name forbidden response has a 4xx status code
func (o *GetOutputByNameForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get output by name forbidden response has a 5xx status code
func (o *GetOutputByNameForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get output by name forbidden response a status code equal to that given
func (o *GetOutputByNameForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get output by name forbidden response
func (o *GetOutputByNameForbidden) Code() int {
	return 403
}

func (o *GetOutputByNameForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/tf-outputs/{name}][%d] getOutputByNameForbidden %s", 403, payload)
}

func (o *GetOutputByNameForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/tf-outputs/{name}][%d] getOutputByNameForbidden %s", 403, payload)
}

func (o *GetOutputByNameForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetOutputByNameForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
