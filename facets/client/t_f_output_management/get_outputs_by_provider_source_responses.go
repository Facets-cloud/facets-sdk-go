...
func (o *GetOutputsByProviderSourceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetOutputsByProviderSourceForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetOutputsByProviderSourceForbidden creates a GetOutputsByProviderSourceForbidden with default headers values
func NewGetOutputsByProviderSourceForbidden() *GetOutputsByProviderSourceForbidden {
	return &GetOutputsByProviderSourceForbidden{}
}

/*
GetOutputsByProviderSourceForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetOutputsByProviderSourceForbidden struct {
	Payload string
}

// IsSuccess returns true when this get outputs by provider source forbidden response has a 2xx status code
func (o *GetOutputsByProviderSourceForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get outputs by provider source forbidden response has a 3xx status code
func (o *GetOutputsByProviderSourceForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get outputs by provider source forbidden response has a 4xx status code
func (o *GetOutputsByProviderSourceForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get outputs by provider source forbidden response has a 5xx status code
func (o *GetOutputsByProviderSourceForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get outputs by provider source forbidden response a status code equal to that given
func (o *GetOutputsByProviderSourceForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get outputs by provider source forbidden response
func (o *GetOutputsByProviderSourceForbidden) Code() int {
	return 403
}

func (o *GetOutputsByProviderSourceForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/tf-outputs/provider][%d] getOutputsByProviderSourceForbidden %s", 403, payload)
}

func (o *GetOutputsByProviderSourceForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/tf-outputs/provider][%d] getOutputsByProviderSourceForbidden %s", 403, payload)
}

func (o *GetOutputsByProviderSourceForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetOutputsByProviderSourceForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
