...
func (o *DeleteOutputReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteOutputForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteOutputForbidden creates a DeleteOutputForbidden with default headers values
func NewDeleteOutputForbidden() *DeleteOutputForbidden {
	return &DeleteOutputForbidden{}
}

/*
DeleteOutputForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteOutputForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete output forbidden response has a 2xx status code
func (o *DeleteOutputForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete output forbidden response has a 3xx status code
func (o *DeleteOutputForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete output forbidden response has a 4xx status code
func (o *DeleteOutputForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete output forbidden response has a 5xx status code
func (o *DeleteOutputForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete output forbidden response a status code equal to that given
func (o *DeleteOutputForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete output forbidden response
func (o *DeleteOutputForbidden) Code() int {
	return 403
}

func (o *DeleteOutputForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/tf-outputs/{name}][%d] deleteOutputForbidden %s", 403, payload)
}

func (o *DeleteOutputForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/tf-outputs/{name}][%d] deleteOutputForbidden %s", 403, payload)
}

func (o *DeleteOutputForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteOutputForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
