...
func (o *GetAllOutputsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllOutputsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllOutputsForbidden creates a GetAllOutputsForbidden with default headers values
func NewGetAllOutputsForbidden() *GetAllOutputsForbidden {
	return &GetAllOutputsForbidden{}
}

/*
GetAllOutputsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllOutputsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all outputs forbidden response has a 2xx status code
func (o *GetAllOutputsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all outputs forbidden response has a 3xx status code
func (o *GetAllOutputsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all outputs forbidden response has a 4xx status code
func (o *GetAllOutputsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all outputs forbidden response has a 5xx status code
func (o *GetAllOutputsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all outputs forbidden response a status code equal to that given
func (o *GetAllOutputsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all outputs forbidden response
func (o *GetAllOutputsForbidden) Code() int {
	return 403
}

func (o *GetAllOutputsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/tf-outputs][%d] getAllOutputsForbidden %s", 403, payload)
}

func (o *GetAllOutputsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/tf-outputs][%d] getAllOutputsForbidden %s", 403, payload)
}

func (o *GetAllOutputsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllOutputsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
