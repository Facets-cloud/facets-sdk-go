...
func (o *DeleteNotificationChannelReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteNotificationChannelForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteNotificationChannelForbidden creates a DeleteNotificationChannelForbidden with default headers values
func NewDeleteNotificationChannelForbidden() *DeleteNotificationChannelForbidden {
	return &DeleteNotificationChannelForbidden{}
}

/*
DeleteNotificationChannelForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteNotificationChannelForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete notification channel forbidden response has a 2xx status code
func (o *DeleteNotificationChannelForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete notification channel forbidden response has a 3xx status code
func (o *DeleteNotificationChannelForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete notification channel forbidden response has a 4xx status code
func (o *DeleteNotificationChannelForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete notification channel forbidden response has a 5xx status code
func (o *DeleteNotificationChannelForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete notification channel forbidden response a status code equal to that given
func (o *DeleteNotificationChannelForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete notification channel forbidden response
func (o *DeleteNotificationChannelForbidden) Code() int {
	return 403
}

func (o *DeleteNotificationChannelForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/notification/channels/{channelId}][%d] deleteNotificationChannelForbidden %s", 403, payload)
}

func (o *DeleteNotificationChannelForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/notification/channels/{channelId}][%d] deleteNotificationChannelForbidden %s", 403, payload)
}

func (o *DeleteNotificationChannelForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteNotificationChannelForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
