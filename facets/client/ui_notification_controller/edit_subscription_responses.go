...
func (o *EditSubscriptionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewEditSubscriptionForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewEditSubscriptionForbidden creates a EditSubscriptionForbidden with default headers values
func NewEditSubscriptionForbidden() *EditSubscriptionForbidden {
	return &EditSubscriptionForbidden{}
}

/*
EditSubscriptionForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type EditSubscriptionForbidden struct {
	Payload string
}

// IsSuccess returns true when this edit subscription forbidden response has a 2xx status code
func (o *EditSubscriptionForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this edit subscription forbidden response has a 3xx status code
func (o *EditSubscriptionForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this edit subscription forbidden response has a 4xx status code
func (o *EditSubscriptionForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this edit subscription forbidden response has a 5xx status code
func (o *EditSubscriptionForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this edit subscription forbidden response a status code equal to that given
func (o *EditSubscriptionForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the edit subscription forbidden response
func (o *EditSubscriptionForbidden) Code() int {
	return 403
}

func (o *EditSubscriptionForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/notification/subscriptions/{subscriptionId}][%d] editSubscriptionForbidden %s", 403, payload)
}

func (o *EditSubscriptionForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/notification/subscriptions/{subscriptionId}][%d] editSubscriptionForbidden %s", 403, payload)
}

func (o *EditSubscriptionForbidden) GetPayload() string {
	return o.Payload
}

func (o *EditSubscriptionForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
