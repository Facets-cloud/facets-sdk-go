...
func (o *CreateNotificationChannelReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCreateNotificationChannelForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateNotificationChannelForbidden creates a CreateNotificationChannelForbidden with default headers values
func NewCreateNotificationChannelForbidden() *CreateNotificationChannelForbidden {
	return &CreateNotificationChannelForbidden{}
}

/*
CreateNotificationChannelForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CreateNotificationChannelForbidden struct {
	Payload string
}

// IsSuccess returns true when this create notification channel forbidden response has a 2xx status code
func (o *CreateNotificationChannelForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create notification channel forbidden response has a 3xx status code
func (o *CreateNotificationChannelForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create notification channel forbidden response has a 4xx status code
func (o *CreateNotificationChannelForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create notification channel forbidden response has a 5xx status code
func (o *CreateNotificationChannelForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create notification channel forbidden response a status code equal to that given
func (o *CreateNotificationChannelForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create notification channel forbidden response
func (o *CreateNotificationChannelForbidden) Code() int {
	return 403
}

func (o *CreateNotificationChannelForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/notification/channels][%d] createNotificationChannelForbidden %s", 403, payload)
}

func (o *CreateNotificationChannelForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/notification/channels][%d] createNotificationChannelForbidden %s", 403, payload)
}

func (o *CreateNotificationChannelForbidden) GetPayload() string {
	return o.Payload
}

func (o *CreateNotificationChannelForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
