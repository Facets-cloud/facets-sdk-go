...
func (o *GetAllNotificationTypesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllNotificationTypesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllNotificationTypesForbidden creates a GetAllNotificationTypesForbidden with default headers values
func NewGetAllNotificationTypesForbidden() *GetAllNotificationTypesForbidden {
	return &GetAllNotificationTypesForbidden{}
}

/*
GetAllNotificationTypesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllNotificationTypesForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all notification types forbidden response has a 2xx status code
func (o *GetAllNotificationTypesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all notification types forbidden response has a 3xx status code
func (o *GetAllNotificationTypesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all notification types forbidden response has a 4xx status code
func (o *GetAllNotificationTypesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all notification types forbidden response has a 5xx status code
func (o *GetAllNotificationTypesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all notification types forbidden response a status code equal to that given
func (o *GetAllNotificationTypesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all notification types forbidden response
func (o *GetAllNotificationTypesForbidden) Code() int {
	return 403
}

func (o *GetAllNotificationTypesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/notification/notificationTypes][%d] getAllNotificationTypesForbidden %s", 403, payload)
}

func (o *GetAllNotificationTypesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/notification/notificationTypes][%d] getAllNotificationTypesForbidden %s", 403, payload)
}

func (o *GetAllNotificationTypesForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllNotificationTypesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
