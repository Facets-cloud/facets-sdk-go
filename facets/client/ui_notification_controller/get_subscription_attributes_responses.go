...
func (o *GetSubscriptionAttributesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetSubscriptionAttributesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetSubscriptionAttributesForbidden creates a GetSubscriptionAttributesForbidden with default headers values
func NewGetSubscriptionAttributesForbidden() *GetSubscriptionAttributesForbidden {
	return &GetSubscriptionAttributesForbidden{}
}

/*
GetSubscriptionAttributesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetSubscriptionAttributesForbidden struct {
	Payload string
}

// IsSuccess returns true when this get subscription attributes forbidden response has a 2xx status code
func (o *GetSubscriptionAttributesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get subscription attributes forbidden response has a 3xx status code
func (o *GetSubscriptionAttributesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get subscription attributes forbidden response has a 4xx status code
func (o *GetSubscriptionAttributesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get subscription attributes forbidden response has a 5xx status code
func (o *GetSubscriptionAttributesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get subscription attributes forbidden response a status code equal to that given
func (o *GetSubscriptionAttributesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get subscription attributes forbidden response
func (o *GetSubscriptionAttributesForbidden) Code() int {
	return 403
}

func (o *GetSubscriptionAttributesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/notification/notificationType/{notificationType}/attributes][%d] getSubscriptionAttributesForbidden %s", 403, payload)
}

func (o *GetSubscriptionAttributesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/notification/notificationType/{notificationType}/attributes][%d] getSubscriptionAttributesForbidden %s", 403, payload)
}

func (o *GetSubscriptionAttributesForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetSubscriptionAttributesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
