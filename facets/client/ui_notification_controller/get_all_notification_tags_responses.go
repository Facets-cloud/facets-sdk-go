...
func (o *GetAllNotificationTagsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllNotificationTagsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllNotificationTagsForbidden creates a GetAllNotificationTagsForbidden with default headers values
func NewGetAllNotificationTagsForbidden() *GetAllNotificationTagsForbidden {
	return &GetAllNotificationTagsForbidden{}
}

/*
GetAllNotificationTagsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllNotificationTagsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all notification tags forbidden response has a 2xx status code
func (o *GetAllNotificationTagsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all notification tags forbidden response has a 3xx status code
func (o *GetAllNotificationTagsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all notification tags forbidden response has a 4xx status code
func (o *GetAllNotificationTagsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all notification tags forbidden response has a 5xx status code
func (o *GetAllNotificationTagsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all notification tags forbidden response a status code equal to that given
func (o *GetAllNotificationTagsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all notification tags forbidden response
func (o *GetAllNotificationTagsForbidden) Code() int {
	return 403
}

func (o *GetAllNotificationTagsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/notification/notificationTags][%d] getAllNotificationTagsForbidden %s", 403, payload)
}

func (o *GetAllNotificationTagsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/notification/notificationTags][%d] getAllNotificationTagsForbidden %s", 403, payload)
}

func (o *GetAllNotificationTagsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllNotificationTagsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
