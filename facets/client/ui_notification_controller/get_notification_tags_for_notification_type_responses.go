...
func (o *GetNotificationTagsForNotificationTypeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetNotificationTagsForNotificationTypeForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetNotificationTagsForNotificationTypeForbidden creates a GetNotificationTagsForNotificationTypeForbidden with default headers values
func NewGetNotificationTagsForNotificationTypeForbidden() *GetNotificationTagsForNotificationTypeForbidden {
	return &GetNotificationTagsForNotificationTypeForbidden{}
}

/*
GetNotificationTagsForNotificationTypeForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetNotificationTagsForNotificationTypeForbidden struct {
	Payload string
}

// IsSuccess returns true when this get notification tags for notification type forbidden response has a 2xx status code
func (o *GetNotificationTagsForNotificationTypeForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get notification tags for notification type forbidden response has a 3xx status code
func (o *GetNotificationTagsForNotificationTypeForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get notification tags for notification type forbidden response has a 4xx status code
func (o *GetNotificationTagsForNotificationTypeForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get notification tags for notification type forbidden response has a 5xx status code
func (o *GetNotificationTagsForNotificationTypeForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get notification tags for notification type forbidden response a status code equal to that given
func (o *GetNotificationTagsForNotificationTypeForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get notification tags for notification type forbidden response
func (o *GetNotificationTagsForNotificationTypeForbidden) Code() int {
	return 403
}

func (o *GetNotificationTagsForNotificationTypeForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/notification/{notificationType}/tags][%d] getNotificationTagsForNotificationTypeForbidden %s", 403, payload)
}

func (o *GetNotificationTagsForNotificationTypeForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/notification/{notificationType}/tags][%d] getNotificationTagsForNotificationTypeForbidden %s", 403, payload)
}

func (o *GetNotificationTagsForNotificationTypeForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetNotificationTagsForNotificationTypeForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
