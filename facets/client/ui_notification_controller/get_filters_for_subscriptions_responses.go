...
func (o *GetFiltersForSubscriptionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetFiltersForSubscriptionsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetFiltersForSubscriptionsForbidden creates a GetFiltersForSubscriptionsForbidden with default headers values
func NewGetFiltersForSubscriptionsForbidden() *GetFiltersForSubscriptionsForbidden {
	return &GetFiltersForSubscriptionsForbidden{}
}

/*
GetFiltersForSubscriptionsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetFiltersForSubscriptionsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get filters for subscriptions forbidden response has a 2xx status code
func (o *GetFiltersForSubscriptionsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get filters for subscriptions forbidden response has a 3xx status code
func (o *GetFiltersForSubscriptionsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get filters for subscriptions forbidden response has a 4xx status code
func (o *GetFiltersForSubscriptionsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get filters for subscriptions forbidden response has a 5xx status code
func (o *GetFiltersForSubscriptionsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get filters for subscriptions forbidden response a status code equal to that given
func (o *GetFiltersForSubscriptionsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get filters for subscriptions forbidden response
func (o *GetFiltersForSubscriptionsForbidden) Code() int {
	return 403
}

func (o *GetFiltersForSubscriptionsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/notification/{notificationType}/tag/{tagName}/values/][%d] getFiltersForSubscriptionsForbidden %s", 403, payload)
}

func (o *GetFiltersForSubscriptionsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/notification/{notificationType}/tag/{tagName}/values/][%d] getFiltersForSubscriptionsForbidden %s", 403, payload)
}

func (o *GetFiltersForSubscriptionsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetFiltersForSubscriptionsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
