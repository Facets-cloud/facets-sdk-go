...
func (o *DeleteSubscriptionForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/notification/subscriptions/{subscriptionId}][%d] deleteSubscriptionForbidden %s", 403, payload)
}
...
func (o *DeleteSubscriptionForbidden) GetPayload() string {
	return o.Payload
}
