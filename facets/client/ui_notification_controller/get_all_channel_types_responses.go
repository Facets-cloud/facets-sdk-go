...
func (o *GetAllChannelTypesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllChannelTypesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllChannelTypesForbidden creates a GetAllChannelTypesForbidden with default headers values
func NewGetAllChannelTypesForbidden() *GetAllChannelTypesForbidden {
	return &GetAllChannelTypesForbidden{}
}

/*
GetAllChannelTypesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllChannelTypesForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all channel types forbidden response has a 2xx status code
func (o *GetAllChannelTypesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all channel types forbidden response has a 3xx status code
func (o *GetAllChannelTypesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all channel types forbidden response has a 4xx status code
func (o *GetAllChannelTypesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all channel types forbidden response has a 5xx status code
func (o *GetAllChannelTypesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all channel types forbidden response a status code equal to that given
func (o *GetAllChannelTypesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all channel types forbidden response
func (o *GetAllChannelTypesForbidden) Code() int {
	return 403
}

func (o *GetAllChannelTypesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/notification/channelTypes][%d] getAllChannelTypesForbidden %s", 403, payload)
}

func (o *GetAllChannelTypesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/notification/channelTypes][%d] getAllChannelTypesForbidden %s", 403, payload)
}

func (o *GetAllChannelTypesForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllChannelTypesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
