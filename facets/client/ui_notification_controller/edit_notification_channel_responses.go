...
func (o *EditNotificationChannelReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewEditNotificationChannelForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewEditNotificationChannelForbidden creates a EditNotificationChannelForbidden with default headers values
func NewEditNotificationChannelForbidden() *EditNotificationChannelForbidden {
	return &EditNotificationChannelForbidden{}
}

/*
EditNotificationChannelForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type EditNotificationChannelForbidden struct {
	Payload string
}

// IsSuccess returns true when this edit notification channel forbidden response has a 2xx status code
func (o *EditNotificationChannelForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this edit notification channel forbidden response has a 3xx status code
func (o *EditNotificationChannelForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this edit notification channel forbidden response has a 4xx status code
func (o *EditNotificationChannelForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this edit notification channel forbidden response has a 5xx status code
func (o *EditNotificationChannelForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this edit notification channel forbidden response a status code equal to that given
func (o *EditNotificationChannelForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the edit notification channel forbidden response
func (o *EditNotificationChannelForbidden) Code() int {
	return 403
}

func (o *EditNotificationChannelForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/notification/channels/{channelId}][%d] editNotificationChannelForbidden %s", 403, payload)
}

func (o *EditNotificationChannelForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/notification/channels/{channelId}][%d] editNotificationChannelForbidden %s", 403, payload)
}

func (o *EditNotificationChannelForbidden) GetPayload() string {
	return o.Payload
}

func (o *EditNotificationChannelForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
