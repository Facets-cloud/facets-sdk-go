...
func (o *GetAllChannelsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllChannelsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllChannelsForbidden creates a GetAllChannelsForbidden with default headers values
func NewGetAllChannelsForbidden() *GetAllChannelsForbidden {
	return &GetAllChannelsForbidden{}
}

/*
GetAllChannelsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllChannelsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all channels forbidden response has a 2xx status code
func (o *GetAllChannelsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all channels forbidden response has a 3xx status code
func (o *GetAllChannelsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all channels forbidden response has a 4xx status code
func (o *GetAllChannelsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all channels forbidden response has a 5xx status code
func (o *GetAllChannelsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all channels forbidden response a status code equal to that given
func (o *GetAllChannelsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all channels forbidden response
func (o *GetAllChannelsForbidden) Code() int {
	return 403
}

func (o *GetAllChannelsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/notification/channels][%d] getAllChannelsForbidden %s", 403, payload)
}

func (o *GetAllChannelsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/notification/channels][%d] getAllChannelsForbidden %s", 403, payload)
}

func (o *GetAllChannelsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllChannelsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
