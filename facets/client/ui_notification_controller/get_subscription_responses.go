...
func (o *GetSubscriptionForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/notification/subscriptions/{subscriptionId}][%d] getSubscriptionForbidden %s", 403, payload)
}
...
func (o *GetSubscriptionForbidden) GetPayload() string {
	return o.Payload
}
