...
// WithName adds the name to the delete using d e l e t e params
func (o *DeleteUsingDELETEParams) WithName(name string) *DeleteUsingDELETEParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the delete using d e l e t e params
func (o *DeleteUsingDELETEParams) SetName(name string) {
	o.Name = name
}
