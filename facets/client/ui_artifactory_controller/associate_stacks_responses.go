...
func (o *AssociateStacksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewAssociateStacksForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewAssociateStacksForbidden creates a AssociateStacksForbidden with default headers values
func NewAssociateStacksForbidden() *AssociateStacksForbidden {
	return &AssociateStacksForbidden{}
}

/*
AssociateStacksForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type AssociateStacksForbidden struct {
	Payload string
}

// IsSuccess returns true when this associate stacks forbidden response has a 2xx status code
func (o *AssociateStacksForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this associate stacks forbidden response has a 3xx status code
func (o *AssociateStacksForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this associate stacks forbidden response has a 4xx status code
func (o *AssociateStacksForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this associate stacks forbidden response has a 5xx status code
func (o *AssociateStacksForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this associate stacks forbidden response a status code equal to that given
func (o *AssociateStacksForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the associate stacks forbidden response
func (o *AssociateStacksForbidden) Code() int {
	return 403
}

func (o *AssociateStacksForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifactories/{artifactoryId}/associate-projects][%d] associateStacksForbidden %s", 403, payload)
}

func (o *AssociateStacksForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifactories/{artifactoryId}/associate-projects][%d] associateStacksForbidden %s", 403, payload)
}

func (o *AssociateStacksForbidden) GetPayload() string {
	return o.Payload
}

func (o *AssociateStacksForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
