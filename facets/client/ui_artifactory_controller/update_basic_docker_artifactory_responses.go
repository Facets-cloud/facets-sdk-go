...
func (o *UpdateBasicDockerArtifactoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateBasicDockerArtifactoryForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateBasicDockerArtifactoryForbidden creates a UpdateBasicDockerArtifactoryForbidden with default headers values
func NewUpdateBasicDockerArtifactoryForbidden() *UpdateBasicDockerArtifactoryForbidden {
	return &UpdateBasicDockerArtifactoryForbidden{}
}

/*
UpdateBasicDockerArtifactoryForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateBasicDockerArtifactoryForbidden struct {
	Payload string
}

// IsSuccess returns true when this update basic docker artifactory forbidden response has a 2xx status code
func (o *UpdateBasicDockerArtifactoryForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update basic docker artifactory forbidden response has a 3xx status code
func (o *UpdateBasicDockerArtifactoryForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update basic docker artifactory forbidden response has a 4xx status code
func (o *UpdateBasicDockerArtifactoryForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update basic docker artifactory forbidden response has a 5xx status code
func (o *UpdateBasicDockerArtifactoryForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update basic docker artifactory forbidden response a status code equal to that given
func (o *UpdateBasicDockerArtifactoryForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update basic docker artifactory forbidden response
func (o *UpdateBasicDockerArtifactoryForbidden) Code() int {
	return 403
}

func (o *UpdateBasicDockerArtifactoryForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifactories/others/{artifactoryId}][%d] updateBasicDockerArtifactoryForbidden %s", 403, payload)
}

func (o *UpdateBasicDockerArtifactoryForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifactories/others/{artifactoryId}][%d] updateBasicDockerArtifactoryForbidden %s", 403, payload)
}

func (o *UpdateBasicDockerArtifactoryForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateBasicDockerArtifactoryForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
