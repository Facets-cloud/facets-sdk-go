...
func (o *DeleteArtifactoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteArtifactoryForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteArtifactoryForbidden creates a DeleteArtifactoryForbidden with default headers values
func NewDeleteArtifactoryForbidden() *DeleteArtifactoryForbidden {
	return &DeleteArtifactoryForbidden{}
}

/*
DeleteArtifactoryForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteArtifactoryForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete artifactory forbidden response has a 2xx status code
func (o *DeleteArtifactoryForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete artifactory forbidden response has a 3xx status code
func (o *DeleteArtifactoryForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete artifactory forbidden response has a 4xx status code
func (o *DeleteArtifactoryForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete artifactory forbidden response has a 5xx status code
func (o *DeleteArtifactoryForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete artifactory forbidden response a status code equal to that given
func (o *DeleteArtifactoryForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete artifactory forbidden response
func (o *DeleteArtifactoryForbidden) Code() int {
	return 403
}

func (o *DeleteArtifactoryForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/artifactories/v2/{artifactoryId}][%d] deleteArtifactoryForbidden %s", 403, payload)
}

func (o *DeleteArtifactoryForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/artifactories/v2/{artifactoryId}][%d] deleteArtifactoryForbidden %s", 403, payload)
}

func (o *DeleteArtifactoryForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteArtifactoryForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
