...
func (o *GetRepositoriesByArtifactoryNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetRepositoriesByArtifactoryNameForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetRepositoriesByArtifactoryNameForbidden creates a GetRepositoriesByArtifactoryNameForbidden with default headers values
func NewGetRepositoriesByArtifactoryNameForbidden() *GetRepositoriesByArtifactoryNameForbidden {
	return &GetRepositoriesByArtifactoryNameForbidden{}
}

/*
GetRepositoriesByArtifactoryNameForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetRepositoriesByArtifactoryNameForbidden struct {
	Payload string
}

// IsSuccess returns true when this get repositories by artifactory name forbidden response has a 2xx status code
func (o *GetRepositoriesByArtifactoryNameForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get repositories by artifactory name forbidden response has a 3xx status code
func (o *GetRepositoriesByArtifactoryNameForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get repositories by artifactory name forbidden response has a 4xx status code
func (o *GetRepositoriesByArtifactoryNameForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get repositories by artifactory name forbidden response has a 5xx status code
func (o *GetRepositoriesByArtifactoryNameForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get repositories by artifactory name forbidden response a status code equal to that given
func (o *GetRepositoriesByArtifactoryNameForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get repositories by artifactory name forbidden response
func (o *GetRepositoriesByArtifactoryNameForbidden) Code() int {
	return 403
}

func (o *GetRepositoriesByArtifactoryNameForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifactories/name/{name}/repos][%d] getRepositoriesByArtifactoryNameForbidden %s", 403, payload)
}

func (o *GetRepositoriesByArtifactoryNameForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifactories/name/{name}/repos][%d] getRepositoriesByArtifactoryNameForbidden %s", 403, payload)
}

func (o *GetRepositoriesByArtifactoryNameForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetRepositoriesByArtifactoryNameForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
