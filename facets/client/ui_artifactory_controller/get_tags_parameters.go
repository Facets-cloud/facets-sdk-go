...
// WithArtifactoryID adds the artifactoryID to the get tags params
func (o *GetTagsParams) WithArtifactoryID(artifactoryID string) *GetTagsParams {
	o.SetArtifactoryID(artifactoryID)
	return o
}

// SetArtifactoryID adds the artifactoryId to the get tags params
func (o *GetTagsParams) SetArtifactoryID(artifactoryID string) {
	o.ArtifactoryID = artifactoryID
}

// WithRepo adds the repo to the get tags params
func (o *GetTagsParams) WithRepo(repo string) *GetTagsParams {
	o.SetRepo(repo)
	return o
}

// SetRepo adds the repo to the get tags params
func (o *GetTagsParams) SetRepo(repo string) {
	o.Repo = repo
}
