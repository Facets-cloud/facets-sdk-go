...
func (o *UpdateECRArtifactoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateECRArtifactoryForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateECRArtifactoryForbidden creates a UpdateECRArtifactoryForbidden with default headers values
func NewUpdateECRArtifactoryForbidden() *UpdateECRArtifactoryForbidden {
	return &UpdateECRArtifactoryForbidden{}
}

/*
UpdateECRArtifactoryForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateECRArtifactoryForbidden struct {
	Payload string
}

// IsSuccess returns true when this update e c r artifactory forbidden response has a 2xx status code
func (o *UpdateECRArtifactoryForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update e c r artifactory forbidden response has a 3xx status code
func (o *UpdateECRArtifactoryForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update e c r artifactory forbidden response has a 4xx status code
func (o *UpdateECRArtifactoryForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update e c r artifactory forbidden response has a 5xx status code
func (o *UpdateECRArtifactoryForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update e c r artifactory forbidden response a status code equal to that given
func (o *UpdateECRArtifactoryForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update e c r artifactory forbidden response
func (o *UpdateECRArtifactoryForbidden) Code() int {
	return 403
}

func (o *UpdateECRArtifactoryForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifactories/{artifactoryId}][%d] updateECRArtifactoryForbidden %s", 403, payload)
}

func (o *UpdateECRArtifactoryForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifactories/{artifactoryId}][%d] updateECRArtifactoryForbidden %s", 403, payload)
}

func (o *UpdateECRArtifactoryForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateECRArtifactoryForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
