...
// WithArtifactoryID adds the artifactoryID to the get repositories params
func (o *GetRepositoriesParams) WithArtifactoryID(artifactoryID string) *GetRepositoriesParams {
	o.SetArtifactoryID(artifactoryID)
	return o
}

// SetArtifactoryID adds the artifactoryId to the get repositories params
func (o *GetRepositoriesParams) SetArtifactoryID(artifactoryID string) {
