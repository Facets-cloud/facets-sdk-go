...
func (o *RequestArtifactoryLinkingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRequestArtifactoryLinkingForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRequestArtifactoryLinkingForbidden creates a RequestArtifactoryLinkingForbidden with default headers values
func NewRequestArtifactoryLinkingForbidden() *RequestArtifactoryLinkingForbidden {
	return &RequestArtifactoryLinkingForbidden{}
}

/*
RequestArtifactoryLinkingForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RequestArtifactoryLinkingForbidden struct {
	Payload string
}

// IsSuccess returns true when this request artifactory linking forbidden response has a 2xx status code
func (o *RequestArtifactoryLinkingForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this request artifactory linking forbidden response has a 3xx status code
func (o *RequestArtifactoryLinkingForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this request artifactory linking forbidden response has a 4xx status code
func (o *RequestArtifactoryLinkingForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this request artifactory linking forbidden response has a 5xx status code
func (o *RequestArtifactoryLinkingForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this request artifactory linking forbidden response a status code equal to that given
func (o *RequestArtifactoryLinkingForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the request artifactory linking forbidden response
func (o *RequestArtifactoryLinkingForbidden) Code() int {
	return 403
}

func (o *RequestArtifactoryLinkingForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifactories/link-container-registry][%d] requestArtifactoryLinkingForbidden %s", 403, payload)
}

func (o *RequestArtifactoryLinkingForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifactories/link-container-registry][%d] requestArtifactoryLinkingForbidden %s", 403, payload)
}

func (o *RequestArtifactoryLinkingForbidden) GetPayload() string {
	return o.Payload
}

func (o *RequestArtifactoryLinkingForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
