...
func (o *GetRepositoriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetRepositoriesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifactories/{artifactoryId}/repos][%d] getRepositoriesForbidden %s", 403, payload)
}
...
func (o *GetRepositoriesForbidden) GetPayload() string {
	return o.Payload
}
