...
func (o *GetTagsByArtifactoryNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetTagsByArtifactoryNameForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetTagsByArtifactoryNameForbidden creates a GetTagsByArtifactoryNameForbidden with default headers values
func NewGetTagsByArtifactoryNameForbidden() *GetTagsByArtifactoryNameForbidden {
	return &GetTagsByArtifactoryNameForbidden{}
}

/*
GetTagsByArtifactoryNameForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetTagsByArtifactoryNameForbidden struct {
	Payload string
}

// IsSuccess returns true when this get tags by artifactory name forbidden response has a 2xx status code
func (o *GetTagsByArtifactoryNameForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get tags by artifactory name forbidden response has a 3xx status code
func (o *GetTagsByArtifactoryNameForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get tags by artifactory name forbidden response has a 4xx status code
func (o *GetTagsByArtifactoryNameForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get tags by artifactory name forbidden response has a 5xx status code
func (o *GetTagsByArtifactoryNameForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get tags by artifactory name forbidden response a status code equal to that given
func (o *GetTagsByArtifactoryNameForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get tags by artifactory name forbidden response
func (o *GetTagsByArtifactoryNameForbidden) Code() int {
	return 403
}

func (o *GetTagsByArtifactoryNameForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifactories/name/{name}/tags][%d] getTagsByArtifactoryNameForbidden %s", 403, payload)
}

func (o *GetTagsByArtifactoryNameForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifactories/name/{name}/tags][%d] getTagsByArtifactoryNameForbidden %s", 403, payload)
}

func (o *GetTagsByArtifactoryNameForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetTagsByArtifactoryNameForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
