...
func (o *DeleteAllSoftDeleteEntitiesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteAllSoftDeleteEntitiesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteAllSoftDeleteEntitiesForbidden creates a DeleteAllSoftDeleteEntitiesForbidden with default headers values
func NewDeleteAllSoftDeleteEntitiesForbidden() *DeleteAllSoftDeleteEntitiesForbidden {
	return &DeleteAllSoftDeleteEntitiesForbidden{}
}

/*
DeleteAllSoftDeleteEntitiesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteAllSoftDeleteEntitiesForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete all soft delete entities forbidden response has a 2xx status code
func (o *DeleteAllSoftDeleteEntitiesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete all soft delete entities forbidden response has a 3xx status code
func (o *DeleteAllSoftDeleteEntitiesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete all soft delete entities forbidden response has a 4xx status code
func (o *DeleteAllSoftDeleteEntitiesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete all soft delete entities forbidden response has a 5xx status code
func (o *DeleteAllSoftDeleteEntitiesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete all soft delete entities forbidden response a status code equal to that given
func (o *DeleteAllSoftDeleteEntitiesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete all soft delete entities forbidden response
func (o *DeleteAllSoftDeleteEntitiesForbidden) Code() int {
	return 403
}

func (o *DeleteAllSoftDeleteEntitiesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/versions/softDeletedEntities/all][%d] deleteAllSoftDeleteEntitiesForbidden %s", 403, payload)
}

func (o *DeleteAllSoftDeleteEntitiesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/versions/softDeletedEntities/all][%d] deleteAllSoftDeleteEntitiesForbidden %s", 403, payload)
}

func (o *DeleteAllSoftDeleteEntitiesForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteAllSoftDeleteEntitiesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
