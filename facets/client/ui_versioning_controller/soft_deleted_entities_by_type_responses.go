...
func (o *SoftDeletedEntitiesByTypeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewSoftDeletedEntitiesByTypeForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSoftDeletedEntitiesByTypeForbidden creates a SoftDeletedEntitiesByTypeForbidden with default headers values
func NewSoftDeletedEntitiesByTypeForbidden() *SoftDeletedEntitiesByTypeForbidden {
	return &SoftDeletedEntitiesByTypeForbidden{}
}

/*
SoftDeletedEntitiesByTypeForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type SoftDeletedEntitiesByTypeForbidden struct {
	Payload string
}

// IsSuccess returns true when this soft deleted entities by type forbidden response has a 2xx status code
func (o *SoftDeletedEntitiesByTypeForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this soft deleted entities by type forbidden response has a 3xx status code
func (o *SoftDeletedEntitiesByTypeForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this soft deleted entities by type forbidden response has a 4xx status code
func (o *SoftDeletedEntitiesByTypeForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this soft deleted entities by type forbidden response has a 5xx status code
func (o *SoftDeletedEntitiesByTypeForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this soft deleted entities by type forbidden response a status code equal to that given
func (o *SoftDeletedEntitiesByTypeForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the soft deleted entities by type forbidden response
func (o *SoftDeletedEntitiesByTypeForbidden) Code() int {
	return 403
}

func (o *SoftDeletedEntitiesByTypeForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/versions/softDeletedEntities/{entityType}][%d] softDeletedEntitiesByTypeForbidden %s", 403, payload)
}

func (o *SoftDeletedEntitiesByTypeForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/versions/softDeletedEntities/{entityType}][%d] softDeletedEntitiesByTypeForbidden %s", 403, payload)
}

func (o *SoftDeletedEntitiesByTypeForbidden) GetPayload() string {
	return o.Payload
}

func (o *SoftDeletedEntitiesByTypeForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
