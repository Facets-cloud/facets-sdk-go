...
// WithVersionID adds the versionID to the restore params
func (o *RestoreParams) WithVersionID(versionID string) *RestoreParams {
	o.SetVersionID(versionID)
	return o
}

// SetVersionID adds the versionId to the restore params
func (o *RestoreParams) SetVersionID(versionID string) {
