...
func (o *SoftDeletedEntitiesByTypeParams) SetDefaults() {
	...
	val := SoftDeletedEntitiesByTypeParams{
		Page:    &pageDefault,
...
func (o *SoftDeletedEntitiesByTypeParams) WithPage(page *int32) *SoftDeletedEntitiesByTypeParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the soft deleted entities by type params
func (o *SoftDeletedEntitiesByTypeParams) SetPage(page *int32) {
	o.Page = page
}

// WithPerPage adds the perPage to the soft deleted entities by type params
func (o *SoftDeletedEntitiesByTypeParams) WithPerPage(perPage *int32) *SoftDeletedEntitiesByTypeParams {
	o.SetPerPage(perPage)
	return o
}

// SetPerPage adds the perPage to the soft deleted entities by type params
func (o *SoftDeletedEntitiesByTypeParams) SetPerPage(perPage *int32) {
	o.PerPage = perPage
}
