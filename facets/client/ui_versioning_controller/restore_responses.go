...
func (o *RestoreOK) GetPayload() any {
	return o.Payload
}
...
// NewRestoreForbidden creates a RestoreForbidden with default headers values
func NewRestoreForbidden() *RestoreForbidden {
	return &RestoreForbidden{}
}

/*
RestoreForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RestoreForbidden struct {
	Payload string
}

// IsSuccess returns true when this restore forbidden response has a 2xx status code
func (o *RestoreForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this restore forbidden response has a 3xx status code
func (o *RestoreForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this restore forbidden response has a 4xx status code
func (o *RestoreForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this restore forbidden response has a 5xx status code
func (o *RestoreForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this restore forbidden response a status code equal to that given
func (o *RestoreForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the restore forbidden response
func (o *RestoreForbidden) Code() int {
	return 403
}

func (o *RestoreForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/versions/{versionId}/restore][%d] restoreForbidden %s", 403, payload)
}

func (o *RestoreForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/versions/{versionId}/restore][%d] restoreForbidden %s", 403, payload)
}

func (o *RestoreForbidden) GetPayload() string {
	return o.Payload
}

func (o *RestoreForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
