...
func (o *GetVersionByIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetVersionByIDForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetVersionByIDForbidden creates a GetVersionByIDForbidden with default headers values
func NewGetVersionByIDForbidden() *GetVersionByIDForbidden {
	return &GetVersionByIDForbidden{}
}

/*
GetVersionByIDForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetVersionByIDForbidden struct {
	Payload string
}

// IsSuccess returns true when this get version by Id forbidden response has a 2xx status code
func (o *GetVersionByIDForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get version by Id forbidden response has a 3xx status code
func (o *GetVersionByIDForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get version by Id forbidden response has a 4xx status code
func (o *GetVersionByIDForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get version by Id forbidden response has a 5xx status code
func (o *GetVersionByIDForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get version by Id forbidden response a status code equal to that given
func (o *GetVersionByIDForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get version by Id forbidden response
func (o *GetVersionByIDForbidden) Code() int {
	return 403
}

func (o *GetVersionByIDForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/versions/id/{id}][%d] getVersionByIdForbidden %s", 403, payload)
}

func (o *GetVersionByIDForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/versions/id/{id}][%d] getVersionByIdForbidden %s", 403, payload)
}

func (o *GetVersionByIDForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetVersionByIDForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
