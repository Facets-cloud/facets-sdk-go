...
func (o *GetVersionsParams) WithPage(page *int32) *GetVersionsParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the get versions params
func (o *GetVersionsParams) SetPage(page *int32) {
	o.Page = page
}

// WithPerPage adds the perPage to the get versions params
func (o *GetVersionsParams) WithPerPage(perPage *int32) *GetVersionsParams {
	o.SetPerPage(perPage)
	return o
}

// SetPerPage adds the perPage to the get versions params
func (o *GetVersionsParams) SetPerPage(perPage *int32) {
	o.PerPage = perPage
}
