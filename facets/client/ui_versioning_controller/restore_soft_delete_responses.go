...
func (o *RestoreSoftDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRestoreSoftDeleteForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRestoreSoftDeleteForbidden creates a RestoreSoftDeleteForbidden with default headers values
func NewRestoreSoftDeleteForbidden() *RestoreSoftDeleteForbidden {
	return &RestoreSoftDeleteForbidden{}
}

/*
RestoreSoftDeleteForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RestoreSoftDeleteForbidden struct {
	Payload string
}

// IsSuccess returns true when this restore soft delete forbidden response has a 2xx status code
func (o *RestoreSoftDeleteForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this restore soft delete forbidden response has a 3xx status code
func (o *RestoreSoftDeleteForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this restore soft delete forbidden response has a 4xx status code
func (o *RestoreSoftDeleteForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this restore soft delete forbidden response has a 5xx status code
func (o *RestoreSoftDeleteForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this restore soft delete forbidden response a status code equal to that given
func (o *RestoreSoftDeleteForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the restore soft delete forbidden response
func (o *RestoreSoftDeleteForbidden) Code() int {
	return 403
}

func (o *RestoreSoftDeleteForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/versions/softDeletedEntities/{entityId}][%d] restoreSoftDeleteForbidden %s", 403, payload)
}

func (o *RestoreSoftDeleteForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/versions/softDeletedEntities/{entityId}][%d] restoreSoftDeleteForbidden %s", 403, payload)
}

func (o *RestoreSoftDeleteForbidden) GetPayload() string {
	return o.Payload
}

func (o *RestoreSoftDeleteForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
