...
func (o *DeleteSoftDeleteEntityReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteSoftDeleteEntityForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteSoftDeleteEntityForbidden creates a DeleteSoftDeleteEntityForbidden with default headers values
func NewDeleteSoftDeleteEntityForbidden() *DeleteSoftDeleteEntityForbidden {
	return &DeleteSoftDeleteEntityForbidden{}
}

/*
DeleteSoftDeleteEntityForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteSoftDeleteEntityForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete soft delete entity forbidden response has a 2xx status code
func (o *DeleteSoftDeleteEntityForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete soft delete entity forbidden response has a 3xx status code
func (o *DeleteSoftDeleteEntityForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete soft delete entity forbidden response has a 4xx status code
func (o *DeleteSoftDeleteEntityForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete soft delete entity forbidden response has a 5xx status code
func (o *DeleteSoftDeleteEntityForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete soft delete entity forbidden response a status code equal to that given
func (o *DeleteSoftDeleteEntityForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete soft delete entity forbidden response
func (o *DeleteSoftDeleteEntityForbidden) Code() int {
	return 403
}

func (o *DeleteSoftDeleteEntityForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/versions/softDeletedEntities][%d] deleteSoftDeleteEntityForbidden %s", 403, payload)
}

func (o *DeleteSoftDeleteEntityForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/versions/softDeletedEntities][%d] deleteSoftDeleteEntityForbidden %s", 403, payload)
}

func (o *DeleteSoftDeleteEntityForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteSoftDeleteEntityForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
