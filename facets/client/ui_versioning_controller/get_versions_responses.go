...
func (o *GetVersionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetVersionsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/versions/{versioningKey}][%d] getVersionsForbidden %s", 403, payload)
}
...
func (o *GetVersionsForbidden) GetPayload() string {
	return o.Payload
}
