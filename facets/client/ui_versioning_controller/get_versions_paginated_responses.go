...
func (o *GetVersionsPaginatedReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetVersionsPaginatedForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetVersionsPaginatedForbidden creates a GetVersionsPaginatedForbidden with default headers values
func NewGetVersionsPaginatedForbidden() *GetVersionsPaginatedForbidden {
	return &GetVersionsPaginatedForbidden{}
}

/*
GetVersionsPaginatedForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetVersionsPaginatedForbidden struct {
	Payload string
}

// IsSuccess returns true when this get versions paginated forbidden response has a 2xx status code
func (o *GetVersionsPaginatedForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get versions paginated forbidden response has a 3xx status code
func (o *GetVersionsPaginatedForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get versions paginated forbidden response has a 4xx status code
func (o *GetVersionsPaginatedForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get versions paginated forbidden response has a 5xx status code
func (o *GetVersionsPaginatedForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get versions paginated forbidden response a status code equal to that given
func (o *GetVersionsPaginatedForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get versions paginated forbidden response
func (o *GetVersionsPaginatedForbidden) Code() int {
	return 403
}

func (o *GetVersionsPaginatedForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/versions/{versioningKey}/paginated][%d] getVersionsPaginatedForbidden %s", 403, payload)
}

func (o *GetVersionsPaginatedForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/versions/{versioningKey}/paginated][%d] getVersionsPaginatedForbidden %s", 403, payload)
}

func (o *GetVersionsPaginatedForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetVersionsPaginatedForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
