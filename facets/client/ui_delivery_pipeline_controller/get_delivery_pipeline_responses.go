...
func (o *GetDeliveryPipelineReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetDeliveryPipelineForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetDeliveryPipelineForbidden creates a GetDeliveryPipelineForbidden with default headers values
func NewGetDeliveryPipelineForbidden() *GetDeliveryPipelineForbidden {
	return &GetDeliveryPipelineForbidden{}
}

/*
GetDeliveryPipelineForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetDeliveryPipelineForbidden struct {
	Payload string
}

// IsSuccess returns true when this get delivery pipeline forbidden response has a 2xx status code
func (o *GetDeliveryPipelineForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get delivery pipeline forbidden response has a 3xx status code
func (o *GetDeliveryPipelineForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get delivery pipeline forbidden response has a 4xx status code
func (o *GetDeliveryPipelineForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get delivery pipeline forbidden response has a 5xx status code
func (o *GetDeliveryPipelineForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get delivery pipeline forbidden response a status code equal to that given
func (o *GetDeliveryPipelineForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get delivery pipeline forbidden response
func (o *GetDeliveryPipelineForbidden) Code() int {
	return 403
}

func (o *GetDeliveryPipelineForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/delivery-pipeline/{stackName}][%d] getDeliveryPipelineForbidden %s", 403, payload)
}

func (o *GetDeliveryPipelineForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/delivery-pipeline/{stackName}][%d] getDeliveryPipelineForbidden %s", 403, payload)
}

func (o *GetDeliveryPipelineForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetDeliveryPipelineForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
