...
func (o *UpdateDeliveryPipelineReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateDeliveryPipelineForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateDeliveryPipelineForbidden creates a UpdateDeliveryPipelineForbidden with default headers values
func NewUpdateDeliveryPipelineForbidden() *UpdateDeliveryPipelineForbidden {
	return &UpdateDeliveryPipelineForbidden{}
}

/*
UpdateDeliveryPipelineForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateDeliveryPipelineForbidden struct {
	Payload string
}

// IsSuccess returns true when this update delivery pipeline forbidden response has a 2xx status code
func (o *UpdateDeliveryPipelineForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update delivery pipeline forbidden response has a 3xx status code
func (o *UpdateDeliveryPipelineForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update delivery pipeline forbidden response has a 4xx status code
func (o *UpdateDeliveryPipelineForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update delivery pipeline forbidden response has a 5xx status code
func (o *UpdateDeliveryPipelineForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update delivery pipeline forbidden response a status code equal to that given
func (o *UpdateDeliveryPipelineForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update delivery pipeline forbidden response
func (o *UpdateDeliveryPipelineForbidden) Code() int {
	return 403
}

func (o *UpdateDeliveryPipelineForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/delivery-pipeline/{stackName}][%d] updateDeliveryPipelineForbidden %s", 403, payload)
}

func (o *UpdateDeliveryPipelineForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/delivery-pipeline/{stackName}][%d] updateDeliveryPipelineForbidden %s", 403, payload)
}

func (o *UpdateDeliveryPipelineForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateDeliveryPipelineForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
