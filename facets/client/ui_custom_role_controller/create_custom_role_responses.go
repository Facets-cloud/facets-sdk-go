...
func (o *CreateCustomRoleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCreateCustomRoleForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateCustomRoleForbidden creates a CreateCustomRoleForbidden with default headers values
func NewCreateCustomRoleForbidden() *CreateCustomRoleForbidden {
	return &CreateCustomRoleForbidden{}
}

/*
CreateCustomRoleForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CreateCustomRoleForbidden struct {
	Payload string
}

// IsSuccess returns true when this create custom role forbidden response has a 2xx status code
func (o *CreateCustomRoleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create custom role forbidden response has a 3xx status code
func (o *CreateCustomRoleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create custom role forbidden response has a 4xx status code
func (o *CreateCustomRoleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create custom role forbidden response has a 5xx status code
func (o *CreateCustomRoleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create custom role forbidden response a status code equal to that given
func (o *CreateCustomRoleForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create custom role forbidden response
func (o *CreateCustomRoleForbidden) Code() int {
	return 403
}

func (o *CreateCustomRoleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/custom-role][%d] createCustomRoleForbidden %s", 403, payload)
}

func (o *CreateCustomRoleForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/custom-role][%d] createCustomRoleForbidden %s", 403, payload)
}

func (o *CreateCustomRoleForbidden) GetPayload() string {
	return o.Payload
}

func (o *CreateCustomRoleForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
