...
func (o *GetCustomRoleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetCustomRoleForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetCustomRoleForbidden creates a GetCustomRoleForbidden with default headers values
func NewGetCustomRoleForbidden() *GetCustomRoleForbidden {
	return &GetCustomRoleForbidden{}
}

/*
GetCustomRoleForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetCustomRoleForbidden struct {
	Payload string
}

// IsSuccess returns true when this get custom role forbidden response has a 2xx status code
func (o *GetCustomRoleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get custom role forbidden response has a 3xx status code
func (o *GetCustomRoleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get custom role forbidden response has a 4xx status code
func (o *GetCustomRoleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get custom role forbidden response has a 5xx status code
func (o *GetCustomRoleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get custom role forbidden response a status code equal to that given
func (o *GetCustomRoleForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get custom role forbidden response
func (o *GetCustomRoleForbidden) Code() int {
	return 403
}

func (o *GetCustomRoleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/custom-role/{roleName}][%d] getCustomRoleForbidden %s", 403, payload)
}

func (o *GetCustomRoleForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/custom-role/{roleName}][%d] getCustomRoleForbidden %s", 403, payload)
}

func (o *GetCustomRoleForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetCustomRoleForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
