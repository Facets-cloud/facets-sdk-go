...
func (o *GetAllRolesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllRolesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllRolesForbidden creates a GetAllRolesForbidden with default headers values
func NewGetAllRolesForbidden() *GetAllRolesForbidden {
	return &GetAllRolesForbidden{}
}

/*
GetAllRolesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllRolesForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all roles forbidden response has a 2xx status code
func (o *GetAllRolesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all roles forbidden response has a 3xx status code
func (o *GetAllRolesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all roles forbidden response has a 4xx status code
func (o *GetAllRolesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all roles forbidden response has a 5xx status code
func (o *GetAllRolesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all roles forbidden response a status code equal to that given
func (o *GetAllRolesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all roles forbidden response
func (o *GetAllRolesForbidden) Code() int {
	return 403
}

func (o *GetAllRolesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/custom-role/roles][%d] getAllRolesForbidden %s", 403, payload)
}

func (o *GetAllRolesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/custom-role/roles][%d] getAllRolesForbidden %s", 403, payload)
}

func (o *GetAllRolesForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllRolesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
