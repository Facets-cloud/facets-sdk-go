...
func (o *DeleteCustomRoleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// IsSuccess returns true when this delete custom role forbidden response has a 2xx status code
func (o *DeleteCustomRoleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete custom role forbidden response has a 3xx status code
func (o *DeleteCustomRoleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete custom role forbidden response has a 4xx status code
func (o *DeleteCustomRoleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete custom role forbidden response has a 5xx status code
func (o *DeleteCustomRoleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete custom role forbidden response a status code equal to that given
func (o *DeleteCustomRoleForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete custom role forbidden response
func (o *DeleteCustomRoleForbidden) Code() int {
	return 403
}

func (o *DeleteCustomRoleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/custom-role/{roleName}][%d] deleteCustomRoleForbidden %s", 403, payload)
}

func (o *DeleteCustomRoleForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/custom-role/{roleName}][%d] deleteCustomRoleForbidden %s", 403, payload)
}

func (o *DeleteCustomRoleForbidden) GetPayload() string {
	return o.Payload
}
