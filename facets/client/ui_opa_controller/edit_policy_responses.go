...
func (o *EditPolicyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewEditPolicyForbidden creates a EditPolicyForbidden with default headers values
func NewEditPolicyForbidden() *EditPolicyForbidden {
	return &EditPolicyForbidden{}
}

/*
EditPolicyForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type EditPolicyForbidden struct {
	Payload string
}

// IsSuccess returns true when this edit policy forbidden response has a 2xx status code
func (o *EditPolicyForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this edit policy forbidden response has a 3xx status code
func (o *EditPolicyForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this edit policy forbidden response has a 4xx status code
func (o *EditPolicyForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this edit policy forbidden response has a 5xx status code
func (o *EditPolicyForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this edit policy forbidden response a status code equal to that given
func (o *EditPolicyForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the edit policy forbidden response
func (o *EditPolicyForbidden) Code() int {
	return 403
}

func (o *EditPolicyForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/opa/{policyName}][%d] editPolicyForbidden %s", 403, payload)
}

func (o *EditPolicyForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/opa/{policyName}][%d] editPolicyForbidden %s", 403, payload)
}

func (o *EditPolicyForbidden) GetPayload() string {
	return o.Payload
}

func (o *EditPolicyForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
