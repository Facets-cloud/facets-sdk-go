...
func (o *ExecutePolicyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewExecutePolicyForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewExecutePolicyForbidden creates a ExecutePolicyForbidden with default headers values
func NewExecutePolicyForbidden() *ExecutePolicyForbidden {
	return &ExecutePolicyForbidden{}
}

/*
ExecutePolicyForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ExecutePolicyForbidden struct {
	Payload string
}

// IsSuccess returns true when this execute policy forbidden response has a 2xx status code
func (o *ExecutePolicyForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this execute policy forbidden response has a 3xx status code
func (o *ExecutePolicyForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this execute policy forbidden response has a 4xx status code
func (o *ExecutePolicyForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this execute policy forbidden response has a 5xx status code
func (o *ExecutePolicyForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this execute policy forbidden response a status code equal to that given
func (o *ExecutePolicyForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the execute policy forbidden response
func (o *ExecutePolicyForbidden) Code() int {
	return 403
}

func (o *ExecutePolicyForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/opa/{policyName}/execute][%d] executePolicyForbidden %s", 403, payload)
}

func (o *ExecutePolicyForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/opa/{policyName}/execute][%d] executePolicyForbidden %s", 403, payload)
}

func (o *ExecutePolicyForbidden) GetPayload() string {
	return o.Payload
}

func (o *ExecutePolicyForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
