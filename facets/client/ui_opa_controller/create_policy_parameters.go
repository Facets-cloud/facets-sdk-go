...
func (o *CreatePolicyParams) WithBody(body *models.OpaPolicyRequest) *CreatePolicyParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create policy params
func (o *CreatePolicyParams) SetBody(body *models.OpaPolicyRequest) {
	o.Body = body
}

// WithPolicyName adds the policyName to the create policy params
func (o *CreatePolicyParams) WithPolicyName(policyName string) *CreatePolicyParams {
	o.SetPolicyName(policyName)
	return o
}

// SetPolicyName adds the policyName to the create policy params
func (o *CreatePolicyParams) SetPolicyName(policyName string) {
