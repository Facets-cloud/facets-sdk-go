...
func (o *GetAllPoliciesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllPoliciesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllPoliciesForbidden creates a GetAllPoliciesForbidden with default headers values
func NewGetAllPoliciesForbidden() *GetAllPoliciesForbidden {
	return &GetAllPoliciesForbidden{}
}

/*
GetAllPoliciesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllPoliciesForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all policies forbidden response has a 2xx status code
func (o *GetAllPoliciesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all policies forbidden response has a 3xx status code
func (o *GetAllPoliciesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all policies forbidden response has a 4xx status code
func (o *GetAllPoliciesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all policies forbidden response has a 5xx status code
func (o *GetAllPoliciesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all policies forbidden response a status code equal to that given
func (o *GetAllPoliciesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all policies forbidden response
func (o *GetAllPoliciesForbidden) Code() int {
	return 403
}

func (o *GetAllPoliciesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/opa][%d] getAllPoliciesForbidden %s", 403, payload)
}

func (o *GetAllPoliciesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/opa][%d] getAllPoliciesForbidden %s", 403, payload)
}

func (o *GetAllPoliciesForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllPoliciesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
