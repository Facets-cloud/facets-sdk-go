...
func (o *GetPolicyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 404:
		...
		return nil, result
	case 405:
		result := NewGetPolicyMethodNotAllowed()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /cc-ui/v1/opa/{policyName}] getPolicy", response, response.Code())
	}
}
...
func (o *GetPolicyOK) Error() string {
	...
	return fmt.Sprintf("[GET /cc-ui/v1/opa/{policyName}][%d] getPolicyOK %s", 200, payload)
}
...
func (o *GetPolicyOK) GetPayload() *models.OpaPolicy {
	return o.Payload
}
...
func (o *GetPolicyBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/opa/{policyName}][%d] getPolicyBadRequest %s", 400, payload)
}
...
func (o *GetPolicyBadRequest) GetPayload() *models.ErrorDetails {
	return o.Payload
}
...
func (o *GetPolicyForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/opa/{policyName}][%d] getPolicyForbidden %s", 403, payload)
}
...
func (o *GetPolicyForbidden) GetPayload() string {
	return o.Payload
}
...
func (o *GetPolicyNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/opa/{policyName}][%d] getPolicyNotFound %s", 404, payload)
}
...
func (o *GetPolicyNotFound) GetPayload() *models.ErrorDetails {
	return o.Payload
}
...
// NewGetPolicyMethodNotAllowed creates a GetPolicyMethodNotAllowed with default headers values
func NewGetPolicyMethodNotAllowed() *GetPolicyMethodNotAllowed {
	return &GetPolicyMethodNotAllowed{}
}

/*
GetPolicyMethodNotAllowed describes a response with status code 405, with default header values.

Method Not Allowed
*/
type GetPolicyMethodNotAllowed struct {
	Payload *models.ErrorDetails
}

// IsSuccess returns true when this get policy method not allowed response has a 2xx status code
func (o *GetPolicyMethodNotAllowed) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get policy method not allowed response has a 3xx status code
func (o *GetPolicyMethodNotAllowed) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get policy method not allowed response has a 4xx status code
func (o *GetPolicyMethodNotAllowed) IsClientError() bool {
	return true
}

// IsServerError returns true when this get policy method not allowed response has a 5xx status code
func (o *GetPolicyMethodNotAllowed) IsServerError() bool {
	return false
}

// IsCode returns true when this get policy method not allowed response a status code equal to that given
func (o *GetPolicyMethodNotAllowed) IsCode(code int) bool {
	return code == 405
}

// Code gets the status code for the get policy method not allowed response
func (o *GetPolicyMethodNotAllowed) Code() int {
	return 405
}

func (o *GetPolicyMethodNotAllowed) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/opa/{policyName}][%d] getPolicyMethodNotAllowed %s", 405, payload)
}

func (o *GetPolicyMethodNotAllowed) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/opa/{policyName}][%d] getPolicyMethodNotAllowed %s", 405, payload)
}

func (o *GetPolicyMethodNotAllowed) GetPayload() *models.ErrorDetails {
	return o.Payload
}

func (o *GetPolicyMethodNotAllowed) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetPolicyInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/opa/{policyName}][%d] getPolicyInternalServerError %s", 500, payload)
}
...
func (o *GetPolicyInternalServerError) GetPayload() *models.ErrorDetails {
	return o.Payload
}
