...
func (o *GetAddOnModulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAddOnModulesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAddOnModulesForbidden creates a GetAddOnModulesForbidden with default headers values
func NewGetAddOnModulesForbidden() *GetAddOnModulesForbidden {
	return &GetAddOnModulesForbidden{}
}

/*
GetAddOnModulesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAddOnModulesForbidden struct {
	Payload string
}

// IsSuccess returns true when this get add on modules forbidden response has a 2xx status code
func (o *GetAddOnModulesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get add on modules forbidden response has a 3xx status code
func (o *GetAddOnModulesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get add on modules forbidden response has a 4xx status code
func (o *GetAddOnModulesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get add on modules forbidden response has a 5xx status code
func (o *GetAddOnModulesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get add on modules forbidden response a status code equal to that given
func (o *GetAddOnModulesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get add on modules forbidden response
func (o *GetAddOnModulesForbidden) Code() int {
	return 403
}

func (o *GetAddOnModulesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/designer/{stackName}/resourceType/{resourceType}/resourceName/{resourceName}/add-ons][%d] getAddOnModulesForbidden %s", 403, payload)
}

func (o *GetAddOnModulesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/designer/{stackName}/resourceType/{resourceType}/resourceName/{resourceName}/add-ons][%d] getAddOnModulesForbidden %s", 403, payload)
}

func (o *GetAddOnModulesForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAddOnModulesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
