...
func (o *RenameResourceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRenameResourceForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRenameResourceForbidden creates a RenameResourceForbidden with default headers values
func NewRenameResourceForbidden() *RenameResourceForbidden {
	return &RenameResourceForbidden{}
}

/*
RenameResourceForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RenameResourceForbidden struct {
	Payload string
}

// IsSuccess returns true when this rename resource forbidden response has a 2xx status code
func (o *RenameResourceForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this rename resource forbidden response has a 3xx status code
func (o *RenameResourceForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this rename resource forbidden response has a 4xx status code
func (o *RenameResourceForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this rename resource forbidden response has a 5xx status code
func (o *RenameResourceForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this rename resource forbidden response a status code equal to that given
func (o *RenameResourceForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the rename resource forbidden response
func (o *RenameResourceForbidden) Code() int {
	return 403
}

func (o *RenameResourceForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/designer/{stackName}/branch/{branch}/rename][%d] renameResourceForbidden %s", 403, payload)
}

func (o *RenameResourceForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/designer/{stackName}/branch/{branch}/rename][%d] renameResourceForbidden %s", 403, payload)
}

func (o *RenameResourceForbidden) GetPayload() string {
	return o.Payload
}

func (o *RenameResourceForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
