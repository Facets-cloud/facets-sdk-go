...
func (o *GetPullRequestsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetPullRequestsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetPullRequestsForbidden creates a GetPullRequestsForbidden with default headers values
func NewGetPullRequestsForbidden() *GetPullRequestsForbidden {
	return &GetPullRequestsForbidden{}
}

/*
GetPullRequestsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetPullRequestsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get pull requests forbidden response has a 2xx status code
func (o *GetPullRequestsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get pull requests forbidden response has a 3xx status code
func (o *GetPullRequestsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get pull requests forbidden response has a 4xx status code
func (o *GetPullRequestsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get pull requests forbidden response has a 5xx status code
func (o *GetPullRequestsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get pull requests forbidden response a status code equal to that given
func (o *GetPullRequestsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get pull requests forbidden response
func (o *GetPullRequestsForbidden) Code() int {
	return 403
}

func (o *GetPullRequestsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/designer/{stackName}/resourceType/{resourceType}/resourceName/{resourceName}/pulls][%d] getPullRequestsForbidden %s", 403, payload)
}

func (o *GetPullRequestsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/designer/{stackName}/resourceType/{resourceType}/resourceName/{resourceName}/pulls][%d] getPullRequestsForbidden %s", 403, payload)
}

func (o *GetPullRequestsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetPullRequestsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
