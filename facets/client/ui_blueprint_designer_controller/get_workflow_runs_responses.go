...
func (o *GetWorkflowRunsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetWorkflowRunsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetWorkflowRunsForbidden creates a GetWorkflowRunsForbidden with default headers values
func NewGetWorkflowRunsForbidden() *GetWorkflowRunsForbidden {
	return &GetWorkflowRunsForbidden{}
}

/*
GetWorkflowRunsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetWorkflowRunsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get workflow runs forbidden response has a 2xx status code
func (o *GetWorkflowRunsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get workflow runs forbidden response has a 3xx status code
func (o *GetWorkflowRunsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get workflow runs forbidden response has a 4xx status code
func (o *GetWorkflowRunsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get workflow runs forbidden response has a 5xx status code
func (o *GetWorkflowRunsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get workflow runs forbidden response a status code equal to that given
func (o *GetWorkflowRunsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get workflow runs forbidden response
func (o *GetWorkflowRunsForbidden) Code() int {
	return 403
}

func (o *GetWorkflowRunsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/designer/{stackName}/workflow-runs][%d] getWorkflowRunsForbidden %s", 403, payload)
}

func (o *GetWorkflowRunsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/designer/{stackName}/workflow-runs][%d] getWorkflowRunsForbidden %s", 403, payload)
}

func (o *GetWorkflowRunsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetWorkflowRunsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
