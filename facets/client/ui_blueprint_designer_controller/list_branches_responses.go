...
func (o *ListBranchesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewListBranchesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewListBranchesForbidden creates a ListBranchesForbidden with default headers values
func NewListBranchesForbidden() *ListBranchesForbidden {
	return &ListBranchesForbidden{}
}

/*
ListBranchesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ListBranchesForbidden struct {
	Payload string
}

// IsSuccess returns true when this list branches forbidden response has a 2xx status code
func (o *ListBranchesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this list branches forbidden response has a 3xx status code
func (o *ListBranchesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list branches forbidden response has a 4xx status code
func (o *ListBranchesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this list branches forbidden response has a 5xx status code
func (o *ListBranchesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this list branches forbidden response a status code equal to that given
func (o *ListBranchesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the list branches forbidden response
func (o *ListBranchesForbidden) Code() int {
	return 403
}

func (o *ListBranchesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/designer/{stackName}/resourceType/{resourceType}/resourceName/{resourceName}/branch-list][%d] listBranchesForbidden %s", 403, payload)
}

func (o *ListBranchesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/designer/{stackName}/resourceType/{resourceType}/resourceName/{resourceName}/branch-list][%d] listBranchesForbidden %s", 403, payload)
}

func (o *ListBranchesForbidden) GetPayload() string {
	return o.Payload
}

func (o *ListBranchesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
