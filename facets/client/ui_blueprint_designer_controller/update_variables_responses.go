...
func (o *UpdateVariablesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateVariablesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateVariablesForbidden creates a UpdateVariablesForbidden with default headers values
func NewUpdateVariablesForbidden() *UpdateVariablesForbidden {
	return &UpdateVariablesForbidden{}
}

/*
UpdateVariablesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateVariablesForbidden struct {
	Payload string
}

// IsSuccess returns true when this update variables forbidden response has a 2xx status code
func (o *UpdateVariablesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update variables forbidden response has a 3xx status code
func (o *UpdateVariablesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update variables forbidden response has a 4xx status code
func (o *UpdateVariablesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update variables forbidden response has a 5xx status code
func (o *UpdateVariablesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update variables forbidden response a status code equal to that given
func (o *UpdateVariablesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update variables forbidden response
func (o *UpdateVariablesForbidden) Code() int {
	return 403
}

func (o *UpdateVariablesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/designer/{stackName}/variables][%d] updateVariablesForbidden %s", 403, payload)
}

func (o *UpdateVariablesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/designer/{stackName}/variables][%d] updateVariablesForbidden %s", 403, payload)
}

func (o *UpdateVariablesForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateVariablesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
