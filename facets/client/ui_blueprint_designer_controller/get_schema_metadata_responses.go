...
func (o *GetSchemaMetadataReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetSchemaMetadataForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/designer/facets-components][%d] getSchemaMetadataForbidden %s", 403, payload)
}
...
func (o *GetSchemaMetadataForbidden) GetPayload() string {
	return o.Payload
}
