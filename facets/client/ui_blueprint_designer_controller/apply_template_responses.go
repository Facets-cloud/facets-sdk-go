...
func (o *ApplyTemplateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewApplyTemplateForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewApplyTemplateForbidden creates a ApplyTemplateForbidden with default headers values
func NewApplyTemplateForbidden() *ApplyTemplateForbidden {
	return &ApplyTemplateForbidden{}
}

/*
ApplyTemplateForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ApplyTemplateForbidden struct {
	Payload string
}

// IsSuccess returns true when this apply template forbidden response has a 2xx status code
func (o *ApplyTemplateForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this apply template forbidden response has a 3xx status code
func (o *ApplyTemplateForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this apply template forbidden response has a 4xx status code
func (o *ApplyTemplateForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this apply template forbidden response has a 5xx status code
func (o *ApplyTemplateForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this apply template forbidden response a status code equal to that given
func (o *ApplyTemplateForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the apply template forbidden response
func (o *ApplyTemplateForbidden) Code() int {
	return 403
}

func (o *ApplyTemplateForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/designer/{stackName}/{templateName}/apply][%d] applyTemplateForbidden %s", 403, payload)
}

func (o *ApplyTemplateForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/designer/{stackName}/{templateName}/apply][%d] applyTemplateForbidden %s", 403, payload)
}

func (o *ApplyTemplateForbidden) GetPayload() string {
	return o.Payload
}

func (o *ApplyTemplateForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
