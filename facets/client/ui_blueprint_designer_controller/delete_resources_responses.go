...
func (o *DeleteResourcesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteResourcesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteResourcesForbidden creates a DeleteResourcesForbidden with default headers values
func NewDeleteResourcesForbidden() *DeleteResourcesForbidden {
	return &DeleteResourcesForbidden{}
}

/*
DeleteResourcesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteResourcesForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete resources forbidden response has a 2xx status code
func (o *DeleteResourcesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete resources forbidden response has a 3xx status code
func (o *DeleteResourcesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete resources forbidden response has a 4xx status code
func (o *DeleteResourcesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete resources forbidden response has a 5xx status code
func (o *DeleteResourcesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete resources forbidden response a status code equal to that given
func (o *DeleteResourcesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete resources forbidden response
func (o *DeleteResourcesForbidden) Code() int {
	return 403
}

func (o *DeleteResourcesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/designer/{stackName}/branch/{branch}][%d] deleteResourcesForbidden %s", 403, payload)
}

func (o *DeleteResourcesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/designer/{stackName}/branch/{branch}][%d] deleteResourcesForbidden %s", 403, payload)
}

func (o *DeleteResourcesForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteResourcesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
