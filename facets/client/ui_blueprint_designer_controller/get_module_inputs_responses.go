...
func (o *GetModuleInputsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetModuleInputsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetModuleInputsForbidden creates a GetModuleInputsForbidden with default headers values
func NewGetModuleInputsForbidden() *GetModuleInputsForbidden {
	return &GetModuleInputsForbidden{}
}

/*
GetModuleInputsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetModuleInputsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get module inputs forbidden response has a 2xx status code
func (o *GetModuleInputsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get module inputs forbidden response has a 3xx status code
func (o *GetModuleInputsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get module inputs forbidden response has a 4xx status code
func (o *GetModuleInputsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get module inputs forbidden response has a 5xx status code
func (o *GetModuleInputsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get module inputs forbidden response a status code equal to that given
func (o *GetModuleInputsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get module inputs forbidden response
func (o *GetModuleInputsForbidden) Code() int {
	return 403
}

func (o *GetModuleInputsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/designer/{stackName}/intent/{intent}/flavor/{flavor}/input][%d] getModuleInputsForbidden %s", 403, payload)
}

func (o *GetModuleInputsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/designer/{stackName}/intent/{intent}/flavor/{flavor}/input][%d] getModuleInputsForbidden %s", 403, payload)
}

func (o *GetModuleInputsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetModuleInputsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
