...
func (o *CreateBranchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCreateBranchForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateBranchForbidden creates a CreateBranchForbidden with default headers values
func NewCreateBranchForbidden() *CreateBranchForbidden {
	return &CreateBranchForbidden{}
}

/*
CreateBranchForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CreateBranchForbidden struct {
	Payload string
}

// IsSuccess returns true when this create branch forbidden response has a 2xx status code
func (o *CreateBranchForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create branch forbidden response has a 3xx status code
func (o *CreateBranchForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create branch forbidden response has a 4xx status code
func (o *CreateBranchForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create branch forbidden response has a 5xx status code
func (o *CreateBranchForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create branch forbidden response a status code equal to that given
func (o *CreateBranchForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create branch forbidden response
func (o *CreateBranchForbidden) Code() int {
	return 403
}

func (o *CreateBranchForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/designer/{stackName}/{branch}/create-branch][%d] createBranchForbidden %s", 403, payload)
}

func (o *CreateBranchForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/designer/{stackName}/{branch}/create-branch][%d] createBranchForbidden %s", 403, payload)
}

func (o *CreateBranchForbidden) GetPayload() string {
	return o.Payload
}

func (o *CreateBranchForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
