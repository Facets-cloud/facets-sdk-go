...
type ClientService interface {
	...
	BulkEditInheritFromBaseForResources(params *BulkEditInheritFromBaseForResourcesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*BulkEditInheritFromBaseForResourcesOK, error)
	...
	GetAllVariableUsages(params *GetAllVariableUsagesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAllVariableUsagesOK, error)
	...
	GetVariableUsages(params *GetVariableUsagesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetVariableUsagesOK, error)
	...
	UpdateMustacheResources(params *UpdateMustacheResourcesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateMustacheResourcesOK, error)
...
/*
BulkEditInheritFromBaseForResources bulk edit inherit from base for resources API
*/
func (a *Client) BulkEditInheritFromBaseForResources(params *BulkEditInheritFromBaseForResourcesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*BulkEditInheritFromBaseForResourcesOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewBulkEditInheritFromBaseForResourcesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "bulkEditInheritFromBaseForResources",
		Method:             "PUT",
		PathPattern:        "/cc-ui/v1/designer/{stackName}/branch/{branch}/resource-inherit-from-base",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &BulkEditInheritFromBaseForResourcesReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*BulkEditInheritFromBaseForResourcesOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for bulkEditInheritFromBaseForResources: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
GetAllVariableUsages gets usages of all secrets and variables for a stack

Returns which resources reference each secret and variable defined in the stack
*/
func (a *Client) GetAllVariableUsages(params *GetAllVariableUsagesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAllVariableUsagesOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewGetAllVariableUsagesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getAllVariableUsages",
		Method:             "GET",
		PathPattern:        "/cc-ui/v1/designer/{stackName}/variables/usages",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetAllVariableUsagesReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*GetAllVariableUsagesOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getAllVariableUsages: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
GetVariableUsages gets usages of a specific secret or variable

Returns which resources reference the given secret or variable at stack and environment level
*/
func (a *Client) GetVariableUsages(params *GetVariableUsagesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetVariableUsagesOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewGetVariableUsagesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getVariableUsages",
		Method:             "GET",
		PathPattern:        "/cc-ui/v1/designer/{stackName}/variables/{variableName}/usages",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetVariableUsagesReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*GetVariableUsagesOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getVariableUsages: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
UpdateMustacheResources updates resources with mustache templates

Updates resource files with mustache template content. Replaces .json files with .mustache files.
*/
func (a *Client) UpdateMustacheResources(params *UpdateMustacheResourcesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateMustacheResourcesOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewUpdateMustacheResourcesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "updateMustacheResources",
		Method:             "PUT",
		PathPattern:        "/cc-ui/v1/designer/{stackName}/branch/{branch}/mustache",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &UpdateMustacheResourcesReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*UpdateMustacheResourcesOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for updateMustacheResources: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
