...
func (o *UpdateResourcesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateResourcesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateResourcesForbidden creates a UpdateResourcesForbidden with default headers values
func NewUpdateResourcesForbidden() *UpdateResourcesForbidden {
	return &UpdateResourcesForbidden{}
}

/*
UpdateResourcesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateResourcesForbidden struct {
	Payload string
}

// IsSuccess returns true when this update resources forbidden response has a 2xx status code
func (o *UpdateResourcesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update resources forbidden response has a 3xx status code
func (o *UpdateResourcesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update resources forbidden response has a 4xx status code
func (o *UpdateResourcesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update resources forbidden response has a 5xx status code
func (o *UpdateResourcesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update resources forbidden response a status code equal to that given
func (o *UpdateResourcesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update resources forbidden response
func (o *UpdateResourcesForbidden) Code() int {
	return 403
}

func (o *UpdateResourcesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/designer/{stackName}/branch/{branch}][%d] updateResourcesForbidden %s", 403, payload)
}

func (o *UpdateResourcesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/designer/{stackName}/branch/{branch}][%d] updateResourcesForbidden %s", 403, payload)
}

func (o *UpdateResourcesForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateResourcesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
