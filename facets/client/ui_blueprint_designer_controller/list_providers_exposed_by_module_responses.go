...
func (o *ListProvidersExposedByModuleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewListProvidersExposedByModuleForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewListProvidersExposedByModuleForbidden creates a ListProvidersExposedByModuleForbidden with default headers values
func NewListProvidersExposedByModuleForbidden() *ListProvidersExposedByModuleForbidden {
	return &ListProvidersExposedByModuleForbidden{}
}

/*
ListProvidersExposedByModuleForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ListProvidersExposedByModuleForbidden struct {
	Payload string
}

// IsSuccess returns true when this list providers exposed by module forbidden response has a 2xx status code
func (o *ListProvidersExposedByModuleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this list providers exposed by module forbidden response has a 3xx status code
func (o *ListProvidersExposedByModuleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list providers exposed by module forbidden response has a 4xx status code
func (o *ListProvidersExposedByModuleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this list providers exposed by module forbidden response has a 5xx status code
func (o *ListProvidersExposedByModuleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this list providers exposed by module forbidden response a status code equal to that given
func (o *ListProvidersExposedByModuleForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the list providers exposed by module forbidden response
func (o *ListProvidersExposedByModuleForbidden) Code() int {
	return 403
}

func (o *ListProvidersExposedByModuleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/designer/{stackName}/intent/{intent}/flavor/{flavor}/output-providers][%d] listProvidersExposedByModuleForbidden %s", 403, payload)
}

func (o *ListProvidersExposedByModuleForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/designer/{stackName}/intent/{intent}/flavor/{flavor}/output-providers][%d] listProvidersExposedByModuleForbidden %s", 403, payload)
}

func (o *ListProvidersExposedByModuleForbidden) GetPayload() string {
	return o.Payload
}

func (o *ListProvidersExposedByModuleForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
