...
func (o *DeleteVariablesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteVariablesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteVariablesForbidden creates a DeleteVariablesForbidden with default headers values
func NewDeleteVariablesForbidden() *DeleteVariablesForbidden {
	return &DeleteVariablesForbidden{}
}

/*
DeleteVariablesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteVariablesForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete variables forbidden response has a 2xx status code
func (o *DeleteVariablesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete variables forbidden response has a 3xx status code
func (o *DeleteVariablesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete variables forbidden response has a 4xx status code
func (o *DeleteVariablesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete variables forbidden response has a 5xx status code
func (o *DeleteVariablesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete variables forbidden response a status code equal to that given
func (o *DeleteVariablesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete variables forbidden response
func (o *DeleteVariablesForbidden) Code() int {
	return 403
}

func (o *DeleteVariablesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/designer/{stackName}/variables][%d] deleteVariablesForbidden %s", 403, payload)
}

func (o *DeleteVariablesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/designer/{stackName}/variables][%d] deleteVariablesForbidden %s", 403, payload)
}

func (o *DeleteVariablesForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteVariablesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
