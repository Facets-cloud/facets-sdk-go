...
func (o *BuySupportPlanReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewBuySupportPlanForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewBuySupportPlanForbidden creates a BuySupportPlanForbidden with default headers values
func NewBuySupportPlanForbidden() *BuySupportPlanForbidden {
	return &BuySupportPlanForbidden{}
}

/*
BuySupportPlanForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type BuySupportPlanForbidden struct {
	Payload string
}

// IsSuccess returns true when this buy support plan forbidden response has a 2xx status code
func (o *BuySupportPlanForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this buy support plan forbidden response has a 3xx status code
func (o *BuySupportPlanForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this buy support plan forbidden response has a 4xx status code
func (o *BuySupportPlanForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this buy support plan forbidden response has a 5xx status code
func (o *BuySupportPlanForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this buy support plan forbidden response a status code equal to that given
func (o *BuySupportPlanForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the buy support plan forbidden response
func (o *BuySupportPlanForbidden) Code() int {
	return 403
}

func (o *BuySupportPlanForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/billing/buy-support-plan][%d] buySupportPlanForbidden %s", 403, payload)
}

func (o *BuySupportPlanForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/billing/buy-support-plan][%d] buySupportPlanForbidden %s", 403, payload)
}

func (o *BuySupportPlanForbidden) GetPayload() string {
	return o.Payload
}

func (o *BuySupportPlanForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
