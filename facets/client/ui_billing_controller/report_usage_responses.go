...
func (o *ReportUsageReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewReportUsageForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewReportUsageForbidden creates a ReportUsageForbidden with default headers values
func NewReportUsageForbidden() *ReportUsageForbidden {
	return &ReportUsageForbidden{}
}

/*
ReportUsageForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ReportUsageForbidden struct {
	Payload string
}

// IsSuccess returns true when this report usage forbidden response has a 2xx status code
func (o *ReportUsageForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this report usage forbidden response has a 3xx status code
func (o *ReportUsageForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this report usage forbidden response has a 4xx status code
func (o *ReportUsageForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this report usage forbidden response has a 5xx status code
func (o *ReportUsageForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this report usage forbidden response a status code equal to that given
func (o *ReportUsageForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the report usage forbidden response
func (o *ReportUsageForbidden) Code() int {
	return 403
}

func (o *ReportUsageForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/billing/report-usage][%d] reportUsageForbidden %s", 403, payload)
}

func (o *ReportUsageForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/billing/report-usage][%d] reportUsageForbidden %s", 403, payload)
}

func (o *ReportUsageForbidden) GetPayload() string {
	return o.Payload
}

func (o *ReportUsageForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
