...
func (o *StartStripeCustomerPortalSessionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewStartStripeCustomerPortalSessionForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewStartStripeCustomerPortalSessionForbidden creates a StartStripeCustomerPortalSessionForbidden with default headers values
func NewStartStripeCustomerPortalSessionForbidden() *StartStripeCustomerPortalSessionForbidden {
	return &StartStripeCustomerPortalSessionForbidden{}
}

/*
StartStripeCustomerPortalSessionForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type StartStripeCustomerPortalSessionForbidden struct {
	Payload string
}

// IsSuccess returns true when this start stripe customer portal session forbidden response has a 2xx status code
func (o *StartStripeCustomerPortalSessionForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this start stripe customer portal session forbidden response has a 3xx status code
func (o *StartStripeCustomerPortalSessionForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this start stripe customer portal session forbidden response has a 4xx status code
func (o *StartStripeCustomerPortalSessionForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this start stripe customer portal session forbidden response has a 5xx status code
func (o *StartStripeCustomerPortalSessionForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this start stripe customer portal session forbidden response a status code equal to that given
func (o *StartStripeCustomerPortalSessionForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the start stripe customer portal session forbidden response
func (o *StartStripeCustomerPortalSessionForbidden) Code() int {
	return 403
}

func (o *StartStripeCustomerPortalSessionForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/billing/manage-billing][%d] startStripeCustomerPortalSessionForbidden %s", 403, payload)
}

func (o *StartStripeCustomerPortalSessionForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/billing/manage-billing][%d] startStripeCustomerPortalSessionForbidden %s", 403, payload)
}

func (o *StartStripeCustomerPortalSessionForbidden) GetPayload() string {
	return o.Payload
}

func (o *StartStripeCustomerPortalSessionForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
