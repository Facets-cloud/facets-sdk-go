...
func (o *GetBillingMetadataReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetBillingMetadataForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetBillingMetadataForbidden creates a GetBillingMetadataForbidden with default headers values
func NewGetBillingMetadataForbidden() *GetBillingMetadataForbidden {
	return &GetBillingMetadataForbidden{}
}

/*
GetBillingMetadataForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetBillingMetadataForbidden struct {
	Payload string
}

// IsSuccess returns true when this get billing metadata forbidden response has a 2xx status code
func (o *GetBillingMetadataForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get billing metadata forbidden response has a 3xx status code
func (o *GetBillingMetadataForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get billing metadata forbidden response has a 4xx status code
func (o *GetBillingMetadataForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get billing metadata forbidden response has a 5xx status code
func (o *GetBillingMetadataForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get billing metadata forbidden response a status code equal to that given
func (o *GetBillingMetadataForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get billing metadata forbidden response
func (o *GetBillingMetadataForbidden) Code() int {
	return 403
}

func (o *GetBillingMetadataForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/billing/metadata][%d] getBillingMetadataForbidden %s", 403, payload)
}

func (o *GetBillingMetadataForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/billing/metadata][%d] getBillingMetadataForbidden %s", 403, payload)
}

func (o *GetBillingMetadataForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetBillingMetadataForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
