...
func (o *GetResourceStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetResourceStatusForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetResourceStatusForbidden creates a GetResourceStatusForbidden with default headers values
func NewGetResourceStatusForbidden() *GetResourceStatusForbidden {
	return &GetResourceStatusForbidden{}
}

/*
GetResourceStatusForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetResourceStatusForbidden struct {
	Payload string
}

// IsSuccess returns true when this get resource status forbidden response has a 2xx status code
func (o *GetResourceStatusForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get resource status forbidden response has a 3xx status code
func (o *GetResourceStatusForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get resource status forbidden response has a 4xx status code
func (o *GetResourceStatusForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get resource status forbidden response has a 5xx status code
func (o *GetResourceStatusForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get resource status forbidden response a status code equal to that given
func (o *GetResourceStatusForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get resource status forbidden response
func (o *GetResourceStatusForbidden) Code() int {
	return 403
}

func (o *GetResourceStatusForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/resources/{projectName}/{environmentName}/status][%d] getResourceStatusForbidden %s", 403, payload)
}

func (o *GetResourceStatusForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/resources/{projectName}/{environmentName}/status][%d] getResourceStatusForbidden %s", 403, payload)
}

func (o *GetResourceStatusForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetResourceStatusForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
