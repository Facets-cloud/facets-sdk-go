...
func (o *SyncResourceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewSyncResourceForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSyncResourceForbidden creates a SyncResourceForbidden with default headers values
func NewSyncResourceForbidden() *SyncResourceForbidden {
	return &SyncResourceForbidden{}
}

/*
SyncResourceForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type SyncResourceForbidden struct {
	Payload string
}

// IsSuccess returns true when this sync resource forbidden response has a 2xx status code
func (o *SyncResourceForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this sync resource forbidden response has a 3xx status code
func (o *SyncResourceForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this sync resource forbidden response has a 4xx status code
func (o *SyncResourceForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this sync resource forbidden response has a 5xx status code
func (o *SyncResourceForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this sync resource forbidden response a status code equal to that given
func (o *SyncResourceForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the sync resource forbidden response
func (o *SyncResourceForbidden) Code() int {
	return 403
}

func (o *SyncResourceForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/resources/sync][%d] syncResourceForbidden %s", 403, payload)
}

func (o *SyncResourceForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/resources/sync][%d] syncResourceForbidden %s", 403, payload)
}

func (o *SyncResourceForbidden) GetPayload() string {
	return o.Payload
}

func (o *SyncResourceForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
