...
func (o *GetNamespacesInUseByDependentClustersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetNamespacesInUseByDependentClustersForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetNamespacesInUseByDependentClustersForbidden creates a GetNamespacesInUseByDependentClustersForbidden with default headers values
func NewGetNamespacesInUseByDependentClustersForbidden() *GetNamespacesInUseByDependentClustersForbidden {
	return &GetNamespacesInUseByDependentClustersForbidden{}
}

/*
GetNamespacesInUseByDependentClustersForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetNamespacesInUseByDependentClustersForbidden struct {
	Payload string
}

// IsSuccess returns true when this get namespaces in use by dependent clusters forbidden response has a 2xx status code
func (o *GetNamespacesInUseByDependentClustersForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get namespaces in use by dependent clusters forbidden response has a 3xx status code
func (o *GetNamespacesInUseByDependentClustersForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get namespaces in use by dependent clusters forbidden response has a 4xx status code
func (o *GetNamespacesInUseByDependentClustersForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get namespaces in use by dependent clusters forbidden response has a 5xx status code
func (o *GetNamespacesInUseByDependentClustersForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get namespaces in use by dependent clusters forbidden response a status code equal to that given
func (o *GetNamespacesInUseByDependentClustersForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get namespaces in use by dependent clusters forbidden response
func (o *GetNamespacesInUseByDependentClustersForbidden) Code() int {
	return 403
}

func (o *GetNamespacesInUseByDependentClustersForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/resources/{baseClusterId}/base-env-in-use-namespaces][%d] getNamespacesInUseByDependentClustersForbidden %s", 403, payload)
}

func (o *GetNamespacesInUseByDependentClustersForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/resources/{baseClusterId}/base-env-in-use-namespaces][%d] getNamespacesInUseByDependentClustersForbidden %s", 403, payload)
}

func (o *GetNamespacesInUseByDependentClustersForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetNamespacesInUseByDependentClustersForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
