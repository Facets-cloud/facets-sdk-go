...
func (o *GetReleasePreviewReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetReleasePreviewForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetReleasePreviewForbidden creates a GetReleasePreviewForbidden with default headers values
func NewGetReleasePreviewForbidden() *GetReleasePreviewForbidden {
	return &GetReleasePreviewForbidden{}
}

/*
GetReleasePreviewForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetReleasePreviewForbidden struct {
	Payload string
}

// IsSuccess returns true when this get release preview forbidden response has a 2xx status code
func (o *GetReleasePreviewForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get release preview forbidden response has a 3xx status code
func (o *GetReleasePreviewForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get release preview forbidden response has a 4xx status code
func (o *GetReleasePreviewForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get release preview forbidden response has a 5xx status code
func (o *GetReleasePreviewForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get release preview forbidden response a status code equal to that given
func (o *GetReleasePreviewForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get release preview forbidden response
func (o *GetReleasePreviewForbidden) Code() int {
	return 403
}

func (o *GetReleasePreviewForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/resources/{clusterId}/release-preview][%d] getReleasePreviewForbidden %s", 403, payload)
}

func (o *GetReleasePreviewForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/resources/{clusterId}/release-preview][%d] getReleasePreviewForbidden %s", 403, payload)
}

func (o *GetReleasePreviewForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetReleasePreviewForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
