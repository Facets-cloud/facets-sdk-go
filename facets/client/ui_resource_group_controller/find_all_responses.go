...
func (o *FindAllReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewFindAllForbidden creates a FindAllForbidden with default headers values
func NewFindAllForbidden() *FindAllForbidden {
	return &FindAllForbidden{}
}

/*
FindAllForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type FindAllForbidden struct {
	Payload string
}

// IsSuccess returns true when this find all forbidden response has a 2xx status code
func (o *FindAllForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this find all forbidden response has a 3xx status code
func (o *FindAllForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this find all forbidden response has a 4xx status code
func (o *FindAllForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this find all forbidden response has a 5xx status code
func (o *FindAllForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this find all forbidden response a status code equal to that given
func (o *FindAllForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the find all forbidden response
func (o *FindAllForbidden) Code() int {
	return 403
}

func (o *FindAllForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/resource-groups][%d] findAllForbidden %s", 403, payload)
}

func (o *FindAllForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/resource-groups][%d] findAllForbidden %s", 403, payload)
}

func (o *FindAllForbidden) GetPayload() string {
	return o.Payload
}

func (o *FindAllForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
