...
func (o *UpdateAllResourcesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateAllResourcesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateAllResourcesForbidden creates a UpdateAllResourcesForbidden with default headers values
func NewUpdateAllResourcesForbidden() *UpdateAllResourcesForbidden {
	return &UpdateAllResourcesForbidden{}
}

/*
UpdateAllResourcesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateAllResourcesForbidden struct {
	Payload string
}

// IsSuccess returns true when this update all resources forbidden response has a 2xx status code
func (o *UpdateAllResourcesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update all resources forbidden response has a 3xx status code
func (o *UpdateAllResourcesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update all resources forbidden response has a 4xx status code
func (o *UpdateAllResourcesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update all resources forbidden response has a 5xx status code
func (o *UpdateAllResourcesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update all resources forbidden response a status code equal to that given
func (o *UpdateAllResourcesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update all resources forbidden response
func (o *UpdateAllResourcesForbidden) Code() int {
	return 403
}

func (o *UpdateAllResourcesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/resource-groups/{resourceGroupId}/resources][%d] updateAllResourcesForbidden %s", 403, payload)
}

func (o *UpdateAllResourcesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/resource-groups/{resourceGroupId}/resources][%d] updateAllResourcesForbidden %s", 403, payload)
}

func (o *UpdateAllResourcesForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateAllResourcesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
