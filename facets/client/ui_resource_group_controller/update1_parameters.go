...
type Update1Params struct {
	...
	// Body.
	Body *models.ResourceGroupRequest
...
func (o *Update1Params) WithBody(body *models.ResourceGroupRequest) *Update1Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update 1 params
func (o *Update1Params) SetBody(body *models.ResourceGroupRequest) {
	o.Body = body
}

// WithResourceGroupID adds the resourceGroupID to the update 1 params
func (o *Update1Params) WithResourceGroupID(resourceGroupID string) *Update1Params {
	o.SetResourceGroupID(resourceGroupID)
	return o
}

// SetResourceGroupID adds the resourceGroupId to the update 1 params
func (o *Update1Params) SetResourceGroupID(resourceGroupID string) {
