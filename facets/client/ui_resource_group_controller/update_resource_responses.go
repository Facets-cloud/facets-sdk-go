...
// Code gets the status code for the update resource forbidden response
func (o *UpdateResourceForbidden) Code() int {
	return 403
}

func (o *UpdateResourceForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /cc-ui/v1/resource-groups/{resourceGroupId}/resources][%d] updateResourceForbidden %s", 403, payload)
}
...
func (o *UpdateResourceForbidden) GetPayload() string {
	return o.Payload
}
