...
func (o *GetResourceGroupsForSessionUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetResourceGroupsForSessionUserForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetResourceGroupsForSessionUserForbidden creates a GetResourceGroupsForSessionUserForbidden with default headers values
func NewGetResourceGroupsForSessionUserForbidden() *GetResourceGroupsForSessionUserForbidden {
	return &GetResourceGroupsForSessionUserForbidden{}
}

/*
GetResourceGroupsForSessionUserForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetResourceGroupsForSessionUserForbidden struct {
	Payload string
}

// IsSuccess returns true when this get resource groups for session user forbidden response has a 2xx status code
func (o *GetResourceGroupsForSessionUserForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get resource groups for session user forbidden response has a 3xx status code
func (o *GetResourceGroupsForSessionUserForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get resource groups for session user forbidden response has a 4xx status code
func (o *GetResourceGroupsForSessionUserForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get resource groups for session user forbidden response has a 5xx status code
func (o *GetResourceGroupsForSessionUserForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get resource groups for session user forbidden response a status code equal to that given
func (o *GetResourceGroupsForSessionUserForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get resource groups for session user forbidden response
func (o *GetResourceGroupsForSessionUserForbidden) Code() int {
	return 403
}

func (o *GetResourceGroupsForSessionUserForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/resource-groups/me][%d] getResourceGroupsForSessionUserForbidden %s", 403, payload)
}

func (o *GetResourceGroupsForSessionUserForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/resource-groups/me][%d] getResourceGroupsForSessionUserForbidden %s", 403, payload)
}

func (o *GetResourceGroupsForSessionUserForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetResourceGroupsForSessionUserForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
