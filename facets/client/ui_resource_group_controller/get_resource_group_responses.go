...
func (o *GetResourceGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the get resource group forbidden response
func (o *GetResourceGroupForbidden) Code() int {
	return 403
}

func (o *GetResourceGroupForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/resource-groups/{resourceGroupId}][%d] getResourceGroupForbidden %s", 403, payload)
}
...
func (o *GetResourceGroupForbidden) GetPayload() string {
	return o.Payload
}
