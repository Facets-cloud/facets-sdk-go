...
// WithResourceGroupID adds the resourceGroupID to the delete 1 params
func (o *Delete1Params) WithResourceGroupID(resourceGroupID string) *Delete1Params {
	o.SetResourceGroupID(resourceGroupID)
	return o
}

// SetResourceGroupID adds the resourceGroupId to the delete 1 params
func (o *Delete1Params) SetResourceGroupID(resourceGroupID string) {
