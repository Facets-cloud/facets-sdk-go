...
func (o *MarkAsPublishedByIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewMarkAsPublishedByIDForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewMarkAsPublishedByIDForbidden creates a MarkAsPublishedByIDForbidden with default headers values
func NewMarkAsPublishedByIDForbidden() *MarkAsPublishedByIDForbidden {
	return &MarkAsPublishedByIDForbidden{}
}

/*
MarkAsPublishedByIDForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type MarkAsPublishedByIDForbidden struct {
	Payload string
}

// IsSuccess returns true when this mark as published by Id forbidden response has a 2xx status code
func (o *MarkAsPublishedByIDForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this mark as published by Id forbidden response has a 3xx status code
func (o *MarkAsPublishedByIDForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this mark as published by Id forbidden response has a 4xx status code
func (o *MarkAsPublishedByIDForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this mark as published by Id forbidden response has a 5xx status code
func (o *MarkAsPublishedByIDForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this mark as published by Id forbidden response a status code equal to that given
func (o *MarkAsPublishedByIDForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the mark as published by Id forbidden response
func (o *MarkAsPublishedByIDForbidden) Code() int {
	return 403
}

func (o *MarkAsPublishedByIDForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/modules/{id}/mark-published][%d] markAsPublishedByIdForbidden %s", 403, payload)
}

func (o *MarkAsPublishedByIDForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/modules/{id}/mark-published][%d] markAsPublishedByIdForbidden %s", 403, payload)
}

func (o *MarkAsPublishedByIDForbidden) GetPayload() string {
	return o.Payload
}

func (o *MarkAsPublishedByIDForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
