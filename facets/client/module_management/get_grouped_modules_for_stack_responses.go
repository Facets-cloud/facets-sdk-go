...
func (o *GetGroupedModulesForStackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetGroupedModulesForStackForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetGroupedModulesForStackForbidden creates a GetGroupedModulesForStackForbidden with default headers values
func NewGetGroupedModulesForStackForbidden() *GetGroupedModulesForStackForbidden {
	return &GetGroupedModulesForStackForbidden{}
}

/*
GetGroupedModulesForStackForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetGroupedModulesForStackForbidden struct {
	Payload string
}

// IsSuccess returns true when this get grouped modules for stack forbidden response has a 2xx status code
func (o *GetGroupedModulesForStackForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get grouped modules for stack forbidden response has a 3xx status code
func (o *GetGroupedModulesForStackForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get grouped modules for stack forbidden response has a 4xx status code
func (o *GetGroupedModulesForStackForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get grouped modules for stack forbidden response has a 5xx status code
func (o *GetGroupedModulesForStackForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get grouped modules for stack forbidden response a status code equal to that given
func (o *GetGroupedModulesForStackForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get grouped modules for stack forbidden response
func (o *GetGroupedModulesForStackForbidden) Code() int {
	return 403
}

func (o *GetGroupedModulesForStackForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules/stack/{stackName}/grouped][%d] getGroupedModulesForStackForbidden %s", 403, payload)
}

func (o *GetGroupedModulesForStackForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules/stack/{stackName}/grouped][%d] getGroupedModulesForStackForbidden %s", 403, payload)
}

func (o *GetGroupedModulesForStackForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetGroupedModulesForStackForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
