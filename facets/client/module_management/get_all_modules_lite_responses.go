...
func (o *GetAllModulesLiteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllModulesLiteForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllModulesLiteForbidden creates a GetAllModulesLiteForbidden with default headers values
func NewGetAllModulesLiteForbidden() *GetAllModulesLiteForbidden {
	return &GetAllModulesLiteForbidden{}
}

/*
GetAllModulesLiteForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllModulesLiteForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all modules lite forbidden response has a 2xx status code
func (o *GetAllModulesLiteForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all modules lite forbidden response has a 3xx status code
func (o *GetAllModulesLiteForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all modules lite forbidden response has a 4xx status code
func (o *GetAllModulesLiteForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all modules lite forbidden response has a 5xx status code
func (o *GetAllModulesLiteForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all modules lite forbidden response a status code equal to that given
func (o *GetAllModulesLiteForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all modules lite forbidden response
func (o *GetAllModulesLiteForbidden) Code() int {
	return 403
}

func (o *GetAllModulesLiteForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules/modules-lite][%d] getAllModulesLiteForbidden %s", 403, payload)
}

func (o *GetAllModulesLiteForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules/modules-lite][%d] getAllModulesLiteForbidden %s", 403, payload)
}

func (o *GetAllModulesLiteForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllModulesLiteForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
