...
func (o *MarkAsPublishedReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewMarkAsPublishedForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewMarkAsPublishedForbidden creates a MarkAsPublishedForbidden with default headers values
func NewMarkAsPublishedForbidden() *MarkAsPublishedForbidden {
	return &MarkAsPublishedForbidden{}
}

/*
MarkAsPublishedForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type MarkAsPublishedForbidden struct {
	Payload string
}

// IsSuccess returns true when this mark as published forbidden response has a 2xx status code
func (o *MarkAsPublishedForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this mark as published forbidden response has a 3xx status code
func (o *MarkAsPublishedForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this mark as published forbidden response has a 4xx status code
func (o *MarkAsPublishedForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this mark as published forbidden response has a 5xx status code
func (o *MarkAsPublishedForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this mark as published forbidden response a status code equal to that given
func (o *MarkAsPublishedForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the mark as published forbidden response
func (o *MarkAsPublishedForbidden) Code() int {
	return 403
}

func (o *MarkAsPublishedForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/modules/intent/{intent}/flavor/{flavor}/version/{version}/mark-published][%d] markAsPublishedForbidden %s", 403, payload)
}

func (o *MarkAsPublishedForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/modules/intent/{intent}/flavor/{flavor}/version/{version}/mark-published][%d] markAsPublishedForbidden %s", 403, payload)
}

func (o *MarkAsPublishedForbidden) GetPayload() string {
	return o.Payload
}

func (o *MarkAsPublishedForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
