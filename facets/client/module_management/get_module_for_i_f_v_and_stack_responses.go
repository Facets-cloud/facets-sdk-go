...
func (o *GetModuleForIFVAndStackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetModuleForIFVAndStackForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetModuleForIFVAndStackForbidden creates a GetModuleForIFVAndStackForbidden with default headers values
func NewGetModuleForIFVAndStackForbidden() *GetModuleForIFVAndStackForbidden {
	return &GetModuleForIFVAndStackForbidden{}
}

/*
GetModuleForIFVAndStackForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetModuleForIFVAndStackForbidden struct {
	Payload string
}

// IsSuccess returns true when this get module for i f v and stack forbidden response has a 2xx status code
func (o *GetModuleForIFVAndStackForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get module for i f v and stack forbidden response has a 3xx status code
func (o *GetModuleForIFVAndStackForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get module for i f v and stack forbidden response has a 4xx status code
func (o *GetModuleForIFVAndStackForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get module for i f v and stack forbidden response has a 5xx status code
func (o *GetModuleForIFVAndStackForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get module for i f v and stack forbidden response a status code equal to that given
func (o *GetModuleForIFVAndStackForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get module for i f v and stack forbidden response
func (o *GetModuleForIFVAndStackForbidden) Code() int {
	return 403
}

func (o *GetModuleForIFVAndStackForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules/stack/{stackName}/{intent}/{flavor}/{version}/module][%d] getModuleForIFVAndStackForbidden %s", 403, payload)
}

func (o *GetModuleForIFVAndStackForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules/stack/{stackName}/{intent}/{flavor}/{version}/module][%d] getModuleForIFVAndStackForbidden %s", 403, payload)
}

func (o *GetModuleForIFVAndStackForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetModuleForIFVAndStackForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
