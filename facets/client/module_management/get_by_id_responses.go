...
func (o *GetByIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// IsSuccess returns true when this get by Id forbidden response has a 2xx status code
func (o *GetByIDForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get by Id forbidden response has a 3xx status code
func (o *GetByIDForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get by Id forbidden response has a 4xx status code
func (o *GetByIDForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get by Id forbidden response has a 5xx status code
func (o *GetByIDForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get by Id forbidden response a status code equal to that given
func (o *GetByIDForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get by Id forbidden response
...
func (o *GetByIDForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules/{id}][%d] getByIdForbidden %s", 403, payload)
}
...
func (o *GetByIDForbidden) GetPayload() string {
	return o.Payload
}
