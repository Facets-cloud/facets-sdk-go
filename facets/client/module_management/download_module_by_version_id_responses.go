...
func (o *DownloadModuleByVersionIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDownloadModuleByVersionIDForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDownloadModuleByVersionIDForbidden creates a DownloadModuleByVersionIDForbidden with default headers values
func NewDownloadModuleByVersionIDForbidden() *DownloadModuleByVersionIDForbidden {
	return &DownloadModuleByVersionIDForbidden{}
}

/*
DownloadModuleByVersionIDForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DownloadModuleByVersionIDForbidden struct {
	Payload string
}

// IsSuccess returns true when this download module by version Id forbidden response has a 2xx status code
func (o *DownloadModuleByVersionIDForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this download module by version Id forbidden response has a 3xx status code
func (o *DownloadModuleByVersionIDForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this download module by version Id forbidden response has a 4xx status code
func (o *DownloadModuleByVersionIDForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this download module by version Id forbidden response has a 5xx status code
func (o *DownloadModuleByVersionIDForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this download module by version Id forbidden response a status code equal to that given
func (o *DownloadModuleByVersionIDForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the download module by version Id forbidden response
func (o *DownloadModuleByVersionIDForbidden) Code() int {
	return 403
}

func (o *DownloadModuleByVersionIDForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules/version/{versionId}/download][%d] downloadModuleByVersionIdForbidden %s", 403, payload)
}

func (o *DownloadModuleByVersionIDForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules/version/{versionId}/download][%d] downloadModuleByVersionIdForbidden %s", 403, payload)
}

func (o *DownloadModuleByVersionIDForbidden) GetPayload() string {
	return o.Payload
}

func (o *DownloadModuleByVersionIDForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
