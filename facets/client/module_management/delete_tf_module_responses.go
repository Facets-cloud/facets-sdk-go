...
func (o *DeleteTfModuleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteTfModuleForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteTfModuleForbidden creates a DeleteTfModuleForbidden with default headers values
func NewDeleteTfModuleForbidden() *DeleteTfModuleForbidden {
	return &DeleteTfModuleForbidden{}
}

/*
DeleteTfModuleForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteTfModuleForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete tf module forbidden response has a 2xx status code
func (o *DeleteTfModuleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete tf module forbidden response has a 3xx status code
func (o *DeleteTfModuleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete tf module forbidden response has a 4xx status code
func (o *DeleteTfModuleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete tf module forbidden response has a 5xx status code
func (o *DeleteTfModuleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete tf module forbidden response a status code equal to that given
func (o *DeleteTfModuleForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete tf module forbidden response
func (o *DeleteTfModuleForbidden) Code() int {
	return 403
}

func (o *DeleteTfModuleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/modules/{id}][%d] deleteTfModuleForbidden %s", 403, payload)
}

func (o *DeleteTfModuleForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/modules/{id}][%d] deleteTfModuleForbidden %s", 403, payload)
}

func (o *DeleteTfModuleForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteTfModuleForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
