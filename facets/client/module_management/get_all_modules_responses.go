...
func (o *GetAllModulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllModulesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllModulesForbidden creates a GetAllModulesForbidden with default headers values
func NewGetAllModulesForbidden() *GetAllModulesForbidden {
	return &GetAllModulesForbidden{}
}

/*
GetAllModulesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllModulesForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all modules forbidden response has a 2xx status code
func (o *GetAllModulesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all modules forbidden response has a 3xx status code
func (o *GetAllModulesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all modules forbidden response has a 4xx status code
func (o *GetAllModulesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all modules forbidden response has a 5xx status code
func (o *GetAllModulesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all modules forbidden response a status code equal to that given
func (o *GetAllModulesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all modules forbidden response
func (o *GetAllModulesForbidden) Code() int {
	return 403
}

func (o *GetAllModulesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules][%d] getAllModulesForbidden %s", 403, payload)
}

func (o *GetAllModulesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules][%d] getAllModulesForbidden %s", 403, payload)
}

func (o *GetAllModulesForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllModulesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
