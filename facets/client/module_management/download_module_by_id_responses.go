...
func (o *DownloadModuleByIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDownloadModuleByIDForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDownloadModuleByIDForbidden creates a DownloadModuleByIDForbidden with default headers values
func NewDownloadModuleByIDForbidden() *DownloadModuleByIDForbidden {
	return &DownloadModuleByIDForbidden{}
}

/*
DownloadModuleByIDForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DownloadModuleByIDForbidden struct {
	Payload string
}

// IsSuccess returns true when this download module by Id forbidden response has a 2xx status code
func (o *DownloadModuleByIDForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this download module by Id forbidden response has a 3xx status code
func (o *DownloadModuleByIDForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this download module by Id forbidden response has a 4xx status code
func (o *DownloadModuleByIDForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this download module by Id forbidden response has a 5xx status code
func (o *DownloadModuleByIDForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this download module by Id forbidden response a status code equal to that given
func (o *DownloadModuleByIDForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the download module by Id forbidden response
func (o *DownloadModuleByIDForbidden) Code() int {
	return 403
}

func (o *DownloadModuleByIDForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules/{id}/download][%d] downloadModuleByIdForbidden %s", 403, payload)
}

func (o *DownloadModuleByIDForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules/{id}/download][%d] downloadModuleByIdForbidden %s", 403, payload)
}

func (o *DownloadModuleByIDForbidden) GetPayload() string {
	return o.Payload
}

func (o *DownloadModuleByIDForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
