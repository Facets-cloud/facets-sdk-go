...
func (o *UploadModuleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUploadModuleForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUploadModuleForbidden creates a UploadModuleForbidden with default headers values
func NewUploadModuleForbidden() *UploadModuleForbidden {
	return &UploadModuleForbidden{}
}

/*
UploadModuleForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UploadModuleForbidden struct {
	Payload string
}

// IsSuccess returns true when this upload module forbidden response has a 2xx status code
func (o *UploadModuleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this upload module forbidden response has a 3xx status code
func (o *UploadModuleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this upload module forbidden response has a 4xx status code
func (o *UploadModuleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this upload module forbidden response has a 5xx status code
func (o *UploadModuleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this upload module forbidden response a status code equal to that given
func (o *UploadModuleForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the upload module forbidden response
func (o *UploadModuleForbidden) Code() int {
	return 403
}

func (o *UploadModuleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/modules/upload][%d] uploadModuleForbidden %s", 403, payload)
}

func (o *UploadModuleForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/modules/upload][%d] uploadModuleForbidden %s", 403, payload)
}

func (o *UploadModuleForbidden) GetPayload() string {
	return o.Payload
}

func (o *UploadModuleForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
