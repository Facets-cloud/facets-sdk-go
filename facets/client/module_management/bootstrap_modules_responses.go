...
func (o *BootstrapModulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewBootstrapModulesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewBootstrapModulesForbidden creates a BootstrapModulesForbidden with default headers values
func NewBootstrapModulesForbidden() *BootstrapModulesForbidden {
	return &BootstrapModulesForbidden{}
}

/*
BootstrapModulesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type BootstrapModulesForbidden struct {
	Payload string
}

// IsSuccess returns true when this bootstrap modules forbidden response has a 2xx status code
func (o *BootstrapModulesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this bootstrap modules forbidden response has a 3xx status code
func (o *BootstrapModulesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this bootstrap modules forbidden response has a 4xx status code
func (o *BootstrapModulesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this bootstrap modules forbidden response has a 5xx status code
func (o *BootstrapModulesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this bootstrap modules forbidden response a status code equal to that given
func (o *BootstrapModulesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the bootstrap modules forbidden response
func (o *BootstrapModulesForbidden) Code() int {
	return 403
}

func (o *BootstrapModulesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/modules/bootstrap][%d] bootstrapModulesForbidden %s", 403, payload)
}

func (o *BootstrapModulesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/modules/bootstrap][%d] bootstrapModulesForbidden %s", 403, payload)
}

func (o *BootstrapModulesForbidden) GetPayload() string {
	return o.Payload
}

func (o *BootstrapModulesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
