...
/*
	...
	- **Description:** Retrieves all add-on modules based on stack, intent and flavor, optionally by cloud.
...
func (a *Client) GetIntentAddOnModules(params *GetIntentAddOnModulesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetIntentAddOnModulesOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/cc-ui/v1/modules/{stackName}/intent/{intent}/flavor/{flavor}/add-ons",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
