...
func (o *GetAll2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewGetAll2Forbidden creates a GetAll2Forbidden with default headers values
func NewGetAll2Forbidden() *GetAll2Forbidden {
	return &GetAll2Forbidden{}
}

/*
GetAll2Forbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAll2Forbidden struct {
	Payload string
}

// IsSuccess returns true when this get all2 forbidden response has a 2xx status code
func (o *GetAll2Forbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all2 forbidden response has a 3xx status code
func (o *GetAll2Forbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all2 forbidden response has a 4xx status code
func (o *GetAll2Forbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all2 forbidden response has a 5xx status code
func (o *GetAll2Forbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all2 forbidden response a status code equal to that given
func (o *GetAll2Forbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all2 forbidden response
func (o *GetAll2Forbidden) Code() int {
	return 403
}

func (o *GetAll2Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules/all][%d] getAll2Forbidden %s", 403, payload)
}

func (o *GetAll2Forbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules/all][%d] getAll2Forbidden %s", 403, payload)
}

func (o *GetAll2Forbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAll2Forbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
