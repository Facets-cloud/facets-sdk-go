...
func (o *GetModuleUsagesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetModuleUsagesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetModuleUsagesForbidden creates a GetModuleUsagesForbidden with default headers values
func NewGetModuleUsagesForbidden() *GetModuleUsagesForbidden {
	return &GetModuleUsagesForbidden{}
}

/*
GetModuleUsagesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetModuleUsagesForbidden struct {
	Payload string
}

// IsSuccess returns true when this get module usages forbidden response has a 2xx status code
func (o *GetModuleUsagesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get module usages forbidden response has a 3xx status code
func (o *GetModuleUsagesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get module usages forbidden response has a 4xx status code
func (o *GetModuleUsagesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get module usages forbidden response has a 5xx status code
func (o *GetModuleUsagesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get module usages forbidden response a status code equal to that given
func (o *GetModuleUsagesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get module usages forbidden response
func (o *GetModuleUsagesForbidden) Code() int {
	return 403
}

func (o *GetModuleUsagesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules/{id}/usages][%d] getModuleUsagesForbidden %s", 403, payload)
}

func (o *GetModuleUsagesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/modules/{id}/usages][%d] getModuleUsagesForbidden %s", 403, payload)
}

func (o *GetModuleUsagesForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetModuleUsagesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
