...
func (o *GetAllSettingsForEntityReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllSettingsForEntityForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllSettingsForEntityForbidden creates a GetAllSettingsForEntityForbidden with default headers values
func NewGetAllSettingsForEntityForbidden() *GetAllSettingsForEntityForbidden {
	return &GetAllSettingsForEntityForbidden{}
}

/*
GetAllSettingsForEntityForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllSettingsForEntityForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all settings for entity forbidden response has a 2xx status code
func (o *GetAllSettingsForEntityForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all settings for entity forbidden response has a 3xx status code
func (o *GetAllSettingsForEntityForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all settings for entity forbidden response has a 4xx status code
func (o *GetAllSettingsForEntityForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all settings for entity forbidden response has a 5xx status code
func (o *GetAllSettingsForEntityForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all settings for entity forbidden response a status code equal to that given
func (o *GetAllSettingsForEntityForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all settings for entity forbidden response
func (o *GetAllSettingsForEntityForbidden) Code() int {
	return 403
}

func (o *GetAllSettingsForEntityForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/settings/entity/{entity}][%d] getAllSettingsForEntityForbidden %s", 403, payload)
}

func (o *GetAllSettingsForEntityForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/settings/entity/{entity}][%d] getAllSettingsForEntityForbidden %s", 403, payload)
}

func (o *GetAllSettingsForEntityForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllSettingsForEntityForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
