...
func (o *SetOnboardingDisplayReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewSetOnboardingDisplayForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSetOnboardingDisplayForbidden creates a SetOnboardingDisplayForbidden with default headers values
func NewSetOnboardingDisplayForbidden() *SetOnboardingDisplayForbidden {
	return &SetOnboardingDisplayForbidden{}
}

/*
SetOnboardingDisplayForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type SetOnboardingDisplayForbidden struct {
	Payload string
}

// IsSuccess returns true when this set onboarding display forbidden response has a 2xx status code
func (o *SetOnboardingDisplayForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this set onboarding display forbidden response has a 3xx status code
func (o *SetOnboardingDisplayForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this set onboarding display forbidden response has a 4xx status code
func (o *SetOnboardingDisplayForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this set onboarding display forbidden response has a 5xx status code
func (o *SetOnboardingDisplayForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this set onboarding display forbidden response a status code equal to that given
func (o *SetOnboardingDisplayForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the set onboarding display forbidden response
func (o *SetOnboardingDisplayForbidden) Code() int {
	return 403
}

func (o *SetOnboardingDisplayForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/settings/onboarding-display/{value}][%d] setOnboardingDisplayForbidden %s", 403, payload)
}

func (o *SetOnboardingDisplayForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/settings/onboarding-display/{value}][%d] setOnboardingDisplayForbidden %s", 403, payload)
}

func (o *SetOnboardingDisplayForbidden) GetPayload() string {
	return o.Payload
}

func (o *SetOnboardingDisplayForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
