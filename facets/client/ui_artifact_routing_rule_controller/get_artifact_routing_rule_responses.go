...
func (o *GetArtifactRoutingRuleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetArtifactRoutingRuleForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetArtifactRoutingRuleForbidden creates a GetArtifactRoutingRuleForbidden with default headers values
func NewGetArtifactRoutingRuleForbidden() *GetArtifactRoutingRuleForbidden {
	return &GetArtifactRoutingRuleForbidden{}
}

/*
GetArtifactRoutingRuleForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetArtifactRoutingRuleForbidden struct {
	Payload string
}

// IsSuccess returns true when this get artifact routing rule forbidden response has a 2xx status code
func (o *GetArtifactRoutingRuleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get artifact routing rule forbidden response has a 3xx status code
func (o *GetArtifactRoutingRuleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get artifact routing rule forbidden response has a 4xx status code
func (o *GetArtifactRoutingRuleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get artifact routing rule forbidden response has a 5xx status code
func (o *GetArtifactRoutingRuleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get artifact routing rule forbidden response a status code equal to that given
func (o *GetArtifactRoutingRuleForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get artifact routing rule forbidden response
func (o *GetArtifactRoutingRuleForbidden) Code() int {
	return 403
}

func (o *GetArtifactRoutingRuleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifact-routing-rule/{ruleId}][%d] getArtifactRoutingRuleForbidden %s", 403, payload)
}

func (o *GetArtifactRoutingRuleForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifact-routing-rule/{ruleId}][%d] getArtifactRoutingRuleForbidden %s", 403, payload)
}

func (o *GetArtifactRoutingRuleForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetArtifactRoutingRuleForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
