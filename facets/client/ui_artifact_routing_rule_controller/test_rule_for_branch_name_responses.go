...
func (o *TestRuleForBranchNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewTestRuleForBranchNameForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTestRuleForBranchNameForbidden creates a TestRuleForBranchNameForbidden with default headers values
func NewTestRuleForBranchNameForbidden() *TestRuleForBranchNameForbidden {
	return &TestRuleForBranchNameForbidden{}
}

/*
TestRuleForBranchNameForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type TestRuleForBranchNameForbidden struct {
	Payload string
}

// IsSuccess returns true when this test rule for branch name forbidden response has a 2xx status code
func (o *TestRuleForBranchNameForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this test rule for branch name forbidden response has a 3xx status code
func (o *TestRuleForBranchNameForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this test rule for branch name forbidden response has a 4xx status code
func (o *TestRuleForBranchNameForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this test rule for branch name forbidden response has a 5xx status code
func (o *TestRuleForBranchNameForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this test rule for branch name forbidden response a status code equal to that given
func (o *TestRuleForBranchNameForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the test rule for branch name forbidden response
func (o *TestRuleForBranchNameForbidden) Code() int {
	return 403
}

func (o *TestRuleForBranchNameForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifact-routing-rule/test][%d] testRuleForBranchNameForbidden %s", 403, payload)
}

func (o *TestRuleForBranchNameForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/artifact-routing-rule/test][%d] testRuleForBranchNameForbidden %s", 403, payload)
}

func (o *TestRuleForBranchNameForbidden) GetPayload() string {
	return o.Payload
}

func (o *TestRuleForBranchNameForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
