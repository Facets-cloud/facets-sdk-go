...
func (o *GetAllArtifactRoutingRulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllArtifactRoutingRulesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllArtifactRoutingRulesForbidden creates a GetAllArtifactRoutingRulesForbidden with default headers values
func NewGetAllArtifactRoutingRulesForbidden() *GetAllArtifactRoutingRulesForbidden {
	return &GetAllArtifactRoutingRulesForbidden{}
}

/*
GetAllArtifactRoutingRulesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllArtifactRoutingRulesForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all artifact routing rules forbidden response has a 2xx status code
func (o *GetAllArtifactRoutingRulesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all artifact routing rules forbidden response has a 3xx status code
func (o *GetAllArtifactRoutingRulesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all artifact routing rules forbidden response has a 4xx status code
func (o *GetAllArtifactRoutingRulesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all artifact routing rules forbidden response has a 5xx status code
func (o *GetAllArtifactRoutingRulesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all artifact routing rules forbidden response a status code equal to that given
func (o *GetAllArtifactRoutingRulesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all artifact routing rules forbidden response
func (o *GetAllArtifactRoutingRulesForbidden) Code() int {
	return 403
}

func (o *GetAllArtifactRoutingRulesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifact-routing-rule][%d] getAllArtifactRoutingRulesForbidden %s", 403, payload)
}

func (o *GetAllArtifactRoutingRulesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/artifact-routing-rule][%d] getAllArtifactRoutingRulesForbidden %s", 403, payload)
}

func (o *GetAllArtifactRoutingRulesForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllArtifactRoutingRulesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
