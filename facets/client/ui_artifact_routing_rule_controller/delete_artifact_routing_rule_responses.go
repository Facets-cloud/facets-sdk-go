...
func (o *DeleteArtifactRoutingRuleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteArtifactRoutingRuleForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteArtifactRoutingRuleForbidden creates a DeleteArtifactRoutingRuleForbidden with default headers values
func NewDeleteArtifactRoutingRuleForbidden() *DeleteArtifactRoutingRuleForbidden {
	return &DeleteArtifactRoutingRuleForbidden{}
}

/*
DeleteArtifactRoutingRuleForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteArtifactRoutingRuleForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete artifact routing rule forbidden response has a 2xx status code
func (o *DeleteArtifactRoutingRuleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete artifact routing rule forbidden response has a 3xx status code
func (o *DeleteArtifactRoutingRuleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete artifact routing rule forbidden response has a 4xx status code
func (o *DeleteArtifactRoutingRuleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete artifact routing rule forbidden response has a 5xx status code
func (o *DeleteArtifactRoutingRuleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete artifact routing rule forbidden response a status code equal to that given
func (o *DeleteArtifactRoutingRuleForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete artifact routing rule forbidden response
func (o *DeleteArtifactRoutingRuleForbidden) Code() int {
	return 403
}

func (o *DeleteArtifactRoutingRuleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/artifact-routing-rule/{ruleId}][%d] deleteArtifactRoutingRuleForbidden %s", 403, payload)
}

func (o *DeleteArtifactRoutingRuleForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/artifact-routing-rule/{ruleId}][%d] deleteArtifactRoutingRuleForbidden %s", 403, payload)
}

func (o *DeleteArtifactRoutingRuleForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteArtifactRoutingRuleForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
