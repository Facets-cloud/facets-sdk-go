...
func (o *UpdateArtifactRoutingRuleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateArtifactRoutingRuleForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateArtifactRoutingRuleForbidden creates a UpdateArtifactRoutingRuleForbidden with default headers values
func NewUpdateArtifactRoutingRuleForbidden() *UpdateArtifactRoutingRuleForbidden {
	return &UpdateArtifactRoutingRuleForbidden{}
}

/*
UpdateArtifactRoutingRuleForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateArtifactRoutingRuleForbidden struct {
	Payload string
}

// IsSuccess returns true when this update artifact routing rule forbidden response has a 2xx status code
func (o *UpdateArtifactRoutingRuleForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update artifact routing rule forbidden response has a 3xx status code
func (o *UpdateArtifactRoutingRuleForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update artifact routing rule forbidden response has a 4xx status code
func (o *UpdateArtifactRoutingRuleForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update artifact routing rule forbidden response has a 5xx status code
func (o *UpdateArtifactRoutingRuleForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update artifact routing rule forbidden response a status code equal to that given
func (o *UpdateArtifactRoutingRuleForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update artifact routing rule forbidden response
func (o *UpdateArtifactRoutingRuleForbidden) Code() int {
	return 403
}

func (o *UpdateArtifactRoutingRuleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/artifact-routing-rule][%d] updateArtifactRoutingRuleForbidden %s", 403, payload)
}

func (o *UpdateArtifactRoutingRuleForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/artifact-routing-rule][%d] updateArtifactRoutingRuleForbidden %s", 403, payload)
}

func (o *UpdateArtifactRoutingRuleForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateArtifactRoutingRuleForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
