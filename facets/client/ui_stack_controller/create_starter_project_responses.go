...
func (o *CreateStarterProjectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCreateStarterProjectForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateStarterProjectForbidden creates a CreateStarterProjectForbidden with default headers values
func NewCreateStarterProjectForbidden() *CreateStarterProjectForbidden {
	return &CreateStarterProjectForbidden{}
}

/*
CreateStarterProjectForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CreateStarterProjectForbidden struct {
	Payload string
}

// IsSuccess returns true when this create starter project forbidden response has a 2xx status code
func (o *CreateStarterProjectForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create starter project forbidden response has a 3xx status code
func (o *CreateStarterProjectForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create starter project forbidden response has a 4xx status code
func (o *CreateStarterProjectForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create starter project forbidden response has a 5xx status code
func (o *CreateStarterProjectForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create starter project forbidden response a status code equal to that given
func (o *CreateStarterProjectForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create starter project forbidden response
func (o *CreateStarterProjectForbidden) Code() int {
	return 403
}

func (o *CreateStarterProjectForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/stacks/starter-project][%d] createStarterProjectForbidden %s", 403, payload)
}

func (o *CreateStarterProjectForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/stacks/starter-project][%d] createStarterProjectForbidden %s", 403, payload)
}

func (o *CreateStarterProjectForbidden) GetPayload() string {
	return o.Payload
}

func (o *CreateStarterProjectForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
