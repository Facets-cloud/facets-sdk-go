...
// WithStackName adds the stackName to the get all subscriptions params
func (o *GetAllSubscriptionsParams) WithStackName(stackName string) *GetAllSubscriptionsParams {
	o.SetStackName(stackName)
	return o
}

// SetStackName adds the stackName to the get all subscriptions params
func (o *GetAllSubscriptionsParams) SetStackName(stackName string) {
