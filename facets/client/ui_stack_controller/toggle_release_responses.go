...
func (o *ToggleReleaseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewToggleReleaseForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewToggleReleaseForbidden creates a ToggleReleaseForbidden with default headers values
func NewToggleReleaseForbidden() *ToggleReleaseForbidden {
	return &ToggleReleaseForbidden{}
}

/*
ToggleReleaseForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ToggleReleaseForbidden struct {
	Payload string
}

// IsSuccess returns true when this toggle release forbidden response has a 2xx status code
func (o *ToggleReleaseForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this toggle release forbidden response has a 3xx status code
func (o *ToggleReleaseForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this toggle release forbidden response has a 4xx status code
func (o *ToggleReleaseForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this toggle release forbidden response has a 5xx status code
func (o *ToggleReleaseForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this toggle release forbidden response a status code equal to that given
func (o *ToggleReleaseForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the toggle release forbidden response
func (o *ToggleReleaseForbidden) Code() int {
	return 403
}

func (o *ToggleReleaseForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/stacks/{stackName}/toggleRelease][%d] toggleReleaseForbidden %s", 403, payload)
}

func (o *ToggleReleaseForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/stacks/{stackName}/toggleRelease][%d] toggleReleaseForbidden %s", 403, payload)
}

func (o *ToggleReleaseForbidden) GetPayload() string {
	return o.Payload
}

func (o *ToggleReleaseForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
