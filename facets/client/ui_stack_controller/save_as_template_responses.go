...
func (o *SaveAsTemplateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewSaveAsTemplateForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSaveAsTemplateForbidden creates a SaveAsTemplateForbidden with default headers values
func NewSaveAsTemplateForbidden() *SaveAsTemplateForbidden {
	return &SaveAsTemplateForbidden{}
}

/*
SaveAsTemplateForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type SaveAsTemplateForbidden struct {
	Payload string
}

// IsSuccess returns true when this save as template forbidden response has a 2xx status code
func (o *SaveAsTemplateForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this save as template forbidden response has a 3xx status code
func (o *SaveAsTemplateForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this save as template forbidden response has a 4xx status code
func (o *SaveAsTemplateForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this save as template forbidden response has a 5xx status code
func (o *SaveAsTemplateForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this save as template forbidden response a status code equal to that given
func (o *SaveAsTemplateForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the save as template forbidden response
func (o *SaveAsTemplateForbidden) Code() int {
	return 403
}

func (o *SaveAsTemplateForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/stacks/{stackName}/template][%d] saveAsTemplateForbidden %s", 403, payload)
}

func (o *SaveAsTemplateForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/stacks/{stackName}/template][%d] saveAsTemplateForbidden %s", 403, payload)
}

func (o *SaveAsTemplateForbidden) GetPayload() string {
	return o.Payload
}

func (o *SaveAsTemplateForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
