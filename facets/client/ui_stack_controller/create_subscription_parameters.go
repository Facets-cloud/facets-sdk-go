...
func (o *CreateSubscriptionParams) WithBody(body *models.Subscription) *CreateSubscriptionParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create subscription params
func (o *CreateSubscriptionParams) SetBody(body *models.Subscription) {
	o.Body = body
}

// WithStackName adds the stackName to the create subscription params
func (o *CreateSubscriptionParams) WithStackName(stackName string) *CreateSubscriptionParams {
	o.SetStackName(stackName)
	return o
}

// SetStackName adds the stackName to the create subscription params
func (o *CreateSubscriptionParams) SetStackName(stackName string) {
