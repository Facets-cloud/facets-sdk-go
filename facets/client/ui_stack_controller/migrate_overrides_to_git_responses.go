...
func (o *MigrateOverridesToGitReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewMigrateOverridesToGitForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewMigrateOverridesToGitForbidden creates a MigrateOverridesToGitForbidden with default headers values
func NewMigrateOverridesToGitForbidden() *MigrateOverridesToGitForbidden {
	return &MigrateOverridesToGitForbidden{}
}

/*
MigrateOverridesToGitForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type MigrateOverridesToGitForbidden struct {
	Payload string
}

// IsSuccess returns true when this migrate overrides to git forbidden response has a 2xx status code
func (o *MigrateOverridesToGitForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this migrate overrides to git forbidden response has a 3xx status code
func (o *MigrateOverridesToGitForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this migrate overrides to git forbidden response has a 4xx status code
func (o *MigrateOverridesToGitForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this migrate overrides to git forbidden response has a 5xx status code
func (o *MigrateOverridesToGitForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this migrate overrides to git forbidden response a status code equal to that given
func (o *MigrateOverridesToGitForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the migrate overrides to git forbidden response
func (o *MigrateOverridesToGitForbidden) Code() int {
	return 403
}

func (o *MigrateOverridesToGitForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/migrate-overrides][%d] migrateOverridesToGitForbidden %s", 403, payload)
}

func (o *MigrateOverridesToGitForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/migrate-overrides][%d] migrateOverridesToGitForbidden %s", 403, payload)
}

func (o *MigrateOverridesToGitForbidden) GetPayload() string {
	return o.Payload
}

func (o *MigrateOverridesToGitForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
