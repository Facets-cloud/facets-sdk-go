...
func (o *GetAllSubscriptionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllSubscriptionsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllSubscriptionsForbidden creates a GetAllSubscriptionsForbidden with default headers values
func NewGetAllSubscriptionsForbidden() *GetAllSubscriptionsForbidden {
	return &GetAllSubscriptionsForbidden{}
}

/*
GetAllSubscriptionsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllSubscriptionsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all subscriptions forbidden response has a 2xx status code
func (o *GetAllSubscriptionsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all subscriptions forbidden response has a 3xx status code
func (o *GetAllSubscriptionsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all subscriptions forbidden response has a 4xx status code
func (o *GetAllSubscriptionsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all subscriptions forbidden response has a 5xx status code
func (o *GetAllSubscriptionsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all subscriptions forbidden response a status code equal to that given
func (o *GetAllSubscriptionsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all subscriptions forbidden response
func (o *GetAllSubscriptionsForbidden) Code() int {
	return 403
}

func (o *GetAllSubscriptionsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/notification/subscriptions][%d] getAllSubscriptionsForbidden %s", 403, payload)
}

func (o *GetAllSubscriptionsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/notification/subscriptions][%d] getAllSubscriptionsForbidden %s", 403, payload)
}

func (o *GetAllSubscriptionsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllSubscriptionsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
