...
func (o *GetApplicationListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetApplicationListForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetApplicationListForbidden creates a GetApplicationListForbidden with default headers values
func NewGetApplicationListForbidden() *GetApplicationListForbidden {
	return &GetApplicationListForbidden{}
}

/*
GetApplicationListForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetApplicationListForbidden struct {
	Payload string
}

// IsSuccess returns true when this get application list forbidden response has a 2xx status code
func (o *GetApplicationListForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get application list forbidden response has a 3xx status code
func (o *GetApplicationListForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get application list forbidden response has a 4xx status code
func (o *GetApplicationListForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get application list forbidden response has a 5xx status code
func (o *GetApplicationListForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get application list forbidden response a status code equal to that given
func (o *GetApplicationListForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get application list forbidden response
func (o *GetApplicationListForbidden) Code() int {
	return 403
}

func (o *GetApplicationListForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/{resourceType}/][%d] getApplicationListForbidden %s", 403, payload)
}

func (o *GetApplicationListForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/{resourceType}/][%d] getApplicationListForbidden %s", 403, payload)
}

func (o *GetApplicationListForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetApplicationListForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
