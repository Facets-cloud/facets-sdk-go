...
func (o *SyncStackWithGitReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewSyncStackWithGitForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSyncStackWithGitForbidden creates a SyncStackWithGitForbidden with default headers values
func NewSyncStackWithGitForbidden() *SyncStackWithGitForbidden {
	return &SyncStackWithGitForbidden{}
}

/*
SyncStackWithGitForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type SyncStackWithGitForbidden struct {
	Payload string
}

// IsSuccess returns true when this sync stack with git forbidden response has a 2xx status code
func (o *SyncStackWithGitForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this sync stack with git forbidden response has a 3xx status code
func (o *SyncStackWithGitForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this sync stack with git forbidden response has a 4xx status code
func (o *SyncStackWithGitForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this sync stack with git forbidden response has a 5xx status code
func (o *SyncStackWithGitForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this sync stack with git forbidden response a status code equal to that given
func (o *SyncStackWithGitForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the sync stack with git forbidden response
func (o *SyncStackWithGitForbidden) Code() int {
	return 403
}

func (o *SyncStackWithGitForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/sync-with-git][%d] syncStackWithGitForbidden %s", 403, payload)
}

func (o *SyncStackWithGitForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/sync-with-git][%d] syncStackWithGitForbidden %s", 403, payload)
}

func (o *SyncStackWithGitForbidden) GetPayload() string {
	return o.Payload
}

func (o *SyncStackWithGitForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
