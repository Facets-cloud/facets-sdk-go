...
func (o *DeleteStackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
/*
DeleteStackForbidden describes a response with status code 403, with default header values.
...
// IsSuccess returns true when this delete stack forbidden response has a 2xx status code
func (o *DeleteStackForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete stack forbidden response has a 3xx status code
func (o *DeleteStackForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete stack forbidden response has a 4xx status code
func (o *DeleteStackForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete stack forbidden response has a 5xx status code
func (o *DeleteStackForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete stack forbidden response a status code equal to that given
func (o *DeleteStackForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete stack forbidden response
func (o *DeleteStackForbidden) Code() int {
	return 403
}

func (o *DeleteStackForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/stacks/{stackName}][%d] deleteStackForbidden %s", 403, payload)
}

func (o *DeleteStackForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/stacks/{stackName}][%d] deleteStackForbidden %s", 403, payload)
}

func (o *DeleteStackForbidden) GetPayload() string {
	return o.Payload
}
