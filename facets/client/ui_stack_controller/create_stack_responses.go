...
func (o *CreateStackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
/*
CreateStackForbidden describes a response with status code 403, with default header values.
...
// IsSuccess returns true when this create stack forbidden response has a 2xx status code
func (o *CreateStackForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create stack forbidden response has a 3xx status code
func (o *CreateStackForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create stack forbidden response has a 4xx status code
func (o *CreateStackForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create stack forbidden response has a 5xx status code
func (o *CreateStackForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create stack forbidden response a status code equal to that given
func (o *CreateStackForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create stack forbidden response
func (o *CreateStackForbidden) Code() int {
	return 403
}

func (o *CreateStackForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/stacks/][%d] createStackForbidden %s", 403, payload)
}

func (o *CreateStackForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/stacks/][%d] createStackForbidden %s", 403, payload)
}

func (o *CreateStackForbidden) GetPayload() string {
	return o.Payload
}
