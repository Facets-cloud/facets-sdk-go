...
func (o *GetAllClustersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllClustersForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllClustersForbidden creates a GetAllClustersForbidden with default headers values
func NewGetAllClustersForbidden() *GetAllClustersForbidden {
	return &GetAllClustersForbidden{}
}

/*
GetAllClustersForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllClustersForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all clusters forbidden response has a 2xx status code
func (o *GetAllClustersForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all clusters forbidden response has a 3xx status code
func (o *GetAllClustersForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all clusters forbidden response has a 4xx status code
func (o *GetAllClustersForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all clusters forbidden response has a 5xx status code
func (o *GetAllClustersForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all clusters forbidden response a status code equal to that given
func (o *GetAllClustersForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all clusters forbidden response
func (o *GetAllClustersForbidden) Code() int {
	return 403
}

func (o *GetAllClustersForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/clusters][%d] getAllClustersForbidden %s", 403, payload)
}

func (o *GetAllClustersForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/clusters][%d] getAllClustersForbidden %s", 403, payload)
}

func (o *GetAllClustersForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllClustersForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
