...
func (o *GetApplicationOK) GetPayload() map[string]any {
	return o.Payload
}
...
func (o *GetApplicationForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/{resourceType}/{appName}][%d] getApplicationForbidden %s", 403, payload)
}
...
func (o *GetApplicationForbidden) GetPayload() string {
	return o.Payload
}
