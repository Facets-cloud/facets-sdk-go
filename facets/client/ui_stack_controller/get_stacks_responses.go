...
func (o *GetStacksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
/*
GetStacksForbidden describes a response with status code 403, with default header values.
...
// IsSuccess returns true when this get stacks forbidden response has a 2xx status code
func (o *GetStacksForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get stacks forbidden response has a 3xx status code
func (o *GetStacksForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get stacks forbidden response has a 4xx status code
func (o *GetStacksForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get stacks forbidden response has a 5xx status code
func (o *GetStacksForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get stacks forbidden response a status code equal to that given
func (o *GetStacksForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get stacks forbidden response
func (o *GetStacksForbidden) Code() int {
	return 403
}

func (o *GetStacksForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/][%d] getStacksForbidden %s", 403, payload)
}

func (o *GetStacksForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/][%d] getStacksForbidden %s", 403, payload)
}

func (o *GetStacksForbidden) GetPayload() string {
	return o.Payload
}
