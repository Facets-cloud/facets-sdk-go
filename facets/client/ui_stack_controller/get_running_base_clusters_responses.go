...
func (o *GetRunningBaseClustersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetRunningBaseClustersForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetRunningBaseClustersForbidden creates a GetRunningBaseClustersForbidden with default headers values
func NewGetRunningBaseClustersForbidden() *GetRunningBaseClustersForbidden {
	return &GetRunningBaseClustersForbidden{}
}

/*
GetRunningBaseClustersForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetRunningBaseClustersForbidden struct {
	Payload string
}

// IsSuccess returns true when this get running base clusters forbidden response has a 2xx status code
func (o *GetRunningBaseClustersForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get running base clusters forbidden response has a 3xx status code
func (o *GetRunningBaseClustersForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get running base clusters forbidden response has a 4xx status code
func (o *GetRunningBaseClustersForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get running base clusters forbidden response has a 5xx status code
func (o *GetRunningBaseClustersForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get running base clusters forbidden response a status code equal to that given
func (o *GetRunningBaseClustersForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get running base clusters forbidden response
func (o *GetRunningBaseClustersForbidden) Code() int {
	return 403
}

func (o *GetRunningBaseClustersForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/running-base-clusters][%d] getRunningBaseClustersForbidden %s", 403, payload)
}

func (o *GetRunningBaseClustersForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/running-base-clusters][%d] getRunningBaseClustersForbidden %s", 403, payload)
}

func (o *GetRunningBaseClustersForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetRunningBaseClustersForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
