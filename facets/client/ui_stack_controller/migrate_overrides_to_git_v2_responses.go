...
func (o *MigrateOverridesToGitV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewMigrateOverridesToGitV2Forbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewMigrateOverridesToGitV2Forbidden creates a MigrateOverridesToGitV2Forbidden with default headers values
func NewMigrateOverridesToGitV2Forbidden() *MigrateOverridesToGitV2Forbidden {
	return &MigrateOverridesToGitV2Forbidden{}
}

/*
MigrateOverridesToGitV2Forbidden describes a response with status code 403, with default header values.

Forbidden
*/
type MigrateOverridesToGitV2Forbidden struct {
	Payload string
}

// IsSuccess returns true when this migrate overrides to git v2 forbidden response has a 2xx status code
func (o *MigrateOverridesToGitV2Forbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this migrate overrides to git v2 forbidden response has a 3xx status code
func (o *MigrateOverridesToGitV2Forbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this migrate overrides to git v2 forbidden response has a 4xx status code
func (o *MigrateOverridesToGitV2Forbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this migrate overrides to git v2 forbidden response has a 5xx status code
func (o *MigrateOverridesToGitV2Forbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this migrate overrides to git v2 forbidden response a status code equal to that given
func (o *MigrateOverridesToGitV2Forbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the migrate overrides to git v2 forbidden response
func (o *MigrateOverridesToGitV2Forbidden) Code() int {
	return 403
}

func (o *MigrateOverridesToGitV2Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/stacks/migrate-overrides-v2][%d] migrateOverridesToGitV2Forbidden %s", 403, payload)
}

func (o *MigrateOverridesToGitV2Forbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/stacks/migrate-overrides-v2][%d] migrateOverridesToGitV2Forbidden %s", 403, payload)
}

func (o *MigrateOverridesToGitV2Forbidden) GetPayload() string {
	return o.Payload
}

func (o *MigrateOverridesToGitV2Forbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
