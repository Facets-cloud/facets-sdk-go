...
func (o *CreateSubStackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCreateSubStackForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateSubStackForbidden creates a CreateSubStackForbidden with default headers values
func NewCreateSubStackForbidden() *CreateSubStackForbidden {
	return &CreateSubStackForbidden{}
}

/*
CreateSubStackForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CreateSubStackForbidden struct {
	Payload string
}

// IsSuccess returns true when this create sub stack forbidden response has a 2xx status code
func (o *CreateSubStackForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create sub stack forbidden response has a 3xx status code
func (o *CreateSubStackForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create sub stack forbidden response has a 4xx status code
func (o *CreateSubStackForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create sub stack forbidden response has a 5xx status code
func (o *CreateSubStackForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create sub stack forbidden response a status code equal to that given
func (o *CreateSubStackForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create sub stack forbidden response
func (o *CreateSubStackForbidden) Code() int {
	return 403
}

func (o *CreateSubStackForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/stacks/substack/{substackName}][%d] createSubStackForbidden %s", 403, payload)
}

func (o *CreateSubStackForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/stacks/substack/{substackName}][%d] createSubStackForbidden %s", 403, payload)
}

func (o *CreateSubStackForbidden) GetPayload() string {
	return o.Payload
}

func (o *CreateSubStackForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
