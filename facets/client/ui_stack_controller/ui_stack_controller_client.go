...
type ClientService interface {
	...
	GetRunningClustersWithKubedebugger(params *GetRunningClustersWithKubedebuggerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetRunningClustersWithKubedebuggerOK, error)
...
/*
GetRunningClustersWithKubedebugger get running clusters with kubedebugger API
*/
func (a *Client) GetRunningClustersWithKubedebugger(params *GetRunningClustersWithKubedebuggerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetRunningClustersWithKubedebuggerOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewGetRunningClustersWithKubedebuggerParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getRunningClustersWithKubedebugger",
		Method:             "GET",
		PathPattern:        "/cc-ui/v1/stacks/running-clusters-with-kubedebugger",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetRunningClustersWithKubedebuggerReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*GetRunningClustersWithKubedebuggerOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getRunningClustersWithKubedebugger: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
