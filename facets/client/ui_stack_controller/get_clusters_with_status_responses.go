...
func (o *GetClustersWithStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetClustersWithStatusForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetClustersWithStatusForbidden creates a GetClustersWithStatusForbidden with default headers values
func NewGetClustersWithStatusForbidden() *GetClustersWithStatusForbidden {
	return &GetClustersWithStatusForbidden{}
}

/*
GetClustersWithStatusForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetClustersWithStatusForbidden struct {
	Payload string
}

// IsSuccess returns true when this get clusters with status forbidden response has a 2xx status code
func (o *GetClustersWithStatusForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get clusters with status forbidden response has a 3xx status code
func (o *GetClustersWithStatusForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get clusters with status forbidden response has a 4xx status code
func (o *GetClustersWithStatusForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get clusters with status forbidden response has a 5xx status code
func (o *GetClustersWithStatusForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get clusters with status forbidden response a status code equal to that given
func (o *GetClustersWithStatusForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get clusters with status forbidden response
func (o *GetClustersWithStatusForbidden) Code() int {
	return 403
}

func (o *GetClustersWithStatusForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/clustersWithStatus][%d] getClustersWithStatusForbidden %s", 403, payload)
}

func (o *GetClustersWithStatusForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/clustersWithStatus][%d] getClustersWithStatusForbidden %s", 403, payload)
}

func (o *GetClustersWithStatusForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetClustersWithStatusForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
