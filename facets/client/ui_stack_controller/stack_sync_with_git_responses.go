...
func (o *StackSyncWithGitReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewStackSyncWithGitForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewStackSyncWithGitForbidden creates a StackSyncWithGitForbidden with default headers values
func NewStackSyncWithGitForbidden() *StackSyncWithGitForbidden {
	return &StackSyncWithGitForbidden{}
}

/*
StackSyncWithGitForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type StackSyncWithGitForbidden struct {
	Payload string
}

// IsSuccess returns true when this stack sync with git forbidden response has a 2xx status code
func (o *StackSyncWithGitForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this stack sync with git forbidden response has a 3xx status code
func (o *StackSyncWithGitForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this stack sync with git forbidden response has a 4xx status code
func (o *StackSyncWithGitForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this stack sync with git forbidden response has a 5xx status code
func (o *StackSyncWithGitForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this stack sync with git forbidden response a status code equal to that given
func (o *StackSyncWithGitForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the stack sync with git forbidden response
func (o *StackSyncWithGitForbidden) Code() int {
	return 403
}

func (o *StackSyncWithGitForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/sync-with-git/v2][%d] stackSyncWithGitForbidden %s", 403, payload)
}

func (o *StackSyncWithGitForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/sync-with-git/v2][%d] stackSyncWithGitForbidden %s", 403, payload)
}

func (o *StackSyncWithGitForbidden) GetPayload() string {
	return o.Payload
}

func (o *StackSyncWithGitForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
