...
func (o *EnableGitOpsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewEnableGitOpsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewEnableGitOpsForbidden creates a EnableGitOpsForbidden with default headers values
func NewEnableGitOpsForbidden() *EnableGitOpsForbidden {
	return &EnableGitOpsForbidden{}
}

/*
EnableGitOpsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type EnableGitOpsForbidden struct {
	Payload string
}

// IsSuccess returns true when this enable git ops forbidden response has a 2xx status code
func (o *EnableGitOpsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this enable git ops forbidden response has a 3xx status code
func (o *EnableGitOpsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this enable git ops forbidden response has a 4xx status code
func (o *EnableGitOpsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this enable git ops forbidden response has a 5xx status code
func (o *EnableGitOpsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this enable git ops forbidden response a status code equal to that given
func (o *EnableGitOpsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the enable git ops forbidden response
func (o *EnableGitOpsForbidden) Code() int {
	return 403
}

func (o *EnableGitOpsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/stacks/{stackName}/enable-git-ops][%d] enableGitOpsForbidden %s", 403, payload)
}

func (o *EnableGitOpsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/stacks/{stackName}/enable-git-ops][%d] enableGitOpsForbidden %s", 403, payload)
}

func (o *EnableGitOpsForbidden) GetPayload() string {
	return o.Payload
}

func (o *EnableGitOpsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
