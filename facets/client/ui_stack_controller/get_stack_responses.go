...
func (o *GetStackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
/*
GetStackForbidden describes a response with status code 403, with default header values.
...
// IsSuccess returns true when this get stack forbidden response has a 2xx status code
func (o *GetStackForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get stack forbidden response has a 3xx status code
func (o *GetStackForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get stack forbidden response has a 4xx status code
func (o *GetStackForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get stack forbidden response has a 5xx status code
func (o *GetStackForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get stack forbidden response a status code equal to that given
func (o *GetStackForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get stack forbidden response
func (o *GetStackForbidden) Code() int {
	return 403
}

func (o *GetStackForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}][%d] getStackForbidden %s", 403, payload)
}

func (o *GetStackForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}][%d] getStackForbidden %s", 403, payload)
}

func (o *GetStackForbidden) GetPayload() string {
	return o.Payload
}
