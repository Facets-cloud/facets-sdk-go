...
func (o *CreateStackV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewCreateStackV2Forbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateStackV2Forbidden creates a CreateStackV2Forbidden with default headers values
func NewCreateStackV2Forbidden() *CreateStackV2Forbidden {
	return &CreateStackV2Forbidden{}
}

/*
CreateStackV2Forbidden describes a response with status code 403, with default header values.

Forbidden
*/
type CreateStackV2Forbidden struct {
	Payload string
}

// IsSuccess returns true when this create stack v2 forbidden response has a 2xx status code
func (o *CreateStackV2Forbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create stack v2 forbidden response has a 3xx status code
func (o *CreateStackV2Forbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create stack v2 forbidden response has a 4xx status code
func (o *CreateStackV2Forbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this create stack v2 forbidden response has a 5xx status code
func (o *CreateStackV2Forbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this create stack v2 forbidden response a status code equal to that given
func (o *CreateStackV2Forbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the create stack v2 forbidden response
func (o *CreateStackV2Forbidden) Code() int {
	return 403
}

func (o *CreateStackV2Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/stacks/v2][%d] createStackV2Forbidden %s", 403, payload)
}

func (o *CreateStackV2Forbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/stacks/v2][%d] createStackV2Forbidden %s", 403, payload)
}

func (o *CreateStackV2Forbidden) GetPayload() string {
	return o.Payload
}

func (o *CreateStackV2Forbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
