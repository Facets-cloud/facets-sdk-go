...
func (o *ReloadStackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewReloadStackForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewReloadStackForbidden creates a ReloadStackForbidden with default headers values
func NewReloadStackForbidden() *ReloadStackForbidden {
	return &ReloadStackForbidden{}
}

/*
ReloadStackForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ReloadStackForbidden struct {
	Payload string
}

// IsSuccess returns true when this reload stack forbidden response has a 2xx status code
func (o *ReloadStackForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this reload stack forbidden response has a 3xx status code
func (o *ReloadStackForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this reload stack forbidden response has a 4xx status code
func (o *ReloadStackForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this reload stack forbidden response has a 5xx status code
func (o *ReloadStackForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this reload stack forbidden response a status code equal to that given
func (o *ReloadStackForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the reload stack forbidden response
func (o *ReloadStackForbidden) Code() int {
	return 403
}

func (o *ReloadStackForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/reload][%d] reloadStackForbidden %s", 403, payload)
}

func (o *ReloadStackForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/reload][%d] reloadStackForbidden %s", 403, payload)
}

func (o *ReloadStackForbidden) GetPayload() string {
	return o.Payload
}

func (o *ReloadStackForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
