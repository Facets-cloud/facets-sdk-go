...
func (o *UpdateStackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
/*
UpdateStackForbidden describes a response with status code 403, with default header values.
...
// IsSuccess returns true when this update stack forbidden response has a 2xx status code
func (o *UpdateStackForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update stack forbidden response has a 3xx status code
func (o *UpdateStackForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update stack forbidden response has a 4xx status code
func (o *UpdateStackForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update stack forbidden response has a 5xx status code
func (o *UpdateStackForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update stack forbidden response a status code equal to that given
func (o *UpdateStackForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update stack forbidden response
func (o *UpdateStackForbidden) Code() int {
	return 403
}

func (o *UpdateStackForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/stacks/{stackName}][%d] updateStackForbidden %s", 403, payload)
}

func (o *UpdateStackForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/stacks/{stackName}][%d] updateStackForbidden %s", 403, payload)
}

func (o *UpdateStackForbidden) GetPayload() string {
	return o.Payload
}
