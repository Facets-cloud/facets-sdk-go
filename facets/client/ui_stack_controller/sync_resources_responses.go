...
func (o *SyncResourcesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewSyncResourcesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSyncResourcesForbidden creates a SyncResourcesForbidden with default headers values
func NewSyncResourcesForbidden() *SyncResourcesForbidden {
	return &SyncResourcesForbidden{}
}

/*
SyncResourcesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type SyncResourcesForbidden struct {
	Payload string
}

// IsSuccess returns true when this sync resources forbidden response has a 2xx status code
func (o *SyncResourcesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this sync resources forbidden response has a 3xx status code
func (o *SyncResourcesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this sync resources forbidden response has a 4xx status code
func (o *SyncResourcesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this sync resources forbidden response has a 5xx status code
func (o *SyncResourcesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this sync resources forbidden response a status code equal to that given
func (o *SyncResourcesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the sync resources forbidden response
func (o *SyncResourcesForbidden) Code() int {
	return 403
}

func (o *SyncResourcesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/sync-resources][%d] syncResourcesForbidden %s", 403, payload)
}

func (o *SyncResourcesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/sync-resources][%d] syncResourcesForbidden %s", 403, payload)
}

func (o *SyncResourcesForbidden) GetPayload() string {
	return o.Payload
}

func (o *SyncResourcesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
