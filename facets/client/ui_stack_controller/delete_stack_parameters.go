...
// WithStackName adds the stackName to the delete stack params
func (o *DeleteStackParams) WithStackName(stackName string) *DeleteStackParams {
	o.SetStackName(stackName)
	return o
}

// SetStackName adds the stackName to the delete stack params
func (o *DeleteStackParams) SetStackName(stackName string) {
