...
// WithStackName adds the stackName to the get stack params
func (o *GetStackParams) WithStackName(stackName string) *GetStackParams {
	o.SetStackName(stackName)
	return o
}

// SetStackName adds the stackName to the get stack params
func (o *GetStackParams) SetStackName(stackName string) {
