...
// WithStackName adds the stackName to the get clusters params
func (o *GetClustersParams) WithStackName(stackName string) *GetClustersParams {
	o.SetStackName(stackName)
	return o
}

// SetStackName adds the stackName to the get clusters params
func (o *GetClustersParams) SetStackName(stackName string) {
