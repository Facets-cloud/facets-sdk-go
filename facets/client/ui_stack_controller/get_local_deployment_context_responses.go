...
func (o *GetLocalDeploymentContextReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetLocalDeploymentContextForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetLocalDeploymentContextForbidden creates a GetLocalDeploymentContextForbidden with default headers values
func NewGetLocalDeploymentContextForbidden() *GetLocalDeploymentContextForbidden {
	return &GetLocalDeploymentContextForbidden{}
}

/*
GetLocalDeploymentContextForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetLocalDeploymentContextForbidden struct {
	Payload string
}

// IsSuccess returns true when this get local deployment context forbidden response has a 2xx status code
func (o *GetLocalDeploymentContextForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get local deployment context forbidden response has a 3xx status code
func (o *GetLocalDeploymentContextForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get local deployment context forbidden response has a 4xx status code
func (o *GetLocalDeploymentContextForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get local deployment context forbidden response has a 5xx status code
func (o *GetLocalDeploymentContextForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get local deployment context forbidden response a status code equal to that given
func (o *GetLocalDeploymentContextForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get local deployment context forbidden response
func (o *GetLocalDeploymentContextForbidden) Code() int {
	return 403
}

func (o *GetLocalDeploymentContextForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/localDeploymentContext][%d] getLocalDeploymentContextForbidden %s", 403, payload)
}

func (o *GetLocalDeploymentContextForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/localDeploymentContext][%d] getLocalDeploymentContextForbidden %s", 403, payload)
}

func (o *GetLocalDeploymentContextForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetLocalDeploymentContextForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
