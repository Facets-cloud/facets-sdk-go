...
func (o *GetClusterMetadataByStackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetClusterMetadataByStackForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetClusterMetadataByStackForbidden creates a GetClusterMetadataByStackForbidden with default headers values
func NewGetClusterMetadataByStackForbidden() *GetClusterMetadataByStackForbidden {
	return &GetClusterMetadataByStackForbidden{}
}

/*
GetClusterMetadataByStackForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetClusterMetadataByStackForbidden struct {
	Payload string
}

// IsSuccess returns true when this get cluster metadata by stack forbidden response has a 2xx status code
func (o *GetClusterMetadataByStackForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get cluster metadata by stack forbidden response has a 3xx status code
func (o *GetClusterMetadataByStackForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get cluster metadata by stack forbidden response has a 4xx status code
func (o *GetClusterMetadataByStackForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get cluster metadata by stack forbidden response has a 5xx status code
func (o *GetClusterMetadataByStackForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get cluster metadata by stack forbidden response a status code equal to that given
func (o *GetClusterMetadataByStackForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get cluster metadata by stack forbidden response
func (o *GetClusterMetadataByStackForbidden) Code() int {
	return 403
}

func (o *GetClusterMetadataByStackForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/clusters-metadata][%d] getClusterMetadataByStackForbidden %s", 403, payload)
}

func (o *GetClusterMetadataByStackForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/stacks/{stackName}/clusters-metadata][%d] getClusterMetadataByStackForbidden %s", 403, payload)
}

func (o *GetClusterMetadataByStackForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetClusterMetadataByStackForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
