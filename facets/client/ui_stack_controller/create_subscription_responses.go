...
// Code gets the status code for the create subscription forbidden response
func (o *CreateSubscriptionForbidden) Code() int {
	return 403
}

func (o *CreateSubscriptionForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/stacks/{stackName}/notification/subscriptions][%d] createSubscriptionForbidden %s", 403, payload)
}
...
func (o *CreateSubscriptionForbidden) GetPayload() string {
	return o.Payload
}
