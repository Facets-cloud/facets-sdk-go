...
func (o *DeleteDomainMappingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewDeleteDomainMappingForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewDeleteDomainMappingForbidden creates a DeleteDomainMappingForbidden with default headers values
func NewDeleteDomainMappingForbidden() *DeleteDomainMappingForbidden {
	return &DeleteDomainMappingForbidden{}
}

/*
DeleteDomainMappingForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type DeleteDomainMappingForbidden struct {
	Payload string
}

// IsSuccess returns true when this delete domain mapping forbidden response has a 2xx status code
func (o *DeleteDomainMappingForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this delete domain mapping forbidden response has a 3xx status code
func (o *DeleteDomainMappingForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete domain mapping forbidden response has a 4xx status code
func (o *DeleteDomainMappingForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this delete domain mapping forbidden response has a 5xx status code
func (o *DeleteDomainMappingForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this delete domain mapping forbidden response a status code equal to that given
func (o *DeleteDomainMappingForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the delete domain mapping forbidden response
func (o *DeleteDomainMappingForbidden) Code() int {
	return 403
}

func (o *DeleteDomainMappingForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/domain-mapping/clusterId/{clusterId}/resourceType/{resourceType}/resourceName/{resourceName}][%d] deleteDomainMappingForbidden %s", 403, payload)
}

func (o *DeleteDomainMappingForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /cc-ui/v1/domain-mapping/clusterId/{clusterId}/resourceType/{resourceType}/resourceName/{resourceName}][%d] deleteDomainMappingForbidden %s", 403, payload)
}

func (o *DeleteDomainMappingForbidden) GetPayload() string {
	return o.Payload
}

func (o *DeleteDomainMappingForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
