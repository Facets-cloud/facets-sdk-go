...
func (o *UpdateDomainMappingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateDomainMappingForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateDomainMappingForbidden creates a UpdateDomainMappingForbidden with default headers values
func NewUpdateDomainMappingForbidden() *UpdateDomainMappingForbidden {
	return &UpdateDomainMappingForbidden{}
}

/*
UpdateDomainMappingForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateDomainMappingForbidden struct {
	Payload string
}

// IsSuccess returns true when this update domain mapping forbidden response has a 2xx status code
func (o *UpdateDomainMappingForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update domain mapping forbidden response has a 3xx status code
func (o *UpdateDomainMappingForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update domain mapping forbidden response has a 4xx status code
func (o *UpdateDomainMappingForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update domain mapping forbidden response has a 5xx status code
func (o *UpdateDomainMappingForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update domain mapping forbidden response a status code equal to that given
func (o *UpdateDomainMappingForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update domain mapping forbidden response
func (o *UpdateDomainMappingForbidden) Code() int {
	return 403
}

func (o *UpdateDomainMappingForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/domain-mapping/clusterId/{clusterId}/resourceType/{resourceType}/resourceName/{resourceName}][%d] updateDomainMappingForbidden %s", 403, payload)
}

func (o *UpdateDomainMappingForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/domain-mapping/clusterId/{clusterId}/resourceType/{resourceType}/resourceName/{resourceName}][%d] updateDomainMappingForbidden %s", 403, payload)
}

func (o *UpdateDomainMappingForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateDomainMappingForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
