...
CreateUserUsingPOSTParams contains all the parameters to send to the API endpoint
	...
	for the create user using p o s t operation.
...
// WithDefaults hydrates default values in the create user using p o s t params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateUserUsingPOSTParams) WithDefaults() *CreateUserUsingPOSTParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the create user using p o s t params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CreateUserUsingPOSTParams) SetDefaults() {
...
// WithUser adds the user to the create user using p o s t params
func (o *CreateUserUsingPOSTParams) WithUser(user *models.User) *CreateUserUsingPOSTParams {
	o.SetUser(user)
	return o
}

// SetUser adds the user to the create user using p o s t params
func (o *CreateUserUsingPOSTParams) SetUser(user *models.User) {
	o.User = user
}
