...
GetUsersUsingGETParams contains all the parameters to send to the API endpoint
	...
	for the get users using g e t operation.
...
// WithDefaults hydrates default values in the get users using g e t params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetUsersUsingGETParams) WithDefaults() *GetUsersUsingGETParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get users using g e t params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetUsersUsingGETParams) SetDefaults() {
