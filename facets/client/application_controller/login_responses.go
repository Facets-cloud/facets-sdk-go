...
func (o *LoginReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 404:
		...
		return nil, result
	case 405:
		result := NewLoginMethodNotAllowed()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /api/login] login", response, response.Code())
	}
}
...
func (o *LoginOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/login][%d] loginOK %s", 200, payload)
}
...
func (o *LoginBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/login][%d] loginBadRequest %s", 400, payload)
}
...
func (o *LoginBadRequest) GetPayload() *models.ErrorDetails {
	return o.Payload
}
...
func (o *LoginForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/login][%d] loginForbidden %s", 403, payload)
}
...
func (o *LoginForbidden) GetPayload() string {
	return o.Payload
}
...
func (o *LoginNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/login][%d] loginNotFound %s", 404, payload)
}
...
func (o *LoginNotFound) GetPayload() *models.ErrorDetails {
	return o.Payload
}
...
// NewLoginMethodNotAllowed creates a LoginMethodNotAllowed with default headers values
func NewLoginMethodNotAllowed() *LoginMethodNotAllowed {
	return &LoginMethodNotAllowed{}
}

/*
LoginMethodNotAllowed describes a response with status code 405, with default header values.

Method Not Allowed
*/
type LoginMethodNotAllowed struct {
	Payload *models.ErrorDetails
}

// IsSuccess returns true when this login method not allowed response has a 2xx status code
func (o *LoginMethodNotAllowed) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this login method not allowed response has a 3xx status code
func (o *LoginMethodNotAllowed) IsRedirect() bool {
	return false
}

// IsClientError returns true when this login method not allowed response has a 4xx status code
func (o *LoginMethodNotAllowed) IsClientError() bool {
	return true
}

// IsServerError returns true when this login method not allowed response has a 5xx status code
func (o *LoginMethodNotAllowed) IsServerError() bool {
	return false
}

// IsCode returns true when this login method not allowed response a status code equal to that given
func (o *LoginMethodNotAllowed) IsCode(code int) bool {
	return code == 405
}

// Code gets the status code for the login method not allowed response
func (o *LoginMethodNotAllowed) Code() int {
	return 405
}

func (o *LoginMethodNotAllowed) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/login][%d] loginMethodNotAllowed %s", 405, payload)
}

func (o *LoginMethodNotAllowed) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/login][%d] loginMethodNotAllowed %s", 405, payload)
}

func (o *LoginMethodNotAllowed) GetPayload() *models.ErrorDetails {
	return o.Payload
}

func (o *LoginMethodNotAllowed) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *LoginInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/login][%d] loginInternalServerError %s", 500, payload)
}
...
func (o *LoginInternalServerError) GetPayload() *models.ErrorDetails {
	return o.Payload
}
