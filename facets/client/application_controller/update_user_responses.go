...
func (o *UpdateUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 404:
		...
		return nil, result
	case 405:
		result := NewUpdateUserMethodNotAllowed()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /api/users/{userId}] updateUser", response, response.Code())
	}
}
...
func (o *UpdateUserOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/users/{userId}][%d] updateUserOK %s", 200, payload)
}
...
func (o *UpdateUserBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/users/{userId}][%d] updateUserBadRequest %s", 400, payload)
}
...
func (o *UpdateUserBadRequest) GetPayload() *models.ErrorDetails {
	return o.Payload
}
...
func (o *UpdateUserForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/users/{userId}][%d] updateUserForbidden %s", 403, payload)
}
...
func (o *UpdateUserForbidden) GetPayload() string {
	return o.Payload
}
...
func (o *UpdateUserNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/users/{userId}][%d] updateUserNotFound %s", 404, payload)
}
...
func (o *UpdateUserNotFound) GetPayload() *models.ErrorDetails {
	return o.Payload
}
...
// NewUpdateUserMethodNotAllowed creates a UpdateUserMethodNotAllowed with default headers values
func NewUpdateUserMethodNotAllowed() *UpdateUserMethodNotAllowed {
	return &UpdateUserMethodNotAllowed{}
}

/*
UpdateUserMethodNotAllowed describes a response with status code 405, with default header values.

Method Not Allowed
*/
type UpdateUserMethodNotAllowed struct {
	Payload *models.ErrorDetails
}

// IsSuccess returns true when this update user method not allowed response has a 2xx status code
func (o *UpdateUserMethodNotAllowed) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update user method not allowed response has a 3xx status code
func (o *UpdateUserMethodNotAllowed) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update user method not allowed response has a 4xx status code
func (o *UpdateUserMethodNotAllowed) IsClientError() bool {
	return true
}

// IsServerError returns true when this update user method not allowed response has a 5xx status code
func (o *UpdateUserMethodNotAllowed) IsServerError() bool {
	return false
}

// IsCode returns true when this update user method not allowed response a status code equal to that given
func (o *UpdateUserMethodNotAllowed) IsCode(code int) bool {
	return code == 405
}

// Code gets the status code for the update user method not allowed response
func (o *UpdateUserMethodNotAllowed) Code() int {
	return 405
}

func (o *UpdateUserMethodNotAllowed) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/users/{userId}][%d] updateUserMethodNotAllowed %s", 405, payload)
}

func (o *UpdateUserMethodNotAllowed) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/users/{userId}][%d] updateUserMethodNotAllowed %s", 405, payload)
}

func (o *UpdateUserMethodNotAllowed) GetPayload() *models.ErrorDetails {
	return o.Payload
}

func (o *UpdateUserMethodNotAllowed) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdateUserInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/users/{userId}][%d] updateUserInternalServerError %s", 500, payload)
}
...
func (o *UpdateUserInternalServerError) GetPayload() *models.ErrorDetails {
	return o.Payload
}
