...
func (o *Login3Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewLogin3Forbidden creates a Login3Forbidden with default headers values
func NewLogin3Forbidden() *Login3Forbidden {
	return &Login3Forbidden{}
}

/*
Login3Forbidden describes a response with status code 403, with default header values.

Forbidden
*/
type Login3Forbidden struct {
	Payload string
}

// IsSuccess returns true when this login3 forbidden response has a 2xx status code
func (o *Login3Forbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this login3 forbidden response has a 3xx status code
func (o *Login3Forbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this login3 forbidden response has a 4xx status code
func (o *Login3Forbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this login3 forbidden response has a 5xx status code
func (o *Login3Forbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this login3 forbidden response a status code equal to that given
func (o *Login3Forbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the login3 forbidden response
func (o *Login3Forbidden) Code() int {
	return 403
}

func (o *Login3Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/login][%d] login3Forbidden %s", 403, payload)
}

func (o *Login3Forbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/login][%d] login3Forbidden %s", 403, payload)
}

func (o *Login3Forbidden) GetPayload() string {
	return o.Payload
}

func (o *Login3Forbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
