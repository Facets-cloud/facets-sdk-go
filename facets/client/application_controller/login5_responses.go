...
func (o *Login5Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewLogin5Forbidden creates a Login5Forbidden with default headers values
func NewLogin5Forbidden() *Login5Forbidden {
	return &Login5Forbidden{}
}

/*
Login5Forbidden describes a response with status code 403, with default header values.

Forbidden
*/
type Login5Forbidden struct {
	Payload string
}

// IsSuccess returns true when this login5 forbidden response has a 2xx status code
func (o *Login5Forbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this login5 forbidden response has a 3xx status code
func (o *Login5Forbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this login5 forbidden response has a 4xx status code
func (o *Login5Forbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this login5 forbidden response has a 5xx status code
func (o *Login5Forbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this login5 forbidden response a status code equal to that given
func (o *Login5Forbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the login5 forbidden response
func (o *Login5Forbidden) Code() int {
	return 403
}

func (o *Login5Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/login][%d] login5Forbidden %s", 403, payload)
}

func (o *Login5Forbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /api/login][%d] login5Forbidden %s", 403, payload)
}

func (o *Login5Forbidden) GetPayload() string {
	return o.Payload
}

func (o *Login5Forbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
