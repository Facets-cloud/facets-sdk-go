...
func (o *Login4Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewLogin4Forbidden creates a Login4Forbidden with default headers values
func NewLogin4Forbidden() *Login4Forbidden {
	return &Login4Forbidden{}
}

/*
Login4Forbidden describes a response with status code 403, with default header values.

Forbidden
*/
type Login4Forbidden struct {
	Payload string
}

// IsSuccess returns true when this login4 forbidden response has a 2xx status code
func (o *Login4Forbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this login4 forbidden response has a 3xx status code
func (o *Login4Forbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this login4 forbidden response has a 4xx status code
func (o *Login4Forbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this login4 forbidden response has a 5xx status code
func (o *Login4Forbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this login4 forbidden response a status code equal to that given
func (o *Login4Forbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the login4 forbidden response
func (o *Login4Forbidden) Code() int {
	return 403
}

func (o *Login4Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /api/login][%d] login4Forbidden %s", 403, payload)
}

func (o *Login4Forbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /api/login][%d] login4Forbidden %s", 403, payload)
}

func (o *Login4Forbidden) GetPayload() string {
	return o.Payload
}

func (o *Login4Forbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
