...
func (o *Login6Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewLogin6Forbidden creates a Login6Forbidden with default headers values
func NewLogin6Forbidden() *Login6Forbidden {
	return &Login6Forbidden{}
}

/*
Login6Forbidden describes a response with status code 403, with default header values.

Forbidden
*/
type Login6Forbidden struct {
	Payload string
}

// IsSuccess returns true when this login6 forbidden response has a 2xx status code
func (o *Login6Forbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this login6 forbidden response has a 3xx status code
func (o *Login6Forbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this login6 forbidden response has a 4xx status code
func (o *Login6Forbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this login6 forbidden response has a 5xx status code
func (o *Login6Forbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this login6 forbidden response a status code equal to that given
func (o *Login6Forbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the login6 forbidden response
func (o *Login6Forbidden) Code() int {
	return 403
}

func (o *Login6Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[OPTIONS /api/login][%d] login6Forbidden %s", 403, payload)
}

func (o *Login6Forbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[OPTIONS /api/login][%d] login6Forbidden %s", 403, payload)
}

func (o *Login6Forbidden) GetPayload() string {
	return o.Payload
}

func (o *Login6Forbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
