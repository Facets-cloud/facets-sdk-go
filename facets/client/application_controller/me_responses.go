...
func (o *MeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *MeForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/me][%d] meForbidden %s", 403, payload)
}
...
func (o *MeForbidden) GetPayload() string {
	return o.Payload
}
