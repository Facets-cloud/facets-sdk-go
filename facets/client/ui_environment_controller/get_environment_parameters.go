...
// WithClusterID adds the clusterID to the get environment params
func (o *GetEnvironmentParams) WithClusterID(clusterID string) *GetEnvironmentParams {
	o.SetClusterID(clusterID)
	return o
}

// SetClusterID adds the clusterId to the get environment params
func (o *GetEnvironmentParams) SetClusterID(clusterID string) {
