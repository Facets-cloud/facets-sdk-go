...
func (o *CreateEnvironmentParams) WithBody(body *models.EnvironmentRequest) *CreateEnvironmentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create environment params
func (o *CreateEnvironmentParams) SetBody(body *models.EnvironmentRequest) {
	o.Body = body
}
