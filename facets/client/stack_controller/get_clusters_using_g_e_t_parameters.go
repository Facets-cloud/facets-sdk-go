...
// WithDefaults hydrates default values in the get clusters using g e t params (not the query body).
//
...
// SetDefaults hydrates default values in the get clusters using g e t params (not the query body).
//
// All values with no default are reset to their zero value.
...
// WithTimeout adds the timeout to the get clusters using g e t params
func (o *GetClustersUsingGETParams) WithTimeout(timeout time.Duration) *GetClustersUsingGETParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get clusters using g e t params
func (o *GetClustersUsingGETParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get clusters using g e t params
func (o *GetClustersUsingGETParams) WithContext(ctx context.Context) *GetClustersUsingGETParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get clusters using g e t params
func (o *GetClustersUsingGETParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get clusters using g e t params
func (o *GetClustersUsingGETParams) WithHTTPClient(client *http.Client) *GetClustersUsingGETParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get clusters using g e t params
func (o *GetClustersUsingGETParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithStackName adds the stackName to the get clusters using g e t params
func (o *GetClustersUsingGETParams) WithStackName(stackName string) *GetClustersUsingGETParams {
	o.SetStackName(stackName)
	return o
}

// SetStackName adds the stackName to the get clusters using g e t params
func (o *GetClustersUsingGETParams) SetStackName(stackName string) {
