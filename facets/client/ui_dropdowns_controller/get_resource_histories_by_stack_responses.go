...
func (o *GetResourceHistoriesByStackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetResourceHistoriesByStackForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetResourceHistoriesByStackForbidden creates a GetResourceHistoriesByStackForbidden with default headers values
func NewGetResourceHistoriesByStackForbidden() *GetResourceHistoriesByStackForbidden {
	return &GetResourceHistoriesByStackForbidden{}
}

/*
GetResourceHistoriesByStackForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetResourceHistoriesByStackForbidden struct {
	Payload string
}

// IsSuccess returns true when this get resource histories by stack forbidden response has a 2xx status code
func (o *GetResourceHistoriesByStackForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get resource histories by stack forbidden response has a 3xx status code
func (o *GetResourceHistoriesByStackForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get resource histories by stack forbidden response has a 4xx status code
func (o *GetResourceHistoriesByStackForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get resource histories by stack forbidden response has a 5xx status code
func (o *GetResourceHistoriesByStackForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get resource histories by stack forbidden response a status code equal to that given
func (o *GetResourceHistoriesByStackForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get resource histories by stack forbidden response
func (o *GetResourceHistoriesByStackForbidden) Code() int {
	return 403
}

func (o *GetResourceHistoriesByStackForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/{stackName}/resourceType/{resourceType}/resourceName/{resourceName}/resource-history][%d] getResourceHistoriesByStackForbidden %s", 403, payload)
}

func (o *GetResourceHistoriesByStackForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/{stackName}/resourceType/{resourceType}/resourceName/{resourceName}/resource-history][%d] getResourceHistoriesByStackForbidden %s", 403, payload)
}

func (o *GetResourceHistoriesByStackForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetResourceHistoriesByStackForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
