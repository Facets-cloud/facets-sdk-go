...
func (o *GetResourceByClusterIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetResourceByClusterIDForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetResourceByClusterIDForbidden creates a GetResourceByClusterIDForbidden with default headers values
func NewGetResourceByClusterIDForbidden() *GetResourceByClusterIDForbidden {
	return &GetResourceByClusterIDForbidden{}
}

/*
GetResourceByClusterIDForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetResourceByClusterIDForbidden struct {
	Payload string
}

// IsSuccess returns true when this get resource by cluster Id forbidden response has a 2xx status code
func (o *GetResourceByClusterIDForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get resource by cluster Id forbidden response has a 3xx status code
func (o *GetResourceByClusterIDForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get resource by cluster Id forbidden response has a 4xx status code
func (o *GetResourceByClusterIDForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get resource by cluster Id forbidden response has a 5xx status code
func (o *GetResourceByClusterIDForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get resource by cluster Id forbidden response a status code equal to that given
func (o *GetResourceByClusterIDForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get resource by cluster Id forbidden response
func (o *GetResourceByClusterIDForbidden) Code() int {
	return 403
}

func (o *GetResourceByClusterIDForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/cluster/{clusterId}/{resourceType}/{resourceName}/resource-info][%d] getResourceByClusterIdForbidden %s", 403, payload)
}

func (o *GetResourceByClusterIDForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/cluster/{clusterId}/{resourceType}/{resourceName}/resource-info][%d] getResourceByClusterIdForbidden %s", 403, payload)
}

func (o *GetResourceByClusterIDForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetResourceByClusterIDForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
