...
func (o *GetAllPermissionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetAllPermissionsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/getAllPermissions][%d] getAllPermissionsForbidden %s", 403, payload)
}
...
func (o *GetAllPermissionsForbidden) GetPayload() string {
	return o.Payload
}
