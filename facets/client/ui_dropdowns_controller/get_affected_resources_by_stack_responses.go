...
func (o *GetAffectedResourcesByStackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAffectedResourcesByStackForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAffectedResourcesByStackForbidden creates a GetAffectedResourcesByStackForbidden with default headers values
func NewGetAffectedResourcesByStackForbidden() *GetAffectedResourcesByStackForbidden {
	return &GetAffectedResourcesByStackForbidden{}
}

/*
GetAffectedResourcesByStackForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAffectedResourcesByStackForbidden struct {
	Payload string
}

// IsSuccess returns true when this get affected resources by stack forbidden response has a 2xx status code
func (o *GetAffectedResourcesByStackForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get affected resources by stack forbidden response has a 3xx status code
func (o *GetAffectedResourcesByStackForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get affected resources by stack forbidden response has a 4xx status code
func (o *GetAffectedResourcesByStackForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get affected resources by stack forbidden response has a 5xx status code
func (o *GetAffectedResourcesByStackForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get affected resources by stack forbidden response a status code equal to that given
func (o *GetAffectedResourcesByStackForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get affected resources by stack forbidden response
func (o *GetAffectedResourcesByStackForbidden) Code() int {
	return 403
}

func (o *GetAffectedResourcesByStackForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/dropdown/stack/{stackName}/affected-resources][%d] getAffectedResourcesByStackForbidden %s", 403, payload)
}

func (o *GetAffectedResourcesByStackForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/dropdown/stack/{stackName}/affected-resources][%d] getAffectedResourcesByStackForbidden %s", 403, payload)
}

func (o *GetAffectedResourcesByStackForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAffectedResourcesByStackForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
