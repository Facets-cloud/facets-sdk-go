...
func (o *GetApplicationListByClusterIDAndResourceNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetApplicationListByClusterIDAndResourceNameForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetApplicationListByClusterIDAndResourceNameForbidden creates a GetApplicationListByClusterIDAndResourceNameForbidden with default headers values
func NewGetApplicationListByClusterIDAndResourceNameForbidden() *GetApplicationListByClusterIDAndResourceNameForbidden {
	return &GetApplicationListByClusterIDAndResourceNameForbidden{}
}

/*
GetApplicationListByClusterIDAndResourceNameForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetApplicationListByClusterIDAndResourceNameForbidden struct {
	Payload string
}

// IsSuccess returns true when this get application list by cluster Id and resource name forbidden response has a 2xx status code
func (o *GetApplicationListByClusterIDAndResourceNameForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get application list by cluster Id and resource name forbidden response has a 3xx status code
func (o *GetApplicationListByClusterIDAndResourceNameForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get application list by cluster Id and resource name forbidden response has a 4xx status code
func (o *GetApplicationListByClusterIDAndResourceNameForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get application list by cluster Id and resource name forbidden response has a 5xx status code
func (o *GetApplicationListByClusterIDAndResourceNameForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get application list by cluster Id and resource name forbidden response a status code equal to that given
func (o *GetApplicationListByClusterIDAndResourceNameForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get application list by cluster Id and resource name forbidden response
func (o *GetApplicationListByClusterIDAndResourceNameForbidden) Code() int {
	return 403
}

func (o *GetApplicationListByClusterIDAndResourceNameForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/{clusterId}/{resourceType}][%d] getApplicationListByClusterIdAndResourceNameForbidden %s", 403, payload)
}

func (o *GetApplicationListByClusterIDAndResourceNameForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/{clusterId}/{resourceType}][%d] getApplicationListByClusterIdAndResourceNameForbidden %s", 403, payload)
}

func (o *GetApplicationListByClusterIDAndResourceNameForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetApplicationListByClusterIDAndResourceNameForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
