...
type ClientService interface {
	...
	GetConnectionStringsByResourceType(params *GetConnectionStringsByResourceTypeParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetConnectionStringsByResourceTypeOK, error)
...
/*
GetConnectionStringsByResourceType get connection strings by resource type API
*/
func (a *Client) GetConnectionStringsByResourceType(params *GetConnectionStringsByResourceTypeParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetConnectionStringsByResourceTypeOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewGetConnectionStringsByResourceTypeParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getConnectionStringsByResourceType",
		Method:             "GET",
		PathPattern:        "/cc-ui/v1/dropdown/{clusterId}/resource-type/{resourceType}/connection-strings",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetConnectionStringsByResourceTypeReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	// only one success response has to be checked
	success, ok := result.(*GetConnectionStringsByResourceTypeOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getConnectionStringsByResourceType: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
