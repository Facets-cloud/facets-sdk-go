...
func (o *GetOutputReferencesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetOutputReferencesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetOutputReferencesForbidden creates a GetOutputReferencesForbidden with default headers values
func NewGetOutputReferencesForbidden() *GetOutputReferencesForbidden {
	return &GetOutputReferencesForbidden{}
}

/*
GetOutputReferencesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetOutputReferencesForbidden struct {
	Payload string
}

// IsSuccess returns true when this get output references forbidden response has a 2xx status code
func (o *GetOutputReferencesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get output references forbidden response has a 3xx status code
func (o *GetOutputReferencesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get output references forbidden response has a 4xx status code
func (o *GetOutputReferencesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get output references forbidden response has a 5xx status code
func (o *GetOutputReferencesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get output references forbidden response a status code equal to that given
func (o *GetOutputReferencesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get output references forbidden response
func (o *GetOutputReferencesForbidden) Code() int {
	return 403
}

func (o *GetOutputReferencesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/{stackName}/output/{outputType}/references][%d] getOutputReferencesForbidden %s", 403, payload)
}

func (o *GetOutputReferencesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/{stackName}/output/{outputType}/references][%d] getOutputReferencesForbidden %s", 403, payload)
}

func (o *GetOutputReferencesForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetOutputReferencesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
