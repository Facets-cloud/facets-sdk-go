...
func (o *GetAllResourcesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllResourcesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllResourcesForbidden creates a GetAllResourcesForbidden with default headers values
func NewGetAllResourcesForbidden() *GetAllResourcesForbidden {
	return &GetAllResourcesForbidden{}
}

/*
GetAllResourcesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllResourcesForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all resources forbidden response has a 2xx status code
func (o *GetAllResourcesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all resources forbidden response has a 3xx status code
func (o *GetAllResourcesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all resources forbidden response has a 4xx status code
func (o *GetAllResourcesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all resources forbidden response has a 5xx status code
func (o *GetAllResourcesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all resources forbidden response a status code equal to that given
func (o *GetAllResourcesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all resources forbidden response
func (o *GetAllResourcesForbidden) Code() int {
	return 403
}

func (o *GetAllResourcesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/cluster/{clusterId}/resources][%d] getAllResourcesForbidden %s", 403, payload)
}

func (o *GetAllResourcesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/cluster/{clusterId}/resources][%d] getAllResourcesForbidden %s", 403, payload)
}

func (o *GetAllResourcesForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllResourcesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
