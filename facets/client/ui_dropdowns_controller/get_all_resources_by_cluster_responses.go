...
func (o *GetAllResourcesByClusterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAllResourcesByClusterForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAllResourcesByClusterForbidden creates a GetAllResourcesByClusterForbidden with default headers values
func NewGetAllResourcesByClusterForbidden() *GetAllResourcesByClusterForbidden {
	return &GetAllResourcesByClusterForbidden{}
}

/*
GetAllResourcesByClusterForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllResourcesByClusterForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all resources by cluster forbidden response has a 2xx status code
func (o *GetAllResourcesByClusterForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all resources by cluster forbidden response has a 3xx status code
func (o *GetAllResourcesByClusterForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all resources by cluster forbidden response has a 4xx status code
func (o *GetAllResourcesByClusterForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all resources by cluster forbidden response has a 5xx status code
func (o *GetAllResourcesByClusterForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all resources by cluster forbidden response a status code equal to that given
func (o *GetAllResourcesByClusterForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all resources by cluster forbidden response
func (o *GetAllResourcesByClusterForbidden) Code() int {
	return 403
}

func (o *GetAllResourcesByClusterForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/cluster/{clusterId}/resources-info][%d] getAllResourcesByClusterForbidden %s", 403, payload)
}

func (o *GetAllResourcesByClusterForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/cluster/{clusterId}/resources-info][%d] getAllResourcesByClusterForbidden %s", 403, payload)
}

func (o *GetAllResourcesByClusterForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllResourcesByClusterForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
