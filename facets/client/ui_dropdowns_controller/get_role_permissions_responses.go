...
func (o *GetRolePermissionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetRolePermissionsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetRolePermissionsForbidden creates a GetRolePermissionsForbidden with default headers values
func NewGetRolePermissionsForbidden() *GetRolePermissionsForbidden {
	return &GetRolePermissionsForbidden{}
}

/*
GetRolePermissionsForbidden describes a response with status code 403, with default header values.
...
// IsSuccess returns true when this get role permissions forbidden response has a 2xx status code
func (o *GetRolePermissionsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get role permissions forbidden response has a 3xx status code
func (o *GetRolePermissionsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get role permissions forbidden response has a 4xx status code
func (o *GetRolePermissionsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get role permissions forbidden response has a 5xx status code
func (o *GetRolePermissionsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get role permissions forbidden response a status code equal to that given
func (o *GetRolePermissionsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get role permissions forbidden response
func (o *GetRolePermissionsForbidden) Code() int {
	return 403
}

func (o *GetRolePermissionsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/rolePermissions/{role}][%d] getRolePermissionsForbidden %s", 403, payload)
}

func (o *GetRolePermissionsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/rolePermissions/{role}][%d] getRolePermissionsForbidden %s", 403, payload)
}

func (o *GetRolePermissionsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetRolePermissionsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
