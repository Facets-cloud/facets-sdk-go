...
func (o *GetLaunchDAGReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetLaunchDAGForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetLaunchDAGForbidden creates a GetLaunchDAGForbidden with default headers values
func NewGetLaunchDAGForbidden() *GetLaunchDAGForbidden {
	return &GetLaunchDAGForbidden{}
}

/*
GetLaunchDAGForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetLaunchDAGForbidden struct {
	Payload string
}

// IsSuccess returns true when this get launch d a g forbidden response has a 2xx status code
func (o *GetLaunchDAGForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get launch d a g forbidden response has a 3xx status code
func (o *GetLaunchDAGForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get launch d a g forbidden response has a 4xx status code
func (o *GetLaunchDAGForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get launch d a g forbidden response has a 5xx status code
func (o *GetLaunchDAGForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get launch d a g forbidden response a status code equal to that given
func (o *GetLaunchDAGForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get launch d a g forbidden response
func (o *GetLaunchDAGForbidden) Code() int {
	return 403
}

func (o *GetLaunchDAGForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/{clusterId}/cloud/{cloud}/launch-dag][%d] getLaunchDAGForbidden %s", 403, payload)
}

func (o *GetLaunchDAGForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/{clusterId}/cloud/{cloud}/launch-dag][%d] getLaunchDAGForbidden %s", 403, payload)
}

func (o *GetLaunchDAGForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetLaunchDAGForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
