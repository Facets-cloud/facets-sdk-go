...
func (o *GetAllVCSReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewGetAllVCSForbidden creates a GetAllVCSForbidden with default headers values
func NewGetAllVCSForbidden() *GetAllVCSForbidden {
	return &GetAllVCSForbidden{}
}

/*
GetAllVCSForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAllVCSForbidden struct {
	Payload string
}

// IsSuccess returns true when this get all v c s forbidden response has a 2xx status code
func (o *GetAllVCSForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get all v c s forbidden response has a 3xx status code
func (o *GetAllVCSForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get all v c s forbidden response has a 4xx status code
func (o *GetAllVCSForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get all v c s forbidden response has a 5xx status code
func (o *GetAllVCSForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get all v c s forbidden response a status code equal to that given
func (o *GetAllVCSForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get all v c s forbidden response
func (o *GetAllVCSForbidden) Code() int {
	return 403
}

func (o *GetAllVCSForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/vcs][%d] getAllVCSForbidden %s", 403, payload)
}

func (o *GetAllVCSForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/vcs][%d] getAllVCSForbidden %s", 403, payload)
}

func (o *GetAllVCSForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAllVCSForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
