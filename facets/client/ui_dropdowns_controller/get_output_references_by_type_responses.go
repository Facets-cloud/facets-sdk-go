...
func (o *GetOutputReferencesByTypeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetOutputReferencesByTypeForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetOutputReferencesByTypeForbidden creates a GetOutputReferencesByTypeForbidden with default headers values
func NewGetOutputReferencesByTypeForbidden() *GetOutputReferencesByTypeForbidden {
	return &GetOutputReferencesByTypeForbidden{}
}

/*
GetOutputReferencesByTypeForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetOutputReferencesByTypeForbidden struct {
	Payload string
}

// IsSuccess returns true when this get output references by type forbidden response has a 2xx status code
func (o *GetOutputReferencesByTypeForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get output references by type forbidden response has a 3xx status code
func (o *GetOutputReferencesByTypeForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get output references by type forbidden response has a 4xx status code
func (o *GetOutputReferencesByTypeForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get output references by type forbidden response has a 5xx status code
func (o *GetOutputReferencesByTypeForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get output references by type forbidden response a status code equal to that given
func (o *GetOutputReferencesByTypeForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get output references by type forbidden response
func (o *GetOutputReferencesByTypeForbidden) Code() int {
	return 403
}

func (o *GetOutputReferencesByTypeForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/{stackName}/output-references][%d] getOutputReferencesByTypeForbidden %s", 403, payload)
}

func (o *GetOutputReferencesByTypeForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/{stackName}/output-references][%d] getOutputReferencesByTypeForbidden %s", 403, payload)
}

func (o *GetOutputReferencesByTypeForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetOutputReferencesByTypeForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
