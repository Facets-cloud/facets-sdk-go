...
func (o *GetRegionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetRegionsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/{cloud}/regions][%d] getRegionsForbidden %s", 403, payload)
}
...
func (o *GetRegionsForbidden) GetPayload() string {
	return o.Payload
}
