...
func (o *GetReleaseStreamsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetReleaseStreamsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetReleaseStreamsForbidden creates a GetReleaseStreamsForbidden with default headers values
func NewGetReleaseStreamsForbidden() *GetReleaseStreamsForbidden {
	return &GetReleaseStreamsForbidden{}
}

/*
GetReleaseStreamsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetReleaseStreamsForbidden struct {
	Payload string
}

// IsSuccess returns true when this get release streams forbidden response has a 2xx status code
func (o *GetReleaseStreamsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get release streams forbidden response has a 3xx status code
func (o *GetReleaseStreamsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get release streams forbidden response has a 4xx status code
func (o *GetReleaseStreamsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get release streams forbidden response has a 5xx status code
func (o *GetReleaseStreamsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get release streams forbidden response a status code equal to that given
func (o *GetReleaseStreamsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get release streams forbidden response
func (o *GetReleaseStreamsForbidden) Code() int {
	return 403
}

func (o *GetReleaseStreamsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/releaseStreams][%d] getReleaseStreamsForbidden %s", 403, payload)
}

func (o *GetReleaseStreamsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/releaseStreams][%d] getReleaseStreamsForbidden %s", 403, payload)
}

func (o *GetReleaseStreamsForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetReleaseStreamsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
