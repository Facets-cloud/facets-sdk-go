...
func (o *GetAzForRegionByCloudReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetAzForRegionByCloudForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetAzForRegionByCloudForbidden creates a GetAzForRegionByCloudForbidden with default headers values
func NewGetAzForRegionByCloudForbidden() *GetAzForRegionByCloudForbidden {
	return &GetAzForRegionByCloudForbidden{}
}

/*
GetAzForRegionByCloudForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetAzForRegionByCloudForbidden struct {
	Payload string
}

// IsSuccess returns true when this get az for region by cloud forbidden response has a 2xx status code
func (o *GetAzForRegionByCloudForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get az for region by cloud forbidden response has a 3xx status code
func (o *GetAzForRegionByCloudForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get az for region by cloud forbidden response has a 4xx status code
func (o *GetAzForRegionByCloudForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get az for region by cloud forbidden response has a 5xx status code
func (o *GetAzForRegionByCloudForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get az for region by cloud forbidden response a status code equal to that given
func (o *GetAzForRegionByCloudForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get az for region by cloud forbidden response
func (o *GetAzForRegionByCloudForbidden) Code() int {
	return 403
}

func (o *GetAzForRegionByCloudForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/{cloud}/region/{region}/availability-zones][%d] getAzForRegionByCloudForbidden %s", 403, payload)
}

func (o *GetAzForRegionByCloudForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/{cloud}/region/{region}/availability-zones][%d] getAzForRegionByCloudForbidden %s", 403, payload)
}

func (o *GetAzForRegionByCloudForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetAzForRegionByCloudForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
