...
func (o *GetFileFromFacetsModulesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetFileFromFacetsModulesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetFileFromFacetsModulesForbidden creates a GetFileFromFacetsModulesForbidden with default headers values
func NewGetFileFromFacetsModulesForbidden() *GetFileFromFacetsModulesForbidden {
	return &GetFileFromFacetsModulesForbidden{}
}

/*
GetFileFromFacetsModulesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetFileFromFacetsModulesForbidden struct {
	Payload string
}

// IsSuccess returns true when this get file from facets modules forbidden response has a 2xx status code
func (o *GetFileFromFacetsModulesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get file from facets modules forbidden response has a 3xx status code
func (o *GetFileFromFacetsModulesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get file from facets modules forbidden response has a 4xx status code
func (o *GetFileFromFacetsModulesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get file from facets modules forbidden response has a 5xx status code
func (o *GetFileFromFacetsModulesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get file from facets modules forbidden response a status code equal to that given
func (o *GetFileFromFacetsModulesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get file from facets modules forbidden response
func (o *GetFileFromFacetsModulesForbidden) Code() int {
	return 403
}

func (o *GetFileFromFacetsModulesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/file][%d] getFileFromFacetsModulesForbidden %s", 403, payload)
}

func (o *GetFileFromFacetsModulesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/file][%d] getFileFromFacetsModulesForbidden %s", 403, payload)
}

func (o *GetFileFromFacetsModulesForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetFileFromFacetsModulesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
