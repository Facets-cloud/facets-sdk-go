...
func (o *SyncSubstackGitHistoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewSyncSubstackGitHistoryForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSyncSubstackGitHistoryForbidden creates a SyncSubstackGitHistoryForbidden with default headers values
func NewSyncSubstackGitHistoryForbidden() *SyncSubstackGitHistoryForbidden {
	return &SyncSubstackGitHistoryForbidden{}
}

/*
SyncSubstackGitHistoryForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type SyncSubstackGitHistoryForbidden struct {
	Payload string
}

// IsSuccess returns true when this sync substack git history forbidden response has a 2xx status code
func (o *SyncSubstackGitHistoryForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this sync substack git history forbidden response has a 3xx status code
func (o *SyncSubstackGitHistoryForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this sync substack git history forbidden response has a 4xx status code
func (o *SyncSubstackGitHistoryForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this sync substack git history forbidden response has a 5xx status code
func (o *SyncSubstackGitHistoryForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this sync substack git history forbidden response a status code equal to that given
func (o *SyncSubstackGitHistoryForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the sync substack git history forbidden response
func (o *SyncSubstackGitHistoryForbidden) Code() int {
	return 403
}

func (o *SyncSubstackGitHistoryForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/dropdown/logs/substack][%d] syncSubstackGitHistoryForbidden %s", 403, payload)
}

func (o *SyncSubstackGitHistoryForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/dropdown/logs/substack][%d] syncSubstackGitHistoryForbidden %s", 403, payload)
}

func (o *SyncSubstackGitHistoryForbidden) GetPayload() string {
	return o.Payload
}

func (o *SyncSubstackGitHistoryForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
