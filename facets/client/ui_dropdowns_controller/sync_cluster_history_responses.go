...
func (o *SyncClusterHistoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewSyncClusterHistoryForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSyncClusterHistoryForbidden creates a SyncClusterHistoryForbidden with default headers values
func NewSyncClusterHistoryForbidden() *SyncClusterHistoryForbidden {
	return &SyncClusterHistoryForbidden{}
}

/*
SyncClusterHistoryForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type SyncClusterHistoryForbidden struct {
	Payload string
}

// IsSuccess returns true when this sync cluster history forbidden response has a 2xx status code
func (o *SyncClusterHistoryForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this sync cluster history forbidden response has a 3xx status code
func (o *SyncClusterHistoryForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this sync cluster history forbidden response has a 4xx status code
func (o *SyncClusterHistoryForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this sync cluster history forbidden response has a 5xx status code
func (o *SyncClusterHistoryForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this sync cluster history forbidden response a status code equal to that given
func (o *SyncClusterHistoryForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the sync cluster history forbidden response
func (o *SyncClusterHistoryForbidden) Code() int {
	return 403
}

func (o *SyncClusterHistoryForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/dropdown/logs/cluster/{clusterId}][%d] syncClusterHistoryForbidden %s", 403, payload)
}

func (o *SyncClusterHistoryForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/dropdown/logs/cluster/{clusterId}][%d] syncClusterHistoryForbidden %s", 403, payload)
}

func (o *SyncClusterHistoryForbidden) GetPayload() string {
	return o.Payload
}

func (o *SyncClusterHistoryForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
