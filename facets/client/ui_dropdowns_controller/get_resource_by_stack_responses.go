...
func (o *GetResourceByStackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetResourceByStackForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetResourceByStackForbidden creates a GetResourceByStackForbidden with default headers values
func NewGetResourceByStackForbidden() *GetResourceByStackForbidden {
	return &GetResourceByStackForbidden{}
}

/*
GetResourceByStackForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetResourceByStackForbidden struct {
	Payload string
}

// IsSuccess returns true when this get resource by stack forbidden response has a 2xx status code
func (o *GetResourceByStackForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get resource by stack forbidden response has a 3xx status code
func (o *GetResourceByStackForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get resource by stack forbidden response has a 4xx status code
func (o *GetResourceByStackForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get resource by stack forbidden response has a 5xx status code
func (o *GetResourceByStackForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get resource by stack forbidden response a status code equal to that given
func (o *GetResourceByStackForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get resource by stack forbidden response
func (o *GetResourceByStackForbidden) Code() int {
	return 403
}

func (o *GetResourceByStackForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/stack/{stackName}/{resourceType}/{resourceName}/resource-info][%d] getResourceByStackForbidden %s", 403, payload)
}

func (o *GetResourceByStackForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/dropdown/stack/{stackName}/{resourceType}/{resourceName}/resource-info][%d] getResourceByStackForbidden %s", 403, payload)
}

func (o *GetResourceByStackForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetResourceByStackForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
