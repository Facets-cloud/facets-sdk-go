...
func (o *TriggerRollbackPlanReleaseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewTriggerRollbackPlanReleaseForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTriggerRollbackPlanReleaseForbidden creates a TriggerRollbackPlanReleaseForbidden with default headers values
func NewTriggerRollbackPlanReleaseForbidden() *TriggerRollbackPlanReleaseForbidden {
	return &TriggerRollbackPlanReleaseForbidden{}
}

/*
TriggerRollbackPlanReleaseForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type TriggerRollbackPlanReleaseForbidden struct {
	Payload string
}

// IsSuccess returns true when this trigger rollback plan release forbidden response has a 2xx status code
func (o *TriggerRollbackPlanReleaseForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this trigger rollback plan release forbidden response has a 3xx status code
func (o *TriggerRollbackPlanReleaseForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this trigger rollback plan release forbidden response has a 4xx status code
func (o *TriggerRollbackPlanReleaseForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this trigger rollback plan release forbidden response has a 5xx status code
func (o *TriggerRollbackPlanReleaseForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this trigger rollback plan release forbidden response a status code equal to that given
func (o *TriggerRollbackPlanReleaseForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the trigger rollback plan release forbidden response
func (o *TriggerRollbackPlanReleaseForbidden) Code() int {
	return 403
}

func (o *TriggerRollbackPlanReleaseForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/deployments/{deploymentId}/{resourceType}/{resourceName}/rollback-plan][%d] triggerRollbackPlanReleaseForbidden %s", 403, payload)
}

func (o *TriggerRollbackPlanReleaseForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/deployments/{deploymentId}/{resourceType}/{resourceName}/rollback-plan][%d] triggerRollbackPlanReleaseForbidden %s", 403, payload)
}

func (o *TriggerRollbackPlanReleaseForbidden) GetPayload() string {
	return o.Payload
}

func (o *TriggerRollbackPlanReleaseForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
