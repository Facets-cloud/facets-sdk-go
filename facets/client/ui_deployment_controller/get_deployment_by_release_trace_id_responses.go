...
func (o *GetDeploymentByReleaseTraceIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetDeploymentByReleaseTraceIDForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetDeploymentByReleaseTraceIDForbidden creates a GetDeploymentByReleaseTraceIDForbidden with default headers values
func NewGetDeploymentByReleaseTraceIDForbidden() *GetDeploymentByReleaseTraceIDForbidden {
	return &GetDeploymentByReleaseTraceIDForbidden{}
}

/*
GetDeploymentByReleaseTraceIDForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetDeploymentByReleaseTraceIDForbidden struct {
	Payload string
}

// IsSuccess returns true when this get deployment by release trace Id forbidden response has a 2xx status code
func (o *GetDeploymentByReleaseTraceIDForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get deployment by release trace Id forbidden response has a 3xx status code
func (o *GetDeploymentByReleaseTraceIDForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get deployment by release trace Id forbidden response has a 4xx status code
func (o *GetDeploymentByReleaseTraceIDForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get deployment by release trace Id forbidden response has a 5xx status code
func (o *GetDeploymentByReleaseTraceIDForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get deployment by release trace Id forbidden response a status code equal to that given
func (o *GetDeploymentByReleaseTraceIDForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get deployment by release trace Id forbidden response
func (o *GetDeploymentByReleaseTraceIDForbidden) Code() int {
	return 403
}

func (o *GetDeploymentByReleaseTraceIDForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/deployments/trace-id/{releaseTraceId}][%d] getDeploymentByReleaseTraceIdForbidden %s", 403, payload)
}

func (o *GetDeploymentByReleaseTraceIDForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/deployments/trace-id/{releaseTraceId}][%d] getDeploymentByReleaseTraceIdForbidden %s", 403, payload)
}

func (o *GetDeploymentByReleaseTraceIDForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetDeploymentByReleaseTraceIDForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
