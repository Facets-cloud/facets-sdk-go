...
// Code gets the status code for the create deployment forbidden response
...
func (o *CreateDeploymentForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/deployments][%d] createDeploymentForbidden %s", 403, payload)
}
...
func (o *CreateDeploymentForbidden) GetPayload() string {
	return o.Payload
}
