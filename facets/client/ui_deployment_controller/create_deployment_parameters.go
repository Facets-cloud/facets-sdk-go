...
// WithClusterID adds the clusterID to the create deployment params
func (o *CreateDeploymentParams) WithClusterID(clusterID string) *CreateDeploymentParams {
	o.SetClusterID(clusterID)
	return o
}

// SetClusterID adds the clusterId to the create deployment params
func (o *CreateDeploymentParams) SetClusterID(clusterID string) {
