...
func (o *TriggerTerraformExportReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewTriggerTerraformExportForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTriggerTerraformExportForbidden creates a TriggerTerraformExportForbidden with default headers values
func NewTriggerTerraformExportForbidden() *TriggerTerraformExportForbidden {
	return &TriggerTerraformExportForbidden{}
}

/*
TriggerTerraformExportForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type TriggerTerraformExportForbidden struct {
	Payload string
}

// IsSuccess returns true when this trigger terraform export forbidden response has a 2xx status code
func (o *TriggerTerraformExportForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this trigger terraform export forbidden response has a 3xx status code
func (o *TriggerTerraformExportForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this trigger terraform export forbidden response has a 4xx status code
func (o *TriggerTerraformExportForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this trigger terraform export forbidden response has a 5xx status code
func (o *TriggerTerraformExportForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this trigger terraform export forbidden response a status code equal to that given
func (o *TriggerTerraformExportForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the trigger terraform export forbidden response
func (o *TriggerTerraformExportForbidden) Code() int {
	return 403
}

func (o *TriggerTerraformExportForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/deployments/terraform-export][%d] triggerTerraformExportForbidden %s", 403, payload)
}

func (o *TriggerTerraformExportForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/deployments/terraform-export][%d] triggerTerraformExportForbidden %s", 403, payload)
}

func (o *TriggerTerraformExportForbidden) GetPayload() string {
	return o.Payload
}

func (o *TriggerTerraformExportForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
