...
func (o *SearchDeploymentsParams) WithEnd(end *strfmt.DateTime) *SearchDeploymentsParams {
	o.SetEnd(end)
	return o
}

// SetEnd adds the end to the search deployments params
func (o *SearchDeploymentsParams) SetEnd(end *strfmt.DateTime) {
	o.End = end
}
...
func (o *SearchDeploymentsParams) WithPageNumber(pageNumber *int32) *SearchDeploymentsParams {
	o.SetPageNumber(pageNumber)
	return o
}

// SetPageNumber adds the pageNumber to the search deployments params
func (o *SearchDeploymentsParams) SetPageNumber(pageNumber *int32) {
	o.PageNumber = pageNumber
}

// WithPageSize adds the pageSize to the search deployments params
func (o *SearchDeploymentsParams) WithPageSize(pageSize *int32) *SearchDeploymentsParams {
	o.SetPageSize(pageSize)
	return o
}

// SetPageSize adds the pageSize to the search deployments params
func (o *SearchDeploymentsParams) SetPageSize(pageSize *int32) {
	o.PageSize = pageSize
}
...
func (o *SearchDeploymentsParams) WithSignedOff(signedOff *bool) *SearchDeploymentsParams {
	o.SetSignedOff(signedOff)
	return o
}

// SetSignedOff adds the signedOff to the search deployments params
func (o *SearchDeploymentsParams) SetSignedOff(signedOff *bool) {
	o.SignedOff = signedOff
}

// WithStart adds the start to the search deployments params
func (o *SearchDeploymentsParams) WithStart(start *strfmt.DateTime) *SearchDeploymentsParams {
	o.SetStart(start)
	return o
}

// SetStart adds the start to the search deployments params
func (o *SearchDeploymentsParams) SetStart(start *strfmt.DateTime) {
	o.Start = start
}
...
// bindParamSearchDeployments binds the parameter excludeStatus
func (o *SearchDeploymentsParams) bindParamExcludeStatus(formats strfmt.Registry) []string {
