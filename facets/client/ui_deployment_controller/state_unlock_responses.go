...
func (o *StateUnlockReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewStateUnlockForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewStateUnlockForbidden creates a StateUnlockForbidden with default headers values
func NewStateUnlockForbidden() *StateUnlockForbidden {
	return &StateUnlockForbidden{}
}

/*
StateUnlockForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type StateUnlockForbidden struct {
	Payload string
}

// IsSuccess returns true when this state unlock forbidden response has a 2xx status code
func (o *StateUnlockForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this state unlock forbidden response has a 3xx status code
func (o *StateUnlockForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this state unlock forbidden response has a 4xx status code
func (o *StateUnlockForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this state unlock forbidden response has a 5xx status code
func (o *StateUnlockForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this state unlock forbidden response a status code equal to that given
func (o *StateUnlockForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the state unlock forbidden response
func (o *StateUnlockForbidden) Code() int {
	return 403
}

func (o *StateUnlockForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/clusters/{clusterId}/deployments/unlock][%d] stateUnlockForbidden %s", 403, payload)
}

func (o *StateUnlockForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/clusters/{clusterId}/deployments/unlock][%d] stateUnlockForbidden %s", 403, payload)
}

func (o *StateUnlockForbidden) GetPayload() string {
	return o.Payload
}

func (o *StateUnlockForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
