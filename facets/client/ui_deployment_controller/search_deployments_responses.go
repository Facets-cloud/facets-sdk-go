...
func (o *SearchDeploymentsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewSearchDeploymentsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewSearchDeploymentsForbidden creates a SearchDeploymentsForbidden with default headers values
func NewSearchDeploymentsForbidden() *SearchDeploymentsForbidden {
	return &SearchDeploymentsForbidden{}
}

/*
SearchDeploymentsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type SearchDeploymentsForbidden struct {
	Payload string
}

// IsSuccess returns true when this search deployments forbidden response has a 2xx status code
func (o *SearchDeploymentsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this search deployments forbidden response has a 3xx status code
func (o *SearchDeploymentsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this search deployments forbidden response has a 4xx status code
func (o *SearchDeploymentsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this search deployments forbidden response has a 5xx status code
func (o *SearchDeploymentsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this search deployments forbidden response a status code equal to that given
func (o *SearchDeploymentsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the search deployments forbidden response
func (o *SearchDeploymentsForbidden) Code() int {
	return 403
}

func (o *SearchDeploymentsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/deployments/search][%d] searchDeploymentsForbidden %s", 403, payload)
}

func (o *SearchDeploymentsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/deployments/search][%d] searchDeploymentsForbidden %s", 403, payload)
}

func (o *SearchDeploymentsForbidden) GetPayload() string {
	return o.Payload
}

func (o *SearchDeploymentsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
