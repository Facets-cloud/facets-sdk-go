...
func (o *GetLatestReleaseByApplicationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetLatestReleaseByApplicationForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetLatestReleaseByApplicationForbidden creates a GetLatestReleaseByApplicationForbidden with default headers values
func NewGetLatestReleaseByApplicationForbidden() *GetLatestReleaseByApplicationForbidden {
	return &GetLatestReleaseByApplicationForbidden{}
}

/*
GetLatestReleaseByApplicationForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetLatestReleaseByApplicationForbidden struct {
	Payload string
}

// IsSuccess returns true when this get latest release by application forbidden response has a 2xx status code
func (o *GetLatestReleaseByApplicationForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get latest release by application forbidden response has a 3xx status code
func (o *GetLatestReleaseByApplicationForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get latest release by application forbidden response has a 4xx status code
func (o *GetLatestReleaseByApplicationForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get latest release by application forbidden response has a 5xx status code
func (o *GetLatestReleaseByApplicationForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get latest release by application forbidden response a status code equal to that given
func (o *GetLatestReleaseByApplicationForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get latest release by application forbidden response
func (o *GetLatestReleaseByApplicationForbidden) Code() int {
	return 403
}

func (o *GetLatestReleaseByApplicationForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/deployments/latest-successful-release/{application}][%d] getLatestReleaseByApplicationForbidden %s", 403, payload)
}

func (o *GetLatestReleaseByApplicationForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/deployments/latest-successful-release/{application}][%d] getLatestReleaseByApplicationForbidden %s", 403, payload)
}

func (o *GetLatestReleaseByApplicationForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetLatestReleaseByApplicationForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
