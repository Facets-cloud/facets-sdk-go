...
func (o *StreamDeploymentLogsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewStreamDeploymentLogsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewStreamDeploymentLogsForbidden creates a StreamDeploymentLogsForbidden with default headers values
func NewStreamDeploymentLogsForbidden() *StreamDeploymentLogsForbidden {
	return &StreamDeploymentLogsForbidden{}
}

/*
StreamDeploymentLogsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type StreamDeploymentLogsForbidden struct {
	Payload string
}

// IsSuccess returns true when this stream deployment logs forbidden response has a 2xx status code
func (o *StreamDeploymentLogsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this stream deployment logs forbidden response has a 3xx status code
func (o *StreamDeploymentLogsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this stream deployment logs forbidden response has a 4xx status code
func (o *StreamDeploymentLogsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this stream deployment logs forbidden response has a 5xx status code
func (o *StreamDeploymentLogsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this stream deployment logs forbidden response a status code equal to that given
func (o *StreamDeploymentLogsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the stream deployment logs forbidden response
func (o *StreamDeploymentLogsForbidden) Code() int {
	return 403
}

func (o *StreamDeploymentLogsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/deployments/{deploymentId}/logs/stream][%d] streamDeploymentLogsForbidden %s", 403, payload)
}

func (o *StreamDeploymentLogsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/deployments/{deploymentId}/logs/stream][%d] streamDeploymentLogsForbidden %s", 403, payload)
}

func (o *StreamDeploymentLogsForbidden) GetPayload() string {
	return o.Payload
}

func (o *StreamDeploymentLogsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
