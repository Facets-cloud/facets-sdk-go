...
func (o *ReleaseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ReleaseForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/clusters/{clusterId}/deployments/release][%d] releaseForbidden %s", 403, payload)
}
...
func (o *ReleaseForbidden) GetPayload() string {
	return o.Payload
}
