...
// IsSuccess returns true when this get deployment forbidden response has a 2xx status code
func (o *GetDeploymentForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get deployment forbidden response has a 3xx status code
func (o *GetDeploymentForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get deployment forbidden response has a 4xx status code
func (o *GetDeploymentForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get deployment forbidden response has a 5xx status code
func (o *GetDeploymentForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get deployment forbidden response a status code equal to that given
func (o *GetDeploymentForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get deployment forbidden response
...
func (o *GetDeploymentForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/deployments/{deploymentId}][%d] getDeploymentForbidden %s", 403, payload)
}
...
func (o *GetDeploymentForbidden) GetPayload() string {
	return o.Payload
}
