...
// WithClusterID adds the clusterID to the simulate params
func (o *SimulateParams) WithClusterID(clusterID string) *SimulateParams {
	o.SetClusterID(clusterID)
	return o
}

// SetClusterID adds the clusterId to the simulate params
func (o *SimulateParams) SetClusterID(clusterID string) {
