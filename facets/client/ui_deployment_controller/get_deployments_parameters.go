...
// WithClusterID adds the clusterID to the get deployments params
func (o *GetDeploymentsParams) WithClusterID(clusterID string) *GetDeploymentsParams {
	o.SetClusterID(clusterID)
	return o
}

// SetClusterID adds the clusterId to the get deployments params
func (o *GetDeploymentsParams) SetClusterID(clusterID string) {
