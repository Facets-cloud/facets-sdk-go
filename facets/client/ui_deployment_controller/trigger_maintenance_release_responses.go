...
func (o *TriggerMaintenanceReleaseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewTriggerMaintenanceReleaseForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewTriggerMaintenanceReleaseForbidden creates a TriggerMaintenanceReleaseForbidden with default headers values
func NewTriggerMaintenanceReleaseForbidden() *TriggerMaintenanceReleaseForbidden {
	return &TriggerMaintenanceReleaseForbidden{}
}

/*
TriggerMaintenanceReleaseForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type TriggerMaintenanceReleaseForbidden struct {
	Payload string
}

// IsSuccess returns true when this trigger maintenance release forbidden response has a 2xx status code
func (o *TriggerMaintenanceReleaseForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this trigger maintenance release forbidden response has a 3xx status code
func (o *TriggerMaintenanceReleaseForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this trigger maintenance release forbidden response has a 4xx status code
func (o *TriggerMaintenanceReleaseForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this trigger maintenance release forbidden response has a 5xx status code
func (o *TriggerMaintenanceReleaseForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this trigger maintenance release forbidden response a status code equal to that given
func (o *TriggerMaintenanceReleaseForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the trigger maintenance release forbidden response
func (o *TriggerMaintenanceReleaseForbidden) Code() int {
	return 403
}

func (o *TriggerMaintenanceReleaseForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/deployments/maintenance][%d] triggerMaintenanceReleaseForbidden %s", 403, payload)
}

func (o *TriggerMaintenanceReleaseForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/deployments/maintenance][%d] triggerMaintenanceReleaseForbidden %s", 403, payload)
}

func (o *TriggerMaintenanceReleaseForbidden) GetPayload() string {
	return o.Payload
}

func (o *TriggerMaintenanceReleaseForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
