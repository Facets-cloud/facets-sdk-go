...
func (o *RunHotfixDeploymentRecipeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRunHotfixDeploymentRecipeForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRunHotfixDeploymentRecipeForbidden creates a RunHotfixDeploymentRecipeForbidden with default headers values
func NewRunHotfixDeploymentRecipeForbidden() *RunHotfixDeploymentRecipeForbidden {
	return &RunHotfixDeploymentRecipeForbidden{}
}

/*
RunHotfixDeploymentRecipeForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RunHotfixDeploymentRecipeForbidden struct {
	Payload string
}

// IsSuccess returns true when this run hotfix deployment recipe forbidden response has a 2xx status code
func (o *RunHotfixDeploymentRecipeForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this run hotfix deployment recipe forbidden response has a 3xx status code
func (o *RunHotfixDeploymentRecipeForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this run hotfix deployment recipe forbidden response has a 4xx status code
func (o *RunHotfixDeploymentRecipeForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this run hotfix deployment recipe forbidden response has a 5xx status code
func (o *RunHotfixDeploymentRecipeForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this run hotfix deployment recipe forbidden response a status code equal to that given
func (o *RunHotfixDeploymentRecipeForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the run hotfix deployment recipe forbidden response
func (o *RunHotfixDeploymentRecipeForbidden) Code() int {
	return 403
}

func (o *RunHotfixDeploymentRecipeForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/deployments/recipes/deployment/hotfix][%d] runHotfixDeploymentRecipeForbidden %s", 403, payload)
}

func (o *RunHotfixDeploymentRecipeForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/deployments/recipes/deployment/hotfix][%d] runHotfixDeploymentRecipeForbidden %s", 403, payload)
}

func (o *RunHotfixDeploymentRecipeForbidden) GetPayload() string {
	return o.Payload
}

func (o *RunHotfixDeploymentRecipeForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
