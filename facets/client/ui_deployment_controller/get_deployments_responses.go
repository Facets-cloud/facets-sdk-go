...
func (o *GetDeploymentsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/deployments][%d] getDeploymentsForbidden %s", 403, payload)
}
...
func (o *GetDeploymentsForbidden) GetPayload() string {
	return o.Payload
}
