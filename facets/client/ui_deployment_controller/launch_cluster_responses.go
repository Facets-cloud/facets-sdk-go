...
func (o *LaunchClusterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewLaunchClusterForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewLaunchClusterForbidden creates a LaunchClusterForbidden with default headers values
func NewLaunchClusterForbidden() *LaunchClusterForbidden {
	return &LaunchClusterForbidden{}
}

/*
LaunchClusterForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type LaunchClusterForbidden struct {
	Payload string
}

// IsSuccess returns true when this launch cluster forbidden response has a 2xx status code
func (o *LaunchClusterForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this launch cluster forbidden response has a 3xx status code
func (o *LaunchClusterForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this launch cluster forbidden response has a 4xx status code
func (o *LaunchClusterForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this launch cluster forbidden response has a 5xx status code
func (o *LaunchClusterForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this launch cluster forbidden response a status code equal to that given
func (o *LaunchClusterForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the launch cluster forbidden response
func (o *LaunchClusterForbidden) Code() int {
	return 403
}

func (o *LaunchClusterForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/clusters/{clusterId}/deployments/launch][%d] launchClusterForbidden %s", 403, payload)
}

func (o *LaunchClusterForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/clusters/{clusterId}/deployments/launch][%d] launchClusterForbidden %s", 403, payload)
}

func (o *LaunchClusterForbidden) GetPayload() string {
	return o.Payload
}

func (o *LaunchClusterForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
