...
func (o *RejectReleaseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewRejectReleaseForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewRejectReleaseForbidden creates a RejectReleaseForbidden with default headers values
func NewRejectReleaseForbidden() *RejectReleaseForbidden {
	return &RejectReleaseForbidden{}
}

/*
RejectReleaseForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type RejectReleaseForbidden struct {
	Payload string
}

// IsSuccess returns true when this reject release forbidden response has a 2xx status code
func (o *RejectReleaseForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this reject release forbidden response has a 3xx status code
func (o *RejectReleaseForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this reject release forbidden response has a 4xx status code
func (o *RejectReleaseForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this reject release forbidden response has a 5xx status code
func (o *RejectReleaseForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this reject release forbidden response a status code equal to that given
func (o *RejectReleaseForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the reject release forbidden response
func (o *RejectReleaseForbidden) Code() int {
	return 403
}

func (o *RejectReleaseForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/deployments/{deploymentId}/rejectRelease][%d] rejectReleaseForbidden %s", 403, payload)
}

func (o *RejectReleaseForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/deployments/{deploymentId}/rejectRelease][%d] rejectReleaseForbidden %s", 403, payload)
}

func (o *RejectReleaseForbidden) GetPayload() string {
	return o.Payload
}

func (o *RejectReleaseForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
