...
func (o *GetReleaseChangesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetReleaseChangesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetReleaseChangesForbidden creates a GetReleaseChangesForbidden with default headers values
func NewGetReleaseChangesForbidden() *GetReleaseChangesForbidden {
	return &GetReleaseChangesForbidden{}
}

/*
GetReleaseChangesForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetReleaseChangesForbidden struct {
	Payload string
}

// IsSuccess returns true when this get release changes forbidden response has a 2xx status code
func (o *GetReleaseChangesForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get release changes forbidden response has a 3xx status code
func (o *GetReleaseChangesForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get release changes forbidden response has a 4xx status code
func (o *GetReleaseChangesForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get release changes forbidden response has a 5xx status code
func (o *GetReleaseChangesForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get release changes forbidden response a status code equal to that given
func (o *GetReleaseChangesForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get release changes forbidden response
func (o *GetReleaseChangesForbidden) Code() int {
	return 403
}

func (o *GetReleaseChangesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/deployments/{deploymentId}/release-changes][%d] getReleaseChangesForbidden %s", 403, payload)
}

func (o *GetReleaseChangesForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/deployments/{deploymentId}/release-changes][%d] getReleaseChangesForbidden %s", 403, payload)
}

func (o *GetReleaseChangesForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetReleaseChangesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
