...
func (o *GetLatestReleaseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewGetLatestReleaseForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewGetLatestReleaseForbidden creates a GetLatestReleaseForbidden with default headers values
func NewGetLatestReleaseForbidden() *GetLatestReleaseForbidden {
	return &GetLatestReleaseForbidden{}
}

/*
GetLatestReleaseForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type GetLatestReleaseForbidden struct {
	Payload string
}

// IsSuccess returns true when this get latest release forbidden response has a 2xx status code
func (o *GetLatestReleaseForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get latest release forbidden response has a 3xx status code
func (o *GetLatestReleaseForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get latest release forbidden response has a 4xx status code
func (o *GetLatestReleaseForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get latest release forbidden response has a 5xx status code
func (o *GetLatestReleaseForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get latest release forbidden response a status code equal to that given
func (o *GetLatestReleaseForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get latest release forbidden response
func (o *GetLatestReleaseForbidden) Code() int {
	return 403
}

func (o *GetLatestReleaseForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/deployments/latest-successful-release][%d] getLatestReleaseForbidden %s", 403, payload)
}

func (o *GetLatestReleaseForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/deployments/latest-successful-release][%d] getLatestReleaseForbidden %s", 403, payload)
}

func (o *GetLatestReleaseForbidden) GetPayload() string {
	return o.Payload
}

func (o *GetLatestReleaseForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
