...
// WithClusterID adds the clusterID to the get cluster state params
func (o *GetClusterStateParams) WithClusterID(clusterID string) *GetClusterStateParams {
	o.SetClusterID(clusterID)
	return o
}

// SetClusterID adds the clusterId to the get cluster state params
func (o *GetClusterStateParams) SetClusterID(clusterID string) {
