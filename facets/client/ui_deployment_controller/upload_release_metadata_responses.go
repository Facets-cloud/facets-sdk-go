...
func (o *UploadReleaseMetadataReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUploadReleaseMetadataForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUploadReleaseMetadataForbidden creates a UploadReleaseMetadataForbidden with default headers values
func NewUploadReleaseMetadataForbidden() *UploadReleaseMetadataForbidden {
	return &UploadReleaseMetadataForbidden{}
}

/*
UploadReleaseMetadataForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UploadReleaseMetadataForbidden struct {
	Payload string
}

// IsSuccess returns true when this upload release metadata forbidden response has a 2xx status code
func (o *UploadReleaseMetadataForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this upload release metadata forbidden response has a 3xx status code
func (o *UploadReleaseMetadataForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this upload release metadata forbidden response has a 4xx status code
func (o *UploadReleaseMetadataForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this upload release metadata forbidden response has a 5xx status code
func (o *UploadReleaseMetadataForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this upload release metadata forbidden response a status code equal to that given
func (o *UploadReleaseMetadataForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the upload release metadata forbidden response
func (o *UploadReleaseMetadataForbidden) Code() int {
	return 403
}

func (o *UploadReleaseMetadataForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/deployments/{deploymentId}/upload-release-metadata][%d] uploadReleaseMetadataForbidden %s", 403, payload)
}

func (o *UploadReleaseMetadataForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/deployments/{deploymentId}/upload-release-metadata][%d] uploadReleaseMetadataForbidden %s", 403, payload)
}

func (o *UploadReleaseMetadataForbidden) GetPayload() string {
	return o.Payload
}

func (o *UploadReleaseMetadataForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
