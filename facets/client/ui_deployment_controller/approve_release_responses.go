...
func (o *ApproveReleaseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewApproveReleaseForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewApproveReleaseForbidden creates a ApproveReleaseForbidden with default headers values
func NewApproveReleaseForbidden() *ApproveReleaseForbidden {
	return &ApproveReleaseForbidden{}
}

/*
ApproveReleaseForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type ApproveReleaseForbidden struct {
	Payload string
}

// IsSuccess returns true when this approve release forbidden response has a 2xx status code
func (o *ApproveReleaseForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this approve release forbidden response has a 3xx status code
func (o *ApproveReleaseForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this approve release forbidden response has a 4xx status code
func (o *ApproveReleaseForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this approve release forbidden response has a 5xx status code
func (o *ApproveReleaseForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this approve release forbidden response a status code equal to that given
func (o *ApproveReleaseForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the approve release forbidden response
func (o *ApproveReleaseForbidden) Code() int {
	return 403
}

func (o *ApproveReleaseForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/deployments/{deploymentId}/approveRelease][%d] approveReleaseForbidden %s", 403, payload)
}

func (o *ApproveReleaseForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /cc-ui/v1/clusters/{clusterId}/deployments/{deploymentId}/approveRelease][%d] approveReleaseForbidden %s", 403, payload)
}

func (o *ApproveReleaseForbidden) GetPayload() string {
	return o.Payload
}

func (o *ApproveReleaseForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
