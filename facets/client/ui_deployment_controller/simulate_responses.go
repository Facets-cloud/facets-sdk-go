...
func (o *SimulateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// NewSimulateForbidden creates a SimulateForbidden with default headers values
func NewSimulateForbidden() *SimulateForbidden {
	return &SimulateForbidden{}
}

/*
SimulateForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type SimulateForbidden struct {
	Payload string
}

// IsSuccess returns true when this simulate forbidden response has a 2xx status code
func (o *SimulateForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this simulate forbidden response has a 3xx status code
func (o *SimulateForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this simulate forbidden response has a 4xx status code
func (o *SimulateForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this simulate forbidden response has a 5xx status code
func (o *SimulateForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this simulate forbidden response a status code equal to that given
func (o *SimulateForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the simulate forbidden response
func (o *SimulateForbidden) Code() int {
	return 403
}

func (o *SimulateForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/deployments/simulate][%d] simulateForbidden %s", 403, payload)
}

func (o *SimulateForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /cc-ui/v1/clusters/{clusterId}/deployments/simulate][%d] simulateForbidden %s", 403, payload)
}

func (o *SimulateForbidden) GetPayload() string {
	return o.Payload
}

func (o *SimulateForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
