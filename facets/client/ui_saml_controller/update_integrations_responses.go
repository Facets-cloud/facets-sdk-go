...
func (o *UpdateIntegrationsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateIntegrationsForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /cc-ui/v1/saml/{registrationId}] updateIntegrations", response, response.Code())
	}
}
...
func (o *UpdateIntegrationsOK) Error() string {
	...
	return fmt.Sprintf("[PUT /cc-ui/v1/saml/{registrationId}][%d] updateIntegrationsOK %s", 200, payload)
}
...
func (o *UpdateIntegrationsOK) GetPayload() []*models.CustomSamlRegistration {
	return o.Payload
}
...
func (o *UpdateIntegrationsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/saml/{registrationId}][%d] updateIntegrationsBadRequest %s", 400, payload)
}
...
// NewUpdateIntegrationsForbidden creates a UpdateIntegrationsForbidden with default headers values
func NewUpdateIntegrationsForbidden() *UpdateIntegrationsForbidden {
	return &UpdateIntegrationsForbidden{}
}

/*
UpdateIntegrationsForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateIntegrationsForbidden struct {
	Payload string
}

// IsSuccess returns true when this update integrations forbidden response has a 2xx status code
func (o *UpdateIntegrationsForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update integrations forbidden response has a 3xx status code
func (o *UpdateIntegrationsForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update integrations forbidden response has a 4xx status code
func (o *UpdateIntegrationsForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update integrations forbidden response has a 5xx status code
func (o *UpdateIntegrationsForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update integrations forbidden response a status code equal to that given
func (o *UpdateIntegrationsForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update integrations forbidden response
func (o *UpdateIntegrationsForbidden) Code() int {
	return 403
}

func (o *UpdateIntegrationsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/saml/{registrationId}][%d] updateIntegrationsForbidden %s", 403, payload)
}

func (o *UpdateIntegrationsForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/saml/{registrationId}][%d] updateIntegrationsForbidden %s", 403, payload)
}

func (o *UpdateIntegrationsForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateIntegrationsForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *UpdateIntegrationsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/saml/{registrationId}][%d] updateIntegrationsNotFound %s", 404, payload)
}
...
func (o *UpdateIntegrationsMethodNotAllowed) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/saml/{registrationId}][%d] updateIntegrationsMethodNotAllowed %s", 405, payload)
}
...
func (o *UpdateIntegrationsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/saml/{registrationId}][%d] updateIntegrationsInternalServerError %s", 500, payload)
}
