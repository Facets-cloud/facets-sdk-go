...
func (o *UpdateK8sClusterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 400:
		...
		return nil, result
	case 403:
		result := NewUpdateK8sClusterForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateK8sClusterForbidden creates a UpdateK8sClusterForbidden with default headers values
func NewUpdateK8sClusterForbidden() *UpdateK8sClusterForbidden {
	return &UpdateK8sClusterForbidden{}
}

/*
UpdateK8sClusterForbidden describes a response with status code 403, with default header values.

Forbidden
*/
type UpdateK8sClusterForbidden struct {
	Payload string
}

// IsSuccess returns true when this update k8s cluster forbidden response has a 2xx status code
func (o *UpdateK8sClusterForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this update k8s cluster forbidden response has a 3xx status code
func (o *UpdateK8sClusterForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update k8s cluster forbidden response has a 4xx status code
func (o *UpdateK8sClusterForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this update k8s cluster forbidden response has a 5xx status code
func (o *UpdateK8sClusterForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this update k8s cluster forbidden response a status code equal to that given
func (o *UpdateK8sClusterForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the update k8s cluster forbidden response
func (o *UpdateK8sClusterForbidden) Code() int {
	return 403
}

func (o *UpdateK8sClusterForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/kubernetes/clusters/{clusterId}][%d] updateK8sClusterForbidden %s", 403, payload)
}

func (o *UpdateK8sClusterForbidden) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /cc-ui/v1/kubernetes/clusters/{clusterId}][%d] updateK8sClusterForbidden %s", 403, payload)
}

func (o *UpdateK8sClusterForbidden) GetPayload() string {
	return o.Payload
}

func (o *UpdateK8sClusterForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
